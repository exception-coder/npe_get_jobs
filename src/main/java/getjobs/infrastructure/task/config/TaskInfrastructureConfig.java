package getjobs.infrastructure.task.config;

import getjobs.infrastructure.task.contract.TaskNotificationListener;
import getjobs.infrastructure.task.executor.TaskExecutor;
import getjobs.infrastructure.task.executor.UniqueTaskManager;
