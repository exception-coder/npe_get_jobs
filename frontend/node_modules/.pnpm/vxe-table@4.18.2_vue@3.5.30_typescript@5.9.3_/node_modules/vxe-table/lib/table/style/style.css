...
.vxe-table-custom-popup--table-wrapper table tr {
  box-sizing: border-box;
}
...
.vxe-table--render-default .vxe-body--row-expanded-cell.is--padding .vxe-body--row-expanded-content {
  padding: var(--vxe-ui-table-expand-padding-default);
}
.vxe-table--render-default .vxe-body--row-expanded-content {
  background-color: var(--vxe-ui-layout-background-color);
}
...
.vxe-table--render-default .vxe-body--column.col--valid-error.show--valid-bg {
