...
export interface IChartBuilderInfo {
    /**
     * @property {string} unitId The unit id of the chart.
     */
    unitId: string;
    /**
     * @property {string} subUnitId The sub unit id of the chart.
     */
    subUnitId: string;
    /**
     * @property {string} chartId The chart id of the chart.
     */
    chartId: string;
    /**
    ...
    height: number;
    /**
     * @property {ChartTypeBits} chartType The chart type of the chart.
     */
...
export declare class FChartBuilderBase extends FBase {
    ...
    range: IRange | undefined;
    /**
     * @property {string} sourceSheetName The source sheet name of the chart.
     */
