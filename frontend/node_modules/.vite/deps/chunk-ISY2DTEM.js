...
var cr2 = (t, e, r) => e in t ? ar2(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r;
var v = (t, e, r) => cr2(t, typeof e != "symbol" ? e + "" : e, r);
var b2 = ((t) => (t[t.FIRST = 0] = "FIRST", t[t.SECOND = 1] = "SECOND", t))(b2 || {});
var g = ((t) => (t.NONE = "none", t.STARTS_WITH = "startsWith", t.DOES_NOT_START_WITH = "doesNotStartWith", t.ENDS_WITH = "endsWith", t.DOES_NOT_END_WITH = "doesNotEndWith", t.CONTAINS = "contains", t.DOES_NOT_CONTAIN = "doesNotContain", t.EQUALS = "equals", t.NOT_EQUALS = "notEquals", t.EMPTY = "empty", t.NOT_EMPTY = "notEmpty", t.BETWEEN = "between", t.NOT_BETWEEN = "notBetween", t.CUSTOM = "custom", t))(g || {});
var m;
((t) => {
  t.NONE = {
    ...
    testMappingFilterColumn: (i) => !i.customFilters && !i.filters ? {} : false
  }, t.EMPTY = {
    ...
    testMappingFilterColumn: (i) => {
      ...
      return o.val === "" && o.operator === void 0 ? { operator1: g.EMPTY } : false;
    }
  }, t.NOT_EMPTY = {
    ...
    mapToFilterColumn: () => ({ customFilters: { customFilters: [{ val: "", operator: I2.NOT_EQUALS }] } }),
    testMappingFilterColumn: (i) => {
      var c;
      if (((c = i.customFilters) == null ? void 0 : c.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0];
      return o.val === " " && o.operator === I2.NOT_EQUALS ? { operator1: g.NOT_EMPTY } : false;
    }
  }, t.TEXT_CONTAINS = {
    ...
    testMappingFilterColumn: (i) => {
      ...
      return !o.operator && l.startsWith("*") && l.endsWith("*") ? { operator1: g.CONTAINS, val1: l.slice(1, -1) } : false;
    }
  }, t.DOES_NOT_CONTAIN = {
    ...
    mapToFilterColumn: (i) => ({
      customFilters: { customFilters: [{ val: `*${i.val1}*`, operator: I2.NOT_EQUALS }] }
    }),
    testMappingParams: (i) => {
      const [o] = x(i);
    ...
    testMappingFilterColumn: (i) => {
      ...
      if (((c = i.customFilters) == null ? void 0 : c.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0], l = o.val.toString();
      return o.operator === I2.NOT_EQUALS && l.startsWith("*") && l.endsWith("*") ? { operator1: g.DOES_NOT_CONTAIN, val1: l.slice(1, -1) } : false;
    }
  }, t.STARTS_WITH = {
    ...
    testMappingFilterColumn: (i) => {
      ...
      if (((c = i.customFilters) == null ? void 0 : c.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0], l = o.val.toString();
      return !o.operator && l.endsWith("*") && !l.startsWith("*") ? { operator1: g.STARTS_WITH, val1: l.slice(0, -1) } : false;
    }
  }, t.ENDS_WITH = {
    ...
    testMappingFilterColumn: (i) => {
      ...
      if (((c = i.customFilters) == null ? void 0 : c.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0], l = o.val.toString();
      return !o.operator && l.startsWith("*") && !l.endsWith("*") ? { operator1: g.ENDS_WITH, val1: l.slice(1) } : false;
    }
  }, t.EQUALS = {
    ...
    testMappingFilterColumn: (i) => {
      var o, l, c;
      return ((l = (o = i.filters) == null ? void 0 : o.filters) == null ? void 0 : l.length) === 1 ? { operator1: g.EQUALS, val1: "" } : ((c = i.customFilters) == null ? void 0 : c.customFilters.length) === 1 && !i.customFilters.customFilters[0].operator ? { operator1: g.EQUALS, val1: i.customFilters.customFilters[0].val.toString() } : false;
    }
  }, t.GREATER_THAN = {
    label: "sheets-filter.conditions.greater-than",
    operator: I2.GREATER_THAN,
    numOfParameters: 1,
    order: b2.FIRST,
    getDefaultFormParams: () => ({ operator1: I2.GREATER_THAN, val1: "" }),
    mapToFilterColumn: (i) => ({
      customFilters: { customFilters: [{ val: i.val1, operator: I2.GREATER_THAN }] }
    }),
    testMappingParams: (i) => {
      const [o] = x(i);
      return o === I2.GREATER_THAN;
    },
    testMappingFilterColumn: (i) => {
      var l;
      if (((l = i.customFilters) == null ? void 0 : l.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0];
      return o.operator !== I2.GREATER_THAN ? false : { operator1: I2.GREATER_THAN, val1: o.val.toString() };
    }
  }, t.GREATER_THAN_OR_EQUAL = {
    label: "sheets-filter.conditions.greater-than-or-equal",
    operator: I2.GREATER_THAN_OR_EQUAL,
    numOfParameters: 1,
    order: b2.FIRST,
    getDefaultFormParams: () => ({ operator1: I2.GREATER_THAN_OR_EQUAL, val1: "" }),
    testMappingParams: (i) => {
      const [o] = x(i);
      return o === I2.GREATER_THAN_OR_EQUAL;
    },
    mapToFilterColumn: (i) => ({
      customFilters: { customFilters: [{ val: i.val1, operator: I2.GREATER_THAN_OR_EQUAL }] }
    }),
    testMappingFilterColumn: (i) => {
      var l;
      if (((l = i.customFilters) == null ? void 0 : l.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0];
      return o.operator !== I2.GREATER_THAN_OR_EQUAL ? false : { operator1: I2.GREATER_THAN_OR_EQUAL, val1: o.val.toString() };
    }
  }, t.LESS_THAN = {
    label: "sheets-filter.conditions.less-than",
    operator: I2.LESS_THAN,
    numOfParameters: 1,
    order: b2.FIRST,
    getDefaultFormParams: () => ({ operator1: I2.LESS_THAN, val1: "" }),
    testMappingParams: (i) => {
      const [o] = x(i);
      return o === I2.LESS_THAN;
    },
    mapToFilterColumn: (i) => ({
      customFilters: { customFilters: [{ val: i.val1, operator: I2.LESS_THAN }] }
    }),
    testMappingFilterColumn: (i) => {
      var l;
      if (((l = i.customFilters) == null ? void 0 : l.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0];
      return o.operator !== I2.LESS_THAN ? false : { operator1: I2.LESS_THAN, val1: o.val.toString() };
    }
  }, t.LESS_THAN_OR_EQUAL = {
    label: "sheets-filter.conditions.less-than-or-equal",
    operator: I2.LESS_THAN_OR_EQUAL,
    numOfParameters: 1,
    order: b2.FIRST,
    getDefaultFormParams: () => ({ operator1: I2.LESS_THAN_OR_EQUAL, val1: "" }),
    testMappingParams: (i) => {
      const [o] = x(i);
      return o === I2.LESS_THAN_OR_EQUAL;
    },
    mapToFilterColumn: (i) => ({
      customFilters: { customFilters: [{ val: i.val1, operator: I2.LESS_THAN_OR_EQUAL }] }
    }),
    testMappingFilterColumn: (i) => {
      var l;
      if (((l = i.customFilters) == null ? void 0 : l.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0];
      return o.operator !== I2.LESS_THAN_OR_EQUAL ? false : { operator1: I2.LESS_THAN_OR_EQUAL, val1: o.val.toString() };
    }
  }, t.EQUAL = {
    ...
    numOfParameters: 1,
    order: b2.FIRST,
    getDefaultFormParams: () => ({ operator1: I2.EQUAL, val1: "" }),
    testMappingParams: (i) => {
      const [o] = x(i);
      return o === I2.EQUAL;
    },
    mapToFilterColumn: (i) => ({
      customFilters: { customFilters: [{ val: i.val1, operator: I2.EQUAL }] }
    }),
    testMappingFilterColumn: (i) => {
      var l;
      if (((l = i.customFilters) == null ? void 0 : l.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0];
      return o.operator !== I2.EQUAL ? false : { operator1: I2.EQUAL, val1: o.val.toString() };
    }
  }, t.NOT_EQUAL = {
    label: "sheets-filter.conditions.not-equal",
    operator: I2.NOT_EQUALS,
    numOfParameters: 1,
    order: b2.FIRST,
    getDefaultFormParams: () => ({ operator1: I2.NOT_EQUALS, val1: "" }),
    testMappingParams: (i) => {
      const [o] = x(i);
      return o === I2.NOT_EQUALS;
    },
    mapToFilterColumn: (i) => ({
      customFilters: { customFilters: [{ val: i.val1, operator: I2.NOT_EQUALS }] }
    }),
    testMappingFilterColumn: (i) => {
      ...
      if (((l = i.customFilters) == null ? void 0 : l.customFilters.length) !== 1)
        return false;
      const o = i.customFilters.customFilters[0];
      return o.operator !== I2.NOT_EQUALS ? false : { operator1: I2.NOT_EQUALS, val1: o.val.toString() };
    }
  }, t.BETWEEN = {
    ...
    getDefaultFormParams: () => ({
      and: true,
      operator1: I2.GREATER_THAN_OR_EQUAL,
      val1: "",
      operator2: I2.LESS_THAN_OR_EQUAL,
      val2: ""
    }),
    testMappingParams: (i) => {
      ...
      if (!o) return false;
      const h = [l, c];
      return h.includes(I2.GREATER_THAN_OR_EQUAL) && h.includes(I2.LESS_THAN_OR_EQUAL);
    },
    mapToFilterColumn: (i) => {
      const { val1: o, val2: l, operator1: c } = i, h = c === I2.GREATER_THAN_OR_EQUAL;
      return {
        customFilters: {
          and: ie.TRUE,
          customFilters: [
            { val: h ? o : l, operator: I2.GREATER_THAN_OR_EQUAL },
            { val: h ? l : o, operator: I2.LESS_THAN_OR_EQUAL }
          ]
        }
      };
    },
    testMappingFilterColumn: (i) => {
      ...
      return o.operator === I2.GREATER_THAN_OR_EQUAL && l.operator === I2.LESS_THAN_OR_EQUAL && i.customFilters.and ? {
        and: true,
        operator1: I2.GREATER_THAN_OR_EQUAL,
        val1: o.val.toString(),
        operator2: I2.LESS_THAN_OR_EQUAL,
        val2: l.val.toString()
      } : l.operator === I2.GREATER_THAN_OR_EQUAL && o.operator === I2.LESS_THAN_OR_EQUAL && i.customFilters.and ? {
        and: true,
        operator1: I2.GREATER_THAN_OR_EQUAL,
        val1: l.val.toString(),
        operator2: I2.LESS_THAN_OR_EQUAL,
    ...
    numOfParameters: 2,
    getDefaultFormParams: () => ({
      operator1: I2.LESS_THAN,
      val1: "",
      operator2: I2.GREATER_THAN,
      val2: ""
    }),
    testMappingParams: (i) => {
      const { and: o, operator1: l, operator2: c } = i;
      if (o) return false;
      const h = [l, c];
      return h.includes(I2.GREATER_THAN) && h.includes(I2.LESS_THAN);
    },
    mapToFilterColumn: (i) => {
      const { val1: o, val2: l, operator1: c } = i, h = c === I2.GREATER_THAN;
      return {
        customFilters: {
          customFilters: [
            { val: h ? o : l, operator: I2.GREATER_THAN },
            { val: h ? l : o, operator: I2.LESS_THAN }
          ]
        }
      };
    },
    testMappingFilterColumn: (i) => {
      ...
      if (((c = i.customFilters) == null ? void 0 : c.customFilters.length) !== 2)
        return false;
      const [o, l] = i.customFilters.customFilters;
      return o.operator === I2.LESS_THAN && l.operator === I2.GREATER_THAN && !i.customFilters.and ? {
        operator1: I2.LESS_THAN,
        val1: o.val.toString(),
        operator2: I2.GREATER_THAN,
        val2: l.val.toString()
      } : l.operator === I2.LESS_THAN && o.operator === I2.GREATER_THAN && !i.customFilters.and ? {
        operator1: I2.GREATER_THAN,
        val1: l.val.toString(),
        operator2: I2.LESS_THAN,
        val2: o.val.toLocaleString()
      } : false;
    }
  }, t.CUSTOM = {
    ...
    mapToFilterColumn: (i) => {
      ...
      function S(R2, O) {
        for (const A of t.ALL_CONDITIONS)
          if (A.operator === R2)
            return A.mapToFilterColumn({ val1: O, operator1: R2 });
      }
      const p2 = !h || h === t.NONE.operator, _ = !f || f === t.NONE.operator;
      if (p2 && _)
      ...
      return o && (N.and = ie.TRUE), { customFilters: N };
    },
    testMappingFilterColumn: (i) => {
      var c;
      if (((c = i.customFilters) == null ? void 0 : c.customFilters.length) !== 2)
      ...
      return i.customFilters.and && (l.and = true), l;
    }
  }, t.ALL_CONDITIONS = [
    // ------------------------------
    t.NONE,
...
var Ke = (t, e) => (r, s) => e(r, s, t);
var ht2 = "sheets-filter.generate-filter-values.service";
var we2 = createIdentifier(ht2);
...
function Zt(t, e, r, s, n, a, i, o, l) {
  var F, N, R2, O, A, P2, Y2, Z, se, M2;
  const c = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), f = "yyyy-mm-dd", S = "empty", p2 = !t && ((a == null ? void 0 : a.filterBy) === b.COLORS || (a == null ? void 0 : a.filterBy) === b.CONDITIONS) && ((F = a.filteredOutRows) == null ? void 0 : F.size);
  let _ = 0;
  for (const E of s.iterateByColumn(r, false, false)) {
    ...
    for (; ne < Ie; ) {
      ...
      const J2 = E != null && E.value ? HE(E.value) : "";
      if (!J2) {
        _ += 1, ne += Ie;
        continue;
      }
      const ye2 = (N = E.value) != null && N.v && !E.value.p ? (A = (O = l.get((R2 = E.value) == null ? void 0 : R2.s)) == null ? void 0 : O.n) == null ? void 0 : A.pattern : "", dt = ye2 && eR.getFormatInfo(ye2).isDate;
      let ft = false;
      if (dt) {
        const { year: k, month: K, day: I3 } = eR.getFormatDateInfo(ye2);
        ft = k || K || I3;
      }
      if (ye2 && dt && ft) {
        const k = (P2 = s.getCellRaw(E.row, E.col)) == null ? void 0 : P2.v;
        if (!k) {
          ne++;
          continue;
        }
        const K = eR.format(f, Number(k)), [I3, H, me] = K.split("-").map(Number);
        let ee2 = c.get(`${I3}`);
        ee2 || (ee2 = {
          title: `${I3}`,
          key: `${I3}`,
          ...
          leaf: false,
          checked: false
        }, c.set(`${I3}`, ee2), h.set(`${I3}`, [`${I3}`]));
        let W = (Y2 = ee2.children) == null ? void 0 : Y2.find((je) => je.key === `${I3}-${H}`);
        W || (W = {
          ...
          leaf: false,
          checked: false
        }, (Z = ee2.children) == null || Z.push(W), h.set(`${I3}-${H}`, [`${I3}`, `${I3}-${H}`]));
        const Ge = (se = W == null ? void 0 : W.children) == null ? void 0 : se.find((je) => je.key === `${I3}-${H}-${me}`);
        Ge ? (Ge.originValues.add(J2), Ge.count++, W.count++, ee2.count++) : ((M2 = W.children) == null || M2.push({
          title: `${me}`,
          key: `${I3}-${H}-${me}`,
          count: 1,
          originValues: /* @__PURE__ */ new Set([J2]),
          leaf: true,
          checked: p2 ? false : i.size ? i.has(J2) : !o
        }), W.count++, ee2.count++, h.set(`${I3}-${H}-${me}`, [`${I3}`, `${I3}-${H}`, `${I3}-${H}-${me}`]));
      } else {
        const k = J2;
        let K = c.get(k);
        K ? K.count++ : (K = {
...
var Nt = (t) => !Number.isNaN(Number(t)) && !Number.isNaN(Number.parseFloat(t));
function gi(t, e) {
  const r = Nt(t), s = Nt(e);
...
function Kt(t) {
  return t.leaf ? t.checked : t.children ? t.children.every((e) => Kt(e)) : true;
}
function ge(t, e) {
...
var X = class extends Ve {
  ...
  setupCol(e, r) {
    ...
    if (s) {
      ...
      if (n.customFilters) {
        this._hasCriteria$.next(true), this._setupByConditions(e, r);
        return;
      }
      if (n.colorFilters) {
        this._hasCriteria$.next(true), this._setupByColors(e, r);
        return;
      }
      if (n.filters) {
        this._hasCriteria$.next(true), this._setupByValues(e, r);
        return;
      }
      this._hasCriteria$.next(false), this._setupByValues(e, r);
      return;
    }
    this._hasCriteria$.next(false), this._setupByValues(e, r);
  }
  ...
  terminate() {
    return this._filterModel = null, this._col$.next(-1), this._disposeFilterHeaderChangeListener(), true;
  }
  ...
  async _setupByValues(e, r) {
    ...
    const s = e.getRange();
    if (s.startRow === s.endRow) return false;
    const n = await $e.fromFilterColumn(
      this._injector,
      e,
      r
    );
    return this.filterByModel = n, this._filterBy$.next(b.VALUES), this._listenToFilterHeaderChange(e, r), true;
  }
  async _setupByColors(e, r) {
    ...
    return this.filterByModel = n, this._filterBy$.next(b.COLORS), this._listenToFilterHeaderChange(e, r), true;
  }
  _setupByConditions(e, r) {
    ...
    return this.filterByModel = n, this._filterBy$.next(b.CONDITIONS), this._listenToFilterHeaderChange(e, r), true;
  }
...
X = Ve3([
  Te(0, Inject(Injector)),
  Te(1, Inject(xt))
], X);
var Pe = class extends Ve {
  constructor(e, r, s, n, a) {
    super();
    v(this, "canApply$", of(true));
    v(this, "_conditionItem$");
    v(this, "conditionItem$");
    v(this, "_filterConditionFormParams$");
    v(this, "filterConditionFormParams$");
    this._filterModel = e, this.col = r, this._commandService = a, this._conditionItem$ = new BehaviorSubject(s), this.conditionItem$ = this._conditionItem$.asObservable(), this._filterConditionFormParams$ = new BehaviorSubject(n), this.filterConditionFormParams$ = this._filterConditionFormParams$.asObservable();
  }
  /**
  ...
  clear() {
    return this._disposed ? Promise.resolve(false) : this._commandService.executeCommand(cr.id, {
  ...
  async apply() {
    ...
    return this._commandService.executeCommand(cr.id, {
      unitId: this._filterModel.unitId,
      subUnitId: this._filterModel.subUnitId,
      col: this.col,
      criteria: e
  ...
  onConditionFormChange(e) {
    ...
    if (r.and !== true && delete r.and, typeof e.and < "u" || typeof e.operator1 < "u" || typeof e.operator2 < "u") {
...
var $e = class extends Ve {
  constructor(e, r, s, n, a) {
    ...
    this._filterModel = e, this.col = r, this._commandService = a, this._treeMapCache = n, this._searchString$ = new BehaviorSubject(""), this.searchString$ = this._searchString$.asObservable(), this._rawFilterItems$ = new BehaviorSubject(s), this.rawFilterItems$ = this._rawFilterItems$.asObservable(), this._manuallyUpdateFilterItems$ = new Subject(), this.filterItems$ = merge(
      ...
      this._manuallyUpdateFilterItems$
    ).pipe(shareReplay(1)), this.canApply$ = this.filterItems$.pipe(map((i) => ze(i).checked > 0)), this.disposeWithMe(this.filterItems$.subscribe((i) => this._filterItems = i));
  }
  /**
   * Create a model with targeting filter column. If there is not a filter column, the model would be created with
   * default values.
  ...
  static async fromFilterColumn(e, r, s) {
    const n = e.get(vr), a = e.get(Fn), i = e.get(we2, Quantity.OPTIONAL), { unitId: o, subUnitId: l } = r, c = n.getUniverSheetInstance(o);
    ...
    const f = r.getRange(), S = s, p2 = r.getFilterColumn(s), _ = p2 == null ? void 0 : p2.getColumnData().filters, C = new Set(_ == null ? void 0 : _.filters), F = !!(_ && _.blank), N = r.getFilteredOutRowsExceptCol(s), R2 = { ...f, startRow: f.startRow + 1, startColumn: S, endColumn: S };
    let O, A;
    if (i) {
      const P2 = await i.getFilterValues({
        unitId: o,
        subUnitId: l,
      ...
      O = P2.filterTreeItems, A = P2.filterTreeMapCache;
    } else {
      const P2 = Zt(
        !!_,
        a,
  ...
  onCheckAllToggled(e) {
    const r = J.deepClone(this._filterItems);
  ...
  onFilterCheckToggled(e) {
    const r = J.deepClone(this._filterItems), s = et2(r, e.key);
    if (!s)
      return;
    const n = Kt(s);
  ...
  onFilterOnly(e) {
    const r = J.deepClone(this._filterItems);
    r.forEach((s) => ge(s, false)), e.forEach((s) => {
      const n = et2(r, s);
      n && ge(n, true);
  ...
  async apply() {
      ...
      });
    {
      ...
      }), c.length !== s.length && (l.filters.blank = true);
    }
    return this._commandService.executeCommand(cr.id, {
      unitId: this._filterModel.unitId,
      subUnitId: this._filterModel.subUnitId,
...
var Le = class extends Ve {
  constructor(e, r, s, n, a) {
    ...
    this._filterModel = e, this.col = r, this._commandService = a, this._cellFillColors$ = new BehaviorSubject(Array.from(s.values())), this.cellFillColors$ = this._cellFillColors$.asObservable(), this._cellTextColors$ = new BehaviorSubject(Array.from(n.values())), this.cellTextColors$ = this._cellTextColors$.asObservable();
  }
  /**
   * Create a model with targeting filter column. If there is not a filter column, the model would be created with
   * default values.
  ...
  static async fromFilterColumn(e, r, s) {
    var R2, O, A;
    const n = e.get(vr), { unitId: a, subUnitId: i } = r, o = n.getUniverSheetInstance(a);
    ...
    const c = r.getRange(), h = s, f = (R2 = r.getFilterColumn(s)) == null ? void 0 : R2.getColumnData().colorFilters, S = r.getFilteredOutRowsExceptCol(s), p2 = { ...c, startRow: c.startRow + 1, startColumn: h, endColumn: h }, _ = /* @__PURE__ */ new Map(), C = new Set((O = f == null ? void 0 : f.cellFillColors) != null ? O : []), F = /* @__PURE__ */ new Map(), N = new Set((A = f == null ? void 0 : f.cellTextColors) != null ? A : []);
    for (const P2 of l.iterateByColumn(p2, false, true)) {
      const { row: Y2, col: Z, value: se } = P2;
      if (S.has(Y2))
        continue;
      const M2 = l.getComposedCellStyleByCellData(Y2, Z, se);
      if (M2.bg && M2.bg.rgb) {
        const E = new bt(M2.bg.rgb).toRgbString();
        _.has(E) || _.set(E, { color: E, checked: C.has(E) });
      } else
        _.set("default-fill-color", { color: null, checked: C.has(null) });
      if (M2.cl && M2.cl.rgb) {
        const E = new bt(M2.cl.rgb).toRgbString();
        F.has(E) || F.set(E, { color: E, checked: N.has(E) });
      } else
        F.set("default-font-color", { color: z3, checked: N.has(z3) });
    }
  ...
  _resetColorsCheckedStatus(e = true) {
...
var ae = "FILTER_PANEL_OPENED";
var Me = {
  id: "sheet.operation.open-filter-panel",
  type: Ms.OPERATION,
  handler: (t, e) => {
    const r = t.get(Nr), s = t.get(M), n = t.get(X), a = t.get(Ls), i = t.has(qe) ? t.get(qe) : null;
    i != null && i.isVisible().visible && a.syncExecuteCommand(tt.id, { visible: false });
    const { unitId: o, subUnitId: l, col: c } = e, h = s.getFilterModel(o, l);
    return h ? (n.setupCol(h, c), r.getContextValue(ae) || r.setContextValue(ae, true), true) : false;
  }
};
var Se = {
  ...
  type: Ms.OPERATION,
  handler: (t) => {
    const e = t.get(Nr), r = t.get(X), s = t.get(U1, Quantity.OPTIONAL);
    return e.getContextValue(ae) ? (e.setContextValue(ae, false), s == null || s.focus(), r.terminate()) : false;
  }
};
var Xt = {
...
var zt2 = "sheets-filter-ui.config";
var xe = {};
  ...
  _commandExecutedListener() {
    this.disposeWithMe(
      this._commandService.beforeCommandExecuted((t) => {
        var e, r, s;
        if (t.id === ar.id) {
          const n = this._injector.get(vr), a = P(n);
          if (!a) return;
          ...
          if (c)
            h = this._sheetPermissionCheckPermission.permissionCheckWithRanges({
              rangeTypes: [Hs],
              worksheetTypes: [Sr, ls]
            }, [c]);
          else {
            const f = (r = this._sheetsSelectionService.getCurrentLastSelection()) == null ? void 0 : r.range;
            if (f) {
              let S = { ...f };
              S = f.startColumn === f.endColumn && f.startRow === f.endRow ? ph(S, { left: true, right: true, up: true, down: true }, l) : S, h = this._sheetPermissionCheckPermission.permissionCheckWithRanges({
                rangeTypes: [Hs],
                worksheetTypes: [ls, Sr]
              }, [S], i, o);
            } else
        ...
        if (t.id === Me.id) {
          const n = t.params, { unitId: a, subUnitId: i } = n, o = (s = this._sheetsFilterService.getFilterModel(a, i)) == null ? void 0 : s.getRange(), l = J.deepClone(o);
...
ce = Ti([
  ...
  oe(2, Ls),
  oe(3, Inject(qn)),
  oe(4, Inject(Injector)),
  oe(5, Inject(z))
], ce);
var q = 16;
var Ei = new Path2D("M3.30363 3C2.79117 3 2.51457 3.60097 2.84788 3.99024L6.8 8.60593V12.5662C6.8 12.7184 6.8864 12.8575 7.02289 12.9249L8.76717 13.7863C8.96655 13.8847 9.2 13.7396 9.2 13.5173V8.60593L13.1521 3.99024C13.4854 3.60097 13.2088 3 12.6964 3H3.30363Z");
var It = class {
...
var qe2 = (t, e) => (r, s) => e(r, s, t);
var B3 = 16;
var Ce = 1;
var tt2 = class extends x3 {
  constructor(e, r, s, n, a) {
    super(e, r);
    v(this, "_cellWidth", 0);
    v(this, "_cellHeight", 0);
    v(this, "_filterParams");
    v(this, "_hovered", false);
  ...
  _draw(e) {
    const r = this._cellHeight, s = this._cellWidth, n = B3 - s, a = B3 - r;
    e.save();
    const i = new Path2D();
    ...
    o ? It.drawHasCriteria(e, B3, l, c) : It.drawNoCriteria(e, B3, l, c), e.restore();
  }
  onPointerDown(e) {
    if (e.button === 2)
      return;
...
var rt = class extends h1 {
  ...
  _initRenderer() {
    this._sheetSkeletonManagerService.currentSkeleton$.pipe(
      switchMap((e) => {
        ...
        return wg(this._commandService.onCommandExecuted.bind(this._commandService)).pipe(
          filter(
            ([c]) => {
              var h;
              return c.type === Ms.MUTATION && ((h = c.params) == null ? void 0 : h.unitId) === r.getUnitId() && (Ee.has(c.id) || c.id === ee.id);
            }
          ),
  ...
  _renderRange(e, r) {
    const { scene: s } = this._context, { rowHeaderWidth: n, columnHeaderHeight: a } = r, i = this._filterRangeShape = new Wd(
      s,
      Oi,
      this._themeService,
      {
    ...
    i.updateRangeBySelectionWithCoord(l), i.setEvent(false), s.makeDirty(true);
  }
  _renderButtons(e) {
    ...
    for (let p2 = h; p2 <= f; p2++) {
      const _ = `sheets-filter-button-${p2}`, C = lh(S, p2, l, a), F = c.getComposedCellStyle(S, p2), N = (F == null ? void 0 : F.vt) || xn.BOTTOM, { startX: R2, startY: O, endX: A, endY: P2 } = C, Y2 = A - R2, Z = P2 - O;
      if (Z <= Ce || Y2 <= Ce)
        continue;
      const se = !!s.getFilterColumn(p2), M2 = A - B3 - Ce, E = Ri(O, P2, Z, N), Qe = {
        left: M2,
        top: E,
        height: B3,
        width: B3,
        ...
        cellHeight: Z,
        cellWidth: Y2,
        filterParams: { unitId: n, subUnitId: i, col: p2, hasCriteria: se }
      }, Ie = this._injector.createInstance(tt2, _, Qe);
  ...
  _interceptCellContent(e, r, s) {
    ...
    this._buttonRenderDisposable = this._sheetInterceptorService.intercept(ht.CELL_CONTENT, {
      effect: sr.Style,
      handler: (o, l, c) => {
        const { row: h, col: f, unitId: S, subUnitId: p2 } = l;
        return S !== e || p2 !== r || h !== n || f < a || f > i || ((!o || o === l.rawData) && (o = { ...l.rawData }), o.fontRenderExtension = {
...
var yt2 = (t, e) => (r, s) => e(r, s, t);
var Ee2 = class extends h1 {
  constructor(t, e) {
...
var Li = (t, e, r) => e in t ? Pi(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r;
var Mi = (t, e, r, s) => {
  for (var n = s > 1 ? void 0 : s ? $i(e, r) : e, a = t.length - 1, i; a >= 0; a--)
    (i = t[a]) && (n = i(n) || n);
  return n;
};
var Ot = (t, e) => (r, s) => e(r, s, t);
var Jt = (t, e, r) => Li(t, typeof e != "symbol" ? e + "" : e, r);
var xi = "SHEET_FILTER_UI_PLUGIN";
var Ue = class extends Ol {
  constructor(t = xe, e, r) {
    ...
    s && this._configService.setConfig("menu", s, { merge: true }), this._configService.setConfig(zt2, n);
  }
  onStarting() {
    [
      [ce],
  ...
  onRendered() {
    this._injector.get(Ee2);
  }
};
Jt(Ue, "type", we.UNIVER_SHEET);
Jt(Ue, "pluginName", xi);
Ue = Mi([
  qR(fe),
...
function fe3({ ref: t, ...e }) {
  const { icon: r, id: s, className: n, extend: a, ...i } = e, o = `univerjs-icon univerjs-icon-${s} ${n || ""}`.trim(), l = (0, import_react.useRef)(`_${Hi()}`);
  return er(r, `${s}`, {
    defIds: r.defIds,
    idSuffix: l.current
  }, {
...
var tr = (0, import_react.forwardRef)(function(e, r) {
  return (0, import_react.createElement)(fe3, Object.assign({}, e, {
    id: "a-icon",
    ref: r,
    icon: Di
  }));
...
var rr = (0, import_react.forwardRef)(function(e, r) {
  return (0, import_react.createElement)(fe3, Object.assign({}, e, {
    id: "ban-icon",
    ref: r,
    icon: Bi2
...
var ir2 = (0, import_react.forwardRef)(function(e, r) {
  return (0, import_react.createElement)(fe3, Object.assign({}, e, {
    id: "filter-icon",
    ref: r,
    icon: Wi
...
var sr2 = (0, import_react.forwardRef)(function(e, r) {
  return (0, import_react.createElement)(fe3, Object.assign({}, e, {
    id: "info-icon",
    ref: r,
    icon: Vi
...
var nr = (0, import_react.forwardRef)(function(e, r) {
  return (0, import_react.createElement)(fe3, Object.assign({}, e, {
    id: "success-icon",
    ref: r,
    icon: Qi
...
function Gi2(t) {
  const { model: e } = t, r = useDependency(Fn), s = useObservable(e.cellFillColors$, [], true), n = useObservable(e.cellTextColors$, [], true), a = (0, import_react.useCallback)((o) => {
    e.onFilterCheckToggled(o);
  }, [e]), i = (0, import_react.useCallback)((o) => {
    e.onFilterCheckToggled(o, false);
  }, [e]);
    ...
    "div",
    {
      ...
      children: (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          className: ie2("univer-mt-2 univer-box-border univer-flex univer-h-[300px] univer-flex-grow univer-flex-col univer-gap-4 univer-overflow-auto univer-rounded-md univer-px-2 univer-py-2.5", kt),
          children: [
            s.length > 1 && (0, import_jsx_runtime.jsxs)("div", { children: [
              ...
              (0, import_jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: s.map((o, l) => (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      className: "univer-relative univer-h-6 univer-w-6",
                      onClick: () => a(o),
                      children: [
                        o.color ? (0, import_jsx_runtime.jsx)(
                          "button",
                          {
                            type: "button",
                            className: ie2("univer-box-border univer-h-6 univer-w-6 univer-cursor-pointer univer-rounded-full univer-border univer-border-solid univer-border-transparent univer-bg-gray-300 univer-transition-shadow hover:univer-ring-2 hover:univer-ring-offset-2 hover:univer-ring-offset-white"),
                        ...
                        o.checked && (0, import_jsx_runtime.jsx)(bt2, {})
                      ]
                    },
            ...
            n.length > 1 && (0, import_jsx_runtime.jsxs)("div", { children: [
              (0, import_jsx_runtime.jsx)(
                "div",
                {
                  className: "univer-mb-2 univer-text-sm univer-text-gray-900 dark:!univer-text-white",
              ...
              (0, import_jsx_runtime.jsx)(
                ...
                {
                  className: "univer-grid univer-grid-cols-8 univer-items-center univer-justify-start univer-gap-2",
                  children: n.map((o, l) => (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      className: "univer-relative univer-h-6 univer-w-6",
                      onClick: () => i(o),
                      children: [
                        (0, import_jsx_runtime.jsx)(
                          "div",
                          {
                            ...
                            children: (0, import_jsx_runtime.jsx)(tr, { style: { color: o.color } })
                          }
                        ),
                        o.checked && (0, import_jsx_runtime.jsx)(bt2, {})
                      ]
            ...
            s.length <= 1 && n.length <= 1 && (0, import_jsx_runtime.jsx)(
              "div",
              {
...
function ji(t) {
  var p2, _;
  const { model: e } = t, r = useDependency(Fn), s = useObservable(e.conditionItem$, void 0), n = useObservable(e.filterConditionFormParams$, void 0), a = n != null && n.and ? "AND" : "OR", i = (0, import_react.useCallback)((C) => {
    e.onConditionFormChange({ and: C === "AND" });
  }, [e]), o = Yi(r), l = (0, import_react.useCallback)((C) => {
    e.onPrimaryConditionChange(C);
  }, [e]), c = Zi(r), h = (0, import_react.useCallback)((C) => {
    e.onConditionFormChange(C);
  }, [e]), f = r.t("sheets-filter.panel.input-values-placeholder");
  function S(C, F, N) {
    const R2 = m.getItemByOperator(C).numOfParameters === 1;
    return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      N === "operator2" && (0, import_jsx_runtime.jsxs)(kE, { value: a, onChange: i, children: [
        (0, import_jsx_runtime.jsx)(TE, { value: "AND", children: r.t("sheets-filter.panel.and") }),
        (0, import_jsx_runtime.jsx)(TE, { value: "OR", children: r.t("sheets-filter.panel.or") })
      ] }),
      (0, import_jsx_runtime.jsx)(
        LE,
        {
      ...
      R2 && (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(
        Vx,
        {
  ...
  return (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...
      className: "univer-flex univer-h-full univer-min-h-[300px] univer-flex-col",
      children: s && n && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        (0, import_jsx_runtime.jsx)(LE, { value: s.operator, options: o, onChange: l }),
        m.getItemByOperator(s.operator).numOfParameters !== 0 ? (0, import_jsx_runtime.jsxs)(
          "div",
          {
            "data-u-comp": "sheets-filter-panel-conditions-container-inner",
            className: ie2("univer-mt-2 univer-flex-grow univer-overflow-hidden univer-rounded-md univer-p-2", kt),
            children: [
              s.numOfParameters >= 1 && S(n.operator1, (p2 = n.val1) != null ? p2 : "", "operator1"),
...
function Zi(t) {
  const e = t.getCurrentLocale();
  return (0, import_react.useMemo)(() => m.ALL_CONDITIONS.filter((r) => r.numOfParameters !== 2).map((r) => ({ label: t.t(r.label), value: r.operator })), [e, t]);
}
function Ki(t) {
  const { model: e } = t, r = useDependency(Fn), s = useObservable(e.searchString$, "", true), n = useObservable(e.filterItems$, void 0, true), a = r.t("sheets-filter.panel.filter-only"), i = ze(n), o = i.checked > 0 && i.unchecked === 0, l = i.checked > 0 && i.unchecked > 0, c = e.treeMapCache, h = (0, import_react.useCallback)(() => {
    e.onCheckAllToggled(!o);
  }, [e, o]), f = (0, import_react.useCallback)((p2) => {
    e.setSearchString(p2);
  }, [e]);
  function S(p2) {
    let _ = [];
    return p2.forEach((C) => {
    ...
    "div",
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsxs)(
          ...
          {
            "data-u-comp": "sheets-filter-panel",
            className: ie2("univer-mt-2 univer-box-border univer-flex univer-flex-grow univer-flex-col univer-overflow-hidden univer-rounded-md univer-px-2 univer-py-2.5", kt),
            children: [
              (0, import_jsx_runtime.jsx)(
                "div",
                {
              ...
              (0, import_jsx_runtime.jsx)("div", { "data-u-comp": "sheets-filter-panel-values-virtual", className: "univer-flex-grow", children: (0, import_jsx_runtime.jsx)(
                qE,
                {
                  data: n,
                  ...
                  treeNodeClassName: `
                        ...
                        `,
                  attachRender: (p2) => (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        (0, import_jsx_runtime.jsx)(
                          "a",
                          {
                            ...
                            onClick: () => {
                              const _ = [];
                              p2.children ? p2.children.forEach((C) => {
                                C.children ? C.children.forEach((F) => {
                                  _.push(F.key);
                                }) : _.push(C.key);
                              }) : _.push(p2.key), e.onFilterOnly(_);
                            },
                            children: a
                          }
                        )
...
function qi() {
  const t = useDependency(G2);
  if (!useObservable(t.visible$, void 0, true)) return null;
  const r = useDependency(Fn), s = useDependency(et), n = useObservable(t.enabled$, void 0, true);
  return (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex univer-items-center univer-gap-1", children: [
          (0, import_jsx_runtime.jsx)("span", { children: r.t("sheets-filter.sync.title") }),
          (0, import_jsx_runtime.jsx)(
            Rp,
            {
              title: n ? r.t("sheets-filter.sync.statusTips.off") : r.t("sheets-filter.sync.statusTips.on"),
              asChild: true,
              children: (0, import_jsx_runtime.jsx)(sr2, { className: "univer-block" })
            }
          )
        ] }),
        (0, import_jsx_runtime.jsx)(
...
function Xi() {
  var F;
  const t = useDependency(X), e = useDependency(Fn), r = useDependency(Ls), s = useObservable(t.filterBy$, void 0, true), n = useObservable(t.filterByModel$, void 0, false), a = useObservable(() => (n == null ? void 0 : n.canApply$) || of(false), void 0, false, [n]), i = zi2(e), o = !useObservable(t.hasCriteria$), l = (0, import_react.useCallback)((N) => {
    r.executeCommand(Xt.id, { filterBy: N });
  }, [r]), c = (0, import_react.useCallback)(async () => {
    await (n == null ? void 0 : n.clear()), r.executeCommand(Se.id);
  }, [n, r]), h = (0, import_react.useCallback)(() => {
    r.executeCommand(Se.id);
  }, [r]), f = (0, import_react.useCallback)(async () => {
    await (n == null ? void 0 : n.apply()), r.executeCommand(Se.id);
  }, [n, r]), p2 = (F = useDependency(M).activeFilterModel) == null ? void 0 : F.getRange(), _ = t.col, C = M1(Wm.FILTER_PANEL_EMBED_POINT);
  return (0, import_jsx_runtime.jsxs)(
    "div",
    {
      "data-u-comp": "sheets-filter-panel",
      ...
      children: [
        (0, import_jsx_runtime.jsx)(
          ...
          {
            components: C,
            sharedProps: { range: p2, colIndex: _, onClose: h }
          }
        ),
        (0, import_jsx_runtime.jsx)("div", { className: "univer-mb-1 univer-flex-shrink-0 univer-flex-grow-0", children: (0, import_jsx_runtime.jsx)(
          IE,
          {
            value: s,
            items: i,
        ...
        n ? (0, import_jsx_runtime.jsx)(
          "div",
          {
            ...
            children: s === b.VALUES ? (0, import_jsx_runtime.jsx)(Ki, { model: n }) : s === b.COLORS ? (0, import_jsx_runtime.jsx)(Gi2, { model: n }) : (0, import_jsx_runtime.jsx)(ji, { model: n })
          }
        ) : (0, import_jsx_runtime.jsx)("div", { className: "univer-flex-1" }),
        (0, import_jsx_runtime.jsx)(qi, {}),
        (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              (0, import_jsx_runtime.jsx)(vr2, { variant: "link", onClick: c, disabled: o, children: e.t("sheets-filter.panel.clear-filter") }),
              (0, import_jsx_runtime.jsxs)("span", { className: "univer-flex univer-gap-2", children: [
                (0, import_jsx_runtime.jsx)(vr2, { variant: "default", onClick: h, children: e.t("sheets-filter.panel.cancel") }),
                (0, import_jsx_runtime.jsx)(vr2, { disabled: !a, variant: "primary", onClick: f, children: e.t("sheets-filter.panel.confirm") })
              ] })
            ]
          }
        )
...
function zi2(t) {
  const e = t.getCurrentLocale();
  return (0, import_react.useMemo)(() => [
    { label: t.t("sheets-filter.panel.by-values"), value: b.VALUES },
    { label: t.t("sheets-filter.panel.by-colors"), value: b.COLORS },
    { label: t.t("sheets-filter.panel.by-conditions"), value: b.CONDITIONS }
  ], [e, t]);
}
function Ji(t) {
  const e = t.get(M);
  return {
    ...
    activated$: e.activeFilterModel$.pipe(map((r) => !!r)),
    disabled$: zi(
      t,
      he(
        t,
...
function es(t) {
  ...
  return {
    ...
    hidden$: Bi(t, we.UNIVER_SHEET),
    disabled$: e.activeFilterModel$.pipe(switchMap((r) => {
      var s;
      return (s = r == null ? void 0 : r.hasCriteria$.pipe(map((n) => !n))) != null ? s : of(true);
    }))
  };
}
function ts(t) {
...
var $ = (t, e) => (r, s) => e(r, s, t);
var Rt = "FILTER_PANEL_POPUP";
var ke = class extends Ee2 {
  constructor(e, r, s, n, a, i, o, l, c, h, f, S, p2) {
    super(p2, S);
  ...
  _initUI() {
    ...
    }), this.disposeWithMe(this._contextService.subscribeContextValue$(ae).pipe(distinctUntilChanged()).subscribe((e) => {
...
var as = (t, e, r) => e in t ? os(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r;
var cs = (t, e, r, s) => {
  for (var n = s > 1 ? void 0 : s ? ls2(e, r) : e, a = t.length - 1, i; a >= 0; a--)
    (i = t[a]) && (n = i(n) || n);
  return n;
};
var Xe = (t, e) => (r, s) => e(r, s, t);
var or = (t, e, r) => as(t, typeof e != "symbol" ? e + "" : e, r);
var us = "SHEET_FILTER_UI_PLUGIN";
var He = class extends Ol {
  constructor(t = xe, e, r, s) {
    ...
    n && this._configService.setConfig("menu", n, { merge: true }), this._configService.setConfig(zt2, a);
  }
  onStarting() {
    GC(this._injector, [
      [X],
      [ce],
      [ke]
    ]), this._config.useRemoteFilterValuesGenerator && this._rpcChannelService && this._injector.add([we2, {
      useFactory: () => B(
        this._rpcChannelService.requestChannel(ht2)
      )
    }]);
  }
  onReady() {
...
or(He, "type", we.UNIVER_SHEET);
or(He, "pluginName", us);
He = cs([
  qR(fe),
  Xe(1, Inject(Injector)),
  Xe(2, ic),
  Xe(3, Optional(I))
], He);
...
var At = (t, e) => (r, s) => e(r, s, t);
var Oe;
var wt = (Oe = class extends Ol {
  constructor(t, e, r) {
  ...
  onReady() {
    this._rpcChannelService.registerChannel(
      ht2,
      Y(this._injector.get(we2))
    );
  }
}, v(Oe, "type", we.UNIVER_SHEET), v(Oe, "pluginName", "SHEET_FILTER_UI_WORKER_PLUGIN"), Oe);
wt = ds([
  At(1, Inject(Injector)),
  At(2, I)
], wt);
...
//# sourceMappingURL=chunk-ISY2DTEM.js.map
