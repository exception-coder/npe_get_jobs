...
var Ye = () => {
  ...
  return a ? (0, import_jsx_runtime.jsxs)(
    "div",
    {
      className: ie2("univer-box-border univer-w-[296px] univer-rounded-xl univer-bg-white univer-p-4 univer-shadow-md dark:!univer-bg-gray-900", kt),
      children: [
...
var mn = (t) => {
  ...
  return (0, import_jsx_runtime.jsxs)(
    "div",
    {
      className: ie2("univer-mb-1 univer-flex univer-max-w-80 univer-flex-row univer-items-center univer-justify-between univer-overflow-hidden univer-rounded-lg univer-bg-white univer-p-3 univer-shadow-md dark:!univer-bg-gray-900", kt),
      onClick: () => e.hideCurrentPopup(),
      children: [
        (0, import_jsx_runtime.jsxs)(
          "div",
          {
            className: ie2("univer-flex univer-h-6 univer-flex-1 univer-cursor-pointer univer-flex-row univer-items-center univer-truncate univer-text-sm univer-leading-5 univer-text-primary-600", { "univer-text-red-500": b }),
            onClick: () => {
          ...
          "div",
          {
            ...
            children: [
              f && (0, import_jsx_runtime.jsx)(
                "div",
                {
                  className: ie2("univer-ml-2 univer-flex univer-size-6 univer-cursor-pointer univer-flex-row univer-items-center univer-justify-center univer-rounded univer-text-base hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700", { "univer-text-red-500": b }),
                  onClick: () => {
                    if (!b) {
                      if (a.type !== E.URL) {
...
//# sourceMappingURL=chunk-W3WTABPG.js.map
