...
import {
  ...
  w,
  xe as xe2
} from "./chunk-SKEIOGXN.js";
import {
  s
} from "./chunk-ZXOFA5VX.js";
import {
  C,
  k as k5
...
var Tn2 = (e) => {
  const { defaultPattern: t4, action: r, onChange: n2 } = e, [i, s2] = (0, import_react.useState)(() => P2(t4 || "", 2)), o3 = (0, import_react.useContext)(Ee3), [m8, c2] = (0, import_react.useState)(() => ot4(t4) || o3[0]), a4 = (0, import_react.useMemo)(() => o3.map((p) => ({ label: p, value: p })), []), l3 = useDependency(Fn).t;
...
var wn2 = (e) => {
  const r = useDependency(Fn).t, n2 = (0, import_react.useContext)(Ee3), [i, s2] = (0, import_react.useState)(() => ot4(e.defaultPattern) || n2[0]), [o3, m8] = (0, import_react.useState)(() => P2(e.defaultPattern || "", 2)), [c2, a4] = (0, import_react.useState)(() => {
    var g7;
    const d2 = it(i);
...
function On4(e) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    (0, import_jsx_runtime.jsx)(
      "div",
      {
        className: ie2("univer-mt-2 univer-max-h-[400px] univer-overflow-auto univer-rounded-lg univer-p-2", kt),
...
function An2(e) {
  const t4 = useDependency(Fn), r = (0, import_react.useMemo)(lt4, []), [n2, i] = (0, import_react.useState)(() => P2(e.defaultPattern || "", 0)), [s2, o3] = (0, import_react.useState)(() => {
    ...
    l3 !== void 0 && (i(P2(l3, 0)), o3(l3), e.onChange(l3));
  };
...
var Hn3 = (e) => {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    "div",
    {
      className: ie2("univer-flex univer-h-full univer-flex-col univer-justify-between univer-overflow-y-auto univer-pb-5", pr2),
      children: [
        ...
        (0, import_jsx_runtime.jsxs)("div", { className: "univer-mb-5 univer-mt-3.5 univer-flex univer-justify-end", children: [
          (0, import_jsx_runtime.jsx)(vr4, { onClick: D5, className: "univer-mr-3", children: m8("sheet.numfmt.cancel") }),
          (0, import_jsx_runtime.jsx)(vr4, { variant: "primary", onClick: O5, children: m8("sheet.numfmt.confirm") })
        ] })
      ]
    }
  );
    ...
    const p = (l3 == null ? void 0 : l3.t) === fn.NUMBER ? l3.v : 12345678, d2 = {
      onChange: (g7) => {
        ...
        if (g7.type === "change")
          ...
          }), n2.executeCommand(O.id, R3), t4.close();
...
var Zn2 = (e) => ({
  ...
  disabled$: he(e, { workbookTypes: [Pe], worksheetTypes: [Ve2, yr], rangeTypes: [Le] })
});
var Yn4 = (e) => ({
  icon: "AddDigitsIcon",
  id: Ve5.id,
...
var qn3 = (e) => {
  const t4 = e.get(vr), r = e.get(Ls), n2 = e.get(Fn), i = e.get(z), s2 = [li.id, to.id], o3 = pt3(
    t4,
    "",
...
var Qn2 = () => {
  const e = useDependency(Ls), t4 = useDependency(Fn), r = useDependency(U12), n2 = useDependency(D3), i = useDependency(z), s2 = (a4) => {
    ...
    }), e.executeCommand(O.id, { values: v7 }), r.focus();
...
var f2 = class extends I3 {
  ...
  createSocket(e) {
    const r = this._injector.createInstance(Ye2).createSocket(e);
    if (!r)
...
}, o(a2, "RibbonStartGroup", G1), o(a2, "RibbonPosition", w1), o(a2, "MenuManagerPosition", ke3), a2);
_2 = D4([
  d(1, Inject(Injector)),
  d(2, Ls),
  d(3, B12)
...
var Y6 = class extends I3 {
  ...
  copy() {
    return this._commandService.executeCommand(Fn3.id);
  }
  paste() {
  ...
  openSiderbar(e) {
    return this._injector.get(we3).open(e);
  }
  openSidebar(e) {
...
var Z3 = class extends P5 {
  ...
  onPaste(e) {
    return this._injector.get(Ls).onCommandExecuted((r) => {
      (r.id === jn2.id || r.id === Qi) && e();
    });
  }
};
P5.extend(Z3);
var ee4 = class extends O2 {
  get BuiltInUIPart() {
    return c12;
  }
  get KeyCode() {
...
export {
  ...
  We2 as AddMergeUndoMutationFactory,
  ...
  ge as BreakType,
  Ge2 as BrowserClipboardService,
  ...
  Fn2 as DeltaColumnWidthCommand,
  zn as DeltaRowHeightCommand,
  vh as DependencyManagerBaseService,
  Th as DependencyManagerService,
  Mt3 as DescriptionService,
  Ye3 as DesktopBeforeCloseService,
  Xe4 as DesktopConfirmService,
  qe2 as DesktopDialogService,
  Je4 as DesktopGalleryService,
  Qe3 as DesktopGlobalZoneService,
  Fe3 as DesktopLayoutService,
  sr3 as DesktopLocalFileService,
  cr3 as DesktopLocalStorageService,
  E5 as DesktopMenu,
  Ke2 as DesktopMessageService,
  e32 as DesktopNotificationService,
  ur2 as DesktopSidebarService,
  ...
  Eo2 as FILE__BMP_CLIPBOARD_MIME_TYPE,
  ...
  Ui as HEADING_LIST,
  Kt2 as HTML_CLIPBOARD_MIME_TYPE,
  Q3 as HTTPEventType,
  I2 as HTTPHeaders,
  _e3 as HTTPProgress,
  X4 as HTTPRequest,
  ...
  zx as Marker,
  H1 as MenuItemType,
  ke3 as MenuManagerPosition,
  je as MenuManagerService,
  Ln2 as MergeCellController,
  Ve3 as MergeInterceptorFactory,
  ...
  Qt3 as PLAIN_TEXT_CLIPBOARD_MIME_TYPE,
  ...
  M4 as RemoteSyncPrimaryService,
  ...
  ye2 as RemoveMergeUndoMutationFactory,
  ...
  fe2 as SetRangeProtectionMutation,
  ...
  Fe2 as SetWorksheetRowIsAutoHeightMutation,
  ...
  E5 as UIMenu,
  B5 as UIMenuSchema,
  Yn2 as UIPartsService,
  _e4 as UI_PLUGIN_CONFIG_KEY,
  ...
  Ye2 as WebSocketService,
  q2 as WebWorkerRemoteInstanceService,
  WithDependency,
  nr as WorkbookCommentPermission,
  sr2 as WorkbookCopyPermission,
  Gu as WorkbookCopySheetPermission,
  or2 as WorkbookCreateProtectPermission,
  rr2 as WorkbookCreateSheetPermission,
  ...
  cr2 as WorkbookRecoverHistoryPermission,
  ...
  Qt2 as WorksheetSetColumnStylePermission,
