...
var st = (a, e, t) => e in a ? rt2(a, e, { enumerable: true, configurable: true, writable: true, value: t }) : a[e] = t;
var b = (a, e, t) => st(a, typeof e != "symbol" ? e + "" : e, t);
var ln2 = Object.getOwnPropertyDescriptor;
var gn = (a, e, t, n) => {
  for (var r = n > 1 ? void 0 : n ? ln2(e, t) : e, s = a.length - 1, o; s >= 0; s--)
    (o = a[s]) && (r = o(r) || r);
  return r;
};
var I2 = (a, e) => (t, n) => e(t, n, a);
function mn2(a, e, t) {
...
var Q = class {
  ...
  setRefByRange(e, t, n, r) {
    return this._definedNameParam.formulaOrRefString = Ft({
      startRow: e,
   ...
   */
  setScopeToWorkbook() {
    return this._definedNameParam.localSheetId = ng, this;
  }
  /**
...
var K = class extends $ {
  ...
  _apply() {
    this._definedNameParam.name === "" && (this._definedNameParam.name = mn2(this._definedNameParam.unitId, this._localeService, this._definedNamesService)), this._commandService.syncExecuteCommand(Qr.id, this._definedNameParam);
  }
  /**
  ...
  setRefByRange(a, e, t, n) {
    this._definedNameParam.formulaOrRefString = Ft({
      startRow: a,
   ...
   */
  setScopeToWorkbook() {
    this._definedNameParam.localSheetId = ng, this._apply();
  }
  /**
   ...
   */
  delete() {
    this._commandService.syncExecuteCommand(Yr.id, this._definedNameParam);
  }
  /**
   ...
   */
  isWorkbookScope() {
    return this._definedNameParam.localSheetId === ng;
  }
  /**
...
var E = (a, e) => (t, n) => e(t, n, a);
var Y = class extends $ {
  constructor(e, t, n, r, s, o, i, h) {
    super();
    b(this, "permissionPointsDefinition", sg);
  ...
  setWorkbookEditPermission(e, t) {
    this.setWorkbookPermissionPoint(e, Pe, t);
  }
  /**
  ...
  async addWorksheetBasePermission(e, t) {
    ...
    if (this._commandService.syncExecuteCommand(ft.id, {
      unitId: e,
      subUnitId: t,
      rule: {
        permissionId: r,
  ...
  async setWorksheetPermissionPoint(e, t, n, r) {
    ...
    if (n === Ve || n === ls)
      ...
      }), this._commandService.syncExecuteCommand(Js.id, { unitId: e, subUnitId: t, rule: { unitId: e, subUnitId: t, permissionId: o } }));
    }
    const h = new n(e, t);
  ...
  async addRangeBaseProtection(e, t, n) {
    ...
    if (this._worksheetProtectionRuleModel.getRule(e, t))
      throw new Error("sheet protection cannot intersect with range protection");
    if (this._rangeProtectionRuleModel.getSubunitRuleList(e, t).some((c) => c.ranges.some((l) => n.some((u) => En.intersects(u.getRange(), l)))))
      throw new Error("range protection cannot intersect");
    if (this._commandService.syncExecuteCommand(Be.id, {
      unitId: e,
      subUnitId: t,
      rules: [{
        permissionId: r,
  ...
  removeRangeProtection(e, t, n) {
    this._commandService.syncExecuteCommand(ot.id, {
      ...
      subUnitId: t,
      ruleIds: n
    }) && this._rangeProtectionRuleModel.getSubunitRuleList(e, t).length === 0 && (this._worksheetProtectionPointRuleModel.deleteRule(e, t), [...He()].forEach((o) => {
      const i = new o(e, t);
  ...
  setRangeProtectionRanges(e, t, n, r) {
    ...
    if (s) {
      if (this._rangeProtectionRuleModel.getSubunitRuleList(e, t).filter((h) => h.id !== n).some((h) => h.ranges.some((d) => r.some((c) => En.intersects(c.getRange(), d)))))
        throw new Error("range protection cannot intersect");
      this._commandService.syncExecuteCommand(fe.id, {
        unitId: e,
        subUnitId: t,
        ruleId: n,
        rule: {
  ...
  getPermissionInfoWithCell(e, t, n, r) {
    const s = V1(n, r), o = this._rangeProtectionRuleModel.getSubunitRuleList(e, t).find((i) => i.ranges.some((d) => En.intersects(s, d)));
    if (o)
      return {
...
var se = (a, e) => (t, n) => e(t, n, a);
var W;
var k = (W = class extends $e {
  ...
  isMerged() {
    ...
    return this._worksheet.getMergedCellRange(t, e, r, n).some((o) => En.equals(o, this._range));
  }
  /**
  ...
  getRichTextValue() {
    ...
    return e != null && e.p ? new dn(e.p) : null;
  }
  /**
   ...
   */
  getRichTextValues() {
    return this.getCellDataGrid().map((t) => t.map((n) => n != null && n.p ? new dn(n.p) : null));
  }
  /**
  ...
  getValueAndRichTextValue() {
    const e = this.getCellData();
    return e != null && e.p ? new dn(e.p) : e == null ? void 0 : e.v;
  }
  /**
  ...
  getValueAndRichTextValues() {
    return this.getCellDatas().map((t) => t.map((n) => n != null && n.p ? new dn(n.p) : n == null ? void 0 : n.v));
  }
  /**
  ...
  getWraps() {
    ...
    return e.map((n) => n.map((r) => {
      var s;
      return ((s = t.getStyleByCell(r)) == null ? void 0 : s.tb) === Bn.WRAP;
    }));
  }
  /**
  ...
  getHorizontalAlignments() {
    return this._worksheet.getRange(this._range).getHorizontalAlignments().map((t) => t.map((n) => Fe2(n)));
  }
  /**
  ...
  getVerticalAlignment() {
    return Ve2(this._worksheet.getRange(this._range).getVerticalAlignment());
  }
  /**
  ...
  getVerticalAlignments() {
    return this._worksheet.getRange(this._range).getVerticalAlignments().map((t) => t.map((n) => Ve2(n)));
  }
  /**
   ...
   */
  setBorder(e, t, n) {
    return this._commandService.syncExecuteCommand(kc.id, {
  ...
  getBackground() {
    ...
    return (n = (t = e == null ? void 0 : e.background) == null ? void 0 : t.rgb) != null ? n : rt.bg.rgb;
  }
  /**
  ...
  getBackgrounds() {
    return this.getCellStyles().map((t) => t.map((n) => {
      var r, s;
      return (s = (r = n == null ? void 0 : n.background) == null ? void 0 : r.rgb) != null ? s : rt.bg.rgb;
    }));
  }
  /**
   ...
   */
  setTextRotation(e) {
    return this._commandService.syncExecuteCommand(Jc.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      range: this._range,
      value: e
  ...
  setRichTextValueForCell(e) {
    const t = e instanceof dn ? e.getData() : e, n = {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      range: {
        startColumn: this._range.startColumn,
    ...
    return this._commandService.syncExecuteCommand(Sn.id, n), this;
  }
  /**
   ...
   */
  setRichTextValues(e) {
    const t = e.map((s) => s.map((o) => o && { p: o instanceof dn ? o.getData() : o })), n = G1(t, this._range), r = {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      range: this._range,
      value: n
    };
    return this._commandService.syncExecuteCommand(Sn.id, r), this;
  }
  /**
  ...
  setWrap(e) {
    return this._commandService.syncExecuteCommand(Kc.id, {
      ...
      subUnitId: this._worksheet.getSheetId(),
      range: this._range,
      value: e ? Bn.WRAP : Bn.UNSPECIFIED
    }), this;
  }
  /**
  ...
  setVerticalAlignment(e) {
    return this._commandService.syncExecuteCommand(zc.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      range: this._range,
      value: Sn2(e)
  ...
  _setFontUnderline(e) {
    ...
    this._commandService.syncExecuteCommand(Ce.id, n);
  }
  /**
  ...
  setFontFamily(e) {
    ...
    return this._commandService.syncExecuteCommand(Ce.id, n), this;
  }
  /**
  ...
  merge(e = true) {
    ...
    return Hh(this._injector, t, n, [this._range], e), this;
  }
  /**
   ...
   */
  mergeAcross(e = true) {
    const t = zr([this._range], Em.ROWS), n = this._workbook.getUnitId(), r = this._worksheet.getSheetId();
    return Hh(this._injector, n, r, t, e), this;
  }
  /**
  ...
  mergeVertically(e = true) {
    const t = zr([this._range], Em.COLUMNS), n = this._workbook.getUnitId(), r = this._worksheet.getSheetId();
    return Hh(this._injector, n, r, t, e), this;
  }
  /**
   ...
   */
  breakApart() {
    return this._commandService.syncExecuteCommand(pc.id, { ranges: [this._range] }), this;
  }
  //#endregion
  /**
  ...
  getA1Notation(e, t, n) {
    ...
    return e ? Hc(this._worksheet.getName(), r) : Ft(r);
  }
  /**
  ...
  activateAsCurrentCell() {
    ...
    if (e && En.equals(e, this._range) || !e && this._range.startRow === this._range.endRow && this._range.startColumn === this._range.endColumn) {
      ...
      if (En.contains(r.getRange(), this._range)) {
        const s = {
          ...
          selections: [
            {
              range: r.getRange(),
              primary: _e(this.getRange(), this._worksheet),
              style: null
            }
          ]
        };
        return this._commandService.syncExecuteCommand(ie2.id, s), this;
      }
      return this.activate();
    } else
  ...
  splitTextToColumns(e, t, n) {
    this._commandService.syncExecuteCommand(ad.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      range: this._range,
      delimiter: t,
   ...
   */
  removeThemeStyle(e) {
    this._commandService.syncExecuteCommand(mc.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      range: this._range,
      themeName: e
   ...
   */
  getUsedThemeStyle() {
    return this._injector.get(Ts).getAppliedRangeThemeStyle({
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      range: this._range
    });
   ...
   */
  clear(e) {
    return e && e.contentsOnly && !e.formatOnly ? this.clearContent() : e && e.formatOnly && !e.contentsOnly ? this.clearFormat() : (this._commandService.syncExecuteCommand(Ws.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      ranges: [this._range],
      options: e
   ...
   */
  insertCells(e) {
    e === Em.ROWS ? this._commandService.executeCommand(Nt.id, {
      range: this._range
   ...
   */
  deleteCells(e) {
    e === Em.ROWS ? this._commandService.executeCommand(Mt.id, {
      range: this._range
  ...
  getDataRegion(e) {
    ...
    if (e !== Em.COLUMNS) {
      let y = false, U = false;
      for (let v = n; v <= s && (t > 0 && !L1(h.getValue(t - 1, v)) && (y = true), r < o - 1 && !L1(h.getValue(r + 1, v)) && (U = true), !(y && U)); v++)
        ;
      y && (d = t - 1), U && (l = r + 1);
    }
    if (e !== Em.ROWS) {
      let y = false, U = false;
      for (let v = t; v <= r && (n > 0 && !L1(h.getValue(v, n - 1)) && (y = true), s < i - 1 && !L1(h.getValue(v, s + 1)) && (U = true), !(y && U)); v++)
        ;
      y && (c = n - 1), U && (u = s + 1);
    }
...
k = vn([
  se(3, Inject(Injector)),
  se(4, Ls),
  se(5, Inject(_r))
], k);
var fn2 = Object.getOwnPropertyDescriptor;
var In2 = (a, e, t, n) => {
  for (var r = n > 1 ? void 0 : n ? fn2(e, t) : e, s = a.length - 1, o; s >= 0; s--)
    (o = a[s]) && (r = o(r) || r);
  return r;
};
var Rn = (a, e) => (t, n) => e(t, n, a);
var J2 = class {
  constructor(a, e, t, n) {
  ...
  updatePrimaryCell(a) {
    ...
    for (const { range: s, style: o } of this._selections)
      En.contains(s, a.getRange()) ? (t.push({
        range: s,
        primary: _e(a.getRange(), this._worksheet),
        style: o
      }), n = true) : t.push({
        range: s,
        primary: null,
    ...
    return e.syncExecuteCommand(ie2.id, r), new J2(this._workbook, this._worksheet, t, this._injector);
  }
  /**
...
var S = class extends $e {
  ...
  getSelection() {
    ...
    return e ? this._injector.createInstance(J2, this._workbook, this._worksheet, e) : null;
  }
  // #region rows
  ...
  setColumnDefaultStyle(e, t) {
    ...
    return this._commandService.syncExecuteCommand(Tc.id, s), this;
  }
  /**
  ...
  setRowDefaultStyle(e, t) {
    ...
    return this._commandService.syncExecuteCommand($c.id, s), this;
  }
  getRange(e, t, n, r) {
    let s, o;
    if (typeof e == "object")
      ...
      const { range: i, sheetName: h } = Dr(e), d = h ? this._workbook.getSheetBySheetName(h) : this._worksheet;
      if (!d)
      ...
      o = d, s = {
        ...
        rangeType: ge.NORMAL,
        startRow: i.rangeType === ge.COLUMN ? 0 : i.startRow,
        endRow: i.rangeType === ge.COLUMN ? o.getMaxRows() - 1 : i.endRow,
        startColumn: i.rangeType === ge.ROW ? 0 : i.startColumn,
        endColumn: i.rangeType === ge.ROW ? o.getMaxColumns() - 1 : i.endColumn
      };
   ...
   */
  insertRowsAfter(e, t) {
    const n = this._workbook.getUnitId(), r = this._worksheet.getSheetId(), s = Cm.DOWN, o = e + 1, i = e + t, h = 0, d = this._worksheet.getColumnCount() - 1, c = pt2(this._worksheet, o, i, h, d, true, e);
    return this._commandService.syncExecuteCommand(Nr2.id, {
      unitId: n,
      subUnitId: r,
      direction: s,
      range: {
  ...
  insertRowsBefore(e, t) {
    const n = this._workbook.getUnitId(), r = this._worksheet.getSheetId(), s = Cm.UP, o = e, i = e + t - 1, h = 0, d = this._worksheet.getColumnCount() - 1, c = pt2(this._worksheet, o, i, h, d, true, e - 1);
    return this._commandService.syncExecuteCommand(Nr2.id, {
      unitId: n,
      subUnitId: r,
      direction: s,
  ...
  setRowHeights(e, t, n) {
    ...
    return h.length > 0 && this._commandService.syncExecuteCommand(Gn.id, {
      unitId: r,
      subUnitId: s,
      ranges: h,
      value: n
    }), i.length > 0 && this._commandService.syncExecuteCommand(eo.id, {
      unitId: r,
      subUnitId: s,
      ranges: i
    }), this;
  ...
  insertColumnsAfter(e, t) {
    const n = this._workbook.getUnitId(), r = this._worksheet.getSheetId(), s = Cm.RIGHT, o = 0, i = this._worksheet.getRowCount() - 1, h = e + 1, d = e + t, c = pt2(this._worksheet, o, i, h, d, false, e);
    return this._commandService.syncExecuteCommand(Dr2.id, {
      unitId: n,
      subUnitId: r,
      direction: s,
      range: {
  ...
  insertColumnsBefore(e, t) {
    const n = this._workbook.getUnitId(), r = this._worksheet.getSheetId(), s = Cm.LEFT, o = 0, i = this._worksheet.getRowCount() - 1, h = e, d = e + t - 1, c = pt2(this._worksheet, o, i, h, d, false, e - 1);
    return this._commandService.syncExecuteCommand(Dr2.id, {
      unitId: n,
      subUnitId: r,
      direction: s,
  ...
  deleteColumns(e, t) {
    ...
    return this._commandService.syncExecuteCommand(xr.id, {
      range: n,
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId()
    }), this;
  ...
  setColumnWidths(e, t, n) {
    ...
    return this._commandService.syncExecuteCommand(Bn2.id, {
      unitId: r,
      subUnitId: s,
      ranges: o,
      value: n
   ...
   */
  setFreeze(e) {
    return this._logService.warn("setFreeze is deprecated, use setFrozenRows and setFrozenColumns instead"), this._commandService.syncExecuteCommand(Oc.id, {
      ...e,
      unitId: this._workbook.getUnitId(),
      subUnitId: this.getSheetId()
    }), this;
   ...
   */
  cancelFreeze() {
    return this._commandService.syncExecuteCommand(Dc.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this.getSheetId()
    }), this;
  }
  ...
  setFrozenColumns(...e) {
    ...
    if (arguments.length === 1) {
      ...
      let [n = 0, r = 0] = e;
      n > r && ([n, r] = [r, n]), this._commandService.syncExecuteCommand(Oc.id, {
        startColumn: r + 1,
        xSplit: r - n + 1,
        startRow: t.startRow,
        ySplit: t.ySplit,
  ...
  setHiddenGridlines(e) {
    return this._commandService.syncExecuteCommand(ld.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
   ...
   */
  setTabColor(e) {
    return this._commandService.syncExecuteCommand(Yc.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      value: e
    }), this;
   ...
   */
  onCellDataChange(e) {
    return this._injector.get(Ls).onCommandExecuted((n) => {
      if (n.id === ee.id) {
        const r = n.params;
        r.unitId === this._workbook.getUnitId() && r.subUnitId === this._worksheet.getSheetId() && r.cellValue && e(new pt(r.cellValue));
      }
    });
  }
  /**
  ...
  onBeforeCellDataChange(e) {
    return this._injector.get(Ls).beforeCommandExecuted((n) => {
      if (n.id === ee.id) {
        const r = n.params;
        r.unitId === this._workbook.getUnitId() && r.subUnitId === this._worksheet.getSheetId() && r.cellValue && e(new pt(r.cellValue));
      }
  ...
  hideSheet() {
    const e = this._injector.get(Ls);
    if (this._workbook.getSheets().filter((s) => s.isSheetHidden() !== ie.TRUE).length <= 1)
      throw new Error("Cannot hide the only visible sheet");
    return e.syncExecuteCommand(ed.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId()
    }), this;
  }
   ...
   */
  showSheet() {
    return this._injector.get(Ls).syncExecuteCommand(ui.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId()
    }), this;
  }
  ...
  clear(e) {
    ...
    const t = this._workbook.getUnitId(), n = this._worksheet.getSheetId(), r = this._injector.get(Ls), s = {
      startRow: 0,
      endRow: this._worksheet.getRowCount() - 1,
      startColumn: 0,
      endColumn: this._worksheet.getColumnCount() - 1
    };
    return r.syncExecuteCommand(Ws.id, {
      unitId: t,
      subUnitId: n,
      ranges: [s],
      options: e
   ...
   */
  clearContents() {
    const e = this._workbook.getUnitId(), t = this._worksheet.getSheetId(), n = this._injector.get(Ls), r = {
      startRow: 0,
      endRow: this._worksheet.getRowCount() - 1,
      startColumn: 0,
      endColumn: this._worksheet.getColumnCount() - 1
    };
    return n.syncExecuteCommand(qs.id, {
      unitId: e,
      subUnitId: t,
      ranges: [r]
    }), this;
  ...
  clearFormats() {
    ...
    return n.syncExecuteCommand(Ls2.id, {
      unitId: e,
      subUnitId: t,
      ranges: [r]
    }), this;
   ...
   */
  equalTo(e) {
    return e instanceof S ? this._worksheet.getSheetId() === e.getSheetId() && this._workbook.getUnitId() === e.getWorkbook().getUnitId() : false;
  }
  /**
   ...
   */
  appendRow(e) {
    const t = this._worksheet.getCellMatrix().hasValue(), n = this._worksheet.getLastRowWithContent(), r = this._worksheet.getRowCount(), s = this._worksheet.getColumnCount(), o = t ? n + 1 : n, i = new pt();
    for (let h = 0; h < e.length; h++)
      i.setValue(o, h, $a(e[h]));
    return this._commandService.syncExecuteCommand(cc.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
   ...
   */
  setRowCount(e) {
    return this._commandService.syncExecuteCommand(id.id, {
      unitId: this._workbook.getUnitId(),
      subUnitId: this._worksheet.getSheetId(),
      rowCount: e
    }), this;
...
var yn = (a, e, t, n) => {
  for (var r = n > 1 ? void 0 : n ? En2(e, t) : e, s = a.length - 1, o; s >= 0; s--)
    (o = a[s]) && (r = o(r) || r);
  return r;
};
var R = (a, e) => (t, n) => e(t, n, a);
var C = class extends $e {
   ...
   */
  setName(e) {
    return this._commandService.syncExecuteCommand(oi.id, {
      unitId: this._workbook.getUnitId(),
      name: e
    }), this;
  }
  ...
  create(e, t, n, r) {
    var h, d, c;
    const s = PE(J.deepClone((h = r == null ? void 0 : r.sheet) != null ? h : {}));
  ...
  insertSheet(e, t) {
    var o, i, h;
    const n = PE(J.deepClone((o = t == null ? void 0 : t.sheet) != null ? o : {}));
   ...
   */
  undo() {
    return this._univerInstanceService.focusUnit(this.id), this._commandService.syncExecuteCommand(gC.id), this;
  }
  /**
   ...
   */
  redo() {
    return this._univerInstanceService.focusUnit(this.id), this._commandService.syncExecuteCommand(_C.id), this;
  }
  /**
  ...
  onSelectionChange(e) {
    return We(
      this._selectionManagerService.selectionMoveEnd$.subscribe((t) => {
        this._univerInstanceService.getCurrentUnitForType(we.UNIVER_SHEET).getUnitId() === this.id && (t != null && t.length ? e(t.map((n) => n.range)) : e([]));
      })
    );
  }
  /**
   ...
   */
  setEditable(e) {
    const t = new Pe(this._workbook.getUnitId());
   ...
   */
  setActiveRange(e) {
    const t = this.getActiveSheet(), n = e.getRange().sheetId || t.getSheetId(), r = n ? this._workbook.getSheetBySheetId(n) : this._workbook.getActiveSheet(true);
    if (!r)
      throw new Error("No active sheet found");
    ...
    const s = {
      unitId: this.getId(),
      subUnitId: n,
      selections: [e].map((o) => ({ range: o.getRange(), primary: _e(o.getRange(), r), style: null }))
    };
    return this._commandService.syncExecuteCommand(ie2.id, s), this;
  }
  /**
   ...
   */
  duplicateSheet(e) {
    return this._commandService.syncExecuteCommand(qr.id, {
  ...
  moveSheet(e, t) {
    let n = t;
    return n < 0 ? n = 0 : n > this._workbook.getSheets().length - 1 && (n = this._workbook.getSheets().length - 1), this._commandService.syncExecuteCommand(ai.id, {
      unitId: e.getWorkbook().getUnitId(),
      order: n,
      subUnitId: e.getSheetId()
    }), this;
  ...
  insertDefinedName(e, t) {
    const r = this._injector.createInstance(Q).setName(e).setRef(t).build();
    return r.localSheetId = ng, this.insertDefinedNameBuilder(r), this;
  }
  /**
  ...
  insertDefinedNameBuilder(e) {
    e.unitId = this.getId(), this._commandService.syncExecuteCommand(Qr.id, e);
  }
  /**
  ...
  updateDefinedNameBuilder(e) {
    this._commandService.syncExecuteCommand(Qr.id, e);
  }
  /**
  ...
  getRegisteredRangeThemes() {
    return this._injector.get(Ts).getRegisteredRangeThemes();
  }
  /**
  ...
  unregisterRangeTheme(e) {
    this._commandService.syncExecuteCommand(cd.id, {
      unitId: this.getId(),
      themeName: e
    });
  }
...
var Un = class extends I {
  ...
  _initWorkbookEvent(e) {
    ...
    this.registerEventHandler(
      ...
      () => t.unitDisposed$.subscribe((n) => {
        n.type === we.UNIVER_SHEET && this.fireEvent(this.Event.WorkbookDisposed, {
          unitId: n.getUnitId(),
          unitType: n.type,
  ...
  createUniverSheet(e, t) {
    const r = this._injector.get(vr).createUnit(we.UNIVER_SHEET, e, t);
  ...
  getUniverSheet(e) {
    const t = this._univerInstanceService.getUnit(e, we.UNIVER_SHEET);
  ...
  onUniverSheetCreated(e) {
    const t = this._univerInstanceService.getTypeOfUnitAdded$(we.UNIVER_SHEET).subscribe((n) => {
  ...
  setFreezeSync(e) {
    this._injector.get(Jn).setEnabled(e);
  }
...
var Tn2 = (a, e) => (t, n) => e(t, n, a);
var He2 = class extends $ {
  constructor(a) {
    super(), this._injector = a;
  }
};
He2 = Nn([
  Tn2(0, Inject(Injector))
], He2);
...
//# sourceMappingURL=chunk-NMAPFXVM.js.map
