...
// node_modules/@univerjs/network/lib/es/index.js
var P = Object.defineProperty;
var S = (e, t, r) => t in e ? P(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
var u = (e, t, r) => S(e, typeof t != "symbol" ? t + "" : t, r);
var pe = "network.config";
var G = {};
...
var Y = createIdentifier("network.http-implementation");
var W = class {
  constructor(t) {
    this.params = t;
  }
...
var x = class extends Ve {
  ...
  registerHTTPInterceptor(t) {
    ...
    }), this._pipe = null, We(() => Os(this._interceptors, t));
  }
  get(t, r) {
  ...
  async request(t, r, n) {
    ...
    const s = new I(n == null ? void 0 : n.headers), o = new W(n == null ? void 0 : n.params), i = new X(t, r, {
      headers: s,
      params: o,
      withCredentials: (l = n == null ? void 0 : n.withCredentials) != null ? l : false,
      ...
      concatMap((a) => this._runInterceptorsAndImplementation(a))
    );
    return await firstValueFrom(c);
  }
  /**
  ...
  getSSE(t, r, n) {
    ...
    const s = new I(n == null ? void 0 : n.headers), o = new W(n == null ? void 0 : n.params), i = new X(t, r, {
      headers: s,
      params: o,
      withCredentials: (c = n == null ? void 0 : n.withCredentials) != null ? c : false,
      reportProgress: true,
      responseType: (d = n == null ? void 0 : n.responseType) != null ? d : "json",
      body: ["GET", "DELETE"].includes(t) || n == null ? void 0 : n.body
    });
    return of(i).pipe(concatMap((l) => this._runInterceptorsAndImplementation(l)));
  }
...
var N = class {
  ...
  async _readBody(e, t, r) {
    ...
    for (; ; ) {
      ...
      if (f) break;
      n.push(y), i += y.length, c && d === "text" && (l = (l != null ? l : "") + (h != null ? h : h = new TextDecoder()).decode(y, { stream: true }), r.next(new _e(
...
var D = class {
  ...
  send(e) {
    return new Observable((t) => {
      ...
      r.open(e.method, n), e.withCredentials && (r.withCredentials = true), s.headers && Object.entries(s.headers).forEach(([h, a]) => r.setRequestHeader(h, a));
      const i = () => {
        ...
        if (o === "blob" && !(p instanceof Blob) && (y = false, f = new Error("Response is not a Blob object")), y)
          t.next(
            new q({
              body: p,
              headers: h,
...
var k = (e, t) => (r, n) => t(r, n, e);
var U;
var V = (U = class extends Ol {
  ...
  onStarting() {
    var r, n, s;
    if (this._injector.get(x, Quantity.OPTIONAL, LookUp.SKIP_SELF) && !((r = this._config) != null && r.forceUseNewInstance)) {
      this._logger.warn(
        "[UniverNetworkPlugin]",
...
var Xe = (e) => {
  ...
  return (s, o) => o(s).pipe(
    catchError((i) => (i instanceof v && t.some((c) => c === i.status) && r(), throwError(() => i)))
  );
};
var De = (e = 300) => {
  let r = () => {
  ...
  return (n) => new Promise((s) => {
    ...
    r = () => {
      clearTimeout(o), s(false);
    };
  });
};
var $e = () => (e, t) => t.map((r) => ({ config: r, result: e }));
var Ve2 = (e, t = {}) => {
  ...
  return (l, h) => r(l) ? new Observable((a) => {
    const g = n(l);
    c.push({
      next: (f) => a.next(f),
      error: (f) => a.error(f),
...
var Je = (e) => {
  ...
  return (o, i) => i(o).pipe(retry({ delay: r, count: t }));
};
var Ke = (e) => {
...
var ze = createIdentifier("univer.network.socket.service");
var Ye = class extends Ve {
  createSocket(t) {
    try {
      const r = new WebSocket(t), n = new ao();
      return {
        URL: t,
        close: (o, i) => {
        ...
        open$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("open", i), n.add(We(() => r.removeEventListener("open", i)));
        }).pipe(share()),
        close$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("close", i), n.add(We(() => r.removeEventListener("close", i)));
        }).pipe(share()),
        error$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("error", i), n.add(We(() => r.removeEventListener("error", i)));
        }).pipe(share()),
        message$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("message", i), n.add(We(() => r.removeEventListener("message", i)));
        }).pipe(share())
      };
    } catch (r) {
...
//# sourceMappingURL=chunk-AFUSFBAE.js.map
