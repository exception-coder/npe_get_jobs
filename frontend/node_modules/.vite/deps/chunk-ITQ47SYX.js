...
var $e = (i, t, e) => t in i ? be(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
var C = (i, t, e) => $e(i, typeof t != "symbol" ? t + "" : t, e);
var Fe = "sheet.mutation.set-filter-range";
var we2 = "sheet.mutation.set-filter-criteria";
var ve = "sheet.mutation.remove-filter";
var Me2 = "sheet.mutation.re-calc-filter";
...
var b = ((i) => (i[i.VALUES = 0] = "VALUES", i[i.COLORS = 1] = "COLORS", i[i.CONDITIONS = 2] = "CONDITIONS", i))(b || {});
var I = ((i) => (i.EQUAL = "equal", i.GREATER_THAN = "greaterThan", i.GREATER_THAN_OR_EQUAL = "greaterThanOrEqual", i.LESS_THAN = "lessThan", i.LESS_THAN_OR_EQUAL = "lessThanOrEqual", i.NOT_EQUALS = "notEqual", i))(I || {});
var Rt = {
  operator: I.GREATER_THAN,
  fn: (i, t) => P2(i) ? i > t : false
};
var pt = {
  ...
  fn: (i, t) => {
    if (typeof t == "string") {
      if (t === " ")
        return i != null;
      const e = Ae(i);
      return e && Ot(t) ? !m1(t).test(e) : e !== t;
    }
    return P2(i) ? i !== t : true;
  }
};
var ye = /* @__PURE__ */ new Map([]);
var vt = [Rt, pt, St, Ft, wt, Oe];
vt.forEach((i) => {
  ye.set(i.operator, i);
});
function Mt(i) {
...
function ce(i) {
  return !!(typeof i == "number" || typeof i == "string" && Jf(i));
}
function Ae(i) {
  return typeof i == "boolean" || i == null ? null : typeof i == "string" ? i : i.toString();
}
function Ot(i) {
  return typeof i == "number" ? false : i.indexOf("*") !== -1 || i.indexOf("?") !== -1;
}
var Y = () => /* @__PURE__ */ new Set();
var q = class _q extends Ve {
  constructor(e, r, n) {
    super();
    C(this, "_filteredOutRows$", new BehaviorSubject(Y()));
    C(this, "filteredOutRows$", this._filteredOutRows$.asObservable());
    C(this, "_hasCriteria$", new BehaviorSubject(false));
  ...
  serialize() {
    const e = {
      ref: En.clone(this._range),
      filterColumns: this._getAllFilterColumns(true).sort(([r], [n]) => r - n).map(([r, n]) => n.serialize())
    };
  ...
  getFilteredOutRowsExceptCol(e) {
    return this._getAllFilterColumns(true).filter(([r]) => r !== e).reduce((r, [, n]) => {
   ...
   */
  setRange(e) {
    this._range = e, this._getAllFilterColumns(true).forEach(([r, n]) => {
      n.setRangeAndColumn({
        startRow: e.startRow,
        endRow: e.endRow,
        startColumn: r,
  ...
  _rebuildAlreadyFilteredOutRowsWithCache() {
    const e = this._getAllFilterColumns().filter((r) => r.hasCache()).reduce((r, n) => u1(r, n.filteredOutRows), /* @__PURE__ */ new Set());
  ...
  _reCalcWithNoCacheColumns() {
    ...
    for (const r of e) {
      const n = r.reCalc();
      n && (this._alreadyFilteredOutRows = u1(this._alreadyFilteredOutRows, n));
    }
  }
};
var yt = class extends Ve {
  ...
  getColumnData() {
    return J.deepClone(this._criteria);
  }
  /**
  ...
  calc(e) {
    ...
    for (const l of this._worksheet.iterateByColumn(n, false, false)) {
      const { row: a, rowSpan: c, col: u } = l;
      if (o.has(a) && (!c || c === 1))
        continue;
      if (!(this._filterBy === b.VALUES ? this._filterFn(HE(this._worksheet.getCell(a, u))) : this._filterBy === b.COLORS ? this._filterFn(this._worksheet.getComposedCellStyle(a, u)) : this._filterFn(Ut(this._worksheet, a, u))) && (s.add(a), c))
        for (let h = 1; h < c; h++)
          s.add(a + h);
    }
    return s;
  ...
  if (i.cellFillColors) {
    ...
    return (e) => {
      ...
      if (!e || !((n = e.bg) != null && n.rgb))
        return !!t.has(null);
      const r = new bt(e.bg.rgb).toRgbString();
      return t.has(r);
    };
  }
  if (i.cellTextColors) {
    ...
    return (e) => {
      ...
      if (!e || !((n = e.cl) != null && n.rgb))
        return !!t.has(z3);
      const r = new bt(e.cl.rgb).toRgbString();
      return t.has(r);
    };
  }
...
function It(i) {
  ...
  return $t(t) ? i.and ? xt2(t) : bt3(t) : t[0];
}
function xt2(i) {
  const [t, e] = i;
  return (r) => t(r) && e(r);
...
function Ut(i, t, e) {
  ...
  return r && !n ? de(r) : n ? r.t === fn.NUMBER && typeof r.v == "string" ? n.v : r.t === fn.NUMBER ? Number(n.v) : de(n) : null;
}
function de(i) {
  var r, n;
  ...
  const e = i.v;
  return typeof e == "string" ? i.t === fn.BOOLEAN ? e.toUpperCase() : e : typeof e == "number" ? i.t === fn.BOOLEAN ? e ? "TRUE" : "FALSE" : e : typeof e == "boolean" ? e ? "TRUE" : "FALSE" : "";
}
...
var X = (i, t) => (e, r) => t(e, r, i);
var Ne = "SHEET_FILTER_PLUGIN";
var M = class extends Ve {
  constructor(t, e, r) {
    super();
    C(this, "_filterModels", /* @__PURE__ */ new Map());
    C(this, "_loadedUnitId$", new BehaviorSubject(null));
    C(this, "loadedUnitId$", this._loadedUnitId$.asObservable());
    C(this, "_errorMsg$", new BehaviorSubject(null));
    C(this, "errorMsg$", this._errorMsg$.asObservable());
    C(this, "_activeFilterModel$", new BehaviorSubject(null));
  ...
  removeFilterModel(t, e) {
    const r = this.getFilterModel(t, e);
    return r ? (r.dispose(), this._filterModels.get(t).delete(e), true) : false;
  }
  setFilterErrorMsg(t) {
  ...
  _updateActiveFilterModel() {
    let t;
    try {
      if (t = this._univerInstanceService.getCurrentUnitForType(we.UNIVER_SHEET), !t) {
  ...
  _initActiveFilterModel() {
    this.disposeWithMe(
      merge(
        ...
        wg(this._commandService.onCommandExecuted.bind(this._commandService)).pipe(filter(([t]) => t.type === Ms.MUTATION && Ee.has(t.id))),
        // source2: activate sheet changes
        this._univerInstanceService.getCurrentTypeOfUnit$(we.UNIVER_SHEET).pipe(switchMap((t) => {
          var e;
          return (e = t == null ? void 0 : t.activeSheet$) != null ? e : of(null);
        }))
...
var R = {
  ...
  handler: (i, t) => {
    ...
    return i.get(M).ensureFilterModel(r, e).setRange(n), true;
  }
};
var p = {
  id: we2,
  type: Ms.MUTATION,
  handler: (i, t) => {
    const { subUnitId: e, unitId: r, criteria: n, col: s, reCalc: o = true } = t, a = i.get(M).getFilterModel(r, e);
    return a ? (a.setCriteria(s, n, o), true) : false;
  }
};
var y2 = {
  id: ve,
...
var Bt = {
  ...
  type: Ms.COMMAND,
  handler: (i, t) => {
    const e = i.get(M), r = i.get(Ls), n = i.get(Qo), s = i.get(vr), { unitId: o, subUnitId: l, range: a } = t;
    if (!P(s, t) || e.getFilterModel(o, l)) return false;
    if (a.endRow === a.startRow) {
      const g = i.get(_E), _ = i.get(Fn);
      return g.emit(_.t("sheets-filter.command.not-valid-filter-range")), false;
    }
    const d = { id: R.id, params: { unitId: o, subUnitId: l, range: a } }, h = r.syncExecuteCommand(d.id, d.params);
    return h && n.pushUndoRedo({
      unitID: o,
      undoMutations: [{ id: y2.id, params: { unitId: o, subUnitId: l } }],
      redoMutations: [d]
    }), h;
  }
};
var zt = {
  ...
  type: Ms.COMMAND,
  handler: (i, t) => {
    const e = i.get(vr), r = i.get(M), n = i.get(Ls), s = i.get(Qo), o = P(e, t);
    if (!o) return false;
    const { unitId: l, subUnitId: a } = o, c = r.getFilterModel(l, a);
    if (!c) return false;
    const u = c == null ? void 0 : c.serialize(), d = Ht(l, a, u), h = n.syncExecuteCommand(y2.id, { unitId: l, subUnitId: a });
    return h && s.pushUndoRedo({
      unitID: l,
      undoMutations: d,
      redoMutations: [{ id: y2.id, params: { unitId: l, subUnitId: a } }]
    }), h;
  }
};
var ar = {
  ...
  type: Ms.COMMAND,
  handler: async (i) => {
    const t = i.get(vr), e = i.get(M), r = i.get(Ls), n = t.getCurrentUnitForType(we.UNIVER_SHEET), s = n == null ? void 0 : n.getActiveSheet();
    if (!s || !n) return false;
    const o = n.getUnitId(), l = s.getSheetId();
    if (e.getFilterModel(o, l))
      return r.executeCommand(zt.id, { unitId: o, subUnitId: l });
    const u = i.get(z).getCurrentLastSelection();
    if (!u) return false;
    const d = u.range, h = Th(u) ? ph(d, { left: true, right: true, up: true, down: true }, s) : d;
...
var cr = {
  ...
  type: Ms.COMMAND,
  handler: (i, t) => {
    const e = i.get(M), r = i.get(Ls), n = i.get(Qo), { unitId: s, subUnitId: o, col: l, criteria: a } = t, c = e.getFilterModel(s, o);
    if (!c) return false;
    const u = c.getRange();
    if (!u || l < u.startColumn || l > u.endColumn) return false;
...
var dr = {
  ...
  type: Ms.COMMAND,
  handler: (i, t) => {
    const e = i.get(M), r = i.get(Qo), n = i.get(Ls), s = i.get(vr), o = P(s, t);
    if (!o) return false;
    const { unitId: l, subUnitId: a } = o, c = e.getFilterModel(o.unitId, o.subUnitId);
    if (!c) return false;
    const u = c.serialize(), d = Te2(l, a, u), h = Vt(l, a, u);
    return fo(h, n).result ? (r.pushUndoRedo({
      unitID: l,
      undoMutations: d,
      redoMutations: h
    }), true) : false;
...
var ur = {
  ...
  type: Ms.COMMAND,
  handler: (i, t) => {
    const e = i.get(M), r = i.get(Ls), n = i.get(vr), s = P(n, t);
    if (!s) return false;
    const { unitId: o, subUnitId: l } = s;
    return e.getFilterModel(s.unitId, s.subUnitId) ? r.executeCommand(B.id, { unitId: o, subUnitId: l }) : false;
  }
};
function Ht(i, t, e) {
  const r = [], n = {
  ...
  return r.push(n), Te2(i, t, e).forEach((o) => r.push(o)), r;
}
function Te2(i, t, e) {
  var n;
  const r = [];
...
var z2 = class extends Ve {
  constructor(t, e, r, n, s, o, l) {
    super();
    C(this, "_disposableCollection", new ao());
  ...
  handleRemoveColCommand(t, e, r) {
    ...
    if (h === l - o + 1) {
      ...
      u.push({ id: y2.id, params: f }), d.unshift({ id: R.id, params: { range: s, unitId: e, subUnitId: r } });
    } else {
  ...
  _handleRemoveRowCommand(t, e, r) {
    ...
    if (_ === l - o + 1 || g) {
      ...
      u.push({ id: y2.id, params: w }), h.forEach((F) => {
        const [f, m] = F, v = {
          unitId: e,
          subUnitId: r,
          col: f,
  ...
  handleMoveColsCommand({ fromRange: t, toRange: e }, r, n) {
    ...
    Pa(t.startColumn, t.endColumn - t.startColumn + 1, e.startColumn, d);
  ...
  _handleMoveRowsCommand(t, e, r) {
    ...
    const g = o;
    let _ = l;
    l >= a.startRow && l <= a.endRow && c.startRow < a.startRow && a.startRow > o && (_ = a.startRow - 1), Pa(a.startRow, a.endRow - a.startRow + 1, c.startRow, h);
  ...
  _handleRemoveSheetCommand(t, e, r) {
    ...
    }), o.push({ id: y2.id, params: { unitId: e, subUnitId: r, range: s } }), l.unshift({ id: R.id, params: { range: s, unitId: e, subUnitId: r } }), {
      undos: l,
      redos: o
    };
  }
  _handleCopySheetCommand(t, e, r) {
    ...
    }), a.push({ id: y2.id, params: { unitId: t, subUnitId: r, range: s } }), o.unshift({ id: R.id, params: { range: s, unitId: t, subUnitId: r } }), {
      undos: l,
      redos: o,
      preUndos: a,
      preRedos: c
  ...
  _initRowFilteredInterceptor() {
    this.disposeWithMe(this._sheetInterceptorService.intercept(ht.ROW_FILTERED, {
      ...
      handler: (t, e) => {
        var r, n;
        return t ? true : (n = (r = this._sheetsFilterService.getFilterModel(
          e.unitId,
          e.subUnitId
        )) == null ? void 0 : r.isRowFiltered(e.row)) != null ? n : false;
      }
    }));
  }
  ...
  _commandExecutedListener() {
    this.disposeWithMe(this._commandService.onCommandExecuted((t, e) => {
      ...
      if (t.id === Ue.id) {
        ...
        o.forEach((g) => {
          g >= d ? (a = true, l.push(g + (h - d + 1))) : l.push(g);
        });
      }
      if (a && (s.filteredOutRows = new Set(l)), t.id === ee.id && !(e != null && e.onlyLocal)) {
          ...
          if (h)
            for (let g = d.startColumn; g <= d.endColumn; g++) {
              ...
              if (_ && this._cellHasValue(_)) {
                ...
                if (S) {
                  const w = ph(d, { down: true }, S), F = this._sheetsFilterService.getFilterModel(r, n), f = F.getRange();
                  F.setRange({
                    ...f,
                    endRow: w.endRow
  ...
  _initErrorHandling() {
    this.disposeWithMe(this._commandService.beforeCommandExecuted((t) => {
      const e = t.params, r = P(this._univerInstanceService);
      if (!r) return;
      const { subUnitId: n, unitId: s } = r, o = this._sheetsFilterService.getFilterModel(s, n);
      if (!o) return;
      const l = o.getRange();
      if (t.id === un.id && e.fromRange.startRow <= l.startRow && e.fromRange.endRow < l.endRow && e.fromRange.endRow >= l.startRow)
...
var G2 = class extends Ve {
  constructor(t, e, r) {
    ...
    super();
    C(this, "_d", new ao());
    C(this, "_visible$", new BehaviorSubject(false));
    C(this, "visible$", this._visible$.asObservable());
    C(this, "_enabled$", new BehaviorSubject(true));
    ...
    n != null && n.enableSyncSwitch && (this._visible$.next(true), typeof n.enableSyncSwitch == "object" && this.setEnabled((s = n.enableSyncSwitch.defaultValue) != null ? s : true));
  }
  get visible() {
  ...
  _initOnlyLocalListener() {
    this._d.add(
      this._commandService.beforeCommandExecuted((t, e) => {
        Jt.includes(t.id) && (e || (e = {}), e.onlyLocal = true);
      })
    ), this._d.add(
...
var Q = class extends Ve {
  ...
  _registerSheetRowFiltered() {
    this._sheetRowFilteredService.register((i, t, e) => {
      var r, n;
      return (n = (r = this._sheetsFilterService.getFilterModel(i, t)) == null ? void 0 : r.isRowFiltered(e)) != null ? n : false;
    });
  }
};
Q = Yt([
...
var he = (i, t) => (e, r) => t(e, r, i);
var W2;
var fe = (W2 = class extends Ol {
...
}, C(W2, "type", we.UNIVER_SHEET), C(W2, "pluginName", Ne), W2);
fe = er([
  he(1, Inject(Injector)),
  he(2, ic)
], fe);
...
//# sourceMappingURL=chunk-ITQ47SYX.js.map
