...
import {
  ...
  S as S2,
  k as k3
} from "./chunk-NMAPFXVM.js";
import "./chunk-ZD4XOXVC.js";
import "./chunk-C7XWF65L.js";
import "./chunk-YS7OJI4F.js";
import {
  O
...
// node_modules/@univerjs/sheets-conditional-formatting/lib/es/facade.js
var U = Object.defineProperty;
var q = (u, e, t) => e in u ? U(u, e, { enumerable: true, configurable: true, writable: true, value: t }) : u[e] = t;
...
var c = class _c {
  ...
  _getDefaultConfig(e = S.highlightCell) {
    switch (e) {
      case S.colorScale:
        return {
          type: e,
          config: [
            { index: 0, color: new bt("").toRgbString(), value: { type: I.min } },
            { index: 0, color: new bt("green").toRgbString(), value: { type: I.max } }
          ]
        };
      case S.dataBar:
        return {
          type: e,
          isShowValue: true,
          config: { min: { type: I.min }, max: { type: I.max }, positiveColor: new bt("green").toRgbString(), nativeColor: new bt("").toRgbString(), isGradient: false }
        };
      case S.highlightCell:
        return {
          type: e,
          subType: A.text,
          operator: L.containsText,
          value: "abc",
          style: {}
        };
      case S.iconSet:
        return {
          ...
          isShowValue: true,
          config: [{
            operator: F.greaterThanOrEqual,
            value: { type: I.min },
            iconType: f1,
            iconId: ""
          }, {
            operator: F.greaterThanOrEqual,
            value: { type: I.percentile, value: 0.5 },
            iconType: f1,
            iconId: ""
          }, {
  ...
  build() {
    var r;
    this._rule.cfId || (this._rule.cfId = b0()), this._rule.ranges || (this._rule.ranges = []), this._rule.stopIfTrue === void 0 && (this._rule.stopIfTrue = false), (r = this._rule.rule) != null && r.type || (this._rule.rule.type = S.highlightCell, this._ensureAttr(this._rule, ["rule", "style"]));
   ...
   */
  copy() {
    const e = J.deepClone(this._rule);
    return e.cfId && (e.cfId = b0()), new _c(e);
  }
  /**
...
var i = class _i extends c {
  ...
  copy() {
    const e = J.deepClone(this._rule);
    return e.cfId && (e.cfId = b0()), new _i(e);
  }
  /**
   * Set average rule.
  ...
  setAverage(e) {
    ...
    return t.type = S.highlightCell, t.subType = A.average, t.operator = e, this;
  }
  /**
  ...
  setUniqueValues() {
    ...
    return e.type = S.highlightCell, e.subType = A.uniqueValues, this;
  }
  /**
  ...
  setDuplicateValues() {
    const e = this._ruleConfig;
    return e.type = S.highlightCell, e.subType = A.duplicateValues, this;
  }
  /**
   * Set rank rule.
  ...
  setRank(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.rank, t.isBottom = e.isBottom, t.isPercent = e.isPercent, t.value = e.value, this;
  }
  /**
  ...
  setBackground(e) {
    var t;
    if (((t = this._ruleConfig) == null ? void 0 : t.type) === S.highlightCell)
      if (e) {
  ...
  setBold(e) {
    var t;
    return ((t = this._ruleConfig) == null ? void 0 : t.type) === S.highlightCell && (this._ensureAttr(this._ruleConfig, ["style"]), this._ruleConfig.style.bl = e ? ie.TRUE : ie.FALSE), this;
  }
  /**
  ...
  setItalic(e) {
    var t;
    return ((t = this._ruleConfig) == null ? void 0 : t.type) === S.highlightCell && (this._ensureAttr(this._ruleConfig, ["style"]), this._ruleConfig.style.it = e ? ie.TRUE : ie.FALSE), this;
  }
  /**
  ...
  setStrikethrough(e) {
    var t;
    return ((t = this._ruleConfig) == null ? void 0 : t.type) === S.highlightCell && (this._ensureAttr(this._ruleConfig, ["style", "st"]), this._ruleConfig.style.st.s = e ? ie.TRUE : ie.FALSE), this;
  }
  /**
  ...
  setUnderline(e) {
    var t;
    return ((t = this._ruleConfig) == null ? void 0 : t.type) === S.highlightCell && (this._ensureAttr(this._ruleConfig, ["style", "ul"]), this._ruleConfig.style.ul.s = e ? ie.TRUE : ie.FALSE), this;
  }
  /**
  ...
  whenCellEmpty() {
    const e = this._ruleConfig;
    return e.type = S.highlightCell, e.subType = A.text, e.value = "", e.operator = L.equal, this;
  }
  /**
  ...
  whenCellNotEmpty() {
    const e = this._ruleConfig;
    return e.type = S.highlightCell, e.subType = A.text, e.value = "", e.operator = L.notEqual, this;
  }
  /**
  ...
  whenDate(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.timePeriod, t.operator = e, this;
  }
  /**
  ...
  whenFormulaSatisfied(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.formula, t.value = e, this;
  }
  /**
  ...
  whenNumberBetween(e, t) {
    ...
    return h.type = S.highlightCell, h.subType = A.number, h.value = [r, l], h.operator = F.between, this;
  }
  /**
  ...
  whenNumberEqualTo(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.number, t.value = e, t.operator = F.equal, this;
  }
  /**
  ...
  whenNumberGreaterThan(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.number, t.value = e, t.operator = F.greaterThan, this;
  }
  /**
  ...
  whenNumberGreaterThanOrEqualTo(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.number, t.value = e, t.operator = F.greaterThanOrEqual, this;
  }
  /**
  ...
  whenNumberLessThan(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.number, t.value = e, t.operator = F.lessThan, this;
  }
  /**
  ...
  whenNumberLessThanOrEqualTo(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.number, t.value = e, t.operator = F.lessThanOrEqual, this;
  }
  /**
  ...
  whenNumberNotBetween(e, t) {
    const r = Math.min(e, t), l = Math.max(e, t), h = this._ruleConfig;
    return h.type = S.highlightCell, h.subType = A.number, h.value = [r, l], h.operator = F.notBetween, this;
  }
  /**
  ...
  whenNumberNotEqualTo(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.number, t.value = e, t.operator = F.notEqual, this;
  }
  /**
  ...
  whenTextContains(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.text, t.value = e, t.operator = L.containsText, this;
  }
  /**
  ...
  whenTextDoesNotContain(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.text, t.value = e, t.operator = L.notContainsText, this;
  }
  /**
  ...
  whenTextEndsWith(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.text, t.value = e, t.operator = L.endsWith, this;
  }
  /**
  ...
  whenTextEqualTo(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.text, t.value = e, t.operator = L.equal, this;
  }
  /**
  ...
  whenTextStartsWith(e) {
    const t = this._ruleConfig;
    return t.type = S.highlightCell, t.subType = A.text, t.value = e, t.operator = L.beginsWith, this;
  }
};
var p = class _p extends c {
  ...
  copy() {
    const e = J.deepClone(this._rule);
    return e.cfId && (e.cfId = b0()), new _p(e);
  }
  /**
   * Set data bar rule.
   * @param {{
  ...
  setDataBar(e) {
    const t = this._ruleConfig;
    return t.type = S.dataBar, t.isShowValue = !!e.isShowValue, t.config = {
      min: e.min,
      max: e.max,
...
var y = class _y extends c {
  ...
  copy() {
    const e = J.deepClone(this._rule);
    return e.cfId && (e.cfId = b0()), new _y(e);
  }
  /**
  ...
  setColorScale(e) {
    const t = this._ruleConfig;
    return t.type = S.colorScale, t.config = e, this;
  }
};
var b = class _b extends c {
  /**
   * Deep clone a current builder.
  ...
  copy() {
    const e = J.deepClone(this._rule);
    return e.cfId && (e.cfId = b0()), new _b(e);
  }
  /**
  ...
  setIconSet(e) {
    const t = this._ruleConfig;
    return t.type = S.iconSet, t.config = e.iconConfigs, t.isShowValue = e.isShowValue, this;
  }
};
var w = class {
  constructor(e = {}) {
...
var W2 = class extends k3 {
  _getConditionalFormattingRuleModel() {
    return this._injector.get(M);
  }
  getConditionalFormattingRules() {
    return [...this._getConditionalFormattingRuleModel().getSubunitRules(this._workbook.getUnitId(), this._worksheet.getSheetId()) || []].filter((t) => t.ranges.some((r) => En.intersects(r, this._range)));
  }
  ...
  addConditionalFormattingRule(e) {
    ...
    return this._commandService.syncExecuteCommand(k0.id, t), this;
  }
  deleteConditionalFormattingRule(e) {
    ...
    return this._commandService.syncExecuteCommand(U0.id, t), this;
  }
  moveConditionalFormattingRule(e, t, r = "after") {
    ...
    return this._commandService.syncExecuteCommand(T0.id, l), this;
  }
  setConditionalFormattingRule(e, t) {
    ...
    return this._commandService.syncExecuteCommand(V0.id, r), this;
  }
  clearConditionalFormatRules() {
    ...
    return this._commandService.syncExecuteCommand(B0.id, e), this;
  }
};
k3.extend(W2);
var L3 = class extends C {
  newColor() {
    return new mo();
  }
};
...
var G = class extends S2 {
  ...
  clearConditionalFormatRules() {
    ...
    return this._commandService.syncExecuteCommand(N0.id, e), this;
  }
};
S2.extend(G);
var P = class {
...
// node_modules/@univerjs/preset-sheets-conditional-formatting/lib/es/index.js
function m() {
  return {
    plugins: [
      N2,
...
//# sourceMappingURL=@univerjs_presets_preset-sheets-conditional-formatting.js.map
