...
var C2 = class extends Ve {
  ...
  setSelection(t, r, n) {
    ...
    this._commandService.executeCommand(ie.id, s);
  }
  ...
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    (0, import_jsx_runtime.jsxs)("div", { onMouseDown: (d) => {
      ...
      (0, import_jsx_runtime.jsx)(
        ...
        {
          ref: l,
          className: ie2("univer-max-h-[310px] univer-overflow-y-auto univer-overflow-x-hidden", pr),
          onScroll: (d) => {
      ...
      (0, import_jsx_runtime.jsx)(
        vf,
        {
          overlay: (0, import_jsx_runtime.jsx)(
            "ul",
            {
              className: ie2("univer-my-0 univer-box-border univer-grid univer-max-h-[310px] univer-w-[var(--radix-popper-anchor-width)] univer-items-center univer-gap-1 univer-overflow-y-auto univer-overflow-x-hidden univer-rounded-lg univer-border univer-bg-white univer-p-1 univer-text-base univer-shadow-lg", pr),
          ...
          children: (0, import_jsx_runtime.jsxs)(
            "div",
            {
              className: ie2("univer-ml-2 univer-flex univer-w-full univer-items-center univer-justify-between univer-overflow-hidden univer-rounded-md univer-py-1.5 univer-text-sm univer-text-gray-900 dark:!univer-text-white"),
              children: [
                (0, import_jsx_runtime.jsx)(
                  "span",
                  {
