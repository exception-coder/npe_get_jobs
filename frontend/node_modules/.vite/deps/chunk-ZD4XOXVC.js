...
var ka = (a, e, n) => e in a ? Ka(a, e, { enumerable: true, configurable: true, writable: true, value: n }) : a[e] = n;
var W2 = (a, e, n) => ka(a, typeof e != "symbol" ? e + "" : e, n);
var ni = {
  id: "formula.command.insert-function",
  type: Ms.COMMAND,
  handler: async (a, e) => {
    const { list: n, listOfRangeHasNumber: i } = e, r = a.get(Ls), o = new pt();
    n.forEach((f) => {
      const { range: m3, primary: c, formula: d } = f, { row: P2, column: E } = c, p = et(6);
      o.setValue(P2, E, {
        f: d,
        si: p
      });
      const { startRow: I2, startColumn: S, endRow: R, endColumn: s } = m3;
      for (let A = I2; A <= R; A++)
        for (let N = S; N <= s; N++)
          (A !== P2 || N !== E) && o.setValue(A, N, {
            si: p
          });
    }), i && i.length > 0 && i.forEach((f) => {
      const { primary: m3, formula: c } = f;
      o.setValue(m3.row, m3.column, {
        f: c
      });
    });
    const u = {
    ...
    return r.executeCommand(Sn.id, u);
  }
};
var ii = {
  ...
  type: Ms.COMMAND,
  handler: async (a) => {
    const n = a.get(z).getCurrentLastSelection();
    if (!n) return false;
    const i = a.get(vr), r = P(i);
    if (!r) return false;
    ...
    }, { left: true, right: true, up: true, down: true }, u), c = new pt(), d = us({
      startRow: m3.endRow,
      endRow: m3.endRow,
      startColumn: m3.startColumn,
      endColumn: m3.endColumn
    }, u);
    if (!En.equals(d, m3))
      for (const p of u.iterateByColumn(d))
        (!p.value || !u.cellHasValue(p.value)) && c.setValue(p.row, p.col, {
          f: `=SUM(${Ft({
            startColumn: p.col,
            endColumn: p.col,
            startRow: m3.startRow,
            endRow: p.row - 1
          })})`
        });
    const P2 = us({
      startRow: m3.startRow,
      startColumn: m3.endColumn,
      endRow: m3.endRow,
      endColumn: m3.endColumn
    }, u);
    if (!En.equals(P2, m3))
      for (const p of u.iterateByRow(P2))
        (!p.value || !u.cellHasValue(p.value)) && c.setValue(p.row, p.col, {
          f: `=SUM(${Ft({
            startColumn: m3.startColumn,
            endColumn: p.col - 1,
    ...
    return (await E1([
      ...
      },
      {
        ...
        params: {
          ...
          selections: [{
            range: m3,
            primary: En.contains(m3, n.primary) ? n.primary : { ...f, actualRow: f.startRow, actualColumn: f.startColumn },
            style: null
          }]
        }
      }
...
var ge2 = "sheets-formula.base.config";
var Pe2 = ((a) => (a[a.FORCED = 0] = "FORCED", a[a.WHEN_EMPTY = 1] = "WHEN_EMPTY", a[a.NO_CALCULATION = 2] = "NO_CALCULATION", a))(Pe2 || {});
var fa = {};
var ri = "sheets-formula.remote.config";
var ca2 = {};
var Ie = ((a) => (a[a.NOT_REGISTER = 1] = "NOT_REGISTER", a[a.SUCCESS = 2] = "SUCCESS", a[a.WAIT = 3] = "WAIT", a[a.ERROR = 4] = "ERROR", a))(Ie || {});
...
var Lt = (a, e) => (n, i) => e(n, i, a);
var je = class extends Ve {
  constructor(e, n, i) {
    super();
    W2(this, "_formulaCacheMap", /* @__PURE__ */ new Map());
    W2(this, "_formulaChangeWithRange$", new Subject());
    W2(this, "formulaChangeWithRange$", this._formulaChangeWithRange$.asObservable());
    W2(this, "_formulaResult$", new Subject());
    W2(this, "formulaResult$", this._formulaResult$.asObservable());
    W2(this, "calculateStarted$", new BehaviorSubject(false));
  ...
  _initFormulaRegister() {
    ...
    const e = (n) => {
      ...
      this._commandService.executeCommand(ha.id, c).then(() => {
    ...
    this.disposeWithMe(
      this._formulaChangeWithRange$.pipe(bufferWhen(() => this.calculateStarted$.pipe(filter((n) => n)))).subscribe((n) => n.forEach(e))
    ), this.disposeWithMe(
    ...
    this.disposeWithMe(this._commandService.onCommandExecuted((e) => {
      if (e.id === lo.id) {
        ...
        for (const o in i) {
          ...
          r[o] = f;
          for (const m3 in u) {
            const c = this._ensureCacheMap(o, m3), d = u[m3], P2 = [];
            f[m3] = P2;
            for (const E in d) {
              const p = d[E];
              if (c.has(E)) {
                ...
                if (!I2)
                  continue;
                I2.result || (I2.result = {});
                const S = new pt(p), R = new pt(I2.result);
                S.forValue((s, A, N) => {
                  R.setValue(s, A, N);
                }), I2.status = Ie.SUCCESS, I2.callbacks.forEach((s) => {
                  s(p);
                }), I2.callbacks.clear(), P2.push(I2);
              }
            }
          }
        }
  ...
  deleteFormula(e, n, i) {
    ...
    this._commandService.executeCommand(ma.id, r);
...
var pe = (a, e) => (n, i) => e(n, i, a);
var la = { done: 0, count: 0 };
var Pt2 = { onlyLocal: true };
var xe = class extends Ve {
  constructor(e, n, i, r, o, u, f) {
    super();
    W2(this, "_waitingCommandQueue", []);
    W2(this, "_executingDirtyData", {
    ...
    W2(this, "_setTimeoutKey", -1);
    W2(this, "_startExecutionTime", 0);
    W2(this, "_totalCalculationTaskCount", 0);
    W2(this, "_doneCalculationTaskCount", 0);
    W2(this, "_executionInProgressParams", null);
    W2(this, "_restartCalculation", false);
    W2(this, "_forceCalculating", false);
    W2(this, "_progress$", new BehaviorSubject(la));
    W2(this, "progress$", this._progress$.asObservable());
  ...
  _getCalculationMode() {
    var n;
    const e = this._configService.getConfig(ge2);
    return (n = e == null ? void 0 : e.initialFormulaComputing) != null ? n : Pe2.WHEN_EMPTY;
  }
    ...
    this.disposeWithMe(
      ...
      this._commandService.onCommandExecuted((e, n) => {
        if (this._activeDirtyManagerService.get(e.id)) {
          if (e.id === ee2.id) {
            const i = e.params;
            if (n && n.onlyLocal === true || i.trigger === Ce.id || i.trigger === vn.id || i.trigger === Ls2.id)
              return;
          }
          this._waitingCommandQueue.push(e), clearTimeout(this._setTimeoutKey), this._setTimeoutKey = setTimeout(() => {
            ...
            this._executingDirtyData = this._mergeDirty(this._executingDirtyData, i), this._executionInProgressParams == null ? this._commandService.executeCommand(uo.id, { ...this._executingDirtyData }, Pt2) : (this._restartCalculation = true, this._commandService.executeCommand(co.id, {})), this._waitingCommandQueue = [];
          }, 100);
        }
      })
    );
  ...
  _generateDirty(e) {
    const n = [], i = {}, r = {}, o = {}, u = {}, f = {};
    for (const m3 of e) {
      const c = this._activeDirtyManagerService.get(m3.id);
      if (c == null)
        continue;
      const d = c.getDirtyData(m3), { dirtyRanges: P2, dirtyNameMap: E, dirtyDefinedNameMap: p, dirtyUnitFeatureMap: I2, dirtyUnitOtherFormulaMap: S, clearDependencyTreeCache: R } = d;
      P2 != null && this._mergeDirtyRanges(n, P2), E != null && this._mergeDirtyNameMap(i, E), p != null && this._mergeDirtyNameMap(r, p), I2 != null && this._mergeDirtyUnitFeatureOrOtherFormulaMap(o, I2), S != null && this._mergeDirtyUnitFeatureOrOtherFormulaMap(u, S), R != null && this._mergeDirtyNameMap(f, R);
    }
    return {
      dirtyRanges: n,
      dirtyNameMap: i,
      ...
      maxIteration: this._configService.getConfig(ey)
      // numfmtItemMap,
    };
  }
  _mergeDirty(e, n) {
    const i = [...e.dirtyRanges, ...n.dirtyRanges], r = { ...e.dirtyNameMap }, o = { ...e.dirtyDefinedNameMap }, u = { ...e.dirtyUnitFeatureMap }, f = { ...e.dirtyUnitOtherFormulaMap }, m3 = { ...e.clearDependencyTreeCache };
    this._mergeDirtyNameMap(r, n.dirtyNameMap), this._mergeDirtyNameMap(o, n.dirtyDefinedNameMap), this._mergeDirtyUnitFeatureOrOtherFormulaMap(u, n.dirtyUnitFeatureMap), this._mergeDirtyUnitFeatureOrOtherFormulaMap(f, n.dirtyUnitOtherFormulaMap), this._mergeDirtyNameMap(m3, n.clearDependencyTreeCache);
    ...
    for (const i of n) {
      ...
      for (const o of e)
        if (i.unitId === o.unitId && i.sheetId === o.sheetId) {
          const { startRow: u, startColumn: f, endRow: m3, endColumn: c } = i.range, { startRow: d, startColumn: P2, endRow: E, endColumn: p } = o.range;
          if (u === d && f === P2 && m3 === E && c === p) {
            r = true;
            break;
          }
        }
  ...
  _initialExecuteFormulaProcessListener() {
    ...
    this.disposeWithMe(
      ...
      this._commandService.onCommandExecuted((i) => {
        if (i.id === uo.id) {
          const { forceCalculation: o = false } = i.params;
          o && (this._forceCalculating = true);
        } else i.id === co.id && this.clearProgress();
        if (i.id !== _n.id)
          return;
        const r = i.params;
        if (r.stageInfo != null) {
          ...
          else if (o === Je2.CURRENTLY_CALCULATING) {
          ...
          } else if (o === Je2.START_DEPENDENCY_ARRAY_FORMULA) {
            if (this._executionInProgressParams = r.stageInfo, e === null) {
              const u = this._localeService.t("formula.progress.array-analysis");
              this._calculateProgress(u);
            }
          } else if (o === Je2.CURRENTLY_CALCULATING_ARRAY_FORMULA && (this._executionInProgressParams = r.stageInfo, e === null)) {
          ...
          (n === 0 || n === -1) && (e ? (clearTimeout(e), e = null, this.clearProgress()) : this._completeProgress(), n = 0, this._doneCalculationTaskCount = 0, this._totalCalculationTaskCount = 0, this._forceCalculating = false), o === Sr.STOP_EXECUTION && this._restartCalculation ? (this._restartCalculation = false, this._commandService.executeCommand(
            uo.id,
            {
  ...
  _initialExecuteFormula() {
    ...
    this._commandService.executeCommand(uo.id, n, Pt2), this._registerOtherFormulaService.calculateStarted$.next(true);
  }
  _getDirtyDataByCalculationMode(e) {
    const n = e === Pe2.FORCED, i = e === Pe2.WHEN_EMPTY ? this._formulaDataModel.getFormulaDirtyRanges() : [];
    return {
      forceCalculation: n,
      dirtyRanges: i,
      dirtyNameMap: {},
...
function di(a, e) {
  ...
  return Object.keys(e).forEach((r) => {
    ...
    Object.keys(o).forEach((f) => {
      const m3 = new pt(o[f] || {}), c = new pt(u[f] || {}), d = new pt(), P2 = new pt();
      if (m3.forValue((R, s, A) => {
        if (A == null)
          return true;
        const N = qe3(A);
        N !== null && (d.setValue(R, s, N), P2.setValue(R, s, c.getValue(R, s)));
      }), d.getSizeOf() === 0)
        return;
      const E = {
        subUnitId: f,
...
function pi(a, e, n) {
  ...
  return Object.keys(i).forEach((f) => {
    Object.keys(i[f]).forEach((m3) => {
      if (Object.keys(i[f][m3]).length !== 0) {
        const c = {
          subUnitId: m3,
          unitId: f,
          cellValue: i[f][m3]
    ...
    Object.keys(r[f]).forEach((m3) => {
      if (Object.keys(r[f][m3]).length !== 0) {
        const c = {
          subUnitId: m3,
          unitId: f,
          cellValue: r[f][m3]
...
function Li(a, e, n) {
  ...
  return (/* @__PURE__ */ new Set([...Object.keys(a), ...Object.keys(e)])).forEach((m3) => {
    if (ci2(a, m3, u))
      return;
    (/* @__PURE__ */ new Set([
      ...Object.keys(a[m3] || {}),
      ...
      var A, N;
      const P2 = (A = a[m3]) == null ? void 0 : A[d], E = (N = e[m3]) == null ? void 0 : N[d], p = new pt(P2 || {}), I2 = new pt(E || {});
      let S = [];
      m3 !== o || d !== u ? S = Ti(I2) : S = Pi(p, I2, n);
      const R = yi(S, p, I2), s = qi2(S, p);
      i[m3] || (i[m3] = {}), r[m3] || (r[m3] = {}), i[m3][d] = {
        ...i[m3][d],
        ...R
      }, r[m3][d] = {
        ...r[m3][d],
...
function Pi(a, e, n) {
  ...
  return a.forValue((m3, c, d) => {
    if (d == null || !Va(d)) return true;
    const P2 = V1(m3, c);
    let E = null, p = false;
    if ([
      0,
      ...
      const I2 = Ii(P2, n);
      E = I2.newCell, p = I2.isReverse;
    }
    if (J.diffValue(P2, E) && !e.getValue(m3, c))
      return true;
    p ? f.unshift({ oldCell: P2, newCell: E }) : f.push({ oldCell: P2, newCell: E });
  }), f;
}
function Ti(a) {
  const e = [];
  return a.forValue((n, i, r) => {
    if (r == null || !Va(r)) return true;
    const o = V1(n, i);
  ...
  const n = vl(
    {
      ...
      params: { range: a, unitId: "", subUnitId: "", direction: Cm.DOWN }
    },
    e
  );
  return At(n, e);
  ...
  const n = Ml(
    {
      ...
      params: { range: a, unitId: "", subUnitId: "", direction: Cm.RIGHT }
    },
    e
  );
  return At(n, e);
...
function yi(a, e, n) {
  ...
  for (let f = 0; f < a.length; f++) {
    const { oldCell: m3, newCell: c } = a[f];
    if ((r = i.getValue(m3.startRow, m3.startColumn)) != null && r.f || (o = i.getValue(m3.startRow, m3.startColumn)) != null && o.si || i.setValue(m3.startRow, m3.startColumn, { f: null, si: null }), c) {
      const d = (u = n.getValue(m3.startRow, m3.startColumn)) != null ? u : e.getValue(m3.startRow, m3.startColumn), P2 = qe3(d);
      i.setValue(c.startRow, c.startColumn, P2);
    }
  }
  return i.getMatrix();
}
function qi2(a, e) {
  ...
  for (let i = a.length - 1; i >= 0; i--) {
    const { oldCell: r, newCell: o } = a[i], u = e.getValue(r.startRow, r.startColumn), f = qe3(u);
    if (n.setValue(r.startRow, r.startColumn, f), o) {
      const m3 = e.getValue(o.startRow, o.startColumn), c = qe3(m3);
...
function qe3(a) {
  if (a == null)
    return;
  const { f: e, si: n, x: i = 0, y: r = 0 } = a, o = Gg(e), u = B1(n);
  if (!o && !u)
    return {
      f: null,
      si: null
...
function gi(a) {
  const e = new pt({});
  return new pt(a).forValue((i, r, o) => {
    const u = qe3(o);
    u && e.setValue(i, r, u);
  }), e.getMatrix();
}
function Va(a) {
  const e = (a == null ? void 0 : a.f) || "", n = (a == null ? void 0 : a.si) || "", i = Gg(e), r = B1(n);
  return !!(i || r);
}
...
function Ha(a, e, n = 0, i = 0) {
  ...
  for (let o = 0, u = a.length; o < u; o++) {
    const f = a[o];
    if (typeof f == "string" || f.nodeType !== $e.REFERENCE || e.includes(o)) {
      r.push(f);
      continue;
    }
    const { token: m3 } = f, c = Cr(m3), { range: d, sheetName: P2, unitId: E } = c, p = En.moveOffset(d, n, i);
    r.push({
      ...f,
      token: Ss({
        range: p,
...
function wa(a, e, n, i) {
  const { type: r, unitId: o, sheetId: u, range: f, from: m3, to: c, rangeFilteredRows: d } = e, {
    range: P2,
    sheetId: E,
    unitId: p,
    sheetName: I2,
  ...
  if (!Ga(
    ...
    return;
  const s = En.moveOffset(P2, S, R);
  let A = null;
  if (r === _.MoveRange) {
    if (m3 == null || c == null)
      return;
    const N = It2(s, m3), L = Wp(s, m3);
    if (L == null || N !== 4)
      return;
    const g = Cl(
      { id: W.MoveRangeCommandId, params: { toRange: c, fromRange: m3 } },
      L
    ), q = At(g, L);
    if (q == null)
      return m2.REF;
    ...
    const N = It2(s, m3);
    let L = Wp(s, m3);
    if (L == null && (m3.endRow < s.startRow && c.endRow <= s.startRow || m3.startRow > s.endRow && c.startRow > s.endRow))
      return;
    L == null && (L = {
      startRow: s.startRow,
      endRow: s.endRow,
    ...
    const g = Hr(
      { id: W.MoveRowsCommandId, params: { toRange: c, fromRange: m3 } },
      L
    ), q = At(g, L);
    if (q == null)
      return m2.REF;
    ...
    const N = It2(s, m3);
    let L = Wp(s, m3);
    if (L == null && (m3.endColumn < s.startColumn && c.endColumn <= s.startColumn || m3.startColumn > s.endColumn && c.startColumn > s.endColumn))
      return;
    L == null && (L = {
      startRow: s.startRow,
      endRow: s.endRow,
    ...
    const g = Fr(
      { id: W.MoveColsCommandId, params: { toRange: c, fromRange: m3 } },
      L
    ), q = At(g, L);
    if (q == null)
      return m2.REF;
  ...
  if (f != null) {
    if (r === _.InsertRow) {
      const N = vl(
        {
          id: W.InsertRowCommandId,
          params: { range: f, unitId: "", subUnitId: "", direction: Cm.DOWN }
        },
        s
      ), L = At(N, s);
      if (L == null)
      ...
      const N = Ml(
        {
          id: W.InsertColCommandId,
          params: { range: f, unitId: "", subUnitId: "", direction: Cm.RIGHT }
        },
        s
      ), L = At(N, s);
      if (L == null)
...
function Et(a, e, n, i, r, o) {
  const { startRow: u, endRow: f, startColumn: m3, endColumn: c, rangeType: d } = be2(e), {
    startRow: P2,
    startColumn: E,
    endRow: p,
    endColumn: I2,
    rangeType: S = ge.NORMAL
  } = be2(n), { startRow: R, startColumn: s, endRow: A, endColumn: N } = be2(i), {
    startRow: L,
    endRow: g,
    startColumn: q,
    endColumn: U2
    ...
    startColumn: F,
    endColumn: B2,
    rangeType: J2 = ge.NORMAL
  } = be2(r), O = { ...r };
  function ce() {
    return d === ge.COLUMN && J2 === ge.COLUMN ? true : m3 >= F && c <= B2;
  }
  function ee3() {
    return d === ge.ROW && J2 === ge.ROW ? true : u >= h && f <= M2;
  }
  if (a === 0)
    if (ce())
      if (u < h)
    ...
    if (ee3())
      if (c > B2)
        ...
        O.startColumn += B2 - E + 1;
      else
        return;
    else
      return;
  else a === 4 ? (O.startRow = u, O.startColumn = m3, O.endRow = f, O.endColumn = c) : E <= F && I2 >= B2 || S === ge.ROW && J2 === ge.ROW ? n.endRow < h ? (R >= h && (O.startRow -= p - P2 + 1), R >= M2 && (O.endRow -= p - P2 + 1)) : n.startRow > M2 ? (A <= M2 && (O.endRow += p - P2 + 1), A <= h && (O.startRow += p - P2 + 1)) : n.startRow >= h && n.endRow <= M2 && (R <= h ? O.startRow += p - P2 + 1 : R >= M2 && (O.endRow -= p - P2 + 1)) : P2 <= h && p >= M2 || S === ge.COLUMN && J2 === ge.COLUMN ? n.endColumn < F ? (s >= F && (O.startColumn -= I2 - E + 1), s >= B2 && (O.endColumn -= I2 - E + 1)) : n.startColumn > B2 ? (N <= B2 && (O.endColumn += I2 - E + 1), N <= F && (O.startColumn += I2 - E + 1)) : n.startColumn >= F && n.endColumn <= B2 && (s <= F ? O.startColumn += I2 - E + 1 : s >= B2 && (O.endColumn -= I2 - E + 1)) : ((s <= U2 + 1 && N >= B2 || s <= F && N >= q - 1) && R <= h && A >= M2 || (R <= g + 1 && A >= M2 || R <= h && A >= L - 1) && s <= F && N >= B2, O.startRow = u, O.startColumn = m3, O.endRow = f, O.endColumn = c);
  return O;
}
function It2(a, e) {
  const n = Ne(a.startRow), i = Re2(a.endRow), r = Ne(a.startColumn), o = Re2(a.endColumn), u = Ne(e.startRow), f = Re2(e.endRow), m3 = Ne(e.startColumn), c = Re2(e.endColumn);
  function d() {
    return a.rangeType === ge.COLUMN && e.rangeType === ge.COLUMN ? true : n >= u && i <= f;
  }
  function P2() {
    return a.rangeType === ge.ROW && e.rangeType === ge.ROW ? true : r >= m3 && o <= c;
  }
  function E() {
    return a.rangeType === ge.ALL && e.rangeType === ge.ALL;
  }
  return d() && P2() || E() ? 4 : P2() && n >= u && n <= f && i > f ? 0 : P2() && i >= u && i <= f && n < u ? 1 : d() && r >= m3 && r <= c && o > c ? 2 : d() && o >= m3 && o <= c && r < m3 ? 3 : null;
}
function Ne(a) {
...
function Ui(a, e) {
  ...
  } = n, f = e.getUnitId(), m3 = e.getActiveSheet();
  if (!m3) return null;
  const c = m3.getSheetId(), d = {
    startRow: i,
    startColumn: 0,
    endRow: r,
    endColumn: m3.getColumnCount() - 1,
    rangeType: ge.ROW
  }, P2 = {
    startRow: o,
    startColumn: 0,
...
function Vi(a, e) {
  const { params: n } = a;
  if (!n) return null;
  const { range: i } = n, { unitId: r, sheetId: o } = Z2(e);
  return {
...
function Wi3(a, e) {
  const { params: n } = a;
  if (!n) return null;
  const { unitId: i, subUnitId: r, name: o } = n, { unitId: u, sheetId: f } = Z2(e);
  return {
    type: _.SetName,
    unitId: i || u,
    sheetId: r || f,
...
function Ki(a, e) {
  const { params: n } = a;
  if (!n) return null;
  const { unitId: i, subUnitId: r } = n, { unitId: o, sheetId: u } = Z2(e);
  return {
    type: _.RemoveSheet,
    unitId: i || o,
    sheetId: r || u
...
function ki(a, e) {
  const { params: n } = a;
  if (!n) return null;
  const { unitId: i, name: r, id: o } = n, { sheetId: u } = Z2(e);
  return {
...
var ze = class extends Ve {
  ...
  _getUpdateDefinedNameMutations(a, e) {
    ...
    const u = [], f = [];
    return Object.values(o).forEach((m3) => {
      var R;
      const { formulaOrRefString: c } = m3, d = this._lexerTreeBuilder.sequenceNodesBuilder(c);
      if (d == null)
        return true;
      let P2 = false;
      const E = [];
      for (let s = 0, A = d.length; s < A; s++) {
        const N = d[s];
        if (typeof N == "string" || N.nodeType !== $e.REFERENCE)
          continue;
        const { token: L } = N, g = Cr(L), { range: q, sheetName: U2, unitId: h } = g, M2 = ((R = a.getSheetBySheetName(U2)) == null ? void 0 : R.getSheetId()) || "", F = {
          range: q,
          sheetId: M2,
          unitId: h,
          sheetName: U2,
        ...
        let B2 = null;
        if (n === _.RemoveSheet)
          B2 = this._removeSheet(m3, i, r);
        else if (n === _.SetName) {
          const {
            sheetId: J2,
            sheetName: O
          } = e;
          if (O == null || M2 == null || M2.length === 0 || J2 !== M2)
            continue;
          B2 = Ss({
            range: q,
            sheetName: O,
  ...
  _removeSheet(a, e, n) {
    ...
    return ((o = this._definedNamesService.getWorksheetByRef(e, i)) == null ? void 0 : o.getSheetId()) === n ? m2.REF : null;
  }
};
ze = ji([
  Ve4(0, Nr2),
...
var zi2 = Object.getOwnPropertyDescriptor;
var Zi = (a, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? zi2(e, n) : e, o = a.length - 1, u; o >= 0; o--)
    (u = a[o]) && (r = u(r) || r);
  return r;
};
var ue2 = (a, e) => (n, i) => e(n, i, a);
var Ze = class extends Ve {
  ...
  _commandExecutedListener() {
    this.disposeWithMe(this._sheetInterceptorService.interceptCommand({
      getMutations: (a) => this._getUpdateFormula(a)
    })), this.disposeWithMe(
      this._commandService.onCommandExecuted((a) => {
        if (a.params)
          ...
          } else a.id === hn.id && this._handleInsertSheetMutation(a.params);
      })
    ), this.disposeWithMe(
      this._commandService.beforeCommandExecuted((a, e) => {
        if (a.id === ee2.id) {
          const n = a.params;
          if (e && e.onlyLocal === true || n.trigger === Ce.id || n.trigger === vn.id || n.trigger === Ls2.id)
            return;
          this._handleSetRangeValuesMutation(n);
        }
      })
    ), this.disposeWithMe(this._univerInstanceService.getTypeOfUnitAdded$(we.UNIVER_SHEET).subscribe((a) => this._handleWorkbookAdded(a))), this.disposeWithMe(this._univerInstanceService.getTypeOfUnitDisposed$(we.UNIVER_SHEET).pipe(map((a) => a.getUnitId())).subscribe((a) => this._handleWorkbookDisposed(a)));
  }
  _handleSetRangeValuesMutation(a) {
    const { subUnitId: e, unitId: n, cellValue: i } = a;
    if (i == null)
      return;
    const r = this._formulaDataModel.updateFormulaData(n, e, i);
  ...
  _handleWorkbookDisposed(a, e) {
    const n = this._formulaDataModel.getFormulaData(), i = Tt2(n, a, e), r = this._formulaDataModel.getArrayFormulaRange(), o = Tt2(r, a, e), u = this._formulaDataModel.getArrayFormulaCellData(), f = Tt2(u, a, e);
  ...
  _handleInsertSheetMutation(a) {
    const { sheet: e, unitId: n } = a, i = this._formulaDataModel.getFormulaData(), { id: r, cellData: o } = e, u = new pt(o), f = fi(i, n, r, u);
    this._commandService.executeCommand(
      fo.id,
      {
        formulaData: f
  ...
  _handleWorkbookAdded(a) {
    ...
    a.getSheets().forEach((c) => {
      var p;
      const d = c.getCellMatrix(), P2 = c.getSheetId(), E = fi(e, n, P2, d);
      i[n][P2] = (p = E[n]) == null ? void 0 : p[P2];
    }), this._commandService.executeCommand(fo.id, { formulaData: i }, { onlyLocal: true });
    const o = this._configService.getConfig(ge2), u = (m3 = o == null ? void 0 : o.initialFormulaComputing) != null ? m3 : Pe2.WHEN_EMPTY, f = this._getDirtyDataByCalculationMode(u);
    this._commandService.executeCommand(uo.id, f, { onlyLocal: true });
  }
  _getDirtyDataByCalculationMode(a) {
    const e = a === Pe2.FORCED, n = a === Pe2.WHEN_EMPTY ? this._formulaDataModel.getFormulaDirtyRanges() : [];
    return {
      forceCalculation: e,
      dirtyRanges: n,
      dirtyNameMap: {},
  ...
  _getFormulaReferenceMoveInfo(a, e, n) {
    if (!J.isDefine(a)) return { newFormulaData: {}, oldFormulaData: {} };
    ...
    for (const u of i) {
      ...
      if (f == null)
        continue;
      const m3 = Object.keys(f);
      J.isDefine(r[u]) || (r[u] = {}), J.isDefine(o[u]) || (o[u] = {});
      for (const c of m3) {
        const d = new pt(f[c] || {}), P2 = new pt(), E = [];
        d.forValue((p, I2, S) => {
          var F;
          if (!S) return true;
          ...
          if (L == null)
            return true;
          let g = false;
          const q = [], { type: U2, from: h } = n;
          for (let B2 = 0, J2 = L.length; B2 < J2; B2++) {
            const O = L[B2];
            if (typeof O == "string")
              continue;
            const { token: ce, nodeType: ee3 } = O;
            if ((U2 === _.SetDefinedName || U2 === _.RemoveDefinedName) && (ee3 === $e.DEFINED_NAME || ee3 === $e.FUNCTION)) {
              const { definedNameId: Ue2, definedName: Te3 } = n;
              if (Ue2 === void 0 || Te3 === void 0)
                continue;
              const se2 = this._definedNamesService.getValueById(u, Ue2);
              if (se2 == null || se2.name !== ce)
                continue;
              L[B2] = {
                ...O,
                token: U2 === _.SetDefinedName ? Te3 : m2.REF
              }, g = true, q.push(B2);
              continue;
            } else if (ee3 !== $e.REFERENCE)
              continue;
            const le2 = Cr(ce), { range: $2, sheetName: ie4, unitId: re2 } = le2, he2 = re2 == null || re2.length === 0 ? u : re2, j2 = ((F = e == null ? void 0 : e[he2]) == null ? void 0 : F[ie4]) || "";
            if (!Ga(
              n.unitId,
              n.sheetId,
              u,
            ...
            if (U2 === _.SetName) {
              ...
              if (se2 == null || j2 == null || j2.length === 0 || Te3 !== j2)
                continue;
              Ce2 = Ss({
                range: $2,
                sheetName: se2,
            ...
            } else if (U2 === _.RemoveSheet) {
              const {
                unitId: Ue2,
                sheetId: Te3,
                sheetName: se2
              } = n;
              if (j2 == null || j2.length === 0 || Te3 !== j2)
                continue;
              Ce2 = m2.REF;
            } else U2 !== _.SetDefinedName && (Ce2 = wa(
              lt,
              n,
              u,
              c
            ...
            Ce2 != null && (L[B2] = {
              ...O,
              token: Ce2
            }, g = true, q.push(B2), N && (s != null ? s : 0) === 0 && (A != null ? A : 0) === 0 && E.push(N));
          }
          if (!g)
            if (N && [_.MoveRows, _.MoveCols, _.MoveRange].includes(U2)) {
              if (h && h.startRow <= p && p <= h.endRow && h.startColumn <= I2 && I2 <= h.endColumn)
...
Ze = Zi([
  ...
  ue2(5, Nr2),
  ue2(6, ic),
  ue2(7, Inject(Injector))
], Ze);
var Ji = "SHEETS_FORMULA_PLUGIN";
...
var Je4 = class extends Ve {
  ...
  _initialMove() {
    ...
    }), this._activeDirtyManagerService.register(On.id, {
      commandId: On.id,
      getDirtyData: (a) => {
        const e = a.params;
        return {
  ...
  _initialRowAndColumn() {
    ...
    }), this._activeDirtyManagerService.register(ke.id, {
      commandId: ke.id,
      getDirtyData: (a) => {
        const e = a.params;
        return {
    ...
    }), this._activeDirtyManagerService.register(Ue.id, {
      commandId: Ue.id,
      getDirtyData: (a) => {
        const e = a.params;
        return {
  ...
  _initialSheet() {
    ...
    }), this._activeDirtyManagerService.register(hn.id, {
      commandId: hn.id,
      getDirtyData: (a) => {
        const e = a.params;
        return {
  ...
  _initialDefinedName() {
    this._activeDirtyManagerService.register(ca.id, {
      commandId: ca.id,
      getDirtyData: (a) => {
        const e = a.params;
        return { dirtyDefinedNameMap: this._getDefinedNameMutation(e) };
      }
    }), this._activeDirtyManagerService.register(oo2.id, {
      commandId: oo2.id,
      getDirtyData: (a) => {
        const e = a.params;
        return { dirtyDefinedNameMap: this._getDefinedNameMutation(e) };
  ...
  _getDefinedNameMutation(a) {
    const { unitId: e, name: n, formulaOrRefString: i } = a, r = {};
    return a == null ? {} : (r[e] = {}, r[e][n] = i, r);
  }
  _getSetRangeValuesMutationDirtyRange(a) {
    const { subUnitId: e, unitId: n, cellValue: i } = a, r = [];
    return i == null || (r.push(...this._getDirtyRangesByCellValue(n, e, i)), r.push(...this._getDirtyRangesForArrayFormula(n, e, i))), r;
  }
  _getMoveRangeMutationDirtyRange(a) {
    const { unitId: e, from: n, to: i } = a, r = [];
  ...
  _getRemoveRowOrColumnMutation(a, e = true) {
    const { subUnitId: n, unitId: i, range: r } = a, o = [], u = this._univerInstanceService.getUniverSheetInstance(i), f = u == null ? void 0 : u.getSheetBySheetId(n), m3 = (f == null ? void 0 : f.getRowCount()) || 0, c = (f == null ? void 0 : f.getColumnCount()) || 0;
    let d = null;
    const { startRow: P2, endRow: E, startColumn: p, endColumn: I2 } = r;
    e === true ? d = this._rangeToMatrix({
      startRow: P2,
      startColumn: 0,
      endRow: E,
      endColumn: c - 1
  ...
  _getInsertSheetMutation(a) {
    const e = {}, { sheet: n, unitId: i } = a;
    return e[i] == null && (e[i] = {}), e[i][n.id] = n.name, e;
  }
  _rangeToMatrix(a) {
    const e = new pt(), { startRow: n, startColumn: i, endRow: r, endColumn: o } = a;
    for (let u = n; u <= r; u++)
      for (let f = i; f <= o; f++)
        e.setValue(u, f, {});
    return e;
  ...
  _getDirtyRangesByCellValue(a, e, n) {
    const i = [];
    return n == null || new pt(n).getDiscreteRanges().forEach((u) => {
  ...
  _getDirtyRangesForArrayFormula(a, e, n) {
    ...
    if (n == null)
      return i;
    const r = new pt(n), o = this._formulaDataModel.getArrayFormulaRange();
    if ((u = o == null ? void 0 : o[a]) != null && u[e]) {
      const m3 = new pt((f = o == null ? void 0 : o[a]) == null ? void 0 : f[e]);
      r.forValue((c, d) => {
        m3.forValue((P2, E, p) => {
          if (p == null)
            return true;
          const { startRow: I2, startColumn: S, endRow: R, endColumn: s } = p;
          c >= I2 && c <= R && d >= S && d <= s && i.push({
            unitId: a,
            sheetId: e,
            range: {
              startRow: I2,
  ...
  _commandExecutedListener() {
    this.disposeWithMe(
      this._commandService.onCommandExecuted((a) => {
        ...
        this._formulaDataModel.setArrayFormulaRange(n), this._formulaDataModel.setArrayFormulaCellData(i), (r = this._configService.getConfig(ge2)) != null && r.writeArrayFormulaToSnapshot && this._writeArrayFormulaToSnapshot(n, i);
      })
    );
  }
  _writeArrayFormulaToSnapshot(a, e) {
    Object.entries(a).forEach(([n, i]) => {
      i && Array.from(Object.entries(i)).forEach(([r, o]) => {
        const u = new pt();
        new pt(o).forValue((m3, c, d) => {
          u.setValue(m3, c, { ref: Ft(d) });
    ...
    this.disposeWithMe(
      this._sheetInterceptorService.intercept(ht.CELL_CONTENT, {
        ...
        handler: (a, e, n) => {
          var d, P2, E;
          let i = a;
          const { unitId: r, subUnitId: o, row: u, col: f } = e, m3 = this._formulaDataModel.getArrayFormulaCellData(), c = (E = (P2 = (d = m3 == null ? void 0 : m3[r]) == null ? void 0 : d[o]) == null ? void 0 : P2[u]) == null ? void 0 : E[f];
          return c == null ? n(i) : ((!i || i === e.rawData) && (i = { ...e.rawData }), c.v == null && c.t == null ? (i.v = 0, i.t = fn.NUMBER, n(i)) : (i == null ? void 0 : i.t) === fn.NUMBER && i.v !== void 0 && i.v !== null && Z1(i.v) ? (i.v = ba(Number(i.v)), n(i)) : (i.v = c.v, i.t = c.t, n(i)));
        }
      })
    );
  }
...
var ir = [
  {
    functionName: ea.ARRAY_CONSTRAIN,
    functionType: yc.Array,
...
var rr = [
  {
    functionName: le.BETADIST,
    functionType: yc.Compatibility,
...
var or = [
  {
    functionName: xm.CUBEKPIMEMBER,
    functionType: yc.Cube,
  ...
  {
    functionName: xm.CUBEMEMBERPROPERTY,
    functionType: yc.Cube,
  ...
  {
    functionName: xm.CUBERANKEDMEMBER,
    functionType: yc.Cube,
...
var ur = [
  {
    functionName: Qe.DAVERAGE,
    functionType: yc.Database,
...
var mr = [
  {
    functionName: be.DATE,
    functionType: yc.Date,
  ...
  {
    functionName: be.NETWORKDAYS_INTL,
    functionType: yc.Date,
...
var fr = [
  {
    functionName: Z.BESSELI,
    functionType: yc.Engineering,
...
var lr2 = [
  {
    functionName: Oe.CELL,
    functionType: yc.Information,
...
var dr = [
  {
    functionName: fe.ADDRESS,
    functionType: yc.Lookup,
...
var pr2 = [
  ...
  {
    functionName: Y2.CEILING_PRECISE,
    functionType: yc.Math,
...
var Lr = [
  {
    functionName: v.AVEDEV,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.AVERAGE_WEIGHTED,
  ...
  {
    functionName: v.BINOM_DIST_RANGE,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.CONFIDENCE_NORM,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.FORECAST_ETS_CONFINT,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.FORECAST_ETS_SEASONALITY,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.FORECAST_ETS_STAT,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.FORECAST_LINEAR,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.GAMMALN_PRECISE,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.PERCENTRANK_EXC,
    functionType: yc.Statistical,
  ...
  {
    functionName: v.PERCENTRANK_INC,
    functionType: yc.Statistical,
...
var Rt = (a, e) => (n, i) => e(n, i, a);
var Gt2 = createIdentifier("formula.description-service");
var Mt2 = class {
  constructor(a, e, n) {
    W2(this, "_descriptions", []);
  ...
  hasFunction(a) {
    return this._functionService.getDescriptions().get(a.toLocaleUpperCase()) !== void 0;
  }
  getFunctionInfo(a) {
    return this._functionService.getDescriptions().get(a.toLocaleUpperCase());
  }
  getSearchListByName(a) {
    ...
    return n.forEach((r) => {
      ...
      o.toLocaleUpperCase().indexOf(i) > -1 && f !== yc.DefinedName && e.push({ name: o, desc: u });
    }), e;
  }
  ...
  getSearchListByType(a) {
    ...
    return this._functionService.getDescriptions().forEach((i) => {
      ...
      (o === a || a === -1) && o !== yc.DefinedName && e.push({ name: r, desc: u });
    }), e;
  }
  registerDescriptions(a) {
    return this._descriptions = this._descriptions.concat(a), this._registerDescriptions(), We(() => {
      const e = a.map((n) => n.functionName);
      this.unregisterDescriptions(e);
    });
  }
  unregisterDescriptions(a) {
    this._descriptions = this._descriptions.filter((e) => !a.includes(e.functionName)), this._functionService.unregisterDescriptions(...a);
  }
  hasDescription(a) {
    return this._descriptions.some((e) => e.functionName === a);
  }
  hasDefinedNameDescription(a) {
    return this._descriptions.some((e) => e.functionName === a && e.functionType === yc.DefinedName);
  }
  isFormulaDefinedName(a) {
    const e = this._descriptions.filter((i) => i.functionName === a && i.functionType === yc.DefinedName);
    if (e.length === 0)
      return false;
  ...
  _initDescription() {
    ...
    const a = [
      ...
      ...pb,
      ...Mb
    ].map((r) => r[1]), e = Ir.filter((r) => a.includes(r.functionName)), n = this._configService.getConfig(ge2);
...
var Ar2 = Object.getOwnPropertyDescriptor;
var Cr2 = (a, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Ar2(e, n) : e, o = a.length - 1, u; o >= 0; o--)
    (u = a[o]) && (r = u(r) || r);
  return r;
};
var He = (a, e) => (n, i) => e(n, i, a);
var tt2 = class extends Ve {
  constructor(e, n, i, r) {
    super();
    W2(this, "_preUnitId", null);
  ...
  _registerDescription(e) {
    ...
    !this._descriptionService.hasDescription(r) && (f == null || f === ng || f === i) && this._descriptionService.registerDescriptions([{
      functionName: r,
      description: u + (o || ""),
      abstract: u,
      functionType: yc.DefinedName,
      functionParameter: []
    }]);
  }
  ...
  _registerDescriptions() {
    ...
    this._preUnitId = e, Array.from(Object.values(i)).forEach((o) => {
      const { name: u, comment: f, formulaOrRefString: m3, localSheetId: c } = o;
      !this._descriptionService.hasDescription(u) && (c == null || c === ng || c === n) && r.push({
        functionName: u,
        description: m3 + (f || ""),
        abstract: m3,
        functionType: yc.DefinedName,
...
var Dr2 = Object.getOwnPropertyDescriptor;
var br2 = (a, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Dr2(e, n) : e, o = a.length - 1, u; o >= 0; o--)
    (u = a[o]) && (r = u(r) || r);
  return r;
};
var Or2 = (a, e) => (n, i) => e(n, i, a);
...
var xr = (a, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Mr2(e, n) : e, o = a.length - 1, u; o >= 0; o--)
    (u = a[o]) && (r = u(r) || r);
  return r;
};
var we4 = (a, e) => (n, i) => e(n, i, a);
function sa(a, e, n, i) {
  ...
  for (let u = 0, f = r.length; u < f; u++) {
    const m3 = r[u];
    if (typeof m3 == "string" || m3.nodeType !== $e.REFERENCE)
      continue;
    const { token: c } = m3, d = Cr(c), { sheetName: P2, unitId: E } = d;
    let p = d.range;
    p.startAbsoluteRefType === ye.ALL && p.endAbsoluteRefType === ye.ALL || (p = gR(p, n, i), o.push({
      unitId: E,
      sheetName: P2,
      range: p
    }));
...
var xt2 = class extends Ve {
  ...
  transformFormulaByEffectCommand(a, e, n, i) {
    const r = this._lexerTreeBuilder.sequenceNodesBuilder(n), o = this._univerInstanceService.getCurrentUnitForType(we.UNIVER_SHEET), u = o.getActiveSheet(), f = o.getUnitId(), m3 = u.getSheetId(), c = r == null ? void 0 : r.map((d) => {
      if (typeof d == "object" && d.nodeType === $e.REFERENCE) {
        const P2 = Cr(d.token), { range: E, unitId: p, sheetName: I2 } = P2, S = this._univerInstanceService.getUnit(p || a), R = I2 ? S == null ? void 0 : S.getSheetBySheetName(I2) : S == null ? void 0 : S.getSheetBySheetId(e);
        if (!R)
        ...
        let L = "";
        if (N) {
          const g = N.startColumn - E.startColumn, q = N.startRow - E.startRow, U2 = gR(E, g, q);
          p && I2 ? L = Gc(p, I2, U2) : I2 ? L = Hc(I2, U2) : L = Ft(U2);
        } else
          L = m2.REF;
        return {
          ...d,
  ...
  registerFormula(a, e, n, i) {
    const r = /* @__PURE__ */ new Map(), o = this._lexerTreeBuilder.sequenceNodesBuilder(n), u = new ao(), f = (m3) => {
      const c = this._univerInstanceService.getCurrentUnitForType(we.UNIVER_SHEET), d = c.getActiveSheet(), P2 = c.getUnitId(), E = d.getSheetId(), p = o == null ? void 0 : o.map((S) => {
        if (typeof S == "object" && S.nodeType === $e.REFERENCE) {
          const R = r.get(S.token);
          if (R.unitId !== P2 || R.subUnitId !== E)
            return S;
          const s = Ro(R.range, m3);
          let A = "";
          if (s) {
            const N = s.startColumn - R.range.startColumn, L = s.startRow - R.range.startRow, g = gR(R.range, N, L);
            R.unitId && R.sheetName ? A = Gc(R.unitId, R.sheetName, g) : R.sheetName ? A = Hc(R.sheetName, g) : A = Ft(g);
          } else
            A = m2.REF;
          return {
            ...S,
    ...
    return o == null || o.forEach((m3) => {
      if (typeof m3 == "object" && m3.nodeType === $e.REFERENCE) {
        const c = Cr(m3.token), { range: d, unitId: P2, sheetName: E } = c, p = this._univerInstanceService.getUnit(P2 || a), I2 = E ? p == null ? void 0 : p.getSheetBySheetName(E) : p == null ? void 0 : p.getSheetBySheetId(e);
        if (!I2)
          return;
        const S = p.getUnitId(), R = I2.getSheetId(), s = {
          unitId: S,
          subUnitId: R,
          range: d,
          sheetName: E
        };
        r.set(m3.token, s), u.add(this._refRangeService.registerRefRange(d, f, S, R));
      }
    }), u;
  }
  _getFormulaDependcy(a, e, n, i) {
    const r = Gg(n) ? this._lexerTreeBuilder.sequenceNodesBuilder(n) : null, o = [];
    return r == null || r.forEach((u) => {
      if (typeof u == "object" && u.nodeType === $e.REFERENCE) {
        const f = Cr(u.token), { range: m3, unitId: c, sheetName: d } = f;
        if (m3.startAbsoluteRefType === ye.ALL && m3.endAbsoluteRefType === ye.ALL)
          return;
        const P2 = this._univerInstanceService.getUnit(c || a), E = d ? P2 == null ? void 0 : P2.getSheetBySheetName(d) : P2 == null ? void 0 : P2.getSheetBySheetId(e);
        if (!E)
          return;
        const p = P2.getUnitId(), I2 = E.getSheetId(), S = i[0].startRow, R = i[0].startColumn, s = m3.startRow, A = m3.startColumn, N = i.map((L) => ({
  ...
  registerRangeFormula(a, e, n, i, r) {
    const o = new ao(), u = i.map((m3) => this._getFormulaDependcy(a, e, m3, n)), f = (m3) => {
      const c = n[0].startRow, d = n[0].startColumn, P2 = [{ unitId: a, subUnitId: e, ranges: n }, ...u.flat()], E = [], p = $h(this._injector, m3);
      for (const { unitId: I2, subUnitId: S, ranges: R } of P2)
        if (I2 === p.unitId && S === p.subUnitId) {
          const s = [], A = R[0].startRow, N = R[0].startColumn, L = A - c, g = N - d;
          for (const q of p.ranges) {
            const U2 = R.map((h) => Wp(q, h)).filter(Boolean);
            U2.length > 0 && s.push(...U2);
          }
          s.length > 0 && E.push(
            s.map((q) => ({
      ...
      if (E.length > 0) {
        const I2 = En.splitIntoGrid([...E.flat()]), S = En.subtractMulti(n, I2);
        S.sort((L, g) => L.startRow - g.startRow || L.startColumn - g.startColumn);
        const R = /* @__PURE__ */ new Map();
        for (let L = 0; L < I2.length; L++) {
          const g = I2[L], q = g.startRow, U2 = g.startColumn, h = q - c, M2 = U2 - d, F = Co(g, m3).sort(($2, ie4) => $2.startRow - ie4.startRow || $2.startColumn - ie4.startColumn);
          if (!F.length)
            continue;
          const B2 = F[0].startRow, J2 = F[0].startColumn, O = B2 - c, ce = J2 - d, ee3 = [];
          for (let $2 = 0; $2 < i.length; $2++) {
            const ie4 = i[$2], re2 = Gg(ie4), he2 = re2 ? this._lexerTreeBuilder.moveFormulaRefOffset(ie4, M2, h) : ie4, j2 = re2 ? this.transformFormulaByEffectCommand(a, e, he2, m3) : he2, lt = sa(this._lexerTreeBuilder, j2, -ce, -O);
            ee3.push({
              newFormula: j2,
              orginFormula: lt
            });
          ...
          const le2 = {
            formulas: ee3,
            ranges: F,
            key: ee3.map(($2) => $2.orginFormula).join("_")
          };
          R.has(le2.key) ? R.get(le2.key).push(le2) : R.set(le2.key, [le2]);
        }
        ...
        if (S.length > 0) {
          ...
          for (let h = 0; h < i.length; h++) {
            const M2 = i[h];
            q.push({
              newFormula: Gg(M2) ? this._lexerTreeBuilder.moveFormulaRefOffset(M2, g - d, L - c) : M2,
              orginFormula: M2
            });
          }
          const U2 = {
          ...
          R.has(U2.key) ? R.get(U2.key).push(U2) : R.set(U2.key, [U2]);
        }
        const A = [], N = Array.from(R.keys());
        for (let L = N.length - 1; L >= 0; L--) {
          const g = N[L], q = R.get(g).sort((M2, F) => M2.ranges[0].startRow - F.ranges[0].startRow || M2.ranges[0].startColumn - F.ranges[0].startColumn), U2 = [];
          for (let M2 = 0; M2 < q[0].formulas.length; M2++)
            U2.push(q[0].formulas[M2].newFormula);
          const h = En.mergeRanges(q.map((M2) => M2.ranges).flat());
          h.sort((M2, F) => M2.startRow - F.startRow || M2.startColumn - F.startColumn), A.push({
            formulas: U2,
            ranges: h
          });
        }
    ...
    return n.forEach((m3) => {
      const c = this._refRangeService.registerRefRange(m3, f, a, e);
      o.add(c);
    }), [...u.flat()].forEach(({ unitId: m3, subUnitId: c, ranges: d }) => {
      d.forEach((P2) => {
        const E = this._refRangeService.registerRefRange(P2, f, m3, c);
        o.add(E);
      });
    }), o;
  }
...
xt2 = xr([
  ...
  we4(1, Inject(ga)),
  we4(2, vr),
  we4(3, Inject(Injector))
], xt2);
var _r2 = Object.getOwnPropertyDescriptor;
var yr = (a, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? _r2(e, n) : e, o = a.length - 1, u; o >= 0; o--)
    (u = a[o]) && (r = u(r) || r);
  return r;
};
var qr2 = (a, e) => (n, i) => e(n, i, a);
var Ht2 = "sheets-formula.remote-register-function.service";
var Xa = createIdentifier(Ht2);
var nt = class {
  constructor(a) {
...
function gr(a, e) {
  const n = new jm(e), i = new Function(`return ${a}`)();
  return n.calculateCustom = i, n;
}
function hr(a, e) {
  const n = new ny(e), i = new Function(`return ${a}`)();
  return n.calculateCustom = i, n;
}
var Ur2 = Object.getOwnPropertyDescriptor;
var Fr2 = (a, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Ur2(e, n) : e, o = a.length - 1, u; o >= 0; o--)
    (u = a[o]) && (r = u(r) || r);
  return r;
};
var Ye2 = (a, e) => (n, i) => e(n, i, a);
var Br2 = createIdentifier(
...
var _t = class extends Ve {
  ...
  registerFunction(a) {
    return this._registerSingleFunction(a);
  }
  registerAsyncFunction(a) {
    return this._registerSingleFunction({ ...a, async: true });
  }
  registerFunctions(a) {
    ...
    if (n)
      ...
      const o = i.map(([u, f, m3]) => ({
        functionName: f,
        functionType: yc.User,
        description: "",
        abstract: m3 || "",
        functionParameter: []
      }));
  ...
  _registerSingleFunction(a) {
    const { name: e, func: n, description: i, locales: r, async: o = false } = a, u = new ao();
    if (r && this._localeService.load(r), typeof i == "string") {
      ...
      u.add(this._descriptionService.registerDescriptions([m3]));
    } else
      u.add(this._descriptionService.registerDescriptions([i]));
    const f = o ? new ny(e) : new jm(e);
    return f.calculateCustom = n, this._functionService.registerExecutors(f), u.add(We(() => this._functionService.unregisterExecutors(e))), u.add(We(() => this._functionService.unregisterDescriptions(e))), u.add(We(() => this._functionService.deleteFormulaAstCacheKey(e))), this._remoteRegisterFunctionService && (this._remoteRegisterFunctionService.registerAsyncFunctions([[n.toString(), e]]), u.add(
      We(() => this._remoteRegisterFunctionService.unregisterFunctions([e]))
    )), u;
  }
  _registerLocalExecutors(a) {
    ...
    return this._functionService.registerExecutors(...n), We(() => this._functionService.unregisterExecutors(...e));
  }
  _registerRemoteExecutors(a) {
    const e = [], n = a.map(([i, r]) => (e.push(r), [i.toString(), r]));
    return this._remoteRegisterFunctionService.registerFunctions(n), We(() => this._remoteRegisterFunctionService.unregisterFunctions(e));
  }
};
_t = Fr2([
  Ye2(0, Inject(Fn)),
...
var vr3 = Object.defineProperty;
var Vr = Object.getOwnPropertyDescriptor;
var Gr = (a, e, n) => e in a ? vr3(a, e, { enumerable: true, configurable: true, writable: true, value: n }) : a[e] = n;
var Wa = (a, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? Vr(e, n) : e, o = a.length - 1, u; o >= 0; o--)
    (u = a[o]) && (r = u(r) || r);
  return r;
};
var it = (a, e) => (n, i) => e(n, i, a);
var ct = (a, e, n) => Gr(a, typeof e != "symbol" ? e + "" : e, n);
var rt = class extends Ol {
  constructor(a = ca2, e, n) {
  ...
  onStarting() {
    this._injector.add([nt]), this._injector.get(I).registerChannel(
      Ht2,
      Y(this._injector.get(nt))
    );
  }
};
ct(rt, "pluginName", "SHEET_FORMULA_REMOTE_PLUGIN");
ct(rt, "type", we.UNIVER_SHEET);
rt = Wa([
  qR(Wi),
  it(1, Inject(Injector)),
  it(2, ic)
], rt);
var ot2 = class extends Ol {
  constructor(a = fa, e, n) {
    ...
    this._configService.setConfig(ge2, i, { merge: true });
  }
  onStarting() {
    ...
    if (this._config.notExecuteFormula) {
      const n = a.get(I);
      e.push([Xa, {
        useFactory: () => B(n.requestChannel(Ht2))
      }]);
    }
    e.forEach((n) => a.add(n));
  }
...
ct(ot2, "pluginName", Ji);
ct(ot2, "type", we.UNIVER_SHEET);
ot2 = Wa([
  qR(Wi, ss),
  it(1, Inject(Injector)),
  it(2, ic)
], ot2);
function kr2(a, e, n, i) {
  const r = a.get(Yt), o = a.get(Ar), u = a.get(Ur), f = a.get(br);
  r.load({
    formulaData: {},
  ...
  const m3 = o.treeBuilder(e), c = u.parse(m3), d = f.execute(Oi(c));
  return ay(d);
}
...
var Gr2 = (e, t, n) => t in e ? Yr2(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var j = (e, t, n) => Gr2(e, typeof t != "symbol" ? t + "" : t, n);
var vn2 = {
  id: "sheet.command.paste-formula",
  type: Ms.COMMAND,
  handler: async (e) => e.get(Ls).executeCommand(hn2.id, {
    value: et2.SPECIAL_PASTE_FORMULA
  })
};
var gt = {
...
var xs = (e, t) => (n, o) => t(n, o, e);
var Ms2 = "FORMULA_PROMPT_ACTIVATED";
var Zt = createIdentifier("formula-ui.prompt-service");
var rn = class {
  constructor(e) {
    j(this, "_search$", new Subject());
    j(this, "_help$", new Subject());
    j(this, "_navigate$", new Subject());
    j(this, "_accept$", new Subject());
    j(this, "_acceptFormulaName$", new Subject());
    ...
    j(this, "_searching", false);
    j(this, "_helping", false);
    j(this, "_sequenceNodes", []);
    j(this, "_isLockedOnSelectionChangeRefString", false);
    j(this, "_isLockedOnSelectionInsertRefString", false);
  ...
  search(e) {
    this._contextService.setContextValue(Ms2, e.visible), this._searching = e.visible, this._search$.next(e);
  }
  isSearching() {
...
var ws2 = {
  ...
  type: Ms.OPERATION,
  handler: async (e, t) => (e.get(Zt).help(t), true)
};
var pe2 = {
  ...
  handler: async (e, t) => {
    var C, _2;
    const n = e.get(z), o = e.get(Ge), r = n.getCurrentSelections();
    if (!r || !r.length)
      return false;
    const s = P(e.get(vr));
    if (!s) return false;
    const { worksheet: i, unitId: c, subUnitId: l } = s, g = i.getCellMatrix(), { value: m3 } = t, h = e.get(Ls);
    e.get(qe2);
    const d = [], u = [];
    let a = null, v2 = 0, p = 0, S = "";
    if (r.length === 1 && (Fs(r[0].range) || Ds(r[0].range) && Yn2(g, r[0].range))) {
      const { range: E, primary: f } = r[0], b = (C = f == null ? void 0 : f.actualRow) != null ? C : E.startRow, y = (_2 = f == null ? void 0 : f.actualColumn) != null ? _2 : E.startColumn;
      a = E, v2 = b, p = y;
      const A = Kn(g, b, y);
      A && (S = Ft(A));
    } else
      r.some((E) => {
        ...
        if (Yn2(g, f)) {
          ...
          if (!O)
            return a = f, v2 = F, p = N, true;
          const k = Ft(O), I2 = `=${m3}(${k})`;
          d.push({
            range: f,
            primary: {
              row: F,
          ...
          if (F === O) {
            const I2 = Ls3(g, F, k, i.getColumnCount() - 1), x = I2 === k ? k - 1 : k, R = Ft({
              startRow: F,
              endRow: O,
              startColumn: N,
              endColumn: x
    ...
    if (a) {
      const E = Uh(v2, p, i), f = {
        ...
        primary: {
          ...
          actualColumn: p,
          isMerged: E.isMerged,
          isMergedMainCell: E.startRow === v2 && E.startColumn === p
        }
      }, b = {
        unitId: c,
        subUnitId: l,
      ...
      await h.executeCommand(ie.id, b);
      const y = o.getEditor(Dl), A = o.getEditor(Ul);
      h.syncExecuteCommand(tt.id, {
        visible: true,
        unitId: c,
        eventType: Kv.Dblclick
      });
      const F = `=${m3}(${S}`;
      y == null || y.replaceText(F), A == null || A.replaceText(F, false);
    }
    return d.length === 0 && u.length === 0 ? false : h.executeCommand(ni.id, {
      list: d,
...
function _t2(e) {
  if (e != null && e.p) {
    ...
    if (t == null)
      return false;
    const n = t.dataStream, r = n.substring(n.length - 2, n.length) === Bc ? n.substring(0, n.length - 2) : n;
    return Z1(r);
  }
  return e && (e.t === fn.NUMBER || M1(e) === fn.NUMBER);
}
function Fs(e) {
...
function Yn2(e, t) {
  for (let n = t.startRow; n <= t.endRow; n++)
    for (let o = t.startColumn; o <= t.endColumn; o++)
      if (_t2(e.getValue(n, o)))
        return false;
  return true;
}
function Ls3(e, t, n, o) {
  for (let r = n; r <= o; r++)
    if (!e.getValue(t, r))
      return r;
  return o;
...
var Ir2 = "SHEET_FORMULA_UI_PLUGIN";
var Er2 = `${Ir2}_MORE_FUNCTIONS_COMPONENT`;
var Cn = {
  id: "formula-ui.operation.more-functions",
  type: Ms.OPERATION,
  handler: async (e) => (e.get(we3).open({
...
var Ps = {
  ...
  type: Ms.OPERATION,
  handler: async (e, t) => (e.get(Zt).search(t), true)
};
...
var $t = class extends Ve {
  ...
  _initialize() {
    this.disposeWithMe(this._sheetInterceptorService.interceptCommand({
      getMutations: (e) => e.id === ys.id ? this._reorderFormula(e.params) : {
        redos: [],
        undos: []
      }
    }));
  ...
  _reorderFormula(e) {
    ...
    const g = l.getCellMatrix(), m3 = new pt(), h = new pt();
    let d = false;
    return Or.foreach(s, (u, a) => {
      let v2 = u;
      i.hasOwnProperty(u) && (v2 = i[u]);
      const p = g.getValue(v2, a);
      if (p != null && p.f || p != null && p.si) {
        d = true;
        const S = this._formulaDataModel.getFormulaStringByCell(v2, a, r, o), C = this._lexerTreeBuilder.moveFormulaRefOffset(
          S,
          0,
          u - v2
        ), _2 = J.deepClone(p);
        _2.f = C, _2.si = null, m3.setValue(u, a, _2);
      } else
        m3.setValue(u, a, p);
...
var yr2 = "sheets-formula-ui.base.config";
var Gn = {};
...
var pt2 = (e, t) => (n, o) => t(n, o, e);
var Jt = "SHEET_FORMULA_ALERT";
var Bs = {
      ...
      if (e) {
        ...
        if ($g(l)) {
          ...
          this._cellAlertManagerService.showAlert({
            ...
            message: this._localeService.t(`formula.error.${Bs[m3]}`),
            location: e.location,
            width: 200,
            height: 74,
            key: Jt
...
var Zn = (e, t) => (n, o) => t(n, o, e);
var Pt3 = class extends Ve {
  constructor(e, t) {
  ...
  _registerAutoFill() {
    const e = {
      type: mt.FORMULA,
      priority: 1001,
      match: (t) => Gg(t == null ? void 0 : t.f) || B1(t == null ? void 0 : t.si),
      isContinue: (t, n) => t.type === mt.FORMULA,
      applyFunctions: {
        [Le2.COPY]: (t, n, o, r, s) => {
  ...
  _fillCopyFormula(e, t, n, o, r, s) {
    ...
    for (let h = 1; h <= t; h++) {
      const d = (h - 1) % e.length, u = o[d], a = J.deepClone(e[d]);
      if (a) {
        const v2 = ((g = e[d]) == null ? void 0 : g.f) || "", p = ((m3 = e[d]) == null ? void 0 : m3.si) || "", S = Gg(v2);
        if (B1(p))
          a.si = p, a.f = null, a.v = null, a.p = null, a.t = null, c.push(a);
        else if (S) {
          let _2 = l.get(d);
          if (_2)
            a.si = _2, a.f = null, a.v = null, a.p = null, a.t = null;
          else {
            _2 = et(6), l.set(d, _2);
            ...
            a.si = _2, a.f = b, a.v = null, a.p = null, a.t = null;
          }
          c.push(a);
        }
      }
...
var St2 = (e, t) => (n, o) => t(n, o, e);
var zs = "default-paste-formula";
var Ut2 = class extends Ve {
  ...
  _onPasteCells(e, t, n, o, r) {
    ...
    const i = this._currentUniverSheet.getCurrentUnitForType(we.UNIVER_SHEET), c = t.unitId || i.getUnitId(), l = t.subUnitId || ((d = i.getActiveSheet()) == null ? void 0 : d.getSheetId());
    if (!c || !l)
      return {
        undos: [],
        redos: []
      };
    const g = t.range, m3 = n, h = {
      copyType: o.copyType || Yn.COPY,
      copyRange: e == null ? void 0 : e.range,
      pasteType: o.pasteType
    };
    return this._injector.invoke((u) => Xs2(
      c,
      l,
      g,
      m3,
...
Ut2 = Zs([
  ...
  St2(1, Inject(ga)),
  St2(2, nn),
  St2(3, Inject(Injector)),
  St2(4, Inject(_r))
], Ut2);
function Xs2(e, t, n, o, r, s, i, c, l = false, g) {
  const m3 = [], h = [], d = Qs2(e, t, n, o, s, i, c, g);
  if (!d.hasValue())
    return {
      undos: [],
      redos: []
...
function Qs2(e, t, n, o, r, s, i, c) {
  return c ? r.pasteType === et2.SPECIAL_PASTE_VALUE ? ei(e, t, n, o, i, c) : r.pasteType === et2.SPECIAL_PASTE_FORMULA ? ti(e, t, n, o, s, i, c) : ni2(e, t, n, o, r.copyType, s, i, c) : Js(e, t, n, o, i);
}
function Js(e, t, n, o, r) {
  const s = new pt(), i = r.getSheetFormulaData(e, t);
  return o.forValue((c, l, g) => {
    var u;
    const m3 = n.rows[c], h = n.cols[l], d = {};
    Gg(g.v) ? (d.v = null, d.f = `${g.v}`, d.si = null, d.p = null, s.setValue(m3, h, d)) : (u = i == null ? void 0 : i[m3]) != null && u[h] && (d.v = g.v, d.f = null, d.si = null, d.p = null, s.setValue(m3, h, d));
  }), s;
}
function ei(e, t, n, o, r, s) {
  var g, m3;
  const i = new pt(), c = (m3 = (g = r.getArrayFormulaCellData()) == null ? void 0 : g[s.unitId]) == null ? void 0 : m3[s.subUnitId], l = r.getSheetFormulaData(e, t);
  return o.forValue((h, d, u) => {
    var _2, E;
    const a = s.range.rows[h % s.range.rows.length], v2 = s.range.cols[d % s.range.cols.length], p = n.rows[h], S = n.cols[d], C = {};
    if (Gg(u.f) || B1(u.si))
      C.v = u.v, C.f = null, C.si = null, C.p = null, i.setValue(p, S, C);
    else if ((_2 = c == null ? void 0 : c[a]) != null && _2[v2]) {
      const f = c[a][v2];
...
function ti(e, t, n, o, r, s, i) {
  const c = new pt(), l = /* @__PURE__ */ new Map();
  return o.forValue((g, m3, h) => {
    const d = n.rows[g], u = n.cols[m3], a = {};
    if (B1(h.si)) {
      if (i.unitId !== e || i.subUnitId !== t) {
        const v2 = s.getFormulaStringByCell(
          i.range.rows[g % i.range.rows.length],
          i.range.cols[m3 % i.range.cols.length],
          i.subUnitId,
          i.unitId
        ), p = n.cols[m3] - i.range.cols[m3 % i.range.cols.length], S = n.rows[g] - i.range.rows[g % i.range.rows.length], C = r.moveFormulaRefOffset(v2 || "", p, S);
        a.si = null, a.f = C;
      } else
        a.si = h.si, a.f = null;
      a.v = null, a.p = null, c.setValue(d, u, a);
    } else if (Gg(h.f)) {
      const v2 = `${g % i.range.rows.length}_${m3 % i.range.cols.length}`;
      let p = l.get(v2);
      if (p)
        a.si = p, a.f = null;
      else {
        p = et(6), l.set(v2, p);
        const S = n.cols[m3] - i.range.cols[m3 % i.range.cols.length], C = n.rows[g] - i.range.rows[g % i.range.rows.length], _2 = r.moveFormulaRefOffset(h.f || "", S, C);
        a.si = p, a.f = _2;
      }
      a.v = null, a.p = null, c.setValue(d, u, a);
    } else {
...
function ni2(e, t, n, o, r, s, i, c) {
  const l = new pt(), g = /* @__PURE__ */ new Map(), m3 = i.getSheetFormulaData(e, t), h = [];
  return r === Yn.CUT ? o.forValue((d, u, a) => {
    const v2 = n.rows[d], p = n.cols[u], S = {};
    if (B1(a.si)) {
      if (Gg(a.f))
      ...
      S.v = null, S.p = null, l.setValue(v2, p, S);
    } else Gg(a.f) && (S.f = a.f, S.si = null, S.v = null, S.p = null, l.setValue(v2, p, S));
  }) : o.forValue((d, u, a) => {
    var C;
    const v2 = n.rows[d], p = n.cols[u], S = {};
    if (B1(a.si)) {
      if (c.unitId !== e || c.subUnitId !== t) {
        const _2 = i.getFormulaStringByCell(
          c.range.rows[d % c.range.rows.length],
          c.range.cols[u % c.range.cols.length],
          c.subUnitId,
          c.unitId
        ), E = n.cols[u] - c.range.cols[u % c.range.cols.length], f = n.rows[d] - c.range.rows[d % c.range.rows.length], b = s.moveFormulaRefOffset(_2 || "", E, f);
        S.si = null, S.f = b;
      } else
        S.si = a.si, S.f = null;
      S.v = null, S.p = null, l.setValue(v2, p, S);
    } else if (Gg(a.f)) {
      const _2 = `${d % c.range.rows.length}_${u % c.range.cols.length}`;
      let E = g.get(_2);
      if (E)
        S.si = E, S.f = null;
      else {
      ...
      S.v = null, S.p = null, l.setValue(v2, p, S);
    } else (C = m3 == null ? void 0 : m3[v2]) != null && C[p] && (S.v = a.v, S.f = null, S.si = null, S.p = a.p, l.setValue(v2, p, S));
  }), h.length > 0 && new pt(m3).forValue((d, u, a) => {
    if (!(c.range.rows.includes(d) && c.range.cols.includes(u)) && !(n.rows.includes(d) && n.cols.includes(u)) && h.includes(a == null ? void 0 : a.si)) {
      const v2 = i.getFormulaStringByCell(
        d,
        u,
        c.subUnitId,
        c.unitId
...
function Tr2(e) {
  if (e != null && e.p) {
    ...
    return n.substring(n.length - 2, n.length) === Bc ? n.substring(0, n.length - 2) : n;
  }
}
var ri2 = Object.getOwnPropertyDescriptor;
var oi2 = (e, t, n, o) => {
  for (var r = o > 1 ? void 0 : o ? ri2(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (r = i(r) || r);
  return r;
};
var He2 = (e, t) => (n, o) => t(n, o, e);
var Vt = class extends Ve {
    ...
    this.disposeWithMe(
      We(
        this._sheetInterceptorService.writeCellInterceptor.intercept(uo2, {
          handler: (t, n, o) => {
            var a, v2, p, S;
            const { row: r, col: s, unitId: i, subUnitId: c, worksheet: l } = n, g = this._formulaDataModel.getArrayFormulaRange(), m3 = this._formulaDataModel.getArrayFormulaCellData();
            if (this._removeArrayFormulaRangeShape(), t == null)
              return o(t);
            let h = null;
            const d = this._formulaDataModel.getFormulaStringByCell(r, s, c, i);
            if (d !== null && (h = { f: d }), t.v != null && t.v !== "" && ((p = (v2 = (a = m3[i]) == null ? void 0 : a[c]) == null ? void 0 : v2[r]) == null ? void 0 : p[s]) == null)
              return h ? { ...t, ...h } : o(t);
  ...
  _commandExecutedListener() {
    this.disposeWithMe(this._commandService.onCommandExecuted((t, n) => {
      (t.id === lo.id || t.id === ws.id && n && n.remove) && this._removeArrayFormulaRangeShape();
    })), this.disposeWithMe(
      this._commandService.beforeCommandExecuted((t) => {
        Xo.id === t.id && requestIdleCallback(() => {
  ...
  _displayArrayFormulaRangeShape(t, n, o, r, s, i, c) {
    ...
    return new pt(t).forValue((g, m3, h) => {
      var p;
      if (h == null)
        return true;
      const { startRow: d, startColumn: u, endRow: a, endColumn: v2 } = h;
      if (g === n && m3 === o)
        return this._createArrayFormulaRangeShape(h, r), false;
      if (n >= d && n <= a && o >= u && o <= v2) {
        const S = i.getCell(d, u);
        if ((S == null ? void 0 : S.v) === m2.SPILL)
          return;
        const C = (p = l == null ? void 0 : l[g]) == null ? void 0 : p[m3];
  ...
  _createArrayFormulaRangeShape(t, n) {
    ...
    const i = {
      ...
      style: {
        ...
        fill: new bt(this._themeService.getColorFromTheme("white")).setAlpha(0).toString(),
        widgets: {}
      }
    }, c = Wt(i, r), { rowHeaderWidth: l, columnHeaderHeight: g } = r, m3 = new Wd(s, gm.FORMULA_EDITOR_SHOW, this._themeService, {
      highlightHeader: false,
      rowHeaderWidth: l,
      columnHeaderHeight: g
    });
    m3.updateRangeBySelectionWithCoord(c), m3.setEvent(false), this._previousShape = m3;
  }
  ...
  _refreshArrayFormulaRangeShapeByRow(t, n, o) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      if (r >= g) {
        ...
        this._refreshArrayFormulaRangeShape(t, m3);
        break;
      }
    }
  }
...
var ii2 = (e, t, n, o) => {
  for (var r = o > 1 ? void 0 : o ? si2(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (r = i(r) || r);
  return r;
};
var zn = (e, t) => (n, o) => t(n, o, e);
  ...
  constructor(e, t) {
    super(), this._sheetInterceptorService = e, this._formulaDataModel = t, this.disposeWithMe(this._sheetInterceptorService.intercept(
      ht.CELL_CONTENT,
      {
        ...
        handler: (n, o, r) => {
          var c, l, g, m3;
          const s = (m3 = (g = (l = (c = this._formulaDataModel.getArrayFormulaCellData()) == null ? void 0 : c[o.unitId]) == null ? void 0 : l[o.subUnitId]) == null ? void 0 : g[o.row]) == null ? void 0 : m3[o.col];
          return !ry(n, !!s) || !n || (n === o.rawData && (n = { ...o.rawData }), n.markers = {
...
function ai() {
  const e = useDependency(xe), t = useDependency(Ls), n = useObservable(e.progress$), o = (0, import_react.useCallback)(() => {
    t.executeCommand(co.id);
  }, [t]), r = (0, import_react.useCallback)(() => {
    e.clearProgress();
  }, [e]);
  return (0, import_jsx_runtime.jsx)(qi, { progress: n, onTerminate: o, onClearProgress: r });
}
function li2(e, t) {
...
function Or3(e) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    n && n.map((o, r) => (0, import_jsx_runtime.jsxs)("span", { children: [
      (0, import_jsx_runtime.jsx)("span", { children: Nr4(o) }),
      r === n.length - 1 ? "" : ","
    ] }, r)),
    ")"
  ] });
...
function vt3(e) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { className: "univer-mb-2 univer-text-xs", children: [
    (0, import_jsx_runtime.jsx)(
      "div",
      {
        className: ie2("univer-mb-2 univer-font-medium univer-text-gray-500 dark:!univer-text-gray-300", t),
        children: o
      }
    ),
    (0, import_jsx_runtime.jsx)(
...
function ui2(e) {
  ...
  if (!t) return null;
  const [o, r] = (0, import_react.useState)([]), [s, i] = (0, import_react.useState)(t.functionParameter), [c, l] = (0, import_react.useState)(-1);
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    (0, import_jsx_runtime.jsx)("div", { className: ie2("univer-h-[364px] univer-overflow-y-auto", pr), children: s.map((g, m3) => (0, import_jsx_runtime.jsxs)("div", { children: [
      (0, import_jsx_runtime.jsx)("div", { className: "univer-text-sm", children: g.name }),
      (0, import_jsx_runtime.jsx)("div", { className: "univer-mb-2 univer-mt-1" })
    ] }, m3)) }),
    (0, import_jsx_runtime.jsx)("div", { className: ie2("univer-flex-1 univer-p-3", Xh), children: (0, import_jsx_runtime.jsx)(
      vt3,
      {
        title: c === -1 ? (0, import_jsx_runtime.jsx)(Or3, { prefix: t.functionName, value: s }) : s[c].name,
        value: c === -1 ? t.description : s[c].detail
      }
    ) })
  ] });
}
function et4({ ref: e, ...t }) {
  const { icon: n, id: o, className: r, extend: s, ...i } = t, c = `univerjs-icon univerjs-icon-${o} ${r || ""}`.trim(), l = (0, import_react.useRef)(`_${fi3()}`);
  return xr2(n, `${o}`, {
    defIds: n.defIds,
    idSuffix: l.current
  }, {
...
function xr2(e, t, n, o, r) {
  return (0, import_react.createElement)(e.tag, {
    key: t,
    ...di2(e, n, r),
    ...o
  }, (hi2(e, n).children || []).map((s, i) => xr2(s, `${t}-${e.tag}-${i}`, n, void 0, r)));
}
function di2(e, t, n) {
  const o = { ...e.attrs };
...
var Mr3 = (0, import_react.forwardRef)(function(t, n) {
  return (0, import_react.createElement)(et4, Object.assign({}, t, {
    id: "check-mark-icon",
    ref: n,
    icon: gi2
  }));
});
Mr3.displayName = "CheckMarkIcon";
var mi2 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
var wr = (0, import_react.forwardRef)(function(t, n) {
  return (0, import_react.createElement)(et4, Object.assign({}, t, {
    id: "close-icon",
    ref: n,
    icon: mi2
...
var kr3 = (0, import_react.forwardRef)(function(t, n) {
  return (0, import_react.createElement)(et4, Object.assign({}, t, {
    id: "delete-icon",
    ref: n,
    icon: pi2
...
var Ar3 = (0, import_react.forwardRef)(function(t, n) {
  return (0, import_react.createElement)(et4, Object.assign({}, t, {
    id: "increase-icon",
    ref: n,
    icon: Si2
...
var Fr3 = (0, import_react.forwardRef)(function(t, n) {
  return (0, import_react.createElement)(et4, Object.assign({}, t, {
    id: "more-icon",
    ref: n,
    icon: vi2
...
var Dr3 = (0, import_react.forwardRef)(function(t, n) {
  return (0, import_react.createElement)(et4, Object.assign({}, t, {
...
Dr3.displayName = "SelectRangeIcon";
function _i2(e) {
  const { onChange: t } = e, n = "-1", [o, r] = (0, import_react.useState)(""), [s, i] = (0, import_react.useState)([]), [c, l] = (0, import_react.useState)(0), [g, m3] = (0, import_react.useState)(n), [h, d] = (0, import_react.useState)(0), [u, a] = (0, import_react.useState)(null), v2 = useDependency(Gt2), p = useDependency(Fn), S = useDependency(we3), C = useObservable(S.sidebarOptions$), _2 = li2(yc, p);
  _2.unshift({
  ...
  (0, import_react.useEffect)(() => {
    ...
    C != null && C.visible && (r(""), i([]), l(0), m3(n), d(0), a(null), A(n));
  }, [C]);
  const b = (I2) => {
    if (o.trim() === "") return I2;
    const x = new RegExp(`(${o.toLocaleUpperCase()})`);
    return I2.split(x).filter(Boolean).map((w, D) => w.match(x) ? (0, import_jsx_runtime.jsx)("span", { className: "univer-text-red-500", children: w }, D) : w);
  }, y = (I2) => {
    if (s.length === 0) {
      a(null);
      return;
    ...
    d(I2);
    const x = v2.getFunctionInfo(s[I2].name);
    if (!x) {
      a(null);
      return;
    }
  ...
  function A(I2) {
    m3(I2);
    const x = v2.getSearchListByType(+I2);
    i(x);
  }
  function F(I2) {
    r(I2);
    const x = v2.getSearchListByName(I2);
    i(x);
  }
  function N(I2) {
    if (I2.stopPropagation(), I2.key === "ArrowDown") {
      const x = c + 1;
      l(x === s.length ? 0 : x);
    } else if (I2.key === "ArrowUp") {
      const x = c - 1;
      l(x === -1 ? s.length - 1 : x);
    } else I2.key === "Enter" && y(c);
  }
  const O = (I2) => {
    l(I2);
  }, k = () => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex univer-items-center univer-justify-between univer-gap-2", children: [
      (0, import_jsx_runtime.jsx)(LE, { value: g, options: _2, onChange: A }),
      (0, import_jsx_runtime.jsx)(
        Vx,
        {
    ...
    s.length > 0 && (0, import_jsx_runtime.jsx)(
      "ul",
      {
        className: ie2("univer-mb-0 univer-mt-2 univer-box-border univer-max-h-72 univer-w-full univer-select-none univer-list-none univer-overflow-y-auto univer-rounded univer-p-3 univer-outline-none", kt2, pr),
        onKeyDown: N,
        tabIndex: -1,
        children: s.map(({ name: I2 }, x) => (0, import_jsx_runtime.jsxs)(
          "li",
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)("span", { className: "univer-block", children: b(I2) })
            ]
          },
          x
        ))
    ...
    u && (0, import_jsx_runtime.jsxs)("div", { className: ie2("univer-mx-0 univer-my-2 univer-overflow-y-auto", pr), children: [
      (0, import_jsx_runtime.jsx)(vt3, { title: u.functionName, value: u.description }),
      (0, import_jsx_runtime.jsx)(
        vt3,
        {
          title: p.t("formula.moreFunctions.syntax"),
          value: (0, import_jsx_runtime.jsx)(Or3, { prefix: u.functionName, value: u.functionParameter })
        }
      ),
      (0, import_jsx_runtime.jsx)(
        vt3,
        {
          ...
          value: `${u.functionName}(${u.functionParameter.map((I2) => I2.example).join(",")})`
        }
      ),
      u.functionParameter && u.functionParameter.map((I2) => (0, import_jsx_runtime.jsx)(
        vt3,
        {
          title: I2.name,
          value: `${I2.require ? E : f} ${I2.detail}`
        },
        I2.name
      ))
    ] })
...
function Ri2() {
  const e = kr(), [t, n] = (0, import_react.useState)(true), [o, r] = (0, import_react.useState)(false), [s, i] = (0, import_react.useState)(null);
  useDependency(qe2);
  const c = useDependency(Fn), l = useDependency(Ge), g = useDependency(vr), m3 = useDependency(Ls);
  function h() {
    n(!t), r(!o);
  }
  function d() {
    const u = P(g);
    if (!u) return;
    m3.executeCommand(tt.id, {
      visible: true,
      unitId: u.unitId,
      eventType: Kv.Dblclick
    });
    const a = l.getEditor(Dl), v2 = l.getEditor(Ul), p = `=${s == null ? void 0 : s.functionName}(`;
    a == null || a.replaceText(p), v2 == null || v2.replaceText(p, false);
  }
  return (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        t && (0, import_jsx_runtime.jsx)(_i2, { onChange: i }),
        o && (0, import_jsx_runtime.jsx)(ui2, { functionInfo: s, onChange: () => {
        } }),
        (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex univer-justify-end", children: [
          ...
          o && (0, import_jsx_runtime.jsx)(vr2, { onClick: h, className: "univer-mb-5 univer-ml-4 univer-mr-0 univer-mt-0", children: c.t("formula.moreFunctions.prev") }),
          t && !!e && (0, import_jsx_runtime.jsx)(
            vr2,
            {
              variant: "primary",
              onClick: d,
...
function Oi3(e) {
  return e.get(vr).getCurrentTypeOfUnit$(we.UNIVER_SHEET).pipe(
    switchMap((o) => o ? e.get(lr) ? new Observable((s) => s.next(!e.get(lr).supportClipboard)) : of(true) : of(true))
  );
}
function xi2(e) {
  return {
...
var wi2 = "meta_key_ctrl_And_Shift";
function ki2(e) {
  return e.getContextValue(qr) && e.getContextValue(xR);
}
var zt = [
  q1.ARROW_DOWN,
  q1.ARROW_UP,
...
var Ai2 = [...zt, q1.ENTER, q1.TAB, q1.ESC];
function Fi2() {
  const e = [];
  for (const t of Ai2)
    e.push({
...
function Li2() {
  ...
  for (const t of zt)
    e.push({
      id: gt.id,
      binding: t | L1.CTRL_COMMAND,
      preconditions: (n) => jy(n),
      staticParameters: {
        eventType: Kv.Keyboard,
        keycode: t,
        metaKey: L1.CTRL_COMMAND
      }
    });
  return e;
}
function $i2() {
  ...
  for (const t of zt)
    e.push({
      id: gt.id,
      binding: t | L1.SHIFT | L1.CTRL_COMMAND,
      preconditions: (n) => jy(n),
      staticParameters: {
        eventType: Kv.Keyboard,
        keycode: t,
...
var Pi2 = {
  id: br3.id,
  binding: q1.F4,
  preconditions: (e) => jy(e)
};
function Ui2() {
  const e = [];
  for (const t of [q1.ENTER, q1.TAB, q1.ARROW_DOWN, q1.ARROW_UP])
    e.push({
      id: gt.id,
      binding: t,
      preconditions: (n) => ki2(n),
      staticParameters: {
        eventType: Kv.Keyboard,
        keycode: t,
        isSingleEditor: true
...
var Vi2 = {
  id: ii.id,
  binding: L1.ALT | q1.EQUAL,
  preconditions: Ve3,
  mac: L1.CTRL_COMMAND | L1.ALT | q1.EQUAL,
  description: "shortcut.sheets-formula-ui.quick-sum",
  group: "4_sheet-edit"
};
var Wi4 = Object.getOwnPropertyDescriptor;
var Hi2 = (e, t, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Wi4(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (r = i(r) || r);
  return r;
};
var Be = (e, t) => (n, o) => t(n, o, e);
var Ht3 = class extends Ve {
  ...
  _registerMenus() {
    this._menuManagerService.mergeMenu(Mi2);
  }
  _registerCommands() {
    [
      vn2,
  ...
  _registerComponents() {
    this.disposeWithMe(this._uiPartsService.registerComponent(Wm2.FORMULA_AUX, () => connectInjector(ai, this._injector))), this._componentManager.register(Er2, Ri2);
  }
  _registerRenderModules() {
    this.disposeWithMe(this._renderManagerService.registerRenderModule(we.UNIVER_SHEET, [Vt]));
  }
};
Ht3 = Hi2([
  Be(0, Inject(Injector)),
  Be(1, B12),
  Be(2, Ls),
  Be(3, ye2),
  Be(4, D1),
...
var Lr2 = class {
  constructor() {
    j(this, "_currentSelector$", new BehaviorSubject(null));
...
var qi3 = (e, t, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Bi3(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (r = i(r) || r);
  return r;
};
var st2 = (e, t) => (n, o) => t(n, o, e);
var De2 = class extends mm {
  constructor(t, n, o, r, s, i, c) {
    ...
    this._context = t, this._contextService = i, this._refSelectionsService = c, this._workbookSelections = this._refSelectionsService.getWorkbookSelections(this._context.unitId), this._initSelectionChangeListener(), this._initSkeletonChangeListener(), this._initUserActionSyncListener(), this._setSelectionStyle(ji2(this._themeService)), this._remainLastEnabled = true, this._highlightHeader = false;
  }
  getLocation() {
  ...
  enableSelectionChanging() {
    return this._disableSelectionChanging(), this._eventDisposables = this._initCanvasEventListeners(), We(() => this._disableSelectionChanging());
  }
  ...
  _initCanvasEventListeners() {
    const t = this._getSheetObject(), { spreadsheetRowHeader: n, spreadsheetColumnHeader: o, spreadsheet: r, spreadsheetLeftTopPlaceholder: s } = t, { scene: i } = this._context, c = new ao();
    return c.add(r == null ? void 0 : r.onPointerDown$.subscribeEvent((l, g) => {
      this.inRefSelectionMode() && (this._onPointerDown(l, r.zIndex + 1, ge.NORMAL, this._getActiveViewport(l)), l.button !== 2 && g.stopPropagation());
    })), c.add(
      n == null ? void 0 : n.onPointerDown$.subscribeEvent((l, g) => {
        if (!this.inRefSelectionMode()) return;
        const m3 = this._sheetSkeletonManagerService.getCurrent().skeleton, { row: h } = Vn(l.offsetX, l.offsetY, i, m3);
        gl(this._workbookSelections.getCurrentSelections(), h, ge.ROW) || (this._onPointerDown(l, (r.zIndex || 1) + 1, ge.ROW, this._getActiveViewport(l), bE.Y), l.button !== 2 && g.stopPropagation());
      })
    ), c.add(o == null ? void 0 : o.onPointerDown$.subscribeEvent((l, g) => {
      if (!this.inRefSelectionMode()) return;
      const m3 = this._sheetSkeletonManagerService.getCurrent().skeleton, { column: h } = Vn(l.offsetX, l.offsetY, i, m3);
      gl(this._workbookSelections.getCurrentSelections(), h, ge.COLUMN) || (this._onPointerDown(l, (r.zIndex || 1) + 1, ge.COLUMN, this._getActiveViewport(l), bE.X), l.button !== 2 && g.stopPropagation());
    })), c.add(s == null ? void 0 : s.onPointerDown$.subscribeEvent((l, g) => {
      if (this._reset(), !this.inRefSelectionMode()) return;
      const m3 = this._sheetSkeletonManagerService.getCurrent().skeleton, h = fm(m3);
  ...
  _addSelectionControlByModelData(t) {
    var i;
    const n = this._skeleton, o = (i = t.style) != null ? i : Sr2(this._themeService), r = this._scene;
  ...
  _initUserActionSyncListener() {
    this.disposeWithMe(this.selectionMoveStart$.subscribe((t) => {
      this._updateSelections(t, we2.MOVE_START);
    })), this.disposeWithMe(this.selectionMoving$.subscribe((t) => {
      this._updateSelections(t, we2.MOVING);
    })), this.disposeWithMe(this.selectionMoveEnd$.subscribe((t) => {
      this._updateSelections(t, we2.MOVE_END);
    }));
  }
  ...
  _initSkeletonChangeListener() {
    this.disposeWithMe(this._sheetSkeletonManagerService.currentSkeleton$.subscribe((t) => {
      ...
      if (!t)
        return;
      const { skeleton: n } = t, { scene: o } = this._context, r = o.getViewport(k2.VIEW_MAIN);
  ...
  _getActiveViewport(t) {
    ...
    return n == null ? void 0 : n.scene.getActiveViewportByCoord(U.FromArray([t.offsetX, t.offsetY]));
  }
  _getSheetObject() {
  ...
  _onPointerDown(t, n = 0, o = ge.NORMAL, r, s = bE.ALL) {
    var N;
    this._rangeType = o;
    ...
    const { offsetX: l, offsetY: g } = t, m3 = c.getViewport(k2.VIEW_MAIN);
    if (!m3) return;
    const h = c.getCoordRelativeToViewport(U.FromArray([l, g])), { x: d, y: u } = h;
    this._startViewportPosX = d, this._startViewportPosY = u;
    const a = c.getScrollXYInfoByViewport(h), { scaleX: v2, scaleY: p } = c.getAncestorScale(), S = this._skeleton.getCellByOffset(d, u, v2, p, a);
    if (!S) return;
    switch (o) {
      case ge.NORMAL:
        break;
    ...
    C.range.rangeType = o;
    const _2 = Wt(C, this._skeleton);
    this._startRangeWhenPointerDown = { ..._2.rangeWithCoord };
    const E = { ..._2.rangeWithCoord, rangeType: o };
    let f = this.getActiveSelectionControl();
    const b = this.getSelectionControls();
    for (const O of b) {
      if (t.button === 2 && En.contains(O.model, E)) {
        f = O;
        return;
      }
    ...
    ) : F && f ? f.updateRangeBySelectionWithCoord(_2) : f = this.newSelectionControl(c, i, C);
    for (let O = 0; O < this.getSelectionControls().length - 1; O++)
      this.getSelectionControls()[O].clearHighlight();
    this._selectionMoveStart$.next(this.getSelectionDataWithStyle()), c.disableObjectsEvent(), this._clearUpdatingListeners(), this._addEndingListeners(), (N = c.getTransformer()) == null || N.clearSelectedObjects(), this._setupPointerMoveListener(m3, f, o, s, d, u), this._escapeShortcutDisposable = this._shortcutService.forceEscape(), this._scenePointerUpSub = c.onPointerUp$.subscribeEvent(() => {
      var O;
  ...
  newSelectionControl(t, n, o) {
    const r = this.getSelectionControls().length, { rowHeaderWidth: s, columnHeaderHeight: i } = n, c = new Wd(t, r, this._themeService, {
...
var _n2 = (e, t, n = true) => {
  ...
  return e.reduce((r, s, i) => {
    ...
    return (n ? r.currentIndex === t : t > c && t <= r.currentIndex) && (o = i, r.isFinish = true), r;
  }, { currentIndex: 0, isFinish: false }), o;
};
var $r = (e, t) => {
  const n = e[t];
  let o = -1;
  if (!n || typeof n == "string" || n.nodeType !== $e.REFERENCE) return -1;
  for (let r = 0; r <= t; r++) {
    const s = e[r];
    typeof s != "string" && s.nodeType === $e.REFERENCE && o++;
  }
  return o;
};
var Ki2 = (e, t = 100) => {
...
function Pr2(e, t, n) {
  const o = useDependency(Ge), r = (0, import_react.useMemo)(() => new BehaviorSubject({ left: -999, top: -999, right: -999, bottom: -999 }), []), s = useDependency(we3), i = useDependency(vr), c = re(() => {
    var _2;
    const l = o.getEditor(e);
    if (!l)
      return;
    const g = l.getBoundingClientRect(), { marginTop: m3 = 0, marginBottom: h = 0 } = l.getDocumentData().documentStyle, d = l.getSkeleton();
    if (!d) return;
    const u = (_2 = d.getSkeletonData()) == null ? void 0 : _2.pages[0].height;
    let { left: a, top: v2, right: p, bottom: S } = g;
    v2 = v2 + m3, S = u ? v2 + u : S - h;
    const C = r.getValue();
    if (!(C.left === a && C.top === v2 && C.right === p && C.bottom === S))
      return r.next({ left: a - 1, right: p + 1, top: v2 - 1, bottom: S + 1 }), g;
  });
  return (0, import_react.useEffect)(() => {
    t && c();
  }, [e, o, i.unitAdded$, c, t, ...n != null ? n : []]), Ki2(c), (0, import_react.useEffect)(() => {
    const l = s.scrollEvent$.pipe(throttleTime(100)).subscribe(c);
    return () => {
      l.unsubscribe();
    };
  }, []), [r, c];
...
var Yi2 = (e, t, n) => {
  const o = useDependency(Zt), r = useDependency(Gt2), s = useDependency(ga), [i, c] = (0, import_react.useState)(), [l, g] = (0, import_react.useState)(-1), [m3, h] = (0, import_react.useState)(true), d = tt3(m3), u = (0, import_react.useRef)(t);
  u.current = t;
  const a = () => {
    c(void 0), g(-1), h(false);
  };
  return (0, import_react.useEffect)(() => {
    const v2 = s.sequenceNodesBuilder(t.slice(1));
    o.setSequenceNodes(v2 != null ? v2 : []);
  }, [t]), (0, import_react.useEffect)(() => {
    if (n && e) {
      const v2 = n.selectionChange$.pipe(debounceTime(50)).subscribe((S) => {
        if (S.textRanges.length === 1) {
          const [C] = S.textRanges;
          if (C.collapsed && d.current) {
            const { startOffset: _2 } = C, E = o.getCurrentSequenceNodeIndex(_2 - 2), f = o.getCurrentSequenceNodeByIndex(E), b = o.getCurrentSequenceNodeByIndex(E + 1);
            if (f)
              if (typeof f != "string" && f.nodeType === 3 && !r.hasDefinedNameDescription(f.token.trim()) && b === K.OPEN_BRACKET) {
                const y = r.getFunctionInfo(f.token);
                c(y), g(-1);
                return;
              } else {
                const y = s.getFunctionAndParameter(`${u.current}A`, _2 - 1);
                if (y) {
...
var Gi3 = ({ onClick: e }) => (0, import_jsx_runtime.jsx)(
  "div",
  {
...
var en2 = ({ className: e, title: t, value: n }) => (0, import_jsx_runtime.jsxs)("div", { className: "univer-my-2", children: [
  (0, import_jsx_runtime.jsx)(
    "div",
    {
...
var Zi2 = (e) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    n && n.map((s, i) => (0, import_jsx_runtime.jsxs)("span", { children: [
      (0, import_jsx_runtime.jsx)(
        "span",
        {
...
function zi3(e) {
  const { onParamsSwitch: t = Xn, onClose: n = Xn, isFocus: o, editor: r, formulaText: s } = e, { functionInfo: i, paramIndex: c, reset: l } = Yi2(o, s, r), g = useDependency(qe2), m3 = !useObservable(g.helpFunctionVisible$), [h, d] = (0, import_react.useState)(true), u = useDependency(Fn), a = u.t("formula.prompt.required"), v2 = u.t("formula.prompt.optional"), p = r.getEditorId(), [S] = Pr2(p, !!i, [i, c]);
  function C(f) {
    t && t(f);
  }
  const _2 = re((f) => {
  ...
  return i ? m3 ? (0, import_jsx_runtime.jsx)(ot, { portal: true, anchorRect$: S, direction: "left-center", children: (0, import_jsx_runtime.jsx)(Gi3, { onClick: () => _2(false) }) }, "hidden") : (0, import_jsx_runtime.jsx)(ot, { portal: true, onClickOutside: () => l(), anchorRect$: S, direction: "vertical", children: (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        (0, import_jsx_runtime.jsxs)(
          "div",
          {
            className: ie2("univer-wrap-anywhere univer-box-border univer-flex univer-items-center univer-justify-between univer-px-4 univer-py-3 univer-text-xs univer-font-medium univer-text-gray-900 dark:!univer-text-white", JS),
            children: [
              (0, import_jsx_runtime.jsx)(
                Zi2,
                {
              ...
              (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex", children: [
                (0, import_jsx_runtime.jsx)(
                  "div",
                  {
                    ...
                    onClick: () => d(!h),
                    children: (0, import_jsx_runtime.jsx)(Fr3, {})
                  }
                ),
                (0, import_jsx_runtime.jsx)(
                  "div",
                  {
                    ...
                    onClick: E,
                    children: (0, import_jsx_runtime.jsx)(wr, {})
                  }
                )
              ] })
            ]
        ...
        (0, import_jsx_runtime.jsx)(
          "div",
          {
            className: ie2("univer-box-border univer-max-h-[350px] univer-overflow-y-auto univer-px-4 univer-pb-3 univer-pt-0", pr),
            style: {
              height: h ? "unset" : 0,
              padding: h ? "revert-layer" : 0
            },
            children: (0, import_jsx_runtime.jsxs)("div", { className: "univer-mt-3", children: [
              (0, import_jsx_runtime.jsx)(
                en2,
                {
              ...
              i && i.functionParameter && i.functionParameter.map((f, b) => (0, import_jsx_runtime.jsx)(
                en2,
                {
                  className: c === b ? "univer-text-primary-500" : "",
                  title: f.name,
                  value: `${f.require ? a : v2} ${f.detail}`
                },
                b
              ))
            ] })
...
function Qi2(e) {
  var r, s;
  const n = e.get(vr).getCurrentUniverDocInstance();
  return n != null && n.getBody() ? { dataStream: (s = (r = n.getBody()) == null ? void 0 : r.dataStream) != null ? s : "", offset: 0 } : void 0;
}
var Te2 = ((e) => (e[e.NOT_SELECT = 0] = "NOT_SELECT", e[e.NEED_ADD = 1] = "NEED_ADD", e[e.CAN_EDIT = 2] = "CAN_EDIT", e[e.EDIT_OTHER_SHEET_REFERENCE = 3] = "EDIT_OTHER_SHEET_REFERENCE", e[e.EDIT_OTHER_WORKBOOK_REFERENCE = 4] = "EDIT_OTHER_WORKBOOK_REFERENCE", e))(Te2 || {});
function Ji2(e) {
  var y;
  const { editorId: t, isFocus: n, disableOnClick: o, unitId: r, subUnitId: s } = e, i = useDependency(ME), c = useDependency(vr), l = i.getRenderById(r), g = i.getRenderById(t), m3 = g == null ? void 0 : g.with(Re), h = useDependency(m), d = useDependency(Injector), [u, a] = (0, import_react.useState)(
    0
    /* NOT_SELECT */
  ), v2 = useDependency(ga), p = (0, import_react.useRef)(true), S = l == null ? void 0 : l.with(De2), C = tt3(u), _2 = c.getUnit(r, we.UNIVER_SHEET), E = _2 == null ? void 0 : _2.getSheetBySheetId(s), f = re((A) => {
    ...
    var ce, ae, he2;
    const A = c.getCurrentUnitOfType(we.UNIVER_SHEET);
    if (!A) return;
    const F = A.getActiveSheet(), N = m3 == null ? void 0 : m3.getActiveTextRange(), O = N != null && N.collapsed ? N.startOffset : -1, k = Qi2(d);
    if (!k) return;
    const I2 = (ce = k == null ? void 0 : k.dataStream) == null ? void 0 : ce.slice(0, -2), x = ((ae = v2.sequenceNodesBuilder(I2)) != null ? ae : []).map((K2) => typeof K2 == "object" ? K2.nodeType === $e.REFERENCE ? {
      ...K2,
      range: Cr(K2.token)
    } : {
      ...K2,
      range: void 0
    } : K2), R = I2[O - 1], w = I2[O], D = x.find((K2) => typeof K2 == "object" && K2.nodeType === $e.REFERENCE && O === K2.endIndex + 2), U2 = R && Xb(R) && (!w || an(w) && w !== K.OPEN_BRACKET), B2 = !!D;
    if ((I2 == null ? void 0 : I2.substring(0, 1)) === "=" && (U2 || B2))
      if (B2) {
        if (p.current)
          return;
        const { sheetName: K2, unitId: J2 } = D.range, nt2 = (he2 = c.getCurrentUnitOfType(we.UNIVER_SHEET)) == null ? void 0 : he2.getUnitId();
        J2 && J2 !== nt2 ? f(
          4
          /* EDIT_OTHER_WORKBOOK_REFERENCE */
        ) : !K2 && F.getSheetId() === (E == null ? void 0 : E.getSheetId()) || K2 === F.getName() ? f(
          2
          /* CAN_EDIT */
        ) : f(
          3
  ...
  return (0, import_react.useEffect)(() => {
    const A = h.textSelection$.pipe(filter((F) => F.unitId === t)).subscribe(() => {
      b();
    });
    return () => A.unsubscribe();
  }, [b, h.textSelection$, t]), (0, import_react.useEffect)(() => {
    n || (f(
      0
      /* NOT_SELECT */
    ), p.current = true);
  }, [n, f]), (0, import_react.useEffect)(() => {
    var F;
    if (!o) return;
  ...
  }, [o, (y = g == null ? void 0 : g.mainComponent) == null ? void 0 : y.onPointerDown$, f]), (0, import_react.useEffect)(() => {
    if (!n) return;
    const A = _2 == null ? void 0 : _2.activeSheet$.subscribe(() => {
      b();
    }), F = c.getCurrentTypeOfUnit$(we.UNIVER_SHEET).subscribe(() => {
      b();
    });
    return () => {
      A == null || A.unsubscribe(), F == null || F.unsubscribe();
    };
  }, [b, n, _2 == null ? void 0 : _2.activeSheet$, c.getCurrentTypeOfUnit$]), { isSelecting: u, isSelectingRef: C };
}
var ec = () => {
  const e = useDependency(ga);
  return (0, import_react.useCallback)((n) => e.sequenceNodesBuilder(n) || [], [e]);
};
function tc(e, t, n) {
  const o = new bt(t).setAlpha(0.05).toRgbString();
  return {
    id: n,
    strokeWidth: 1,
    stroke: t,
...
function Ur3(e) {
  ...
  const {
    ...
    themeService: g,
    univerInstanceService: m3
  } = e, h = o.getUnitId(), d = m3.getUnit(t, we.UNIVER_SHEET), u = d == null ? void 0 : d.getActiveSheet(), a = [];
  if (!d || !u) {
    i.setSelections(a);
    return;
  }
  const v2 = u.getSheetId(), p = (b) => {
    var y;
    return (y = d == null ? void 0 : d.getSheetBySheetName(b)) == null ? void 0 : y.getSheetId();
  };
  if (!((_2 = l == null ? void 0 : l.getWorksheetSkeleton(v2)) == null ? void 0 : _2.skeleton)) return;
  const C = [];
  for (let b = 0, y = r.length; b < y; b++) {
    const A = r[b], { themeColor: F, token: N, refIndex: O, endIndex: k } = A, I2 = Dr(N), { unitId: x, sheetName: R, range: w } = I2, D = p(R);
    if (!D && R || h !== t && x !== h || x && x !== h || D && D !== v2 || !D && v2 !== n)
      continue;
    const U2 = kh(w, u.getRowCount(), u.getColumnCount());
    U2.unitId = t, U2.sheetId = v2, a.push({
      range: U2,
      primary: null,
...
function nc(e, t) {
  const n = useDependency(vr), o = useDependency(Gi), r = useDependency(Fu), s = useDependency(ME), i = useObservable((0, import_react.useMemo)(() => n.getCurrentTypeOfUnit$(we.UNIVER_SHEET), [n])), c = i ? s.getRenderById(i.getUnitId()) : null, l = c == null ? void 0 : c.with(De2), g = c == null ? void 0 : c.with(ue), m3 = re((h, d) => {
    const u = n.getCurrentUnitOfType(we.UNIVER_SHEET);
...
function Vr2(e = "") {
  const t = useDependency(Gt2), n = rc(), o = useDependency(Ls), r = (0, import_react.useMemo)(() => e.length, [e]);
  return re((i, c, l = true, g) => {
    const m3 = i.getDocumentData(), h = i.getEditorId();
    if (!m3)
      return [];
    const d = m3.body;
    if (!d)
      return [];
    const u = d.dataStream.slice(0, d.dataStream.length - 2), a = { dataStream: "", ...m3.body };
    if (!u.startsWith(e)) return [];
    if (c == null || c.length === 0)
      return a.textRuns = [], o.syncExecuteCommand(Jd.id, {
        unitId: h,
        body: kt(a, 0, a.dataStream.length - 2)
      }), [];
    {
      const { textRuns: v2, refSelections: p } = oc(t, n, c);
      r && v2.forEach((_2) => {
        _2.ed = _2.ed + r, _2.st = _2.st + r;
      }), a.textRuns = [{ st: 0, ed: 1, ts: { fs: 11 } }, ...v2];
      const S = c.reduce((_2, E) => typeof E == "string" ? `${_2}${E}` : `${_2}${E.token}`, "");
      a.dataStream = `${e}${S}\r
`;
      let C;
      if (l) {
        C = i.getSelectionRanges();
        const _2 = a.dataStream.length - 2 + r;
        C.forEach((E) => {
          E.startOffset = Math.max(0, Math.min(E.startOffset, _2)), E.endOffset = Math.max(0, Math.min(E.endOffset, _2));
        });
      }
      return o.syncExecuteCommand(Jd.id, {
        unitId: h,
        body: kt(a, 0, a.dataStream.length - 2),
...
function rc() {
  const e = useDependency(Gi), t = e.getCurrentTheme();
...
function oc(e, t, n) {
  ...
  for (let h = 0, d = n.length; h < d; h++) {
    const u = n[h];
    if (typeof u == "string") {
      const _2 = c[c.length - 1], E = _2 ? _2.ed : 0, f = E + u.length;
      c.push({
        st: E,
        ed: f,
        ts: {
    ...
    const { startIndex: a, endIndex: v2, nodeType: p, token: S } = u;
    let C = "";
    if (p === $e.REFERENCE) {
      if (g.has(S))
        C = g.get(S);
      else {
        const _2 = m3 % o.length;
        C = o[_2], g.set(S, C), m3++;
      }
      l.push({
        refIndex: h,
    ...
    } else p === $e.NUMBER ? C = r : (p === $e.STRING || p === $e.ARRAY) && (C = s);
    C && C.length > 0 ? c.push({
      st: a,
      ed: v2 + 1,
      ts: {
...
var sc = (e, t, n, o) => {
  const r = useDependency(Ls), s = useDependency(ye2), i = (0, import_react.useRef)(t);
  i.current = t;
  const c = (0, import_react.useRef)(o);
  c.current = o, (0, import_react.useEffect)(() => {
    if (!n || !e)
      return;
    const g = `sheet.formula-embedding-editor.${n.getEditorId()}`, m3 = new ao(), h = (a, v2) => {
      if (c.current) {
        c.current(a, v2);
        return;
      }
      let p = Cm.LEFT;
      a === q1.ARROW_DOWN ? p = Cm.DOWN : a === q1.ARROW_UP ? p = Cm.UP : a === q1.ARROW_RIGHT && (p = Cm.RIGHT), v2 === L1.SHIFT ? r.executeCommand(vt2.id, {
        direction: p
      ...
      let p = Cm.DOWN;
      a === q1.ARROW_DOWN ? p = Cm.DOWN : a === q1.ARROW_UP ? p = Cm.UP : a === q1.ARROW_LEFT ? p = Cm.LEFT : a === q1.ARROW_RIGHT && (p = Cm.RIGHT), i.current ? v2 === L1.CTRL_COMMAND ? r.executeCommand(Ut.id, {
        direction: p,
        jumpOver: Ln.moveGap,
        extra: "formula-editor",
        fromCurrentSelection: i.current === Te2.NEED_ADD || i.current === Te2.EDIT_OTHER_SHEET_REFERENCE
      }) : v2 === L1.SHIFT ? r.executeCommand(Gt.id, {
        direction: p,
        extra: "formula-editor"
      }) : v2 === (L1.CTRL_COMMAND | L1.SHIFT) ? r.executeCommand(Gt.id, {
        direction: p,
        jumpOver: Ln.moveGap,
        extra: "formula-editor"
      }) : r.executeCommand(Ut.id, {
        direction: p,
        extra: "formula-editor",
        fromCurrentSelection: i.current === Te2.NEED_ADD || i.current === Te2.EDIT_OTHER_SHEET_REFERENCE
      }) : h(a, v2);
    };
    return m3.add(r.registerCommand({
      id: g,
      type: Ms.OPERATION,
      handler(a, v2) {
        const { keyCode: p, metaKey: S } = v2;
        d(p, S);
      }
    })), [
      ...
      m3.add(s.registerShortcut(a));
    }), () => {
      m3.dispose();
    };
  }, [r, n, e, s]);
};
var ic2 = (e, t, n, o, r = true) => {
  var u;
  const s = useDependency(ME), i = useDependency(Nr), c = useDependency(c3), l = useDependency(Fu), g = useDependency(vr), m3 = useObservable((0, import_react.useMemo)(() => g.getCurrentTypeOfUnit$(we.UNIVER_SHEET), [g])), h = s.getRenderById((u = m3 == null ? void 0 : m3.getUnitId()) != null ? u : ""), d = h == null ? void 0 : h.with(De2);
  (0, import_react.useLayoutEffect)(() => {
    if (e)
      return i.setContextValue(mE, true), r && c.disable(), () => {
        const a = g.getCurrentUnitOfType(we.UNIVER_DOC);
        (a == null ? void 0 : a.getUnitId()) === o && i.setContextValue(mE, false), r && c.enable(), l.clear();
      };
  }, [i, e, l, r, o]), (0, import_react.useLayoutEffect)(() => {
    if (e && t) {
      const a = d == null ? void 0 : d.enableSelectionChanging();
      return i.setContextValue($u, true), () => {
        i.setContextValue($u, false), a == null || a.dispose();
      };
    }
...
var cc = (e, t, n) => {
  const o = useDependency(vr), r = useDependency(z);
  return (0, import_react.useCallback)(() => {
    if (e) {
      const i = [...r.getWorkbookSelections(t).getSelectionsOfWorksheet(n)], c = o.getCurrentUnitForType(we.UNIVER_SHEET), l = c == null ? void 0 : c.getActiveSheet();
      (c == null ? void 0 : c.getUnitId()) !== t && o.setCurrentUnitForType(t), l && l.getSheetId() === n && r.setSelections(i);
    }
  }, [e, r, n, t, o]);
};
var ac = (e) => e.reduce((t, n) => typeof n == "string" ? t + n.length : t + n.token.length, 0);
var sn = (e) => e.map((t) => typeof t == "string" ? t : t.token).join("");
var kt3 = (e, t = false, n = "", o = false) => !t && !o ? e.map((r) => Ft(r.range)) : e.map((r) => o ? Ss(r) : r.sheetName !== "" && r.sheetName !== n ? Hc(r.sheetName, r.range) : Ft(r.range));
var lc = (e) => {
  var m3, h, d;
  const { editor: t, lexerTreeBuilder: n } = e, o = t == null ? void 0 : t.getSelectionRanges();
  if ((o == null ? void 0 : o.length) !== 1)
    return;
  const s = o[0].startOffset - 1, i = ((h = (m3 = t == null ? void 0 : t.getDocumentData().body) == null ? void 0 : m3.dataStream) != null ? h : `\r
`).slice(0, -2), c = (d = n.sequenceNodesBuilder(i.slice(1))) != null ? d : [], l = _n2(c, s, false), g = $r(c, l);
  return {
    nodeIndex: l,
    updatingRefIndex: g,
    sequenceNodes: c,
...
var dc = (e, t, n, o, r, s, i, c, l, g = uc) => {
  var O;
  const m3 = useDependency(ME), h = useDependency(vr), d = useDependency(Ls), u = useDependency(m), a = useDependency(Gi), v2 = useDependency(ga), p = h.getUnit(o), S = re((k, I2) => {
    var x, R, w;
    return (w = (R = (x = h.getUnit(k)) == null ? void 0 : x.getSheetBySheetId(I2)) == null ? void 0 : R.getName()) != null ? w : "";
  }), C = (0, import_react.useMemo)(() => S(o, r), [S, r, o]), _2 = useObservable(p == null ? void 0 : p.activeSheet$), E = tt3({ activeSheet: _2, sheetName: C }), f = useObservable((0, import_react.useMemo)(() => h.getCurrentTypeOfUnit$(we.UNIVER_SHEET), [h])), b = m3.getRenderById((O = f == null ? void 0 : f.getUnitId()) != null ? O : ""), y = b == null ? void 0 : b.with(De2), A = b == null ? void 0 : b.with(ue), F = useDependency(Fu), N = re((k, I2) => {
    var B2, ce, ae, he2, K2, J2, nt2, rt2, yt2, Re3;
    const x = lc({ editor: l, lexerTreeBuilder: v2 });
    if (!x) return;
    const { nodeIndex: R, updatingRefIndex: w, sequenceNodes: D, offset: U2 } = x;
    if (n.current === Te2.NEED_ADD)
      if (U2 !== 0) {
        if (R === -1 && D.length)
          return;
        const Y3 = k[k.length - 1], X2 = D.splice(R + 1), Ie2 = (B2 = Y3.sheetId) != null ? B2 : r, fe2 = {
          range: Y3,
          unitId: (ce = Y3.unitId) != null ? ce : f.getUnitId(),
          sheetName: S((ae = Y3.unitId) != null ? ae : f.getUnitId(), Ie2)
        }, ee3 = Ie2 !== r, le2 = (f == null ? void 0 : f.getUnitId()) !== o, Ee = kt3([fe2], i && (ee3 || le2), C, le2);
        D.push({ token: Ee[0], nodeType: $e.REFERENCE });
        const $e2 = [...D, ...X2], Me2 = sn($e2);
        g(Me2, ac(D), I2);
      } else {
        const Y3 = k[k.length - 1], X2 = (he2 = Y3.sheetId) != null ? he2 : r, Ie2 = {
          range: Y3,
          unitId: (K2 = Y3.unitId) != null ? K2 : f.getUnitId(),
          sheetName: S((J2 = Y3.unitId) != null ? J2 : f.getUnitId(), X2)
        }, fe2 = X2 !== r, ee3 = (f == null ? void 0 : f.getUnitId()) !== o, le2 = kt3([Ie2], i && (fe2 || ee3), C, ee3);
        D.unshift({ token: le2[0], nodeType: $e.REFERENCE });
        const Ee = sn(D);
        g(Ee, le2[0].length, I2);
      }
    else if (n.current === Te2.EDIT_OTHER_SHEET_REFERENCE || n.current === Te2.EDIT_OTHER_WORKBOOK_REFERENCE) {
      const Y3 = k.pop();
      if (!Y3) return;
      const X2 = D[R];
      if (typeof X2 == "object" && X2.nodeType === $e.REFERENCE) {
        const Ie2 = X2.token;
        (f == null ? void 0 : f.getUnitId()) !== o ? X2.token = Gc((nt2 = f == null ? void 0 : f.getUnitId()) != null ? nt2 : "", C, Y3) : X2.token = C === (_2 == null ? void 0 : _2.getName()) ? Ft(Y3) : Hc(_2.getName(), Y3);
        const ee3 = U2 + (X2.token.length - Ie2.length);
        g(ci(D), ee3, I2);
      }
    } else {
      const Y3 = [...k];
      ...
      const Ie2 = D.map((G2) => {
        ...
        if (typeof G2 == "string")
          return G2;
        if (G2.nodeType === $e.REFERENCE) {
          const Ve5 = Dr(G2.token);
          if (Ve5.sheetName || (Ve5.sheetName = C), (Ve5.unitId || o) !== (f == null ? void 0 : f.getUnitId()) || i && ((ge3 = E.current.activeSheet) == null ? void 0 : ge3.getName()) !== Ve5.sheetName)
            return G2.token;
          const oe = Y3[X2];
          if (X2++, !oe)
            return "";
          const be3 = (ot3 = oe.sheetId) != null ? ot3 : r, Tt3 = {
            range: oe,
            unitId: (Pe3 = oe.unitId) != null ? Pe3 : f.getUnitId(),
            sheetName: S((Ue2 = oe.unitId) != null ? Ue2 : f.getUnitId(), be3)
          }, Nt3 = (f == null ? void 0 : f.getUnitId()) !== o;
          return kt3([Tt3], i && (be3 !== r || Nt3), C, Nt3)[0];
        }
        return G2.token;
      });
      let fe2 = "", ee3;
      Ie2.forEach((G2, ge3) => {
        fe2 += G2, ge3 === R && (ee3 = fe2.length);
      });
      const le2 = [];
      for (let G2 = X2; G2 <= k.length - 1; G2++) {
        const ge3 = k[G2], ot3 = (rt2 = ge3.sheetId) != null ? rt2 : r, Pe3 = {
          range: ge3,
          unitId: (yt2 = ge3.unitId) != null ? yt2 : f.getUnitId(),
          sheetName: S((Re3 = ge3.unitId) != null ? Re3 : f.getUnitId(), ot3)
        }, Ue2 = (f == null ? void 0 : f.getUnitId()) !== o, oe = kt3([Pe3], i && (ot3 !== r || Ue2), C, Ue2);
        le2.push(oe[0]);
      }
      const Ee = D[D.length - 1], $e2 = Ee && (typeof Ee == "string" ? false : Ee.nodeType === $e.REFERENCE), Me2 = `${fe2}${le2.length && $e2 ? "," : ""}${le2.join(",")}`;
      g(Me2, !le2.length && ee3 ? ee3 : Me2.length, I2);
    }
  });
  (0, import_react.useEffect)(() => {
    if (y && e) {
  ...
  }, [e, N, y]), (0, import_react.useEffect)(() => {
    if (t && y && l) {
      const k = new ao(), I2 = () => {
        k.dispose(), y.getSelectionControls().forEach((w, D) => {
          k.add(
            w.selectionScaling$.subscribe((U2) => {
              const B2 = y.getSelectionDataWithStyle().map((ae) => ae.rangeWithCoord), ce = B2[D];
              U2.sheetId = ce.sheetId, U2.unitId = ce.unitId, B2[D] = U2, N(B2, false);
            })
          ), k.add(
            w.selectionMoving$.subscribe((U2) => {
              const B2 = y.getSelectionDataWithStyle().map((ae) => ae.rangeWithCoord), ce = B2[D];
              U2.sheetId = ce.sheetId, U2.unitId = ce.unitId, B2[D] = U2, N(B2, true);
            })
          );
        });
      }, x = merge(
  ...
  }, [l, t, N, y, F.selectionSet$]), y == null || y.getSelectionDataWithStyle(), (0, import_react.useEffect)(() => {
    if (c) {
      const k = d.onCommandExecuted((I2) => {
        var R;
        if (I2.id !== ie.id)
          return;
        const x = I2.params;
        if (x.extra === "formula-editor" && x.selections.length) {
          ...
          if (w) {
            const D = n.current === Te2.NEED_ADD, U2 = ((R = y == null ? void 0 : y.getSelectionDataWithStyle()) != null ? R : []).map((B2) => B2.rangeWithCoord);
            D ? U2.push(w.range) : U2[U2.length - 1] = w.range, N(U2, true);
          }
        }
      });
      return () => {
  ...
  }, [d, l, n, v2, c, N, y]), (0, import_react.useEffect)(() => {
    if (!l)
      return;
    const k = u.textSelection$.subscribe((I2) => {
      I2.unitId === l.getEditorId() && Ur3({
        unitId: o,
        subUnitId: r,
...
var hc = (e, t, n, o, r, s) => {
  const i = useDependency(Ls), c = useDependency(Ge), g = useDependency(ME).getRenderById(t), m3 = useDependency(vr), h = g == null ? void 0 : g.with(De2);
  (0, import_react.useEffect)(() => {
    if (e && h)
      if (n) {
        const d = () => {
          const v2 = h.getSelectionControls().length;
          for (let p = 1; p <= v2; p++)
            h.clearLastSelection();
          return setTimeout(() => {
            s();
          }, 30);
        }, u = i.onCommandExecuted((v2) => {
          v2.id === pn.id && d();
        }), a = m3.getCurrentTypeOfUnit$(we.UNIVER_SHEET).subscribe((v2) => {
          d();
        });
        return () => {
...
var fc = (e, t, n) => {
  const o = useDependency(ga), r = (0, import_react.useRef)(true);
  (0, import_react.useEffect)(() => {
    if (e) {
      const s = setTimeout(() => {
        r.current = false;
    ...
    if (!r.current && t) {
      ...
      t(s === 0 && n.startsWith(X.EQUALS), `${n}`);
    }
  }, [n, t]);
};
var gc = (e, t = [], n) => {
  const o = useDependency(Gt2), [r, s] = (0, import_react.useState)([]), [i, c] = (0, import_react.useState)(""), l = (0, import_react.useRef)(-1), g = tt3({ nodes: t }), m3 = () => {
    s([]), c(""), l.current = -1;
  };
  return (0, import_react.useEffect)(() => {
    if (n && e) {
      const d = n.input$.pipe(debounceTime(300)).subscribe(() => {
        const u = n.getSelectionRanges();
        if (u.length === 1) {
          const a = g.current.nodes, v2 = u[0];
          if (v2.collapsed) {
            const p = _n2(a, v2.startOffset - 1, false);
            l.current = p;
            const S = a[p];
            if (S && typeof S != "string" && S.nodeType === $e.FUNCTION) {
              l.current = p;
              const C = S.token, _2 = o.getSearchListByNameFirstLetter(C);
              s(_2), c(C);
              return;
            }
          }
    ...
    handlerFormulaReplace: (d, u) => {
      ...
      if (l.current !== -1) {
        const v2 = a.splice(l.current + 1), p = a.pop() || "";
        let S = (typeof p == "string" ? p.length : p.token.length) - d.length;
        return a.push(d), v2[0] !== K.OPEN_BRACKET && u !== yc.DefinedName && (a.push(K.OPEN_BRACKET), S--), { text: sn([...a, ...v2]), offset: S };
      }
    },
    reset: m3
  };
...
var pc = (0, import_react.forwardRef)(Sc);
function Sc(e, t) {
  const { isFocus: n, sequenceNodes: o, onSelect: r, editor: s, onClose: i = mc } = e, c = s.getEditorId(), l = useDependency(ye2), g = useDependency(Ls), { searchList: m3, searchText: h, handlerFormulaReplace: d, reset: u } = gc(n, o, s), a = (0, import_react.useMemo)(() => !!m3.length, [m3]), v2 = (0, import_react.useRef)(void 0), [p, S] = (0, import_react.useState)(0), C = (0, import_react.useRef)(false), [_2] = Pr2(c, a, [h, m3]), E = tt3({ searchList: m3, active: p }), f = (N, O) => {
    const k = d(N, O);
    k && (u(), r(k));
  };
  function b(N) {
  ...
  (0, import_react.useEffect)(() => {
    if (!m3.length)
      return;
    const N = `sheet.formula-embedding-editor.search_function.${c}`, O = new ao(), k = (I2) => {
    ...
    })), [q1.ARROW_UP, q1.ARROW_DOWN, q1.ENTER, q1.ESC, q1.TAB].map((I2) => ({
      id: N,
      binding: I2,
      preconditions: () => true,
      priority: 1e3,
  ...
  function A(N) {
    ...
    if (!k) return;
    const x = O.getBoundingClientRect().top, R = O.offsetHeight, w = k.getBoundingClientRect(), D = w.top, U2 = w.height;
    if (D >= 0 && D > x && D - x + U2 <= R)
      return;
    const B2 = k.offsetTop - (R - U2) / 2;
    O.scrollTo({
      top: B2,
      behavior: "smooth"
    });
  ...
  const F = (0, import_react.useMemo)(() => {
    let N = "";
    return () => {
      clearTimeout(N), C.current = true, N = setTimeout(() => {
        C.current = false;
      }, 300);
    };
  }, []);
  return m3.length > 0 && a && (0, import_jsx_runtime.jsx)(ot, { portal: true, anchorRect$: _2, direction: "vertical", children: (0, import_jsx_runtime.jsx)(
    "ul",
    {
      ref: (N) => {
        v2.current = N, t && (t.current = N);
      },
      "data-u-comp": "sheets-formula-editor",
      className: ie2("univer-m-0 univer-box-border univer-max-h-[400px] univer-w-[250px] univer-list-none univer-overflow-y-auto univer-rounded-lg univer-bg-white univer-p-2 univer-leading-5 univer-shadow-md univer-outline-none dark:!univer-bg-gray-900", kt2, pr),
      children: m3.map((N, O) => (0, import_jsx_runtime.jsxs)(
        "li",
        {
          ...
          children: [
            (0, import_jsx_runtime.jsxs)("span", { className: "univer-block univer-truncate univer-text-xs", children: [
              (0, import_jsx_runtime.jsx)("span", { className: "univer-text-red-500", children: N.name.substring(0, h.length) }),
              (0, import_jsx_runtime.jsx)("span", { children: N.name.slice(h.length) })
            ] }),
            (0, import_jsx_runtime.jsx)(
              "span",
              {
...
var vc = (e) => e.startsWith(X.EQUALS) ? e.slice(1) : "";
var Qn = () => {
};
var Cc = (0, import_react.forwardRef)((e, t) => {
  var En2, bn, yn, Tn;
  const {
    errorText: n,
    initValue: o,
    ...
    editorId: u,
    moveCursor: a = true,
    onFormulaSelectingChange: v2,
    keyboardEventConfig: p,
    onMoveInEditor: S,
    resetSelectionOnBlur: C = true,
    autoScrollbar: _2 = true,
    isSingle: E = true,
    disableSelectionOnClick: f = false,
    autofocus: b = true,
    disableContextMenu: y,
    style: A
  } = e, F = useDependency(Ge), N = (0, import_react.useRef)(null), O = re(m3);
  (0, import_react.useImperativeHandle)(t, () => ({
    isClickOutSide: (Z3) => N.current ? !N.current.contains(Z3.target) : false
  }));
  const k = re(v2), I2 = (0, import_react.useRef)(null), x = (0, import_react.useRef)(void 0), R = x.current, [w, D] = (0, import_react.useState)(i), U2 = (0, import_react.useRef)(null), B2 = (0, import_react.useMemo)(() => u != null ? u : VC(`${q0}-${et(4)}`), []), ce = (0, import_react.useMemo)(() => n !== void 0, [n]), ae = useDependency(vr), he2 = ae.getUnit(B2);
  useObservable(he2 == null ? void 0 : he2.change$);
  const K2 = ec(), J2 = Je.transform.getPlainText((bn = (En2 = he2 == null ? void 0 : he2.getBody()) == null ? void 0 : En2.dataStream) != null ? bn : ""), nt2 = tt3(J2), rt2 = (0, import_react.useMemo)(() => vc(J2), [J2]), yt2 = (0, import_react.useMemo)(() => K2(rt2), [rt2, K2]), { isSelecting: Re3, isSelectingRef: Y3 } = Ji2({ unitId: r, subUnitId: s, editorId: B2, isFocus: w, disableOnClick: f }), X2 = (0, import_react.useRef)(""), fe2 = useDependency(ME).getRenderById(B2), ee3 = fe2 == null ? void 0 : fe2.with(Re), le2 = ee3 == null ? void 0 : ee3.isFocusing, Ee = (0, import_react.useMemo)(() => ae.getCurrentTypeOfUnit$(we.UNIVER_DOC), [ae]), $e2 = useObservable(Ee), Me2 = ($e2 == null ? void 0 : $e2.getUnitId()) === B2, G2 = (0, import_react.useRef)([]), ge3 = Re3, Pe3 = (Tn = (yn = useDependency(ic).getConfig(yr2)) == null ? void 0 : yn.functionScreenTips) != null ? Tn : true;
  zi(() => {
    O(J2);
  }, [J2, O]);
  const Ue2 = Vr2("="), Ve5 = nc(r, s), oe = re((Z3, se2 = true, we5, ye3) => {
    if (!x.current) return;
    X2.current = Z3;
    const Ot = Z3[0] === "=" ? Z3.slice(1) : "", ke2 = K2(Ot), qr3 = ke2.reduce((We2, Mt3) => typeof Mt3 == "object" ? `${We2}${Mt3.token}` : `${We2}${Mt3}`, ""), xt3 = Ue2(
      x.current,
      qr3 === Ot ? ke2 : [],
      se2,
      ye3
    );
    if (G2.current = xt3, we5) {
      const We2 = ye3 != null ? ye3 : R == null ? void 0 : R.getSelectionRanges();
      if ((We2 == null ? void 0 : We2.length) !== 1)
        return;
      const jr = We2[0].startOffset - 1, Kr = _n2(ke2, jr, false), Nn = $r(ke2, Kr);
      if (Nn >= 0) {
        const On2 = xt3.splice(Nn, 1)[0];
        On2 && xt3.push(On2);
      }
      Ve5(w ? xt3 : [], x.current);
    }
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (w) {
      if (X2.current === J2) return;
      oe(J2, false, true);
    }
  }, [J2]), fc(w, h, J2);
  const be3 = Xi2(R), Tt3 = cc(w, r, s);
  (0, import_react.useEffect)(() => {
    var Z3;
    k(Re3, (Z3 = ee3 == null ? void 0 : ee3.isFocusing) != null ? Z3 : true);
  }, [k, Re3]), Bf(w, p, R), (0, import_react.useLayoutEffect)(() => {
    let Z3;
    if (U2.current) {
      Z3 = F.register({
        autofocus: b,
...
`,
      ...
      const se2 = F.getEditor(B2);
      x.current = se2, oe(o, false, true);
    }
    return () => {
      Z3 == null || Z3.dispose();
    };
  }, []), (0, import_react.useLayoutEffect)(() => {
    i ? (D(i), be3()) : (C && (R == null || R.blur(), Tt3()), D(i));
  }, [i, R, be3, Tt3, C]);
  const { checkScrollBar: Nt3 } = Mf(R, E, _2);
  ic2(w, !!(Re3 && Me2), r, B2, y), sc(!!(w && le2 && a), ge3, R, S);
  const Rn = re((Z3, se2, we5) => {
    if (!le2)
      return;
    const ye3 = se2 !== -1 ? [{ startOffset: se2 + 1, endOffset: se2 + 1, collapsed: true }] : void 0;
    oe(`=${Z3}`, true, we5, ye3), we5 && (be3(), se2 !== -1 && setTimeout(() => {
      const Ot = { startOffset: se2 + 1, endOffset: se2 + 1 }, ke2 = R == null ? void 0 : R.render.with(uo3);
      ke2 == null || ke2.scrollToRange({ ...Ot, collapsed: true });
    }, 50), Nt3());
  });
  dc(
    w && !!(Re3 && Me2),
    ...
    R,
    Rn
  ), hc(w && !!(Re3 && Me2), r, c, D, g, () => {
    oe(nt2.current, false, true);
  });
  const In = (Z3) => {
    if (Z3) {
      const se2 = R == null ? void 0 : R.getSelectionRanges();
      if (se2 && se2.length === 1) {
        const we5 = se2[0];
        if (we5.collapsed) {
          const ye3 = Z3.offset;
          setTimeout(() => {
            R == null || R.setSelectionRanges([{ startOffset: we5.startOffset - ye3, endOffset: we5.endOffset - ye3 }]);
          }, 30);
        }
      }
      be3(), oe(`=${Z3.text}`);
  ...
  return (0, import_jsx_runtime.jsxs)("div", { className: d, children: [
    (0, import_jsx_runtime.jsx)(
      "div",
      {
        ref: N,
    ...
    n !== void 0 && (0, import_jsx_runtime.jsx)("div", { className: "univer-my-1 univer-text-xs univer-text-red-500", children: n }),
    Pe3 && R && rt2 !== "" && (0, import_jsx_runtime.jsx)(
      zi3,
      {
        editor: R,
        isFocus: w,
    ...
    Pe3 && !!R && (0, import_jsx_runtime.jsx)(
      pc,
      {
        isFocus: w,
        sequenceNodes: yt2,
...
function _c(e, t, n, o) {
  const r = useDependency(ga), s = Vr2(""), i = useObservable(e == null ? void 0 : e.getDocumentDataModel().change$), [c, l] = (0, import_react.useState)([]), g = useDependency(Wi2), m3 = (0, import_react.useRef)(""), h = useDependency(vr);
  return (0, import_react.useEffect)(() => {
    if (!e) return;
    ...
    l(u != null ? u : []);
  }, [i, e, r]), (0, import_react.useEffect)(() => {
    var a, v2;
    if (!e) return;
    if (!t) {
      ...
      e.setDocumentData({
        ...
        body: {
          ...p.body,
          dataStream: (v2 = (a = p.body) == null ? void 0 : a.dataStream) != null ? v2 : "",
          textRuns: []
        }
      });
      return;
    }
    const d = s(e, c, false), u = new ao();
    return d.forEach((p) => {
      const S = Dr(p.token), C = h.getCurrentUnitForType(we.UNIVER_SHEET), _2 = C == null ? void 0 : C.getActiveSheet();
      if (!S.sheetName && o !== (_2 == null ? void 0 : _2.getSheetId()) || S.sheetName && (_2 == null ? void 0 : _2.getName()) !== S.sheetName)
        return;
      const E = new bt(p.themeColor).toRgb(), f = g.addShape({
        range: S.range,
        style: {
          stroke: p.themeColor,
...
function Rc(e) {
  const t = useDependency(z), { supportAcrossSheet: n = false, keepSheetReference: o = false, unitId: r, subUnitId: s, onChange: i } = e, l = useDependency(vr).getUnit(r, we.UNIVER_SHEET), g = re(i), m3 = re((h, d) => {
    const u = l == null ? void 0 : l.getActiveSheet();
    if (!u || !n && u.getSheetId() !== s || !(h != null && h.length)) return;
    const a = o ? u.getName() : u.getSheetId() === s ? "" : u.getName(), v2 = h.map((p) => ({
      range: p.range,
      unitId: r,
      sheetName: a
    }));
  ...
  }, [m3, t.selectionMoveEnd$, t.selectionMoveStart$, t.selectionMoving$]);
}
var Jn = (e) => !e.some((n) => {
  if (typeof n == "string") {
    if (n !== K.COMMA)
      return true;
  } else if (n.nodeType !== $e.REFERENCE)
    return true;
  return false;
});
var Ic = (e) => {
...
function Ec(e) {
  const {
    ...
    onConfirm: l,
    onClose: g,
    onShowBySelection: m3
  } = e, h = useDependency(Fn), d = useDependency(ga), [u, a] = (0, import_react.useState)([]), [v2, p] = (0, import_react.useState)(0), S = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
    if (t && n.length) {
      const f = n.map((b) => b.sheetName ? Hc(b.sheetName, b.range) : Ft(b.range));
      a(f), p(f.length - 1);
    } else
      a([""]), p(0);
  }, [t]);
  ...
  return Rc({
    ...
    onChange: (f, b) => {
      if (!t && m3 != null && m3(f))
        return;
      const y = new Set(u), A = f.map((O) => O.sheetName ? Hc(O.sheetName, O.range) : Ft(O.range)), F = A.filter((O) => !y.has(O));
      if (!F.length) return;
      const N = [...u];
      if (A.length > 1) {
        b || N.splice(v2, 1), N.push(...F);
        const O = N.slice(0, s);
    ...
    kd,
    {
      ...
      mask: false,
      maskClosable: false,
      footer: (0, import_jsx_runtime.jsxs)("footer", { className: "univer-flex univer-gap-2", children: [
        (0, import_jsx_runtime.jsx)(vr2, { onClick: g, children: h.t("rangeSelector.cancel") }),
        (0, import_jsx_runtime.jsx)(
          vr2,
          {
            variant: "primary",
            onClick: () => {
              l(
                u.filter((f) => {
                  ...
                  return b && b.length === 1 && typeof b[0] != "string" && b[0].nodeType === $e.REFERENCE;
                }).map((f) => Dr(f)).map((f) => ({ ...f, range: Ic(f.range) }))
              );
            },
      ...
      children: (0, import_jsx_runtime.jsxs)(
        ...
        {
          ref: S,
          className: ie2("-univer-mx-6 univer-max-h-60 univer-overflow-y-auto univer-px-6", pr),
          children: [
            u.map((f, b) => (0, import_jsx_runtime.jsxs)(
              "div",
              {
                ...
                children: [
                  (0, import_jsx_runtime.jsx)(
                    Vx,
                    {
                      className: ie2("univer-w-full", {
                        "univer-border-primary-600": v2 === b
                      }),
                  ...
                  u.length > 1 && (0, import_jsx_runtime.jsx)(
                    kr3,
                    {
            ...
            u.length < s && (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsxs)(vr2, { variant: "link", onClick: _2, children: [
              (0, import_jsx_runtime.jsx)(Ar3, {}),
              (0, import_jsx_runtime.jsx)("span", { children: h.t("rangeSelector.addAnotherRange") })
            ] }) })
          ]
        }
      )
...
function bc(e) {
  return e.split(K.COMMA).filter((t) => !!t).map((t) => Dr(t));
}
function yc2(e) {
  return e.map((t) => t.sheetName ? Hc(t.sheetName, t.range) : Ft(t.range)).join(K.COMMA);
}
function Wr(e) {
  const [t, n] = (0, import_react.useState)(null), {
    ...
    onClickOutside: u,
    onFocusChange: a,
    forceShowDialogWhenSelectionChanged: v2,
    hideEditor: p,
    resetRange: S
  } = e, [C, _2] = (0, import_react.useState)(m3 != null ? m3 : false), [E, f] = (0, import_react.useState)(false), [b, y] = (0, import_react.useState)([]), A = useDependency(Fn), F = useDependency(Ge), { sequenceNodes: N } = _c(t, C, s, i), O = tt3(N), k = useDependency(Ls), I2 = re(() => {
    t == null || t.setSelectionRanges([]), t == null || t.blur(), F.blur();
  }), x = re(() => {
    var R;
    I2(), y(bc((R = t == null ? void 0 : t.getDocumentDataModel().getPlainText()) != null ? R : "")), f(true);
  });
  return (0, import_react.useEffect)(() => {
    r && (r.current = {
      get editor() {
  ...
  }, [I2, t, F, r, O]), (0, import_react.useEffect)(() => {
    var R;
    ...
    p ? null : (0, import_jsx_runtime.jsx)(
      Jf,
      {
        ...
        editorRef: n,
        onClickOutside: () => {
          _2(false), I2(), u == null || u();
        },
        icon: (0, import_jsx_runtime.jsx)(Rp, { title: A.t("rangeSelector.buttonTooltip"), placement: "bottom", children: (0, import_jsx_runtime.jsx)(
          Dr3,
          {
    ...
    (0, import_jsx_runtime.jsx)(
      Ec,
      {
        ...
        maxRangeCount: c,
        onConfirm: (R) => {
          const w = yc2(R), D = Pn.newEmptyData();
          D.body.dataStream = w, t == null || t.replaceText(w, false), h == null || h(D, w), f(false), y([]), requestAnimationFrame(() => {
            I2();
          });
        },
        onClose: () => {
        ...
        supportAcrossSheet: l,
        keepSheetReference: g,
        onShowBySelection: (R) => C || v2 ? (y(R), f(true), false) : true
      }
    )
  ] });
}
var Tc = () => {
  var o, r;
  const e = useDependency(Lr2), t = useObservable(e.currentSelector$), n = (0, import_react.useRef)(null);
  return (0, import_react.useEffect)(() => {
    var s, i;
    if (t)
    ...
    Wr,
    {
      ...
      onChange: (s, i) => {
        var c;
        t == null || t.callback((c = i == null ? void 0 : i.split(",").map((l) => Dr(l))) != null ? c : []);
      }
    }
  );
};
...
var xc = (e, t, n) => t in e ? Nc(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var Mc = (e, t, n, o) => {
  for (var r = o > 1 ? void 0 : o ? Oc(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (r = i(r) || r);
  return r;
};
var At2 = (e, t) => (n, o) => t(n, o, e);
var Hr3 = (e, t, n) => xc(e, typeof t != "symbol" ? t + "" : t, n);
var Bt = class extends Ol {
  constructor(e = Gn, t, n, o, r) {
    ...
    s && this._configService.setConfig("menu", s, { merge: true }), this._configService.setConfig(yr2, i, { merge: true });
  }
  onStarting() {
    GC(this._injector, [
      [Zt, { useClass: rn }],
  ...
  onSteady() {
    this._injector.get(Pt3), this._injector.get($t);
  }
  _initUIPart() {
    const e = this._injector.get(S1);
    this.disposeWithMe(e.register(hm, Wr)), this.disposeWithMe(e.register(Ld, Cc)), this.disposeWithMe(this._uiPartsService.registerComponent(c1.GLOBAL, () => connectInjector(Tc, this._injector)));
  }
};
Hr3(Bt, "pluginName", Ir2);
Hr3(Bt, "type", we.UNIVER_SHEET);
Bt = Mc([
  qR(Wi, ot2),
  At2(1, Inject(Injector)),
  At2(2, ME),
  At2(3, ic),
  At2(4, D1)
], Bt);
...
//# sourceMappingURL=chunk-ZD4XOXVC.js.map
