...
function di(r) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex univer-h-full univer-flex-col", children: [
    ...
    (0, import_jsx_runtime.jsx)(
      "div",
      {
        className: ie2("univer-mt-2 univer-box-border univer-flex univer-h-[180px] univer-max-h-[180px] univer-flex-grow univer-flex-col univer-overflow-hidden univer-rounded-md univer-py-1.5 univer-pl-2", kt),
        children: (0, import_jsx_runtime.jsx)(
          "div",
          {
            className: ie2("univer-h-40 univer-overflow-y-auto univer-py-1 univer-pl-2", pr),
...
var Ci = () => {
  ...
  return w ? (0, import_jsx_runtime.jsx)("div", { className: "univer-absolute univer-z-50 univer-h-0 univer-w-0", children: h.map((b2) => {
    ...
    return (0, import_jsx_runtime.jsxs)(
      "div",
      {
        className: ie2("univer-shadow-xs univer-absolute univer-box-border univer-cursor-pointer univer-items-center univer-rounded-xl univer-pl-2 univer-pr-2", kt, {
          "univer-flex": !Pe2,
          "univer-hidden": Pe2
        }),
        style: {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    (0, import_jsx_runtime.jsx)("div", { className: "univer-flex univer-gap-2", children: E.map((p) => {
      ...
      return (0, import_jsx_runtime.jsxs)(
        "div",
        {
          className: ie2("univer-h-10 univer-w-8 univer-cursor-pointer univer-border univer-border-solid univer-border-gray-200 univer-p-px [&>div]:univer-box-border [&>div]:univer-h-2.5", {
    ...
    (0, import_jsx_runtime.jsxs)("div", { className: ie2("univer-w-full univer-rounded-sm", kt), children: [
      (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex univer-flex-wrap univer-gap-2 univer-p-2", children: [
        (0, import_jsx_runtime.jsx)(
          "div",
          {
            className: ie2("univer-h-10 univer-w-8 univer-cursor-pointer univer-p-px univer-text-center univer-leading-10", kt),
            onClick: V3,
            children: "+"
          }
        ),
        C2.map((p) => {
          ...
          return (0, import_jsx_runtime.jsxs)(
            "div",
            {
              className: ie2("univer-relative univer-h-10 univer-w-8 univer-cursor-pointer univer-border univer-border-solid univer-border-gray-200 univer-p-px", {
                "univer-border-blue-500": p === S3.theme
              }),
              onClick: () => Y(p),
              onMouseEnter: () => L(p),
        ...
        (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex univer-flex-col univer-gap-2 univer-p-2", children: [
          (0, import_jsx_runtime.jsxs)("div", { className: "univer-flex univer-h-9 univer-gap-2", children: [
            (0, import_jsx_runtime.jsx)(
              "div",
              {
                className: ie2("univer-box-border univer-h-full univer-w-52 univer-rounded-sm univer-text-center univer-leading-9", kt, {
            ...
            (0, import_jsx_runtime.jsx)(
              vf,
              {
                ...
                children: (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    className: ie2("univer-flex univer-cursor-pointer univer-items-center univer-gap-2 univer-rounded-sm univer-bg-white univer-p-1", kt),
                    children: [
                      (0, import_jsx_runtime.jsx)(
                        "div",
                        {
                          className: ie2("univer-h-4 univer-w-4 univer-rounded-lg univer-bg-gray-400", kt, {
                            "univer-text-white": ue3,
                            "univer-text-gray-900": !ue3
                          }),
                          style: {
