...
// node_modules/@univerjs/sheets-conditional-formatting/lib/es/index.js
var X2 = Object.defineProperty;
var K2 = (s, r, t) => r in s ? X2(s, r, { enumerable: true, configurable: true, writable: true, value: t }) : s[r] = t;
var m = (s, r, t) => K2(s, typeof r != "symbol" ? r + "" : r, t);
var Z2 = "SHEET_CONDITIONAL_FORMATTING_PLUGIN";
var L = ((s) => (s.beginsWith = "beginsWith", s.endsWith = "endsWith", s.containsText = "containsText", s.notContainsText = "notContainsText", s.equal = "equal", s.notEqual = "notEqual", s.containsBlanks = "containsBlanks", s.notContainsBlanks = "notContainsBlanks", s.containsErrors = "containsErrors", s.notContainsErrors = "notContainsErrors", s))(L || {});
var k = ((s) => (s.today = "today", s.yesterday = "yesterday", s.tomorrow = "tomorrow", s.last7Days = "last7Days", s.thisMonth = "thisMonth", s.lastMonth = "lastMonth", s.nextMonth = "nextMonth", s.thisWeek = "thisWeek", s.lastWeek = "lastWeek", s.nextWeek = "nextWeek", s))(k || {});
var F = ((s) => (s.greaterThan = "greaterThan", s.greaterThanOrEqual = "greaterThanOrEqual", s.lessThan = "lessThan", s.lessThanOrEqual = "lessThanOrEqual", s.notBetween = "notBetween", s.between = "between", s.equal = "equal", s.notEqual = "notEqual", s))(F || {});
var S = ((s) => (s.highlightCell = "highlightCell", s.dataBar = "dataBar", s.colorScale = "colorScale", s.iconSet = "iconSet", s))(S || {});
var A = ((s) => (s.uniqueValues = "uniqueValues", s.duplicateValues = "duplicateValues", s.rank = "rank", s.text = "text", s.timePeriod = "timePeriod", s.number = "number", s.average = "average", s.formula = "formula", s))(A || {});
var I = ((s) => (s.num = "num", s.min = "min", s.max = "max", s.percent = "percent", s.percentile = "percentile", s.formula = "formula", s))(I || {});
var V1 = "#fff";
var O1 = "#000000";
var $1 = () => ({
  cfId: void 0,
...
var q1 = (s, r) => s.id === r.id && s.type === r.type;
var b0 = () => `${et(8)}`;
var M = class {
  constructor() {
...
var i2 = {
  ...
  handler(s, r) {
    ...
    return s.get(M).moveRulePriority(t, e, n, i), true;
  }
};
var L0 = (s) => {
...
var K = {
  ...
  handler(s, r) {
    ...
    return s.get(M).deleteRule(t, e, n), true;
  }
};
var H2 = (s, r) => ({ id: K.id, params: { unitId: r.unitId, subUnitId: r.subUnitId, cfId: r.rule.cfId } });
var a2 = {
  type: Ms.MUTATION,
  ...
  handler(s, r) {
    ...
    return s.get(M).addRule(t, e, n), true;
  }
};
var k0 = {
  type: Ms.COMMAND,
  ...
  handler(s, r) {
    if (!r)
      return false;
    const { rule: t } = r, e = s.get(Qo), n = s.get(Ls), i = s.get(M), a = s.get(vr), u = P(a, r);
    if (!u) return false;
...
var o2 = {
  ...
  handler(s, r) {
    ...
    return s.get(M).setRule(t, e, n, i), true;
  }
};
var j2 = (s, r) => {
...
var B0 = {
  ...
  handler(s, r) {
    ...
    if (!r)
      return false;
    const t = s.get(M), e = s.get(vr), n = s.get(Ls), i = s.get(Qo), a = s.get(z), u = P(e, r);
    if (!u) return false;
...
var N0 = {
  ...
  handler(s, r) {
    const t = s.get(M), e = s.get(vr), n = s.get(Ls), i = s.get(Qo), a = P(e, r);
    if (!a) return false;
    const { unitId: u, subUnitId: o } = a, l = t.getSubunitRules(u, o);
    if (!(l != null && l.length))
      return false;
    const d = l.map((D) => ({ cfId: D.cfId, unitId: u, subUnitId: o })), c = d.map((D) => ({ id: K.id, params: D })), g = d.map((D) => w2(s, D)[0]), h = fo(c, n).result;
...
var U0 = {
  ...
  handler(s, r) {
    if (!r)
      return false;
    const t = s.get(Qo), e = s.get(Ls), n = s.get(vr), i = P(n, r);
    if (!i) return false;
...
var T0 = {
  ...
  handler(s, r) {
    if (!r)
      return false;
    const t = s.get(Qo), e = s.get(Ls), n = s.get(vr), i = s.get(M), a = P(n, r);
    if (!a) return false;
...
var E2 = (s, r) => (t, e) => r(t, e, s);
var N = ((s) => (s[s.NOT_REGISTER = 1] = "NOT_REGISTER", s[s.SUCCESS = 2] = "SUCCESS", s[s.WAIT = 3] = "WAIT", s[s.ERROR = 4] = "ERROR", s))(N || {});
var P0 = (s) => {
  const r = s && s[0] && s[0][0];
  return (r == null ? void 0 : r.t) === fn.BOOLEAN ? r.v === ie.TRUE || r.v === true : r ? r.v : false;
};
var z2 = class extends Ve {
  constructor(r, t, e) {
    super();
    m(this, "_formulaMap", /* @__PURE__ */ new Map());
    m(this, "_result$", new Subject());
        ...
        for (const e in t.unitOtherData)
          for (const n in t.unitOtherData[e])
            for (const i in t.unitOtherData[e][n]) {
              const a = new pt(t.unitOtherData[e][n][i]), u = this._ensureSubunitFormulaMap(e, n).getValue(i, ["formulaId"]);
              if (!u)
                continue;
              const o = u.ranges;
              if (!o)
  ...
  _ensureSubunitFormulaMap(r, t) {
    ...
    let n = e.get(t);
    return n || (n = new pR([], ["formulaId", "id"]), e.set(t, n)), n;
  }
  ...
  registerFormulaWithRange(r, t, e, n, i = [{ startRow: 0, endRow: 0, startColumn: 0, endColumn: 0 }]) {
    ...
    this._commandService.executeCommand(ha.id, l, { onlyLocal: true }).then(() => {
      this._commandService.executeCommand(h2.id, { [r]: { [t]: { [o]: true } } }, { onlyLocal: true });
    });
  }
  _removeFormulaByCfId(r, t, e) {
    const i = this.deleteCache(r, t, e).map((a) => a.formulaId);
    this._commandService.executeCommand(ma.id, { unitId: r, subUnitId: t, formulaIdList: i }, { onlyLocal: true });
  }
...
var V = ((s) => (s.preComputingStart = "preComputingStart", s.preComputing = "preComputing", s.preComputingEnd = "preComputingEnd", s.preComputingError = "preComputingError", s))(V || {});
var F2 = class {
  constructor(r) {
    m(this, "_cache");
    m(this, "_preComputingStatus$", new BehaviorSubject(
      "preComputingStart"
      /* preComputingStart */
    ));
    m(this, "preComputingStatus$", this._preComputingStatus$.asObservable().pipe(distinctUntilChanged()));
    m(this, "_preComputingCache");
    m(this, "_rule");
    this._context = r, this._cache = new gs(r.limit), this._rule = r.rule, this._preComputingCache = null, this._initClearCacheListener();
  }
  setCacheLength(r) {
    this._cache.limit = r;
  }
...
var W0 = class extends F2 {
  preComputing(r, t, e) {
    const n = e.rule, i = e.worksheet, a = new pt();
    !n.rule.config.every((d) => d.value.type === I.num) && R2(n.ranges, i.getMaxRows() - 1, i.getMaxColumns() - 1).forEach((c) => {
      Or.foreach(c, (g, h) => {
        ...
        if (!B(f) && (D == null ? void 0 : D.t) === fn.NUMBER) {
          const w = Number(f);
    ...
    const o = [...n.rule.config].sort((d, c) => d.index - c.index).map((d) => ({
      ...
      color: new bt(d.color)
    }));
    if (!o.some((d) => KT(d.value) ? d.value.status !== N.SUCCESS : false)) {
...
var q0 = "sheet-conditional-rule-data-bar";
var L2 = "#ffbe38";
var k2 = "#abd91a";
var Z0 = "#000";
var G0 = 34;
...
var j0 = class extends C3 {
  ...
  draw(t, e, n, i) {
    ...
    t.save(), Or.foreach(n.rowColumnSegment, (o, l) => {
      if (!a.getRowVisible(o) || !a.getColVisible(l))
        return;
      const d = n.getCellWithCoordByIndex(o, l, false), { isMerged: c, isMergedMainCell: g, mergeInfo: h } = d;
      let D = a.getCell(o, l);
      ...
      const { color: f, value: w, startPoint: p, isGradient: y } = D.dataBar, { startX: E, endX: R, startY: b, endY: v2 } = c || g ? h : d, l2 = R - E, p22 = v2 + p2 - b, Z = l2 - this._paddingRightAndLeft * 2, I2 = p22 - this._paddingTopAndBottom * 2;
      if (w > 0) {
        const $ = Math.max(Z * (1 - p / 100) * w / 100, 1), G3 = E + this._paddingRightAndLeft + p / 100 * Z, H = b + this._paddingTopAndBottom;
        if (y) {
          const j = t.createLinearGradient(G3, H, G3 + $, H);
          j.addColorStop(0, f), j.addColorStop(1, "rgb(255 255 255)"), t.fillStyle = j, t.strokeStyle = f, t.lineWidth = 1;
        } else
          t.fillStyle = f;
        this._drawRectWithRoundedCorner(t, G3, H, $, I2, false, true, true, false), y && t.stroke();
      } else {
        const $ = Math.max(Z * p / 100 * Math.abs(w) / 100, 1), G3 = E + this._paddingRightAndLeft + p / 100 * Z - $, H = b + this._paddingTopAndBottom;
        if (y) {
          const j = t.createLinearGradient(G3, H, G3 + $, H);
          j.addColorStop(0, "rgb(255 255 255)"), j.addColorStop(1, f), t.fillStyle = j, t.strokeStyle = f, t.lineWidth = 1;
        } else
          t.fillStyle = f;
        this._drawRectWithRoundedCorner(t, G3, H, $, I2, true, false, false, true), y && t.stroke();
      }
    }), t.restore();
  }
...
q3.add(j0);
var c2 = (s) => Math.max(Math.min(100, s), 0);
var X0 = (s, r, t) => {
  const e = t(s, r);
  if (e && e.t === fn.NUMBER) {
    const n = Number(e.v);
...
var K0 = class extends F2 {
  preComputing(r, t, e) {
    const n = e.rule, i = n.rule, a = e.worksheet, u = new pt();
    ![n.rule.config.max, n.rule.config.min].every((h) => h.type === I.num) && R2(n.ranges, a.getMaxRows() - 1, a.getMaxColumns() - 1).forEach((D) => {
      Or.foreach(D, (f, w) => {
        ...
        if (!B(y) && (p == null ? void 0 : p.t) === fn.NUMBER) {
          const E = Number(y);
...
var Y0 = class extends F2 {
        ...
        case A.average: {
          ...
          return i.forEach((d) => {
            Or.foreach(d, (c, g) => {
              ...
              h && h.t === fn.NUMBER && D !== void 0 && (o += Number(D) || 0, l++);
            });
        ...
        case A.rank: {
          ...
          i.forEach((c) => {
            Or.foreach(c, (g, h) => {
              ...
              D && D.t === fn.NUMBER && f !== void 0 && o.push(Number(f) || 0);
            });
          }), o.sort((c, g) => g - c);
          const l = e.rule.rule;
          if (l.isPercent) {
        ...
        case A.timePeriod:
          switch (n.operator) {
            case k.last7Days:
              return {
                value: {
                  start: tn().subtract(7, "day").valueOf(),
                  end: tn().valueOf()
                },
                type: n.subType
              };
            case k.lastMonth:
              return {
                value: {
                  start: tn().startOf("month").subtract(1, "month").valueOf(),
                  end: tn().endOf("month").subtract(1, "month").valueOf()
                },
                type: n.subType
              };
            case k.lastWeek:
              return {
                value: {
                  start: tn().startOf("week").subtract(1, "week").valueOf(),
                  end: tn().endOf("week").subtract(1, "week").valueOf()
                },
                type: n.subType
              };
            case k.nextMonth:
              return {
                value: {
                  start: tn().startOf("month").add(1, "month").valueOf(),
                  end: tn().endOf("month").add(1, "month").valueOf()
                },
                type: n.subType
              };
            case k.nextWeek:
              return {
                value: {
                  start: tn().startOf("week").add(1, "week").valueOf(),
                  end: tn().endOf("week").add(1, "week").valueOf()
                },
                type: n.subType
              };
            case k.thisMonth:
              return {
                value: {
                  start: tn().startOf("month").valueOf(),
                  end: tn().endOf("month").valueOf()
                },
                type: n.subType
              };
            case k.thisWeek:
              return {
                value: {
                  start: tn().startOf("week").valueOf(),
                  end: tn().endOf("week").valueOf()
                },
                type: n.subType
              };
            case k.today:
              return {
                value: {
                  start: tn().startOf("day").valueOf(),
                  end: tn().endOf("day").valueOf()
                },
                type: n.subType
              };
            case k.tomorrow:
              return {
                value: {
                  start: tn().startOf("day").add(1, "day").valueOf(),
                  end: tn().endOf("day").add(1, "day").valueOf()
                },
                type: n.subType
              };
            case k.yesterday:
              return {
                value: {
                  start: tn().startOf("day").subtract(1, "day").valueOf(),
                  end: tn().endOf("day").subtract(1, "day").valueOf()
                },
                type: n.subType
              };
          }
  ...
  getCellResult(r, t, e, n) {
    ...
    return (() => {
      switch (a.subType) {
        case A.number: {
          const l = i && Number(i.v), d = (i == null ? void 0 : i.t) === fn.NUMBER, c = a;
        ...
        case A.timePeriod: {
          const l = W(i);
          if (B(l) || Number.isNaN(Number(l)) || (i == null ? void 0 : i.t) !== fn.NUMBER || !e)
            return;
          const d = n1(Number(l)), { start: c, end: g } = e.value;
          return d >= c && d <= g;
        }
        case A.average: {
          const l = i && i.v, d = Number(l), c = (i == null ? void 0 : i.t) === fn.NUMBER, g = a;
          if (!c)
        ...
        case A.rank: {
          ...
          if (B(l) || Number.isNaN(d) || (i == null ? void 0 : i.t) !== fn.NUMBER || !e)
            return false;
          const c = e.value;
        ...
        case A.uniqueValues: {
          const l = W(i);
          return B(l) || !e ? false : e.value.get(l) === 1;
        }
        case A.duplicateValues: {
          const l = W(i);
          return B(l) || !e ? false : e.value.get(l) !== 1;
        ...
        case A.formula: {
          ...
          return l ? l.getValue(r, t) === true : false;
        }
      }
    })() ? a.style : {};
  }
...
var z0 = class extends F2 {
  preComputing(r, t, e) {
    const n = e.rule.rule, i = e.worksheet, a = new pt();
  ...
  getCellResult(r, t, e, n) {
    ...
    if (i === null)
      return;
    const a = n.rule.rule, u = a.isShowValue === void 0 ? true : !!a.isShowValue;
...
var u2 = (s, r) => (t, e) => r(t, e, s);
var A2 = 1e3 * 3 * 3;
var Q = class extends Ve {
  constructor(r, t, e, n) {
    super();
    m(this, "_calculateUnitManagers", /* @__PURE__ */ new Map());
    m(this, "_rTreeManager", new QR());
    m(this, "_cellCache", new gs(A2));
    m(this, "_markDirty$", new Subject());
    m(this, "markDirty$", this._markDirty$.asObservable());
    m(this, "_markRuleDirtyAtOnce", (r3, t2, e2, n2 = true) => {
      if (this._cellCache.clear(), n2) {
        const a = this._ensureCalculateUnitManager(r3, t2).get(e2);
    ...
    m(this, "markRuleDirty", (() => {
      const r3 = new Subject();
      return this.disposeWithMe(r3.pipe(bufferTime(100), filter((t2) => !!t2.length), map((t2) => {
        const e2 = /* @__PURE__ */ new Set(), n2 = [];
        return t2.forEach((i) => {
          const a = `${i.unitId}_${i.subUnitId}_${i.cfId}`;
          if (e2.has(a)) {
            if (i.isNeedResetPreComputingCache) {
              const u = n2.find((o) => o.cfId === i.cfId);
              u.isNeedResetPreComputingCache = true;
            }
            return;
          }
          e2.add(a), n2.push({ ...i });
        ...
        t2.forEach((e2) => {
          this._markRuleDirtyAtOnce(e2.unitId, e2.subUnitId, e2.cfId, e2.isNeedResetPreComputingCache);
        });
      })), (t2, e2, n2, i = true) => {
        r3.next({ unitId: t2, subUnitId: e2, cfId: n2, isNeedResetPreComputingCache: i });
      };
    })());
...
var n1 = (s) => {
  ...
  const n = e < 0 ? x2 + e : e, [i, a, u] = t1(s, true), o = Math.floor(n / 60 / 60) % 60, l = Math.floor(n / 60) % 60, d = Math.floor(n) % 60;
  return tn(`${i}/${a}/${u} ${o}:${l}:${d}`).valueOf();
};
var D2 = (s, r, t) => {
  switch (s.type) {
    case I.max: {
    ...
    case I.formula: {
      const { accessor: e, unitId: n, subUnitId: i, cfId: a } = t, u = String(s.value), o = e.get(z2);
...
var Z1 = (s, r, t, e) => {
  const { accessor: n } = e, i = n.get(Q), a = new pt();
...
var s1 = (s, r) => {
  ...
  if (n >= 0) {
    ...
    if (i.color.isValid && a.color.isValid) {
      ...
      return new bt(c).toRgbString();
    }
  } else
    return s[s.length - 1].color.toRgbString();
};
var R2 = (s, r, t) => s.map((e) => {
...
var f1 = "EMPTY_ICON_TYPE";
var m1 = "ssheets-conditional-formatting.config";
var B2 = {};
...
var Y = (s, r) => (t, e) => r(t, e, s);
var s2 = class extends Ve {
  ...
  _initSnapshot() {
    ...
    this.disposeWithMe(
      this._resourceManagerService.registerPluginResource({
        ...
        parseJson: (t) => r(t),
        onUnLoad: (t) => {
          this._conditionalFormattingRuleModel.deleteUnitId(t), !Yc(t) && this._conditionalFormattingViewModelV2.dispose();
        },
        onLoad: (t, e) => {
      ...
      this._commandService.onCommandExecuted((s) => {
        ...
        switch (s.id) {
          ...
          case Me.id: {
            ...
            i && i.filter((o) => o.ranges.some((l) => En.intersects(l, a))).forEach((o) => {
          ...
          case Je.id: {
            ...
            a && a.filter((l) => l.ranges.some((d) => En.intersects(d, u))).forEach((l) => {
          ...
          case On.id: {
            ...
            i && i.filter((u) => u.ranges.some((o) => En.intersects(o, t))).forEach((u) => {
...
var v1 = (s) => s.getCurrentUnitForType(we.UNIVER_SHEET).getUnitId();
var p1 = (s) => {
  var r;
  return (r = s.getCurrentUnitForType(we.UNIVER_SHEET).getActiveSheet()) == null ? void 0 : r.getSheetId();
};
...
var _2 = (s, r) => (t, e) => r(t, e, s);
var d2;
var N2 = (d2 = class extends Ol {
  ...
  onStarting() {
    this._injector.get(s2), zc(this._injector, [[s2], [Q]]);
  }
}, m(d2, "pluginName", Z2), m(d2, "type", we.UNIVER_SHEET), d2);
N2 = A1([
  _2(1, Inject(Injector)),
  _2(2, Inject(Ls)),
  _2(3, ic)
], N2);
var x1 = "sheet-conditional-rule-icon";
var _1 = 35;
var M1 = 15;
var y1 = 2;
var R1 = (s) => {
  ...
  draw(t, e, n, i) {
    ...
    t.save(), Or.foreach(n.rowColumnSegment, (o, l) => {
      ...
      if (this._width > l2 || this._width > v2 + this._paddingRightAndLeft * 2)
        return;
      const p22 = (l2 - this._width) / 2 + R;
      t.drawImage(p, y + this._paddingRightAndLeft, p22, this._width, this._width);
    }), t.restore();
  }
  _init() {
    for (const t in f2)
...
//# sourceMappingURL=chunk-DWXYAMJX.js.map
