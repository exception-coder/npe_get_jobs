...
// node_modules/@univerjs/thread-comment/lib/es/index.js
var P = Object.defineProperty;
var L = (s, t, e) => t in s ? P(s, t, { enumerable: true, configurable: true, writable: true, value: e }) : s[t] = e;
...
var p = createIdentifier("univer.thread-comment.data-source-service");
...
var i = class extends Ve {
  constructor(t, e) {
    ...
    this._dataSourceService = t, this._lifecycleService = e, this.disposeWithMe(() => {
      ...
      n === ke.Rendered && (this._tasks.forEach(({ unitId: r, subUnitId: a, threadIds: d }) => {
        let m = o.get(r);
  ...
  async syncThreadComments(t, e, n) {
    if (this._lifecycleService.stage < ke.Rendered) {
...
var Q = {
  ...
  async handler(s, t) {
    if (!t)
      return false;
    const e = s.get(Ls), n = s.get(p), { comment: o } = t, r = await n.addComment(o), a = n.syncUpdateMutationToColla, d = !o.parentId, m = {
      id: R.id,
      params: {
        ...t,
        comment: r
...
var X = {
  ...
  async handler(s, t) {
    if (!t)
      return false;
    const { unitId: e, subUnitId: n, payload: o } = t, r = s.get(Ls), a = s.get(i), d = s.get(p), m = d.syncUpdateMutationToColla, c = a.getComment(
      e,
      n,
      o.commentId
    );
    ...
    return r.executeCommand(N.id, N.params, { onlyLocal: !m }), true;
  }
};
var Z = {
...
var ee = {
  ...
  async handler(s, t) {
    if (!t)
      return false;
    const e = s.get(i), n = s.get(p), o = s.get(Ls), { unitId: r, subUnitId: a, commentId: d } = t, m = n.syncUpdateMutationToColla, c = e.getComment(r, a, d);
...
var te = {
  ...
  async handler(s, t) {
    if (!t)
      return false;
    const e = s.get(i), n = s.get(Ls), o = s.get(p), { unitId: r, subUnitId: a, commentId: d } = t, m = e.getCommentWithChildren(r, a, d);
    return !m || !await o.deleteComment(r, a, m.root.threadId, d) ? false : await n.executeCommand(E.id, {
      unitId: r,
      subUnitId: a,
      commentId: m.root.id
    });
...
function he(s) {
  return tn(s).format("YYYY/MM/DD HH:mm");
}
var $ = "UNIVER_THREAD_COMMENT_PLUGIN";
  ...
  _initSnapshot() {
    ...
    this.disposeWithMe(
      this._resourceManagerService.registerPluginResource({
        pluginName: re,
        businesses: [we.UNIVER_SHEET, we.UNIVER_DOC],
        toJson: (e) => s(e),
        parseJson: (e) => t(e),
        onUnLoad: (e) => {
...
}, u(_, "pluginName", $), u(_, "type", we.UNIVER_UNKNOWN), _);
I = me([
  y(1, Inject(Injector)),
  y(2, Ls),
  y(3, ic)
...
//# sourceMappingURL=chunk-6Q4G5S6Y.js.map
