...
var Ae2 = (s, e, t) => e in s ? $e(s, e, { enumerable: true, configurable: true, writable: true, value: t }) : s[e] = t;
var w = (s, e, t) => Ae2(s, typeof e != "symbol" ? e + "" : e, t);
...
var vt = (s, e) => (t, n) => e(t, n, s);
var R = class extends Ve {
  constructor(e) {
    super();
  ...
  getHyperLinkByLocationSync(e, t, n, r) {
    var l, u, h, g, p;
    const { matrix: i } = this._ensureMap(e, t), a = this._univerInstanceService.getUnit(e, we.UNIVER_SHEET), o = (l = a == null ? void 0 : a.getSheetBySheetId(t)) == null ? void 0 : l.getCellRaw(n, r), c = ((p = (g = o == null ? void 0 : o.v) != null ? g : (h = (u = o == null ? void 0 : o.p) == null ? void 0 : u.body) == null ? void 0 : h.dataStream.slice(0, -2)) != null ? p : "").toString(), d = i.getValue(n, r);
    if (d)
      return {
        ...d,
        display: c
...
var St = {
  ...
  async handler(s, e) {
    if (!e) return false;
    const t = s.get(Ls), n = s.get(Qo), r = s.get(vr), i = s.get(R), a = s.get(G), o = P(r, e);
    if (!o) return false;
    const { unitId: c, subUnitId: d, workbook: l, worksheet: u } = o, { link: h } = e, { payload: g, display: p, row: f, column: m, id: _ } = h, C = u.getCell(f, m), y = u.getBlankCellDocumentModel(C, f, m), v = y.documentModel.getSnapshot(), S = J.deepClone(v.body);
    if (!S) return false;
    let P2;
    if (p ? P2 = Je.selection.replace({
      selection: {
        startOffset: 0,
    ...
    const F = Ne.apply(S, P2.serialize()), O = {
      p: {
        ...v,
        body: F
      },
    ...
    })), await fo(K, t) ? await a.onValidateCell(l, u, f, m) === false ? (fo(H, t), false) : (n.pushUndoRedo({
      redoMutations: K,
      undoMutations: H,
      unitID: c
    }), true) : false;
...
var Rt = {
  ...
  handler: async (s, e) => {
    if (!e)
      return false;
    const { documentId: t, link: n } = e, r = s.get(Ls), i = et(), { payload: a } = n, o = Ge(s, {
      unitId: t,
      rangeId: i,
      rangeType: pn.HYPERLINK,
      properties: {
...
var It = {
  ...
  handler(s, e) {
    var O, A;
    if (!e) return false;
    const t = s.get(Ls), n = s.get(Qo), r = s.get(vr), i = s.get(R), a = P(r, e);
    if (!a) return false;
    ...
    if (!(p != null && p.documentModel)) return false;
    const f = J.deepClone(p.documentModel.getSnapshot()), m = (A = (O = f.body) == null ? void 0 : O.customRanges) == null ? void 0 : A.find((W) => `${W.rangeId}` === d);
    if (!m) return false;
    const _ = Je.customRange.delete({ documentDataModel: p.documentModel, rangeId: m.rangeId });
    if (!_) return false;
    const C = Ne.apply(f.body, _.serialize()), y = [], v = [], S = {
      unitId: l,
      subUnitId: u,
      cellValue: {
        [o]: {
...
var Mt = {
  ...
  handler(s, e) {
    ...
    if (!e)
      return false;
    const { id: t, documentId: n } = e, r = s.get(Ls), a = s.get(vr).getUnit(n, we.UNIVER_DOC), o = (u = (l = a == null ? void 0 : a.getBody()) == null ? void 0 : l.customRanges) == null ? void 0 : u.find((h) => h.rangeId === t);
    let c = null;
    o && o.endIndex === a.getBody().dataStream.length - 3 && (c = {
      dataStream: " "
    });
    const d = ze(s, { unitId: n, rangeId: t, insert: c });
...
var Ct = {
  ...
  async handler(s, e) {
    var we2, ke, Le;
    if (!e) return false;
    const t = s.get(Ls), n = s.get(Qo), r = s.get(vr), i = s.get(R), a = s.get(G), o = P(r, {
      unitId: e.unitId,
    ...
    if (!(y != null && y.documentModel)) return false;
    const v = y.documentModel.getSnapshot(), S = (ke = (we2 = v.body) == null ? void 0 : we2.customRanges) == null ? void 0 : ke.find((Ee) => `${Ee.rangeId}` === u);
    if (!S) return false;
    const P2 = et(), $ = (Le = kt(y.documentModel.getBody(), S.startIndex, S.endIndex + 1).textRuns) == null ? void 0 : Le[0];
    $ && ($.ed = _.length + 1);
    const O = Fe(s, {
      unitId: p,
      body: {
    ...
    if (!O)
      return false;
    const A = Ne.apply(J.deepClone(v.body), O.textX.serialize()), W = {
      p: {
        ...v,
        body: A
      },
      t: fn.STRING
    }, pe = a.onWriteCell(h, g, d, l, W), z2 = {
      id: ee.id,
      params: {
        unitId: p,
        subUnitId: f,
      ...
      id: ee.id,
      params: he
    }, H = [z2], x = [K], J2 = i.getHyperLinkByLocation(p, f, d, l);
    return J2 && (H.push({
      id: N.id,
      params: {
        unitId: p,
    ...
    })), fo(H, t) ? await a.onValidateCell(h, g, d, l) === false ? (fo(x, t), false) : (n.pushUndoRedo({
      redoMutations: H,
      undoMutations: x,
      unitID: p
    }), true) : false;
...
var wt = {
  ...
  handler: (s, e) => {
    ...
    if (!e)
      return false;
    const { documentId: t, payload: n, id: r } = e, i = s.get(vr), a = s.get(Ls), o = i.getUnit(t, we.UNIVER_DOC);
    if (!o)
      return false;
    const c = (f = (p = o.getBody()) == null ? void 0 : p.customRanges) == null ? void 0 : f.find((C) => C.rangeId === r);
    if (!c)
      return false;
    const d = (m = e.payload.display) != null ? m : "", l = et(), h = (_ = kt(o.getBody(), c.startIndex, c.endIndex + 1).textRuns) == null ? void 0 : _[0];
    h && (h.ed = d.length + 1);
    const g = Fe(s, {
      unitId: t,
      body: {
...
var Q = {
  ...
  handler(s, e) {
    ...
    if (!e)
      return false;
    const { unitId: t, subUnitId: n, row: r, col: i, id: a, url: o } = e, c = s.get(vr), d = P(c, { unitId: t, subUnitId: n });
    if (!d)
      return false;
    const { worksheet: l } = d, u = l.getCellRaw(r, i), h = (f = (p = (g = u == null ? void 0 : u.p) == null ? void 0 : g.body) == null ? void 0 : p.customRanges) == null ? void 0 : f.find((m) => m.rangeType === pn.HYPERLINK && m.rangeId === a);
    return h && (h.properties.url = o), true;
  }
};
var kt2 = "sheets-hyper-link.config";
var Ue = {};
var xe = "SHEET_HYPER_LINK_PLUGIN";
var te = "err";
...
var ne = class extends Ve {
  ...
  _registerPosition(e, t, n) {
    const r = n.id, i = {
      ...
      const c = xh(i, o, { selectionManagerService: this._selectionManagerService }), d = Array.isArray(c) ? c[0] : c;
  ...
  _registerRange(e, t, n, r = false) {
    ...
    if (n.startsWith("#")) {
      ...
      if (d.range && d.gid) {
        const l = d.gid, u = Dr(d.range).range;
        if (z1(u) && d.range !== te) {
          const h = (g) => {
            const p = Ah(u, g, { selectionManagerService: this._selectionManagerService });
            return p && Ft(p) === Ft(u) ? {
              redos: [],
              undos: []
            } : {
              redos: [{
                ...
                params: {
                  ...
                  id: t,
                  payload: {
                    payload: `#gid=${l}&range=${p ? Ft(p) : "err"}`
                  }
                }
              }],
              undos: [{
    ...
    this.disposeWithMe(
      this._sheetInterceptorService.interceptCommand({
        getMutations: (s) => {
          var e;
          if (s.id === Xs.id) {
            const t = s.params, n = t.unitId ? this._univerInstanceService.getUnit(t.unitId) : this._univerInstanceService.getCurrentUnitForType(we.UNIVER_SHEET);
            if (!n)
              return { redos: [], undos: [] };
...
var se = class extends Ve {
  ...
  _enusreMap(e, t) {
    ...
    let r = n.get(t);
    return r || (r = new pt(), n.set(t, r)), r;
  }
  _isLegalRangeUrl(e, t) {
    var r, i, a;
    const n = this._univerInstanceService.getUnit(e, we.UNIVER_SHEET);
    if (!n)
      return null;
    if (t && t.startsWith("#")) {
      ...
      if (c.range && c.gid) {
        ...
        if (!l)
          return null;
        const u = Dr(c.range).range;
        if (z1(u, l) && c.range !== te)
          return {
            range: u,
            worksheet: l
          };
  ...
  _registerRange(e, t, n, r, i) {
    ...
    if ((c = (o = i.body) == null ? void 0 : o.customRanges) != null && c.some((u) => {
      var h;
      return u.rangeType === pn.HYPERLINK && this._isLegalRangeUrl(e, (h = u.properties) == null ? void 0 : h.url);
    })) {
      const u = new ao();
      let h = false;
      (l = (d = i.body) == null ? void 0 : d.customRanges) == null || l.forEach((g) => {
        var p;
        if (g.rangeType === pn.HYPERLINK) {
  ...
  _initWorkbookLoad() {
    ...
    this._univerInstanceService.getAllUnitsForType(we.UNIVER_SHEET).forEach((t) => {
      e(t);
    }), this.disposeWithMe(
      this._univerInstanceService.unitAdded$.subscribe((t) => {
        t.type === we.UNIVER_SHEET && e(t);
      })
    );
  }
  _initWorkbookUnload() {
  ...
  _initSetRangesListener() {
    this.disposeWithMe(
      ...
      this._commandService.onCommandExecuted((e) => {
        if (e.id === Q.id) {
          const t = e.params, { unitId: n, subUnitId: r, row: i, col: a } = t, o = P(this._univerInstanceService, { unitId: n, subUnitId: r }), d = this._enusreMap(n, r).getValue(i, a);
          if (d && d.dispose(), o) {
...
var ie = class extends Ve {
    ...
    this.disposeWithMe(this._sheetInterceptorService.interceptCommand({
      getMutations: (s) => {
        if (s.id === Sn.id) {
          ...
          return e.cellValue && new pt(e.cellValue).forValue((a, o) => {
  ...
  _initClearSelectionCommandInterceptor() {
    this.disposeWithMe(this._sheetInterceptorService.interceptCommand({
      getMutations: (s) => {
        if (s.id === qs.id || s.id === Ws.id || s.id === Ls2.id) {
          const e = [], t = [], n = this._selectionManagerService.getCurrentLastSelection(), r = P(this._univerInstanceService);
          if (n && r) {
            const { unitId: i, subUnitId: a } = r;
            Or.foreach(n.range, (o, c) => {
  ...
  _initAfterEditor() {
    this.disposeWithMe(this._sheetInterceptorService.writeCellInterceptor.intercept(ms, {
      handler: (s, e, t) => {
        if (!s || s.p)
          return t(s);
        if (typeof s.v == "string" && J.isLegalUrl(s.v) && s.v[s.v.length - 1] !== " ") {
          const { unitId: n, subUnitId: r, row: i, col: a } = e, o = J.normalizeUrl(s.v), c = this._univerInstanceService.getUnit(n, we.UNIVER_SHEET), d = c == null ? void 0 : c.getSheetBySheetId(r);
          if (!d)
            return t(s);
          const l = d.getBlankCellDocumentModel(s, i, a);
          if (!l.documentModel)
            return t(s);
          const u = Je.selection.replace({
            selection: {
              startOffset: 0,
          ...
          return Ne.apply(h, u.serialize()), t({
            ...s,
            p: {
              id: Dl,
              body: h,
...
var E = ((s) => (s.SHEET = "gid", s.RANGE = "range", s.DEFINE_NAME = "rangeid", s.INVALID = "invalid", s.URL = "url", s))(E || {});
...
var me = (s, e) => (t, n) => e(t, n, s);
var ve = class {
  constructor(s, e, t) {
    this._univerInstanceService = s, this._localeService = e, this._definedNamesService = t;
  }
  buildHyperLink(s, e, t) {
    return `#${E.SHEET}=${e}${t ? `&${typeof t == "string" ? E.DEFINE_NAME : E.RANGE}=${typeof t == "string" ? t : Ft(t)}` : ""}`;
  }
  parseHyperLink(s) {
    var e, t, n, r;
    if (s.startsWith("#")) {
  ...
  _getURLName(s) {
    var d;
    const { gid: e, range: t, rangeid: n, unitid: r } = s, i = r ? this._univerInstanceService.getUnit(r, we.UNIVER_SHEET) : this._univerInstanceService.getCurrentUnitForType(we.UNIVER_SHEET), a = {
      type: E.INVALID,
...
var Ft2 = (s, e, t) => e in s ? Bt(s, e, { enumerable: true, configurable: true, writable: true, value: t }) : s[e] = t;
var Kt = (s, e, t, n) => {
...
var Ve2 = (s, e, t) => Ft2(s, typeof e != "symbol" ? e + "" : e, t);
var de = class extends Ol {
  constructor(s = Ue, e, t) {
    ...
    this._configService.setConfig(kt2, n);
  }
  onStarting() {
    GC(this._injector, [
      [R],
...
Ve2(de, "pluginName", xe);
Ve2(de, "type", we.UNIVER_SHEET);
de = Kt([
  qR(ss),
...
//# sourceMappingURL=chunk-XVGFBPKD.js.map
