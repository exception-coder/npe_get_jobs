...
var ke = (t) => {
  const { color: e, onChange: n, disable: r = false, Icon: i = er, className: o } = t, s = (0, import_react.useMemo)(() => new bt(e), [e]), d = () => {
    const a = {
      className: ie3("univer-fill-primary-600", r && o),
  ...
  return r ? d() : (0, import_jsx_runtime.jsx)(
    vf2,
    {
      ...
      children: (0, import_jsx_runtime.jsx)(
        "span",
        {
          className: ie3("univer-flex univer-cursor-pointer univer-items-center univer-rounded univer-p-1 hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700", o),
          children: d()
        }
      )
    }
...
var st = ie3("univer-mt-5 univer-px-1 univer-py-2 univer-rounded", kt);
...
var Zt = (t) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    v !== void 0 && (I2.cl = { rgb: v }), y !== void 0 && (I2.bg = { rgb: y }), l !== void 0 && (I2.st = { s: l }), a !== void 0 && (I2.ul = { s: a }), n(S1(I2));
  }, [i, s, a, l, v, y]);
  const w = "univer-flex univer-cursor-pointer univer-items-center univer-rounded univer-px-1";
  return (0, import_jsx_runtime.jsxs)("div", { className: ie3("univer-my-2.5 univer-flex univer-justify-between", r), children: [
    (0, import_jsx_runtime.jsx)(
      "div",
      {
        className: ie3(w, {
    ...
    (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)("span", { className: "univer-ml-2", children: "无单元格图标" })
        ]
      }
    ),
            ...
            (0, import_jsx_runtime.jsx)("div", { className: "univer-flex univer-items-center", children: (0, import_jsx_runtime.jsx)(
              vf2,
              {
                ...
                children: (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    className: ie3("univer-box-border univer-flex univer-h-8 univer-w-full univer-items-center univer-justify-between univer-rounded-md univer-bg-white univer-px-4 univer-py-2 univer-text-xs univer-text-gray-600 univer-transition-all hover:univer-border-primary-600 dark:!univer-text-gray-200", kt),
                    children: [
    ...
    (0, import_jsx_runtime.jsx)("div", { className: "univer-mt-3", children: (0, import_jsx_runtime.jsx)(
      vf2,
      {
        ...
        children: (0, import_jsx_runtime.jsxs)(
          "div",
          {
            className: ie3("univer-box-border univer-flex univer-h-8 univer-w-full univer-items-center univer-justify-between univer-rounded-md univer-bg-white univer-px-4 univer-py-2 univer-text-xs univer-text-gray-600 univer-transition-all hover:univer-border-primary-600", kt),
            children: [
              v,
              (0, import_jsx_runtime.jsx)(Gt, {})
            ]
...
var Ai = (t) => {
  ...
  pR(y), (0, import_react.useEffect)(() => {
    ...
    const D = new Observable((B) => {
      const G2 = [ie2.id, a2.id, o2.id, K.id, i2.id], z2 = o.onCommandExecuted((ee) => {
    ...
    (0, import_jsx_runtime.jsx)("div", { ref: C, children: b > 0 && (0, import_jsx_runtime.jsx)(
      ib,
      {
        ...
        children: pe == null ? void 0 : pe.map((D, B) => (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsxs)(
          "div",
          {
            className: ie3("univer-group univer-relative univer-flex univer-items-center univer-justify-between univer-rounded univer-py-2 univer-pl-5 univer-pr-8 hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700", {
            ...
            children: [
              (0, import_jsx_runtime.jsx)(
                "div",
                {
                  className: ie3("univer-absolute univer-left-0 univer-hidden univer-size-5 univer-cursor-grab univer-items-center univer-justify-center univer-rounded group-hover:univer-flex", "draggableHandle"),
              ...
              (0, import_jsx_runtime.jsx)(
                "div",
                {
                  className: ie3("univer-absolute univer-right-1 univer-hidden univer-size-6 univer-cursor-pointer univer-items-center univer-justify-center univer-rounded group-hover:univer-flex hover:univer-bg-gray-200", {
...
//# sourceMappingURL=chunk-4R64IBKE.js.map
