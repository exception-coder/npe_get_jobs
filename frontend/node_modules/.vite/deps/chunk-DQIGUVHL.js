...
var J2 = (i, r, e) => Dt(i, typeof r != "symbol" ? r + "" : r, e);
var D = ((i) => (i.default = "0", i.left = "1", i.center = "2", i.right = "3", i.top = "4", i.middle = "5", i.bottom = "6", i.horizon = "7", i.vertical = "8", i))(D || {});
var ze = {
...
var Be = class extends Ve {
  constructor(r, e, t, n) {
    super();
    J2(this, "_sceneListenerOnDrawingMap", /* @__PURE__ */ new WeakSet());
...
var Ie = class extends x3 {
  constructor(e, t) {
    ...
    J2(this, "_srcRect");
    J2(this, "_prstGeom");
    J2(this, "_applyTransform");
    J2(this, "_dragPadding", 8);
    J2(this, "_cacheCanvas");
...
var xe = class extends Ve {
  constructor(r, e, t, n, s, a) {
    super();
    J2(this, "_sceneListenerOnImageMap", /* @__PURE__ */ new WeakSet());
...
}, J2(Ge, "pluginName", br), Ge);
nt3 = Sr([
  rt(1, Inject(Injector)),
  rt(2, ic)
], nt3);
var Ir = (i) => {
  const r = useDependency(Ls), e = useDependency(Fn), { alignShow: t } = i, [n, s] = (0, import_react.useState)(D.default), a = [
    {
...
var F2 = "docs-drawing.config";
var v2 = {};
var J3 = Object.getOwnPropertyDescriptor;
var L = (r, t, e, n) => {
  for (var i = n > 1 ? void 0 : n ? J3(t, e) : t, a = r.length - 1, s; a >= 0; a--)
    (s = r[a]) && (i = s(i) || i);
  return i;
};
...
var h2 = (c = class extends Ol {
  constructor(r = v2, t, e) {
    ...
    this._configService.setConfig(F2, n);
  }
  onStarting() {
    [
      [D2],
...
//# sourceMappingURL=chunk-DQIGUVHL.js.map
