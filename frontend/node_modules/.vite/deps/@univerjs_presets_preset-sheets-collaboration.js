import {
  ...
  ve,
  we as we2
} from "./chunk-E437QPCP.js";
import {
  at as at3
} from "./chunk-W3WTABPG.js";
import {
  Tt as Tt3
} from "./chunk-BIBVCJFX.js";
import {
  Ie
} from "./chunk-SRDVFLKN.js";
import {
  xt as xt3
} from "./chunk-4R64IBKE.js";
import {
  He
} from "./chunk-ISY2DTEM.js";
import {
  Nn,
  Ut,
  V as V2,
  ve as ve2
} from "./chunk-QDSVZCZ3.js";
import {
  $t as $t2,
  Cd,
  Fm,
...
oe2 = Ci([se2(0, vr), se2(1, Inject(Injector)), se2(2, Inject(nt)), se2(3, D1)], oe2);
...
var we4 = class extends h1 {
  ...
  ["init"]() {
    ...
    this["_init"] || (this[_0x372bd1(596)] = true, this[_0x372bd1(918)][_0x372bd1(648)][_0x372bd1(359)](takeUntil(this[_0x372bd1(447)]))[_0x372bd1(369)]((_0x7868f2) => {
      ...
      if (this[_0xbad7c0(588)] && _0x5b50e9["id"] === ie["id"] && _0x5b50e9["params"][_0xbad7c0(413)] === this[_0xbad7c0(446)]) {
...
H = Hi([Ee(0, vr), Ee(1, Inject(Injector)), Ee(2, Inject(we2))], H);
var Q = 20;
var it2 = 200;
var pe2 = 4;
var Yi = 5;
...
var nt3 = class {
  ...
  [_0x59d238(511)]() {
    ...
    var _0x48692e;
    const { _docSkeleton: _0x23706b, _document: _0x3f1f78 } = this, { color: _0x1a620d, name: _0x30a36a, ranges: _0x1f6bde } = this[_0x13064d(531)], _0x47cf96 = _0x3f1f78["getOffsetConfig"](), { docsLeft: _0x4196d7, docsTop: _0x6c854b } = _0x47cf96, _0x2c8c00 = new It3(_0x47cf96, _0x23706b);
...
$e = tn([Ce(1, Inject(ue2)), Ce(2, Inject(H)), Ce(3, Inject(Gi))], $e);
...
var ue3 = class extends Ve {
  ...
  ["_initEntityListener"]() {
    ...
    this[_0xa847f2(621)](this[_0xa847f2(476)][_0xa847f2(552)]["subscribe"]((_0x4c4b88) => {
      ...
      if (_0x4c4b88[_0x2c1574(621)](_0x3209b5), _0x4c4b88 instanceof It2) {
...
ue3 = In([b(0, Inject(Io)), b(1, Inject(nt)), b(2, Inject(_e)), b(3, Inject(le2)), b(4, Inject(he2)), b(5, Inject(Xe2)), b(6, et2), b(7, Inject(Fn))], ue3);
...
var Be2 = class extends Ol {
  ...
  [_0x59d238(577)]() {
    ...
    var _0x492711;
    const _0x12bcfd = [[je], [de3], [he2], [_e], [le2], [Xe2], [At3, { "useClass": Rn }], [ze, { "useClass": Ye2 }], [J3, { "useClass": xe }], [oe2], [ue3], [ce2], [H], [Ae], [ae2]];
...
function J5(_0x161a30, _0x1df202) {
  ...
  switch (_0x1df202) {
    case Ns["ZH_CN"]:
      return _0x5442ba ? "今天" : (_0x538299 = _0x3aabfb === _0x5d69df ? "" : _0x5d69df + "年", _0x5e790a = _0x29f045 + "月", _0x6518ba = _0xd29969 + "日", "" + _0x538299 + _0x5e790a + _0x6518ba);
    default:
...
g2 = ds([$2(0, et2), $2(1, at2), $2(2, Inject(Fn)), $2(3, Inject(A3))], g2);
...
q2 = Ps([b2(1, Inject(g2)), b2(2, Inject(w)), b2(3, vr), b2(4, ME), b2(5, Inject(ue2)), b2(6, Ls)], q2);
function Ls2() {
...
Y = Vs2([U2(0, we3), U2(1, Inject(S1)), U2(2, Inject(Fn)), U2(3, Inject(g2))], Y);
...
var ee3 = class extends Ol {
  ...
  [_0x24fbc0(745)]() {
    ...
    [[g2], [F2], [w], [A3], [Y], [H2], [gr2, { "useClass": Nt }], [ct, { "useClass": ks }], [El, { "useClass": Rt }]][_0x1544d3(556)]((_0x4cc6ef) => this["_injector"][_0x1544d3(681)](_0x4cc6ef)), this[_0x1544d3(642)][_0x1544d3(878)](F2);
  }
  [_0x24fbc0(716)]() {
...
f2 = li2([l2(0, Inject(Fn)), l2(1, vr), l2(2, ic), l2(3, Ls), l2(4, et2), l2(5, eC), l2(6, Inject(me)), l2(7, Inject(ct)), l2(8, Inject(we3)), l2(9, Inject(Gi))], f2);
...
p = vi2([m2(0, Ls), m2(1, B12), m2(2, Inject(S1)), m2(3, Inject(f2)), m2(4, Inject(Fn)), m2(5, et2), m2(6, Inject(nt)), m2(7, J3)], p);
...
c = y2([a(1, Inject(Injector)), a(2, vr), a(3, Inject(zt)), a(4, Inject(nt))], c);
...
export {
  ...
  we2 as CollaborationSessionService,
  ...
  Nt as SnapshotServerOverHTTPService,
  ...
  at as isTransformMutationSuccess,
