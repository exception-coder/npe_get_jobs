...
`;function p6(e){const{children:n,className:t,style:r,disabled:o=!1,active:l=!1,noIcon:i,onClick:c,onDoubleClick:v,...p}=e,b=w=>{if(o){w.preventDefault();return}c&&c(w)},d=w=>{if(o){w.preventDefault();return}v&&v(w)};return C.jsx("button",{type:"button",className:T.clsx(g6,{"univer-px-2":i,"!univer-bg-gray-200 dark:!univer-bg-gray-500":l}),style:r,disabled:o,onClick:b,onDoubleClick:d,...p,children:n})}function m6(e){const{disabled$:n,hidden$:t,activated$:r,value$:o}=e,[l,i]=s.useState(),[c,v]=s.useState(!1),[p,b]=s.useState(!1),[d,w]=s.useState(!1);return s.useEffect(()=>{const I=[];return n&&I.push(n.subscribe(S=>v(S))),t&&I.push(t.subscribe(S=>w(S))),r&&I.push(r.subscribe(S=>b(S))),o&&I.push(o.subscribe(S=>i(S))),()=>I.forEach(S=>S.unsubscribe())},[r,n,t,o]),{disabled:c,value:l,activated:p,hidden:d}}const We=s.createContext({dropdownVisible:!1,setDropdownVisible:e=>{}}),s4=s.forwardRef((e,n)=>{const{children:t,...r}=e,o=s.useRef(null),[l,i]=s.useState(!1),[c,v]=s.useState(!1);function p(w){i(c?!1:w)}function b(w){v(w),i(!1)}const d=s.useMemo(()=>({dropdownVisible:c,setDropdownVisible:b}),[c]);return s.useImperativeHandle(n,()=>({el:o.current})),r.title?C.jsx(T.Tooltip,{visible:l,onVisibleChange:p,...r,children:C.jsx("span",{ref:o,children:C.jsx(We.Provider,{value:d,children:t})})}):C.jsx("span",{ref:o,children:t})});function a4(e){const{children:n,overlay:t,disabled:r,align:o="start"}=e,{dropdownVisible:l,setDropdownVisible:i}=s.useContext(We);function c(v){i(v)}return C.jsx(T.Dropdown,{align:o,overlay:C.jsx("div",{className:"univer-grid univer-gap-2",children:t}),disabled:r,open:l,onOpenChange:c,children:C.jsx("div",{className:"univer-h-full",onClick:v=>v.stopPropagation(),children:n})})}function me({icon:e,value:n,option:t,onOptionSelect:r}){var i;const o=c=>{r==null||r({value:c,label:t==null?void 0:t.label,commandId:t==null?void 0:t.commandId})},l=typeof t.label=="string"||typeof t.label=="object"&&((i=t.label)==null?void 0:i.selectable)!==!1;return C.jsxs("div",{className:T.clsx("univer-relative univer-flex univer-items-center univer-gap-2",{"univer-pl-6":l}),children:[l&&String(n)===String(t.value)&&C.jsx(Re,{className:"univer-absolute univer-left-1 univer-top-0.5 univer-text-primary-600"}),C.jsx(d1,{className:"univer-text-sm",icon:e,value$:t.value$,value:t.value,label:t.label,onChange:o})]})}function b6({menuId:e,slot:n,value:t,options:r,children:o,disabled:l,onOptionSelect:i}){var N;const{dropdownVisible:c,setDropdownVisible:v}=s.useContext(We),p=V.useDependency(M1),[b,d]=s.useState({}),w=s.useMemo(()=>e?p.getMenuByPositionKey(e):[],[e]),I=s.useMemo(()=>w.filter(D=>{var $;if(!D.children)return!b[D.key];const _=(($=D.key)==null?void 0:$.toString())||"";return!b[_]}),[w,b]);function S(D){v(D)}if(s.useEffect(()=>{const D=[];return w.forEach(_=>{var $;if(_.children){const O=_.children.map(M=>{var x,P;return(P=(x=M.item)==null?void 0:x.hidden$)!=null?P:U.of(!1)}),k=U.combineLatest(O).subscribe(M=>{const x=M.every(P=>P===!0);d(P=>({...P,[_.key]:x}))});D.push(k)}else if(($=_.item)!=null&&$.hidden$){const O=_.item.hidden$.subscribe(k=>{d(M=>({...M,[_.key]:k}))});D.push(O)}}),()=>{D.forEach(_=>_==null?void 0:_.unsubscribe()),d({})}},[w]),n)return C.jsx(a4,{disabled:l,overlay:r.map((D,_)=>C.jsx(me,{value:t,option:D,onOptionSelect:i},_)),children:o});if(r!=null&&r.length){const D=r.map(_=>{var $;return{type:"item",className:T.clsx({"focus:univer-bg-white":typeof _.label!="string"&&(($=_.label)==null?void 0:$.hoverable)===!1}),children:C.jsx(me,{icon:_.icon,value:t,option:_,onOptionSelect:i}),disabled:_.disabled,onSelect:()=>{typeof _.value>"u"||i==null||i({..._})}}});for(const _ of I){if(!_.item)continue;const{title:$,id:O,commandId:k,icon:M}=_.item;if(!$)throw new Error("Menu item title is required");D.push({type:"item",children:C.jsx(me,{icon:M,value:t,option:{label:{name:$,selectable:!1}}}),onSelect:()=>{i==null||i({commandId:k,id:O})}})}return C.jsx(T.DropdownMenu,{align:"start",items:D,disabled:l,open:c,onOpenChange:S,children:o})}else{const D=[];for(const _ of I)if(_.item){const{title:$,id:O,commandId:k,icon:M}=_.item;if(!$)throw new Error("Menu item title is required");D.push({type:"item",children:C.jsx(me,{icon:M,value:t,option:{label:{name:$,selectable:!1}}}),onSelect:()=>{i==null||i({commandId:k,id:O})}})}else(N=_.children)!=null&&N.length;return C.jsx(T.DropdownMenu,{align:"start",items:D,disabled:l,open:c,onOpenChange:S,children:o})}}const ee=s.forwardRef((e,n)=>{const t=V.useDependency(f.LocaleService),r=V.useDependency(f.ICommandService),o=V.useDependency(S1),l=V.useDependency(v1),{value:i,hidden:c,disabled:v,activated:p}=m6(e),b=(G,Y)=>{o.focus(),r.executeCommand(G,Y)},{tooltip:d,shortcut:w,icon:I,title:S,label:N,id:D,commandId:_,type:$,slot:O,params:k}=e,M=t.t(d!=null?d:"")+(w?` (${w})`:""),{selections:x}=e,P=s.useMemo(()=>U.isObservable(x)?x:new U.Observable(G=>{G.next(x)}),[x]),X=V.useObservable(P),F=s.useMemo(()=>U.isObservable(I)?I:new U.Observable(G=>{var e1,s1;const Y=(s1=(e1=X==null?void 0:X.find(C1=>C1.value===i))==null?void 0:e1.icon)!=null?s1:I;G.next(Y)}),[I,X,i]),W=V.useObservable(F,void 0,!0);function q(G){var l1;const Y=e.selectionsCommandId,e1=_!=null?_:D,s1=(l1=Y!=null?Y:_)!=null?l1:D;function C1(r1){if(v)return;let u1=s1;r1.id&&(u1=r1.id),b(u1,{value:r1.value})}function b1(r1){v||b(s1,{value:r1})}function y1(){v||G===g1.BUTTON_SELECTOR&&b(e1,{value:i})}return G===g1.BUTTON_SELECTOR?C.jsxs("div",{"data-u-command":D,"data-disabled":v,className:T.clsx("univer-animate-in univer-fade-in univer-group univer-relative univer-flex univer-h-6 univer-cursor-pointer univer-items-center univer-rounded univer-pr-5 univer-text-sm univer-transition-colors hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700",{"univer-text-gray-900 dark:!univer-text-white":!v,"univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600":v}),children:[C.jsx("div",{className:T.clsx("univer-relative univer-z-[1] univer-flex univer-h-full univer-items-center univer-rounded-l univer-px-1 univer-transition-colors hover:univer-bg-gray-200 dark:hover:!univer-bg-gray-600",{"univer-bg-gray-200 dark:!univer-bg-gray-500":p,"univer-bg-gray-100":p&&v}),onClick:y1,children:C.jsx(d1,{icon:W,title:S,value:i,label:N,onChange:b1})}),C.jsx(b6,{menuId:D,slot:O,value:i,options:X,disabled:v,onOptionSelect:C1,children:C.jsx("div",{className:T.clsx("univer-absolute univer-right-0 univer-top-0 univer-box-border univer-flex univer-h-6 univer-w-5 univer-items-center univer-justify-center univer-rounded-r univer-transition-colors hover:univer-bg-gray-200 dark:hover:!univer-bg-gray-600",{"univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600":v,"univer-bg-gray-200 dark:!univer-bg-gray-500":p,"univer-bg-gray-100":p&&v}),"data-disabled":v,children:C.jsx(W1,{})})})]}):C.jsx(b6,{menuId:D,slot:O,value:i,options:X,disabled:v,onOptionSelect:C1,children:C.jsxs("div",{"data-u-command":D,className:T.clsx("univer-animate-in univer-fade-in univer-relative univer-flex univer-h-6 univer-cursor-pointer univer-items-center univer-gap-2 univer-whitespace-nowrap univer-rounded univer-px-1 univer-transition-colors hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700",{"univer-text-gray-900 dark:!univer-text-white":!v,"univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600":v,"univer-bg-gray-200":p,"univer-bg-gray-100":p&&v}),children:[C.jsx(d1,{icon:W,title:S,value:i,label:N,onChange:b1}),C.jsx("div",{className:T.clsx("univer-flex univer-h-full univer-items-center",{"univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600":v}),children:C.jsx(W1,{})})]})})}function J(){var Y;const G=l.get(typeof N=="string"?N:(Y=N==null?void 0:N.name)!=null?Y:"");return C.jsx(p6,{"data-u-command":D,className:"univer-text-sm",noIcon:!I,active:p,disabled:v,onClick:()=>{var e1;return b((e1=e.commandId)!=null?e1:e.id,i!=null?i:k)},onDoubleClick:()=>e.subId&&b(e.subId),children:G?C.jsx(d1,{title:S,value:i,label:N}):I?C.jsx(d1,{icon:I}):C.jsx(d1,{title:S})})}function K(){switch($){case g1.BUTTON_SELECTOR:case g1.SELECTOR:case g1.SUBITEMS:return q($);case g1.BUTTON:default:return J()}}return!c&&C.jsx(s4,{ref:n,title:M,placement:"bottom",children:K()})}),c4={[f1.START]:lt,[f1.INSERT]:ut,[f1.FORMULAS]:Ne,[f1.DATA]:z3,[f1.VIEW]:q3,[f1.OTHERS]:Te};function L6(e){const{ribbonType:n,headerMenuComponents:t,headerMenu:r=!0}=e,o=V.useDependency(M1),l=V.useDependency(f.IUniverInstanceService),i=V.useDependency(f.LocaleService),[c,v]=s.useState(0),p=V.useObservable(l.focused$);s.useEffect(()=>{const F=o.menuChanged$.subscribe(()=>{v(W=>W+1)});return()=>{F.unsubscribe()}},[]);const b=s.useRef(null),d=s.useRef({}),[w,I]=s.useState([]),[S,N]=s.useState(f1.START),[D,_]=s.useState(!1),[$,O]=s.useState([]),[k,M]=s.useState(!1),x=s.useCallback(F=>{d.current={},N(F.key),_(!1)},[]);s.useEffect(()=>{var J;const F=o.getMenuByPositionKey(X1.RIBBON),W=[],q=[];for(const K of F)if(K.children){for(const G of K.children)if(G.children)for(const Y of G.children)(J=Y.item)!=null&&J.hidden$&&(W.push(Y.item.hidden$),q.push(`${K.key}/${G.key}/${Y.key}`))}U.combineLatest(W).subscribe(K=>{var e1,s1,C1,b1,y1,l1;const G=[],Y=K.map((r1,u1)=>r1?q[u1]:null).filter(r1=>!!r1);for(const r1 of F){const u1={...r1,children:[]};if((e1=r1.children)!=null&&e1.length)for(const L1 of r1.children){const _1={...L1,children:[]};let $1=!0;if((s1=L1.children)!=null&&s1.length){for(const k1 of L1.children){const U1=`${r1.key}/${L1.key}/${k1.key}`;Y.includes(U1)||(C1=_1.children)==null||C1.push(k1)}(b1=_1.children)!=null&&b1.every(k1=>{var U1;return((U1=k1.children)==null?void 0:U1.length)===0})&&($1=!1)}$1&&((y1=u1.children)==null||y1.push(_1))}(l1=u1.children)!=null&&l1.length&&u1.children.every(L1=>{var _1;return(_1=L1.children)==null?void 0:_1.length})&&G.push(u1)}if(n==="simple"){const r1=[{key:f1.START,children:[],order:0}];G.forEach(u1=>{var L1;(L1=u1.children)==null||L1.forEach(_1=>{var $1;($1=r1[0].children)==null||$1.push(_1)})}),I(r1)}else I(G)}).unsubscribe()},[c,p]);const P=s.useMemo(()=>{var J,K;const F=(K=(J=w.find(G=>G.key===S))==null?void 0:J.children)!=null?K:[],W=[],q=[];for(const G of F)if(G.children){const Y=G.children.filter(e1=>!$.includes(e1.key));Y.length>0&&W.push({...G,children:Y}),Y.length<G.children.length&&q.push({...G,children:G.children.filter(e1=>$.includes(e1.key))})}return{allGroups:F,visibleGroups:W,hiddenGroups:q}},[$,w,S]);s.useEffect(()=>{let F=null;const W=new ResizeObserver(f.throttle(q=>{for(const J of q)M(!0),F=requestAnimationFrame(()=>{var y1,l1;const{width:K}=J.contentRect,Y=Object.values(d.current).sort((r1,u1)=>r1.order-u1.order||r1.groupOrder-u1.groupOrder||r1.itemOrder-u1.itemOrder),e1=[];let s1=32;const b1=(((l1=(y1=w.find(r1=>r1.key===S))==null?void 0:y1.children)!=null?l1:[]).length-1)*8;s1+=b1;for(const{el:r1,key:u1}of Y){const{width:L1}=r1.getBoundingClientRect();s1+=L1+8,s1>K&&e1.push(u1)}O(e1),M(!1)})},100));return W.observe(b.current),()=>{F&&cancelAnimationFrame(F),W.disconnect()}},[w,S]);const X=s.useMemo(()=>C.jsx("div",{"aria-hidden":"true",className:T.clsx("univer-invisible univer-absolute -univer-left-[99999] -univer-top-[99999] univer-box-border univer-flex univer-h-10 univer-min-w-min univer-items-center univer-px-3 univer-opacity-0",{"univer-hidden":!k},T.divideXClassName,T.borderBottomClassName),children:P.allGroups.map((F,W)=>{var q,J;return(((q=F.children)==null?void 0:q.length)||F.item)&&C.jsx(s.Fragment,{children:C.jsx("div",{className:"univer-grid univer-shrink-0 univer-grid-flow-col univer-gap-2 univer-px-2",children:F.children&&((J=F.children)==null?void 0:J.map(K=>K.item&&C.jsx(ee,{...K.item,ref:G=>{G!=null&&G.el&&(d.current[K.key]={el:G.el,key:K.key,order:W,groupOrder:F.order,itemOrder:K.order})}},K.key)))})},F.key)})}),[P.allGroups,k]);return C.jsxs(C.Fragment,{children:[r&&t&&t.size>0&&C.jsx("header",{className:T.clsx("univer-relative univer-h-11 univer-select-none",T.borderBottomClassName),children:C.jsx("div",{className:"univer-absolute univer-right-2 univer-top-0 univer-flex univer-h-full univer-items-center univer-gap-2 [&>*]:univer-inline-flex [&>*]:univer-h-6 [&>*]:univer-items-center [&>*]:univer-rounded [&>*]:univer-px-1 [&>*]:univer-transition-colors hover:[&>*]:univer-bg-gray-100",children:C.jsx(p1,{components:t})})}),C.jsxs("div",{className:T.clsx("univer-box-border univer-grid univer-h-10 univer-grid-flow-col univer-items-center univer-px-3",{"univer-grid-cols-[auto,1fr]":w.length>1,"univer-grid-cols-none":w.length===1},T.borderBottomClassName),children:[w.length>1&&C.jsx(T.HoverCard,{className:"univer-max-w-96 !univer-rounded-xl",align:"start",open:D,overlay:C.jsx("div",{className:"univer-grid univer-gap-1 univer-px-2 univer-py-1",children:w.map(F=>{const W=c4[F.key];return C.jsxs("a",{"data-u-comp":"ribbon-group-btn",className:"univer-box-border univer-flex univer-cursor-pointer univer-items-center univer-gap-2.5 univer-rounded-lg univer-px-2 univer-py-1.5 hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700",onClick:()=>x(F),children:[C.jsx("span",{className:T.clsx("univer-box-border univer-flex univer-size-9 univer-flex-shrink-0 univer-items-center univer-justify-center univer-rounded-lg",T.borderClassName),children:C.jsx(W,{className:"univer-text-gray-500 dark:!univer-text-gray-300"})}),C.jsxs("span",{className:"univer-flex univer-flex-col",children:[C.jsx("strong",{className:"univer-text-sm univer-font-semibold univer-text-gray-800 dark:!univer-text-gray-200",children:i.t(F.key)}),C.jsx("span",{className:"univer-text-xs univer-text-gray-400",children:i.t(`${F.key}Desc`)})]})]},F.key)})}),onOpenChange:_,children:C.jsxs("a",{className:"univer-mr-2 univer-flex univer-h-7 univer-cursor-pointer univer-items-center univer-gap-1.5 univer-whitespace-nowrap !univer-rounded-full univer-bg-gray-700 univer-pl-3 univer-pr-2 univer-text-sm univer-text-white dark:!univer-bg-gray-200 dark:!univer-text-gray-800",onClick:()=>_(!0),children:[i.t(S),C.jsx(W1,{className:"univer-text-gray-200 dark:!univer-text-gray-500"})]})}),C.jsxs("div",{"data-u-comp":"ribbon-toolbar",ref:b,className:T.clsx("univer-flex univer-overflow-hidden",T.divideXClassName),children:[P.visibleGroups.map(F=>{var W,q;return(((W=F.children)==null?void 0:W.length)||F.item)&&C.jsx(s.Fragment,{children:C.jsx("div",{className:"univer-grid univer-shrink-0 univer-grid-flow-col univer-gap-2 univer-px-2",children:F.children&&((q=F.children)==null?void 0:q.map(J=>J.item&&C.jsx(ee,{...J.item},J.key)))})},F.key)}),$.length>0&&C.jsx("div",{"data-u-comp":"ribbon-toolbar-more",className:"univer-pl-2 rtl:univer-pr-2",children:C.jsx(T.Dropdown,{collisionPadding:{right:12,left:12},overlay:C.jsx("div",{className:"univer-box-border univer-grid univer-max-w-[var(--radix-popper-available-width)] univer-gap-2 univer-p-2",children:P.hiddenGroups.map(F=>{var W;return C.jsx("div",{className:"univer-flex univer-items-center univer-gap-2",children:C.jsx("div",{className:"univer-flex univer-flex-wrap univer-gap-2",children:F.children?(W=F.children)==null?void 0:W.map(q=>q.item&&C.jsx(ee,{...q.item},q.key)):F.item&&C.jsx(ee,{...F.item},F.key)})},F.key)})}),children:C.jsx("a",{className:g6,type:"button",children:C.jsx(Te,{})})})})]})]}),X]})}class te extends f.Disposable{constructor(){super(...arguments);z(this,"_styleSheetId","univer-theme-css-variables")}injectThemeToHead(t){function r(c,v="--univer"){const p=[];function b(d,w=""){for(const I in d){const S=d[I],N=w?`${w}-${I}`:I;typeof S=="object"&&S!==null?b(S,N):p.push(`${v}-${N}: ${S};`)}}return b(c),p.join(`
`)}const o=r(t),l=document.getElementById(this._styleSheetId);l&&l.remove();const i=document.createElement("style");i.setAttribute("id",this._styleSheetId),i.innerHTML=`:root {
${o}
}`,document.head.appendChild(i)}dispose(){super.dispose()}}const ne=f.createIdentifier("ui.contextmenu.service");class Ye extends f.Disposable{constructor(){super(...arguments);z(this,"_currentHandler",null);z(this,"disabled",!1)}get visible(){var t,r;return(r=(t=this._currentHandler)==null?void 0:t.visible)!=null?r:!1}disable(){this.disabled=!0}enable(){this.disabled=!1}triggerContextMenu(t,r){var o;t.stopPropagation(),!this.disabled&&((o=this._currentHandler)==null||o.handleContextMenu(t,r))}hideContextMenu(){var t;(t=this._currentHandler)==null||t.hideContextMenu()}registerContextMenuHandler(t){if(this._currentHandler)throw new Error("There is already a context menu handler!");return this._currentHandler=t,f.toDisposable(()=>this._currentHandler=null)}}function w6(){const e=s.useRef(null),[n,t]=s.useState(!1),[r,o]=s.useState(""),[l,i]=s.useState([0,0]),c=s.useRef(n),v=V.useDependency(ne),p=V.useDependency(f.ICommandService),b=V.useInjector();c.current=n,s.useEffect(()=>{const I=v.registerContextMenuHandler({handleContextMenu:d,hideContextMenu(){t(!1)},get visible(){return c.current}});function S(N){e.current&&!e.current.contains(N.target)&&w()}return document.addEventListener("pointerdown",S),document.addEventListener("wheel",w),()=>{document.removeEventListener("pointerdown",S),document.removeEventListener("wheel",w),I.dispose()}},[v]);function d(I,S){t(!1),requestAnimationFrame(()=>{o(S),i([I.clientX,I.clientY]),t(!0)})}function w(){t(!1)}return C.jsx(T.Popup,{visible:n,offset:l,children:C.jsx("section",{ref:e,children:r&&C.jsx(Ae,{menuType:r,onOptionSelect:I=>{const{label:S,commandId:N,value:D}=I;p&&p.executeCommand(N!=null?N:S,{value:D}),b.get(S1).focus(),t(!1)}})})})}const be=f.createIdentifier("univer.global-zone-service");function Xe(){const e=V.useDependency(be),[n,t]=s.useState(!1),r=V.useObservable(e.componentKey$,e.componentKey),o=V.useDependency(v1),l=s.useMemo(()=>{const i=o.get(r!=null?r:"");if(i)return i},[r,o]);return s.useEffect(()=>{const i=e.visible$.subscribe(c=>{t(c)});return()=>{i.unsubscribe()}},[e.visible$]),n?C.jsx("section",{className:T.clsx("univer-absolute univer-bg-gray-100",{"univer-hidden":!n,"univer-inset-0 univer-z-[100] univer-block univer-size-full":n}),children:l&&C.jsx(l,{})}):null}function qe(){const e=V.useDependency(x1),n=V.useObservable(e.sidebarOptions$),t=s.useRef(null),r=s.useMemo(()=>{if(!n)return null;const i={...n};for(const c of["children","header","footer"]){const v=c;if(n[v]){const{key:p,...b}=n[v];b&&(i[v]=C.jsx(d1,{...b},p))}}return i},[n]);s.useEffect(()=>(t.current&&e.setContainer(t.current),()=>{e.setContainer(void 0)}),[e]),s.useEffect(()=>{const i=v=>{e.scrollEvent$.next(v)},c=t.current;return c&&c.addEventListener("scroll",i),()=>{c==null||c.removeEventListener("scroll",i)}},[e]);const o=s.useMemo(()=>r!=null&&r.visible?typeof r.width=="number"?`${r.width}px`:r.width:0,[r]);function l(){var c;const i={...n,visible:!1};e.options.visible=!1,e.sidebarOptions$.next(i),(c=i==null?void 0:i.onClose)==null||c.call(i)}return C.jsx("section",{"data-u-comp":"sidebar",className:T.clsx("univer-relative univer-h-full univer-bg-white univer-text-gray-900 dark:!univer-bg-gray-900 dark:!univer-text-white",{"univer-w-96 univer-translate-x-0":r==null?void 0:r.visible,"univer-w-0 univer-translate-x-full":!(r!=null&&r.visible)}),style:{width:o},children:C.jsxs("section",{ref:t,className:T.clsx("univer-box-border univer-grid univer-h-0 univer-min-h-full univer-grid-rows-[auto_1fr_auto] univer-overflow-y-auto",T.borderLeftBottomClassName,T.scrollbarClassName),children:[C.jsxs("header",{className:"univer-sticky univer-top-0 univer-z-10 univer-box-border univer-flex univer-items-center univer-justify-between univer-bg-white univer-p-4 univer-pb-2 univer-text-base univer-font-medium univer-text-gray-800 dark:!univer-bg-gray-900 dark:!univer-text-white",children:[r==null?void 0:r.header,C.jsx("a",{className:"univer-cursor-pointer univer-text-gray-500 dark:!univer-text-gray-300",onClick:l,children:C.jsx(Ve,{})})]}),C.jsx("section",{className:"univer-box-border univer-px-4",style:r==null?void 0:r.bodyStyle,children:r==null?void 0:r.children}),(r==null?void 0:r.footer)&&C.jsx("footer",{className:"univer-sticky univer-bottom-0 univer-box-border univer-bg-white univer-p-4 dark:!univer-bg-gray-900",children:r.footer})]})})}const Le=f.createIdentifier("univer.zen-zone-service");function Je(){const e=V.useDependency(Le),[n,t]=s.useState(!1),[r,o]=s.useState(),l=V.useObservable(e.temporaryHidden$),i=V.useDependency(v1);s.useEffect(()=>{const v=[e.visible$.subscribe(p=>{t(p)}),e.componentKey$.subscribe(p=>{o(p)})];return()=>{v.forEach(p=>{p.unsubscribe()})}},[]);const c=s.useMemo(()=>{const v=i.get(r!=null?r:"");if(v)return v},[r]);return C.jsx("section",{className:T.clsx("univer-absolute univer-z-[-1] univer-flex",{"univer-animate-in univer-fade-in univer-inset-0 univer-z-[100] univer-bg-gray-100":n,"univer-hidden":l}),children:C.jsx("div",{className:"univer-relative univer-flex-1",children:c&&C.jsx(c,{})})})}function u4(e){const n=Z9(A1);return C.jsx(d4,{...e,...n})}function d4(e){var K;const{header:n=!0,toolbar:t=!0,footer:r=!0,headerMenu:o=!0,contextMenu:l=!0,ribbonType:i="default",mountContainer:c,onRendered:v}=e,p=V.useDependency(f.LocaleService),b=V.useDependency(f.ThemeService),d=V.useDependency(te),w=s.useRef(null),S=V.useDependency(f.IConfigService).getConfig(A1),N=m1(i1.CUSTOM_HEADER),D=m1(i1.FOOTER),_=m1(i1.HEADER),$=m1(i1.HEADER_MENU),O=m1(i1.CONTENT),k=m1(i1.LEFT_SIDEBAR),M=m1(i1.GLOBAL),x=m1(i1.TOOLBAR),P=(K=S==null?void 0:S.popupRootId)!=null?K:"univer-popup-portal";s.useLayoutEffect(()=>{const G=b.currentTheme$.subscribe(Y=>{d.injectThemeToHead(Y)});return()=>{G.unsubscribe()}},[]);const[X,F]=s.useState(!1);s.useLayoutEffect(()=>{const G=b.darkMode$.subscribe(Y=>{F(Y),Y?document.documentElement.classList.add("univer-dark"):document.documentElement.classList.remove("univer-dark")});return()=>{G.unsubscribe()}},[]),s.useEffect(()=>{w.current&&(v==null||v(w.current))},[v]);const[W,q]=s.useState(p.getLocales()),J=s.useMemo(()=>document.createElement("div"),[]);return s.useEffect(()=>{document.body.appendChild(J);const G=[p.localeChanged$.subscribe(()=>{q(p.getLocales())})];return()=>{G.forEach(Y=>Y.unsubscribe()),document.body.removeChild(J)}},[p,c,J]),C.jsxs(T.ConfigProvider,{locale:W==null?void 0:W.design,mountContainer:J,children:[C.jsxs("div",{"data-u-comp":"workbench-layout",className:T.clsx("univer-flex univer-h-full univer-min-h-0 univer-flex-col univer-bg-white dark:!univer-bg-gray-800",{"univer-dark":X}),tabIndex:-1,onBlur:G=>G.stopPropagation(),onContextMenu:G=>G.preventDefault(),children:[C.jsx("div",{className:"univer-relative univer-flex univer-min-h-0 univer-flex-col univer-bg-white dark:!univer-bg-gray-800",children:C.jsx(p1,{components:N},"custom-header")}),n&&t&&C.jsx("header",{"data-u-comp":"headerbar",className:"univer-relative univer-z-10 univer-w-full univer-overflow-hidden",children:C.jsx(p1,{components:x,sharedProps:{ribbonType:i,headerMenuComponents:$,headerMenu:o}},"toolbar")}),C.jsxs("section",{className:"univer-relative univer-flex univer-min-h-0 univer-flex-1 univer-flex-col",children:[C.jsxs("div",{className:"univer-grid univer-h-full univer-grid-cols-[auto_1fr_auto] univer-grid-rows-[100%] univer-overflow-hidden",children:[C.jsx("aside",{"data-u-comp":"left-sidebar",className:"univer-h-full",children:C.jsx(p1,{components:k},"left-sidebar")}),C.jsxs("section",{className:T.clsx("univer-relative univer-grid univer-flex-1 univer-grid-rows-[auto_1fr] univer-overflow-hidden univer-bg-white dark:!univer-bg-gray-800",T.borderBottomClassName),children:[C.jsx("header",{children:n&&C.jsx(p1,{components:_},"header")}),C.jsx("section",{className:"univer-relative univer-overflow-hidden dark:!univer-bg-gray-900",ref:w,"data-range-selector":!0,onContextMenu:G=>G.preventDefault(),children:C.jsx(p1,{components:O},"content")})]}),C.jsx("aside",{"data-u-comp":"right-sidebar",className:"univer-h-full",children:C.jsx(qe,{})})]}),r&&C.jsx("footer",{children:C.jsx(p1,{components:D,sharedProps:{contextMenu:l}},"footer")}),C.jsx(Je,{})]})]}),C.jsx(p1,{components:M},"global"),C.jsx(Xe,{}),l&&C.jsx(w6,{}),C.jsx(f4,{}),C.jsx("div",{id:P})]})}function f4(){const{mountContainer:e}=s.useContext(T.ConfigContext),n=m1(i1.FLOATING);return S3.createPortal(C.jsx(p1,{components:n},"floating"),e)}const h4=3e3;class Qe extends f.Disposable{constructor(t,r,o,l,i){super();z(this,"_steadyTimeout");z(this,"_renderTimeout");z(this,"_currentRenderId",null);this._injector=t,this._instanceService=r,this._layoutService=o,this._lifecycleService=l,this._renderManagerService=i}dispose(){super.dispose(),clearTimeout(this._steadyTimeout),clearTimeout(this._renderTimeout),delete this._instanceService,delete this._layoutService,delete this._lifecycleService,delete this._renderManagerService}_bootstrapWorkbench(){this.disposeWithMe(this.bootstrap(async(t,r)=>{this._layoutService&&(this.disposeWithMe(this._layoutService.registerRootContainerElement(r)),this.disposeWithMe(this._layoutService.registerContentElement(t)));try{await this._lifecycleService.onStage(f.LifecycleStages.Ready),this._renderTimeout=window.setTimeout(()=>{const o=this._renderManagerService.getRenderAll();for(const[l]of o)if(this._changeRenderUnit(l,t))break;this.disposeWithMe(this._instanceService.focused$.subscribe(l=>{l&&this._changeRenderUnit(l,t)})),this.disposeWithMe(this._renderManagerService.created$.subscribe(l=>{var i;l.unitId===((i=this._instanceService.getFocusedUnit())==null?void 0:i.getUnitId())&&this._changeRenderUnit(l.unitId,t)})),this.disposeWithMe(this._renderManagerService.disposed$.subscribe(l=>{this._currentRenderId===l&&(this._currentRenderId=null)})),this._lifecycleService.stage=f.LifecycleStages.Rendered,this._steadyTimeout=window.setTimeout(()=>{this._lifecycleService.stage=f.LifecycleStages.Steady},h4)},300)}catch(o){if(o instanceof f.LifecycleUnreachableError)return;throw o}}))}_changeRenderUnit(t,r){if(this._currentRenderId===t)return!1;const o=this._renderManagerService.getRenderById(t);if(!o||!o.unitId||f.isInternalEditorID(o.unitId))return!1;const l=this._currentRenderId?this._renderManagerService.getRenderById(this._currentRenderId):null;return l==null||l.deactivate(),l==null||l.engine.unmount(),o.engine.mount(r),o.activate(),this._currentRenderId=t,!0}}var C4=Object.getOwnPropertyDescriptor,v4=(e,n,t,r)=>{for(var o=r>1?void 0:r?C4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},O1=(e,n)=>(t,r)=>n(t,r,e);h.DesktopUIController=class extends Qe{constructor(n,t,r,o,l,i,c,v,p){super(t,i,l,r,o),this._config=n,this._componentManager=p,c.mergeMenu(t6),this._initBuiltinComponents(v),this._registerComponents(),this._bootstrapWorkbench()}_registerComponents(){[[N9,V9],[$9,T9],[F9,P9],[k9,B9],[j9,U9],[A9,T.ColorPicker]].forEach(([n,t])=>{this.disposeWithMe(this._componentManager.register(n,t))})}dispose(){super.dispose(),this._componentManager.dispose()}bootstrap(n){return g4(this._injector,this._config,n)}_initBuiltinComponents(n){this.disposeWithMe(n.registerComponent(i1.FLOATING,()=>V.connectInjector(Ge,this._injector))),this.disposeWithMe(n.registerComponent(i1.CONTENT,()=>V.connectInjector(je,this._injector))),this.disposeWithMe(n.registerComponent(i1.TOOLBAR,()=>V.connectInjector(L6,this._injector)))}},h.DesktopUIController=v4([O1(1,f.Inject(f.Injector)),O1(2,f.Inject(f.LifecycleService)),O1(3,z1.IRenderManagerService),O1(4,S1),O1(5,f.IUniverInstanceService),O1(6,M1),O1(7,w1),O1(8,f.Inject(v1))],h.DesktopUIController);function g4(e,n,t){let r;const o=n.container;if(typeof o=="string"){const v=document.getElementById(o);v?r=v:r=y6(o)}else o instanceof HTMLElement?r=o:r=y6("univer");const l=V.connectInjector(u4,e),i=v=>t(v,r);function c(){T.render(C.jsx(l,{...n,mountContainer:r,onRendered:i}),r)}return c(),f.toDisposable(()=>{T.render(C.jsx("div",{}),r),setTimeout(()=>T.render(C.jsx("div",{}),r),200),setTimeout(()=>T.unmount(r),500)})}function y6(e){const n=document.createElement("div");return n.id=e,n}const re=f.createIdentifier("univer.ui.ui-controller");function p4(e){const{menuType:n,onOptionSelect:t}=e,r=V.useDependency(M1);if(!n)return null;const o=s.useMemo(()=>{const l=r.getMenuByPositionKey(n);function i(c){return c.reduce((v,p)=>p.children?[...v,...i(p.children)]:[...v,p],[])}return i(l)},[n]);return C.jsx("div",{className:"univer-box-border univer-grid univer-min-w-8 univer-max-w-52 univer-gap-1 univer-rounded univer-bg-gray-900 univer-px-2 univer-py-1",style:{gridTemplateColumns:`repeat(${Math.min(2,o.length)},  72px)`},children:o.map(l=>l.item&&C.jsx(m4,{menuItem:l.item,onClick:i=>t==null?void 0:t({value:"",label:l.key,...i})},l.key))})}function m4(e){const{menuItem:n,onClick:t}=e,{id:r,type:o,title:l,label:i,icon:c}=n;if(o!==g1.BUTTON)throw new Error(`[MobileMenuItem]: on mobile devices only "BUTTON" type menu items are supported. Please check "${r}".`);const v=V.useObservable(n.disabled$,!1),p=V.useObservable(n.value$);return C.jsx("button",{type:"button",className:T.clsx("univer-w-18 univer-flex univer-flex-col univer-items-center univer-justify-center univer-border-none univer-bg-transparent univer-text-white [&>span]:univer-mt-0.5 [&>span]:univer-w-full [&>span]:univer-truncate [&>span]:univer-text-sm [&>svg]:univer-size-[18px] [&>svg]:univer-text-lg"),disabled:v,onClick:()=>t({id:r}),children:C.jsx(d1,{value:p,title:l,label:i,icon:c})},r)}function I6(){const[e,n]=s.useState(!1),[t,r]=s.useState(""),[o,l]=s.useState([0,0]),i=s.useRef(e),c=V.useDependency(ne),v=V.useDependency(f.ICommandService);i.current=e,s.useEffect(()=>{const d=c.registerContextMenuHandler({handleContextMenu:p,hideContextMenu(){n(!1)},get visible(){return i.current}});return document.addEventListener("pointerdown",b),document.addEventListener("wheel",b),()=>{document.removeEventListener("pointerdown",b),document.removeEventListener("wheel",b),d.dispose()}},[c]);function p(d,w){r(w),l([d.clientX,d.clientY]),n(!0)}function b(){n(!1)}return C.jsx(T.Popup,{visible:e,offset:o,children:C.jsx("section",{onPointerDown:d=>d.stopPropagation(),children:t&&C.jsx(p4,{menuType:t,onOptionSelect:d=>{const{label:w,value:I,commandId:S}=d;v&&v.executeCommand(S!=null?S:w,{value:I}),n(!1)}})})})}function b4(e){const{header:n=!0,footer:t=!0,contextMenu:r=!0,mountContainer:o,onRendered:l}=e,i=V.useDependency(f.LocaleService),c=V.useDependency(f.ThemeService),v=V.useDependency(te),p=s.useRef(null),b=m1(i1.FOOTER),d=m1(i1.HEADER),w=m1(i1.CONTENT),I=m1(i1.LEFT_SIDEBAR),S=m1(i1.GLOBAL),[N,D]=s.useState(!1);s.useEffect(()=>{const k=c.darkMode$.subscribe(M=>{D(M)});return()=>{k.unsubscribe()}},[]),s.useEffect(()=>{p.current&&(l==null||l(p.current))},[l]);const[_,$]=s.useState(i.getLocales()),O=s.useMemo(()=>document.createElement("div"),[]);return s.useLayoutEffect(()=>{const k=c.currentTheme$.subscribe(M=>{v.injectThemeToHead(M)});return()=>{k.unsubscribe()}},[]),s.useEffect(()=>{document.body.appendChild(O);const k=[i.localeChanged$.subscribe(()=>{$(i.getLocales())})];return()=>{k.forEach(M=>M.unsubscribe()),document.body.removeChild(O)}},[i,o,O]),C.jsxs(T.ConfigProvider,{locale:_==null?void 0:_.design,mountContainer:O,children:[C.jsxs("div",{"data-u-comp":"app-layout",className:T.clsx("univer-relative univer-flex univer-h-full univer-min-h-0 univer-flex-col univer-bg-white dark:!univer-bg-gray-800",{"univer-dark":N}),tabIndex:-1,onBlur:k=>k.stopPropagation(),children:[n&&C.jsx("header",{className:"univer-relative univer-z-10 univer-w-full"}),C.jsxs("section",{className:"univer-relative univer-flex univer-min-h-0 univer-flex-1 univer-flex-col",children:[C.jsxs("div",{className:"univer-grid univer-h-full univer-grid-cols-[auto_1fr_auto] univer-grid-rows-[100%] univer-overflow-hidden",children:[C.jsx("aside",{className:"univer-h-full",children:C.jsx(p1,{components:I},"left-sidebar")}),C.jsxs("section",{className:T.clsx("univer-relative univer-grid univer-flex-1 univer-grid-rows-[auto_1fr] univer-overflow-hidden univer-bg-white dark:!univer-bg-gray-800",T.borderBottomClassName),children:[C.jsx("header",{className:"univer-w-screen",children:n&&C.jsx(p1,{components:d},"header")}),C.jsx("section",{ref:p,className:"univer-relative univer-overflow-hidden","data-range-selector":!0,onContextMenu:k=>k.preventDefault(),children:C.jsx(p1,{components:w},"content")})]}),C.jsx("aside",{className:"univer-h-full",children:C.jsx(qe,{})})]}),t&&C.jsx("footer",{children:C.jsx(p1,{components:b},"footer")}),C.jsx(Xe,{}),C.jsx(Je,{})]})]}),C.jsx(p1,{components:S},"global"),r&&C.jsx(I6,{})]})}var L4=Object.getOwnPropertyDescriptor,w4=(e,n,t,r)=>{for(var o=r>1?void 0:r?L4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},F1=(e,n)=>(t,r)=>n(t,r,e);let Ke=class extends Qe{constructor(e,n,t,r,o,l,i){super(n,l,o,t,r),this._config=e,this._initBuiltinComponents(i),this._bootstrapWorkbench()}bootstrap(e){return y4(this._injector,this._config,e)}_initBuiltinComponents(e){this.disposeWithMe(e.registerComponent(i1.CONTENT,()=>V.connectInjector(Ge,this._injector))),this.disposeWithMe(e.registerComponent(i1.CONTENT,()=>V.connectInjector(je,this._injector)))}};Ke=w4([F1(1,f.Inject(f.Injector)),F1(2,f.Inject(f.LifecycleService)),F1(3,z1.IRenderManagerService),F1(4,S1),F1(5,f.IUniverInstanceService),F1(6,w1)],Ke);function y4(e,n,t){let r;const o=n.container;if(typeof o=="string"){const v=document.getElementById(o);v?r=v:r=M6(o)}else o instanceof HTMLElement?r=o:r=M6("univer");const l=V.connectInjector(b4,e),i=v=>t(v,r);function c(){T.render(C.jsx(l,{...n,mountContainer:r,onRendered:i}),r)}return c(),f.toDisposable(()=>{T.unmount(r)})}function M6(e){const n=document.createElement("div");return n.id=e,n}const oe=f.createIdentifier("ui.notification.service");var I4=Object.getOwnPropertyDescriptor,M4=(e,n,t,r)=>{for(var o=r>1?void 0:r?I4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},_4=(e,n)=>(t,r)=>n(t,r,e);const e3=f.createIdentifier("univer.ui.before-close-service");h.DesktopBeforeCloseService=class{constructor(n){z(this,"_beforeUnloadCallbacks",[]);z(this,"_onCloseCallbacks",[]);this._notificationService=n,this._init()}registerBeforeClose(n){return this._beforeUnloadCallbacks.push(n),{dispose:()=>{this._beforeUnloadCallbacks=this._beforeUnloadCallbacks.filter(t=>t!==n)}}}registerOnClose(n){return this._onCloseCallbacks.push(n),{dispose:()=>{this._onCloseCallbacks=this._onCloseCallbacks.filter(t=>t!==n)}}}_init(){window.addEventListener("beforeunload",n=>{let t=n;const r=this._beforeUnloadCallbacks.map(o=>o()).filter(o=>!!o).join(`
`);if(r)return this._notificationService.show({type:"error",title:"Some changes are not saved",content:r}),typeof t>"u"&&(t=window.event),t.returnValue=r,r}),window.addEventListener("unload",()=>{this._onCloseCallbacks.forEach(n=>n())})}},h.DesktopBeforeCloseService=M4([_4(0,oe)],h.DesktopBeforeCloseService);function _6(){return typeof navigator.clipboard<"u"&&typeof navigator.clipboard.readText<"u"}var S4=Object.getOwnPropertyDescriptor,H4=(e,n,t,r)=>{for(var o=r>1?void 0:r?S4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},t3=(e,n)=>(t,r)=>n(t,r,e);const n3="text/plain",r3="text/html",S6="image/png",H6="image/jpeg",E6="image/bmp",D6="image/webp",E4="image/svg+xml",D4=new Set([E6,H6,D6,S6]),o3=f.createIdentifier("univer.clipboard-interface-service");h.BrowserClipboardService=class extends f.Disposable{constructor(n,t,r){super(),this._localeService=n,this._logService=t,this._notificationService=r}get supportClipboard(){return _6()}async write(n,t){if(!this.supportClipboard)return this._legacyCopyHtml(t);try{return await navigator.clipboard.write([new ClipboardItem({[n3]:new Blob([n],{type:n3}),[r3]:new Blob([t],{type:r3})})])}catch(r){this._logService.error("[BrowserClipboardService]",r),this._showClipboardAuthenticationNotification()}}async writeText(n){if(!this.supportClipboard)return this._legacyCopyText(n);try{return await navigator.clipboard.writeText(n)}catch(t){this._logService.error("[BrowserClipboardService]",t),this._showClipboardAuthenticationNotification()}}async read(){if(!this.supportClipboard)throw new Error("[BrowserClipboardService] read() is not supported on this platform.");try{return navigator.clipboard.read()}catch(n){return this._logService.error("[BrowserClipboardService]",n),this._showClipboardAuthenticationNotification(),[]}}async readText(){if(!this.supportClipboard)throw new Error("[BrowserClipboardService] read() is not supported on this platform.");try{return await navigator.clipboard.readText()}catch(n){return this._logService.error("[BrowserClipboardService]",n),this._showClipboardAuthenticationNotification(),""}}_legacyCopyHtml(n){const t=document.activeElement,r=R4();document.body.appendChild(r),r.innerHTML=n;try{O6(r),document.execCommand("copy")}finally{t instanceof HTMLElement&&t.focus(),document.body.removeChild(r)}}_legacyCopyText(n){const t=document.activeElement,r=O4();document.body.appendChild(r),r.value=n;try{O6(r),document.execCommand("copy")}finally{t instanceof HTMLElement&&t.focus(),document.body.removeChild(r)}}_showClipboardAuthenticationNotification(){var n;(n=this._notificationService)==null||n.show({type:"warning",title:this._localeService.t("clipboard.authentication.title"),content:this._localeService.t("clipboard.authentication.content")})}},h.BrowserClipboardService=H4([t3(0,f.Inject(f.LocaleService)),t3(1,f.ILogService),t3(2,f.Optional(oe))],h.BrowserClipboardService);function O4(){const e=document.createElement("textarea");return e.style.position="absolute",e.style.height="1px",e.style.width="1px",e.style.opacity="0",e.readOnly=!0,e}function R4(){const e=document.createElement("div");return e.contentEditable="true",e.style.position="absolute",e.style.opacity="0",e.style.height="1px",e.style.width="1px",e}function O6(e){if(e instanceof HTMLTextAreaElement){const r=e.hasAttribute("readonly");return r||e.setAttribute("readonly",""),e.select(),e.setSelectionRange(0,e.value.length),r||e.removeAttribute("readonly"),e.value}e.hasAttribute("contenteditable")&&e.focus();const n=document.createRange();n.selectNodeContents(e);const t=window.getSelection();if(!t)throw new Error;return t.removeAllRanges(),t.addRange(n),t.toString()}const we=f.createIdentifier("univer.confirm-service");class V4{constructor(){z(this,"confirmOptions$",new U.Subject)}dispose(){this.confirmOptions$.complete()}open(n){throw new Error("This is not implemented in the test service!")}confirm(n){return Promise.resolve(!0)}close(n){throw new Error("This is not implemented in the test service!")}}const N4=e=>{const{children:n,onClose:t,onConfirm:r}=e,[o]=s.useState({}),l=n?s.cloneElement(n,{hooks:o}):null;return C.jsx(T.Confirm,{...e,children:l,onClose:()=>{const i=o.beforeClose;if(i){const c=i();if(c.cancel)return;t==null||t(c);return}t==null||t()},onConfirm:()=>{const i=o.beforeConfirm;if(i){const c=i();if(c.cancel)return;r==null||r(c);return}r==null||r()}})};function T4(){const e=V.useDependency(we),[n,t]=s.useState([]);s.useEffect(()=>{const o=e.confirmOptions$.subscribe(l=>{t(l)});return()=>{o.unsubscribe()}},[]);const r=n.map(o=>{const{children:l,title:i,...c}=o,v=c;for(const p of["children","title"]){const b=p,d=o[b];d&&(v[b]=C.jsx(d1,{...d}))}return v});return r==null?void 0:r.map((o,l)=>C.jsx(N4,{...o,children:o.children},l))}var $4=Object.getOwnPropertyDescriptor,x4=(e,n,t,r)=>{for(var o=r>1?void 0:r?$4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},R6=(e,n)=>(t,r)=>n(t,r,e);h.DesktopConfirmService=class extends f.Disposable{constructor(t,r){super();z(this,"_confirmOptions",[]);z(this,"confirmOptions$",new U.BehaviorSubject([]));this._injector=t,this._uiPartsService=r,this._initUIPart()}open(t){return this._confirmOptions.find(r=>r.id===t.id)?this._confirmOptions=this._confirmOptions.map(r=>({...r.id===t.id?t:r,visible:r.id===t.id?!0:r.visible})):this._confirmOptions.push({...t,visible:!0}),this.confirmOptions$.next(this._confirmOptions),f.toDisposable(()=>{this._confirmOptions=[],this.confirmOptions$.next([])})}confirm(t){return new Promise(r=>{const o=this.open({...t,onConfirm:()=>{o.dispose(),r(!0)},onClose:()=>{o.dispose(),r(!1)}})})}close(t){this._confirmOptions=this._confirmOptions.map(r=>({...r,visible:r.id===t?!1:r.visible})),this.confirmOptions$.next([...this._confirmOptions])}_initUIPart(){this.disposeWithMe(this._uiPartsService.registerComponent(i1.GLOBAL,()=>V.connectInjector(T4,this._injector)))}},h.DesktopConfirmService=x4([R6(0,f.Inject(f.Injector)),R6(1,w1)],h.DesktopConfirmService);const ye=f.createIdentifier("univer.ui.dialog-service");function Z4(){const e=V.useDependency(ye),[n,t]=s.useState([]);s.useEffect(()=>{const l=e.getDialogs$().subscribe(i=>{t(i)});return()=>l.unsubscribe()},[]);const r=s.useMemo(()=>n.map(o=>{const{children:l,title:i,footer:c,...v}=o,p=v;for(const b of["children","title","footer"]){const d=b,w=o[d];w&&(p[d]=C.jsx(d1,{...w}))}return p}),[n]);return r==null?void 0:r.map(o=>C.jsx(T.Dialog,{...o},o.id))}var A4=Object.getOwnPropertyDescriptor,P4=(e,n,t,r)=>{for(var o=r>1?void 0:r?A4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},V6=(e,n)=>(t,r)=>n(t,r,e);h.DesktopDialogService=class extends f.Disposable{constructor(t,r){super();z(this,"_dialogOptions",[]);z(this,"_dialogOptions$",new U.Subject);this._injector=t,this._uiPartsService=r,this._initUIPart()}dispose(){super.dispose(),this._dialogOptions=[],this._dialogOptions$.complete()}open(t){return this._dialogOptions.find(r=>r.id===t.id)?this._dialogOptions=this._dialogOptions.map(r=>({...r.id===t.id?t:r,open:r.id===t.id?!0:r.open})):this._dialogOptions.push({...t,open:!0}),this._dialogOptions$.next(this._dialogOptions),f.toDisposable(()=>{this._dialogOptions=[],this._dialogOptions$.next([])})}close(t){this._dialogOptions=this._dialogOptions.map(r=>({...r,open:r.id===t?!1:r.open})),this._dialogOptions$.next([...this._dialogOptions])}closeAll(t){const r=new Set(t);this._dialogOptions=this._dialogOptions.map(o=>({...o,open:r.has(o.id)?o.open:!1})),this._dialogOptions$.next([...this._dialogOptions])}getDialogs$(){return this._dialogOptions$.asObservable()}_initUIPart(){this.disposeWithMe(this._uiPartsService.registerComponent(i1.GLOBAL,()=>V.connectInjector(Z4,this._injector)))}},h.DesktopDialogService=P4([V6(0,f.Inject(f.Injector)),V6(1,w1)],h.DesktopDialogService);const Ie=f.createIdentifier("univer.ui.gallery-service");function B4(){const e=V.useDependency(Ie),n=V.useObservable(e.gallery$);return n?C.jsx(T.Gallery,{...n}):null}var F4=Object.getOwnPropertyDescriptor,k4=(e,n,t,r)=>{for(var o=r>1?void 0:r?F4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},N6=(e,n)=>(t,r)=>n(t,r,e);h.DesktopGalleryService=class extends f.Disposable{constructor(t,r){super();z(this,"gallery$",new U.Subject);this._injector=t,this._uiPartsService=r,this._initUIPart()}dispose(){super.dispose()}open(t){return this.gallery$.next({open:!0,...t}),f.toDisposable(()=>{this.gallery$.complete()})}close(){this.gallery$.next({open:!1,images:[]})}_initUIPart(){this.disposeWithMe(this._uiPartsService.registerComponent(i1.GLOBAL,()=>V.connectInjector(B4,this._injector)))}},h.DesktopGalleryService=k4([N6(0,f.Inject(f.Injector)),N6(1,w1)],h.DesktopGalleryService);var U4=Object.getOwnPropertyDescriptor,j4=(e,n,t,r)=>{for(var o=r>1?void 0:r?U4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},z4=(e,n)=>(t,r)=>n(t,r,e);h.DesktopGlobalZoneService=class{constructor(n){z(this,"visible$",new U.Subject);z(this,"componentKey$",new U.Subject);z(this,"_componentKey","");this._componentManager=n}get componentKey(){return this._componentKey}set(n,t){return this._componentManager.register(n,t),this.componentKey$.next(n),this._componentKey=n,f.toDisposable(()=>{this._componentManager.delete(n),this.visible$.complete(),this.componentKey$.complete()})}open(){this.visible$.next(!0)}close(){this.visible$.next(!1)}},h.DesktopGlobalZoneService=j4([z4(0,f.Inject(v1))],h.DesktopGlobalZoneService);class i3 extends f.Disposable{openFile(n){return new Promise(t=>{var o,l;const r=document.createElement("input");r.type="file",r.accept=(o=n==null?void 0:n.accept)!=null?o:"",r.multiple=(l=n==null?void 0:n.multiple)!=null?l:!1,r.onchange=i=>{const c=i.target.files;c&&t(Array.from(c))},r.click()})}downloadFile(n,t){const r=document.createElement("a");r.download=t,r.href=window.URL.createObjectURL(n),r.click()}}const l3=f.createIdentifier("univer-ui.local-file.service");var Me=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function G4(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function _e(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var s3={exports:{}};/*!
    localForage -- Offline Storage, Improved
    Version 1.10.0
    https://localforage.github.io/localForage
    (c) 2013-2017 Mozilla, Apache License 2.0
*/var T6;function W4(){return T6||(T6=1,(function(e,n){(function(t){e.exports=t()})(function(){return(function t(r,o,l){function i(p,b){if(!o[p]){if(!r[p]){var d=typeof _e=="function"&&_e;if(!b&&d)return d(p,!0);if(c)return c(p,!0);var w=new Error("Cannot find module '"+p+"'");throw w.code="MODULE_NOT_FOUND",w}var I=o[p]={exports:{}};r[p][0].call(I.exports,function(S){var N=r[p][1][S];return i(N||S)},I,I.exports,t,r,o,l)}return o[p].exports}for(var c=typeof _e=="function"&&_e,v=0;v<l.length;v++)i(l[v]);return i})({1:[function(t,r,o){(function(l){var i=l.MutationObserver||l.WebKitMutationObserver,c;if(i){var v=0,p=new i(S),b=l.document.createTextNode("");p.observe(b,{characterData:!0}),c=function(){b.data=v=++v%2}}else if(!l.setImmediate&&typeof l.MessageChannel<"u"){var d=new l.MessageChannel;d.port1.onmessage=S,c=function(){d.port2.postMessage(0)}}else"document"in l&&"onreadystatechange"in l.document.createElement("script")?c=function(){var D=l.document.createElement("script");D.onreadystatechange=function(){S(),D.onreadystatechange=null,D.parentNode.removeChild(D),D=null},l.document.documentElement.appendChild(D)}:c=function(){setTimeout(S,0)};var w,I=[];function S(){w=!0;for(var D,_,$=I.length;$;){for(_=I,I=[],D=-1;++D<$;)_[D]();$=I.length}w=!1}r.exports=N;function N(D){I.push(D)===1&&!w&&c()}}).call(this,typeof Me<"u"?Me:typeof self<"u"?self:typeof window<"u"?window:{})},{}],2:[function(t,r,o){var l=t(1);function i(){}var c={},v=["REJECTED"],p=["FULFILLED"],b=["PENDING"];r.exports=d;function d(M){if(typeof M!="function")throw new TypeError("resolver must be a function");this.state=b,this.queue=[],this.outcome=void 0,M!==i&&N(this,M)}d.prototype.catch=function(M){return this.then(null,M)},d.prototype.then=function(M,x){if(typeof M!="function"&&this.state===p||typeof x!="function"&&this.state===v)return this;var P=new this.constructor(i);if(this.state!==b){var X=this.state===p?M:x;I(P,X,this.outcome)}else this.queue.push(new w(P,M,x));return P};function w(M,x,P){this.promise=M,typeof x=="function"&&(this.onFulfilled=x,this.callFulfilled=this.otherCallFulfilled),typeof P=="function"&&(this.onRejected=P,this.callRejected=this.otherCallRejected)}w.prototype.callFulfilled=function(M){c.resolve(this.promise,M)},w.prototype.otherCallFulfilled=function(M){I(this.promise,this.onFulfilled,M)},w.prototype.callRejected=function(M){c.reject(this.promise,M)},w.prototype.otherCallRejected=function(M){I(this.promise,this.onRejected,M)};function I(M,x,P){l(function(){var X;try{X=x(P)}catch(F){return c.reject(M,F)}X===M?c.reject(M,new TypeError("Cannot resolve promise with itself")):c.resolve(M,X)})}c.resolve=function(M,x){var P=D(S,x);if(P.status==="error")return c.reject(M,P.value);var X=P.value;if(X)N(M,X);else{M.state=p,M.outcome=x;for(var F=-1,W=M.queue.length;++F<W;)M.queue[F].callFulfilled(x)}return M},c.reject=function(M,x){M.state=v,M.outcome=x;for(var P=-1,X=M.queue.length;++P<X;)M.queue[P].callRejected(x);return M};function S(M){var x=M&&M.then;if(M&&(typeof M=="object"||typeof M=="function")&&typeof x=="function")return function(){x.apply(M,arguments)}}function N(M,x){var P=!1;function X(J){P||(P=!0,c.reject(M,J))}function F(J){P||(P=!0,c.resolve(M,J))}function W(){x(F,X)}var q=D(W);q.status==="error"&&X(q.value)}function D(M,x){var P={};try{P.value=M(x),P.status="success"}catch(X){P.status="error",P.value=X}return P}d.resolve=_;function _(M){return M instanceof this?M:c.resolve(new this(i),M)}d.reject=$;function $(M){var x=new this(i);return c.reject(x,M)}d.all=O;function O(M){var x=this;if(Object.prototype.toString.call(M)!=="[object Array]")return this.reject(new TypeError("must be an array"));var P=M.length,X=!1;if(!P)return this.resolve([]);for(var F=new Array(P),W=0,q=-1,J=new this(i);++q<P;)K(M[q],q);return J;function K(G,Y){x.resolve(G).then(e1,function(s1){X||(X=!0,c.reject(J,s1))});function e1(s1){F[Y]=s1,++W===P&&!X&&(X=!0,c.resolve(J,F))}}}d.race=k;function k(M){var x=this;if(Object.prototype.toString.call(M)!=="[object Array]")return this.reject(new TypeError("must be an array"));var P=M.length,X=!1;if(!P)return this.resolve([]);for(var F=-1,W=new this(i);++F<P;)q(M[F]);return W;function q(J){x.resolve(J).then(function(K){X||(X=!0,c.resolve(W,K))},function(K){X||(X=!0,c.reject(W,K))})}}},{1:1}],3:[function(t,r,o){(function(l){typeof l.Promise!="function"&&(l.Promise=t(2))}).call(this,typeof Me<"u"?Me:typeof self<"u"?self:typeof window<"u"?window:{})},{2:2}],4:[function(t,r,o){var l=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(a){return typeof a}:function(a){return a&&typeof Symbol=="function"&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};function i(a,g){if(!(a instanceof g))throw new TypeError("Cannot call a class as a function")}function c(){try{if(typeof indexedDB<"u")return indexedDB;if(typeof webkitIndexedDB<"u")return webkitIndexedDB;if(typeof mozIndexedDB<"u")return mozIndexedDB;if(typeof OIndexedDB<"u")return OIndexedDB;if(typeof msIndexedDB<"u")return msIndexedDB}catch{return}}var v=c();function p(){try{if(!v||!v.open)return!1;var a=typeof openDatabase<"u"&&/(Safari|iPhone|iPad|iPod)/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent)&&!/BlackBerry/.test(navigator.platform),g=typeof fetch=="function"&&fetch.toString().indexOf("[native code")!==-1;return(!a||g)&&typeof indexedDB<"u"&&typeof IDBKeyRange<"u"}catch{return!1}}function b(a,g){a=a||[],g=g||{};try{return new Blob(a,g)}catch(m){if(m.name!=="TypeError")throw m;for(var u=typeof BlobBuilder<"u"?BlobBuilder:typeof MSBlobBuilder<"u"?MSBlobBuilder:typeof MozBlobBuilder<"u"?MozBlobBuilder:WebKitBlobBuilder,L=new u,y=0;y<a.length;y+=1)L.append(a[y]);return L.getBlob(g.type)}}typeof Promise>"u"&&t(3);var d=Promise;function w(a,g){g&&a.then(function(u){g(null,u)},function(u){g(u)})}function I(a,g,u){typeof g=="function"&&a.then(g),typeof u=="function"&&a.catch(u)}function S(a){return typeof a!="string"&&(console.warn(a+" used as a key, but it is not a string."),a=String(a)),a}function N(){if(arguments.length&&typeof arguments[arguments.length-1]=="function")return arguments[arguments.length-1]}var D="local-forage-detect-blob-support",_=void 0,$={},O=Object.prototype.toString,k="readonly",M="readwrite";function x(a){for(var g=a.length,u=new ArrayBuffer(g),L=new Uint8Array(u),y=0;y<g;y++)L[y]=a.charCodeAt(y);return u}function P(a){return new d(function(g){var u=a.transaction(D,M),L=b([""]);u.objectStore(D).put(L,"key"),u.onabort=function(y){y.preventDefault(),y.stopPropagation(),g(!1)},u.oncomplete=function(){var y=navigator.userAgent.match(/Chrome\/(\d+)/),m=navigator.userAgent.match(/Edge\//);g(m||!y||parseInt(y[1],10)>=43)}}).catch(function(){return!1})}function X(a){return typeof _=="boolean"?d.resolve(_):P(a).then(function(g){return _=g,_})}function F(a){var g=$[a.name],u={};u.promise=new d(function(L,y){u.resolve=L,u.reject=y}),g.deferredOperations.push(u),g.dbReady?g.dbReady=g.dbReady.then(function(){return u.promise}):g.dbReady=u.promise}function W(a){var g=$[a.name],u=g.deferredOperations.pop();if(u)return u.resolve(),u.promise}function q(a,g){var u=$[a.name],L=u.deferredOperations.pop();if(L)return L.reject(g),L.promise}function J(a,g){return new d(function(u,L){if($[a.name]=$[a.name]||r1(),a.db)if(g)F(a),a.db.close();else return u(a.db);var y=[a.name];g&&y.push(a.version);var m=v.open.apply(v,y);g&&(m.onupgradeneeded=function(E){var R=m.result;try{R.createObjectStore(a.storeName),E.oldVersion<=1&&R.createObjectStore(D)}catch(Z){if(Z.name==="ConstraintError")console.warn('The database "'+a.name+'" has been upgraded from version '+E.oldVersion+" to version "+E.newVersion+', but the storage "'+a.storeName+'" already exists.');else throw Z}}),m.onerror=function(E){E.preventDefault(),L(m.error)},m.onsuccess=function(){var E=m.result;E.onversionchange=function(R){R.target.close()},u(E),W(a)}})}function K(a){return J(a,!1)}function G(a){return J(a,!0)}function Y(a,g){if(!a.db)return!0;var u=!a.db.objectStoreNames.contains(a.storeName),L=a.version<a.db.version,y=a.version>a.db.version;if(L&&(a.version!==g&&console.warn('The database "'+a.name+`" can't be downgraded from version `+a.db.version+" to version "+a.version+"."),a.version=a.db.version),y||u){if(u){var m=a.db.version+1;m>a.version&&(a.version=m)}return!0}return!1}function e1(a){return new d(function(g,u){var L=new FileReader;L.onerror=u,L.onloadend=function(y){var m=btoa(y.target.result||"");g({__local_forage_encoded_blob:!0,data:m,type:a.type})},L.readAsBinaryString(a)})}function s1(a){var g=x(atob(a.data));return b([g],{type:a.type})}function C1(a){return a&&a.__local_forage_encoded_blob}function b1(a){var g=this,u=g._initReady().then(function(){var L=$[g._dbInfo.name];if(L&&L.dbReady)return L.dbReady});return I(u,a,a),u}function y1(a){F(a);for(var g=$[a.name],u=g.forages,L=0;L<u.length;L++){var y=u[L];y._dbInfo.db&&(y._dbInfo.db.close(),y._dbInfo.db=null)}return a.db=null,K(a).then(function(m){return a.db=m,Y(a)?G(a):m}).then(function(m){a.db=g.db=m;for(var E=0;E<u.length;E++)u[E]._dbInfo.db=m}).catch(function(m){throw q(a,m),m})}function l1(a,g,u,L){L===void 0&&(L=1);try{var y=a.db.transaction(a.storeName,g);u(null,y)}catch(m){if(L>0&&(!a.db||m.name==="InvalidStateError"||m.name==="NotFoundError"))return d.resolve().then(function(){if(!a.db||m.name==="NotFoundError"&&!a.db.objectStoreNames.contains(a.storeName)&&a.version<=a.db.version)return a.db&&(a.version=a.db.version+1),G(a)}).then(function(){return y1(a).then(function(){l1(a,g,u,L-1)})}).catch(u);u(m)}}function r1(){return{forages:[],db:null,dbReady:null,deferredOperations:[]}}function u1(a){var g=this,u={db:null};if(a)for(var L in a)u[L]=a[L];var y=$[u.name];y||(y=r1(),$[u.name]=y),y.forages.push(g),g._initReady||(g._initReady=g.ready,g.ready=b1);var m=[];function E(){return d.resolve()}for(var R=0;R<y.forages.length;R++){var Z=y.forages[R];Z!==g&&m.push(Z._initReady().catch(E))}var A=y.forages.slice(0);return d.all(m).then(function(){return u.db=y.db,K(u)}).then(function(B){return u.db=B,Y(u,g._defaultConfig.version)?G(u):B}).then(function(B){u.db=y.db=B,g._dbInfo=u;for(var j=0;j<A.length;j++){var Q=A[j];Q!==g&&(Q._dbInfo.db=u.db,Q._dbInfo.version=u.version)}})}function L1(a,g){var u=this;a=S(a);var L=new d(function(y,m){u.ready().then(function(){l1(u._dbInfo,k,function(E,R){if(E)return m(E);try{var Z=R.objectStore(u._dbInfo.storeName),A=Z.get(a);A.onsuccess=function(){var B=A.result;B===void 0&&(B=null),C1(B)&&(B=s1(B)),y(B)},A.onerror=function(){m(A.error)}}catch(B){m(B)}})}).catch(m)});return w(L,g),L}function _1(a,g){var u=this,L=new d(function(y,m){u.ready().then(function(){l1(u._dbInfo,k,function(E,R){if(E)return m(E);try{var Z=R.objectStore(u._dbInfo.storeName),A=Z.openCursor(),B=1;A.onsuccess=function(){var j=A.result;if(j){var Q=j.value;C1(Q)&&(Q=s1(Q));var t1=a(Q,j.key,B++);t1!==void 0?y(t1):j.continue()}else y()},A.onerror=function(){m(A.error)}}catch(j){m(j)}})}).catch(m)});return w(L,g),L}function $1(a,g,u){var L=this;a=S(a);var y=new d(function(m,E){var R;L.ready().then(function(){return R=L._dbInfo,O.call(g)==="[object Blob]"?X(R.db).then(function(Z){return Z?g:e1(g)}):g}).then(function(Z){l1(L._dbInfo,M,function(A,B){if(A)return E(A);try{var j=B.objectStore(L._dbInfo.storeName);Z===null&&(Z=void 0);var Q=j.put(Z,a);B.oncomplete=function(){Z===void 0&&(Z=null),m(Z)},B.onabort=B.onerror=function(){var t1=Q.error?Q.error:Q.transaction.error;E(t1)}}catch(t1){E(t1)}})}).catch(E)});return w(y,u),y}function k1(a,g){var u=this;a=S(a);var L=new d(function(y,m){u.ready().then(function(){l1(u._dbInfo,M,function(E,R){if(E)return m(E);try{var Z=R.objectStore(u._dbInfo.storeName),A=Z.delete(a);R.oncomplete=function(){y()},R.onerror=function(){m(A.error)},R.onabort=function(){var B=A.error?A.error:A.transaction.error;m(B)}}catch(B){m(B)}})}).catch(m)});return w(L,g),L}function U1(a){var g=this,u=new d(function(L,y){g.ready().then(function(){l1(g._dbInfo,M,function(m,E){if(m)return y(m);try{var R=E.objectStore(g._dbInfo.storeName),Z=R.clear();E.oncomplete=function(){L()},E.onabort=E.onerror=function(){var A=Z.error?Z.error:Z.transaction.error;y(A)}}catch(A){y(A)}})}).catch(y)});return w(u,a),u}function D0(a){var g=this,u=new d(function(L,y){g.ready().then(function(){l1(g._dbInfo,k,function(m,E){if(m)return y(m);try{var R=E.objectStore(g._dbInfo.storeName),Z=R.count();Z.onsuccess=function(){L(Z.result)},Z.onerror=function(){y(Z.error)}}catch(A){y(A)}})}).catch(y)});return w(u,a),u}function O0(a,g){var u=this,L=new d(function(y,m){if(a<0){y(null);return}u.ready().then(function(){l1(u._dbInfo,k,function(E,R){if(E)return m(E);try{var Z=R.objectStore(u._dbInfo.storeName),A=!1,B=Z.openKeyCursor();B.onsuccess=function(){var j=B.result;if(!j){y(null);return}a===0||A?y(j.key):(A=!0,j.advance(a))},B.onerror=function(){m(B.error)}}catch(j){m(j)}})}).catch(m)});return w(L,g),L}function R0(a){var g=this,u=new d(function(L,y){g.ready().then(function(){l1(g._dbInfo,k,function(m,E){if(m)return y(m);try{var R=E.objectStore(g._dbInfo.storeName),Z=R.openKeyCursor(),A=[];Z.onsuccess=function(){var B=Z.result;if(!B){L(A);return}A.push(B.key),B.continue()},Z.onerror=function(){y(Z.error)}}catch(B){y(B)}})}).catch(y)});return w(u,a),u}function V0(a,g){g=N.apply(this,arguments);var u=this.config();a=typeof a!="function"&&a||{},a.name||(a.name=a.name||u.name,a.storeName=a.storeName||u.storeName);var L=this,y;if(!a.name)y=d.reject("Invalid arguments");else{var m=a.name===u.name&&L._dbInfo.db,E=m?d.resolve(L._dbInfo.db):K(a).then(function(R){var Z=$[a.name],A=Z.forages;Z.db=R;for(var B=0;B<A.length;B++)A[B]._dbInfo.db=R;return R});a.storeName?y=E.then(function(R){if(R.objectStoreNames.contains(a.storeName)){var Z=R.version+1;F(a);var A=$[a.name],B=A.forages;R.close();for(var j=0;j<B.length;j++){var Q=B[j];Q._dbInfo.db=null,Q._dbInfo.version=Z}var t1=new d(function(n1,c1){var a1=v.open(a.name,Z);a1.onerror=function(I1){var le=a1.result;le.close(),c1(I1)},a1.onupgradeneeded=function(){var I1=a1.result;I1.deleteObjectStore(a.storeName)},a1.onsuccess=function(){var I1=a1.result;I1.close(),n1(I1)}});return t1.then(function(n1){A.db=n1;for(var c1=0;c1<B.length;c1++){var a1=B[c1];a1._dbInfo.db=n1,W(a1._dbInfo)}}).catch(function(n1){throw(q(a,n1)||d.resolve()).catch(function(){}),n1})}}):y=E.then(function(R){F(a);var Z=$[a.name],A=Z.forages;R.close();for(var B=0;B<A.length;B++){var j=A[B];j._dbInfo.db=null}var Q=new d(function(t1,n1){var c1=v.deleteDatabase(a.name);c1.onerror=function(){var a1=c1.result;a1&&a1.close(),n1(c1.error)},c1.onblocked=function(){console.warn('dropInstance blocked for database "'+a.name+'" until all open connections are closed')},c1.onsuccess=function(){var a1=c1.result;a1&&a1.close(),t1(a1)}});return Q.then(function(t1){Z.db=t1;for(var n1=0;n1<A.length;n1++){var c1=A[n1];W(c1._dbInfo)}}).catch(function(t1){throw(q(a,t1)||d.resolve()).catch(function(){}),t1})})}return w(y,g),y}var N0={_driver:"asyncStorage",_initStorage:u1,_support:p(),iterate:_1,getItem:L1,setItem:$1,removeItem:k1,clear:U1,length:D0,key:O0,keys:R0,dropInstance:V0};function T0(){return typeof openDatabase=="function"}var R1="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",$0="~~local_forage_type~",U6=/^~~local_forage_type~([^~]+)~/,De="__lfsc__:",v3=De.length,g3="arbf",p3="blob",j6="si08",z6="ui08",G6="uic8",W6="si16",Y6="si32",X6="ur16",q6="ui32",J6="fl32",Q6="fl64",K6=v3+g3.length,en=Object.prototype.toString;function tn(a){var g=a.length*.75,u=a.length,L,y=0,m,E,R,Z;a[a.length-1]==="="&&(g--,a[a.length-2]==="="&&g--);var A=new ArrayBuffer(g),B=new Uint8Array(A);for(L=0;L<u;L+=4)m=R1.indexOf(a[L]),E=R1.indexOf(a[L+1]),R=R1.indexOf(a[L+2]),Z=R1.indexOf(a[L+3]),B[y++]=m<<2|E>>4,B[y++]=(E&15)<<4|R>>2,B[y++]=(R&3)<<6|Z&63;return A}function m3(a){var g=new Uint8Array(a),u="",L;for(L=0;L<g.length;L+=3)u+=R1[g[L]>>2],u+=R1[(g[L]&3)<<4|g[L+1]>>4],u+=R1[(g[L+1]&15)<<2|g[L+2]>>6],u+=R1[g[L+2]&63];return g.length%3===2?u=u.substring(0,u.length-1)+"=":g.length%3===1&&(u=u.substring(0,u.length-2)+"=="),u}function x0(a,g){var u="";if(a&&(u=en.call(a)),a&&(u==="[object ArrayBuffer]"||a.buffer&&en.call(a.buffer)==="[object ArrayBuffer]")){var L,y=De;a instanceof ArrayBuffer?(L=a,y+=g3):(L=a.buffer,u==="[object Int8Array]"?y+=j6:u==="[object Uint8Array]"?y+=z6:u==="[object Uint8ClampedArray]"?y+=G6:u==="[object Int16Array]"?y+=W6:u==="[object Uint16Array]"?y+=X6:u==="[object Int32Array]"?y+=Y6:u==="[object Uint32Array]"?y+=q6:u==="[object Float32Array]"?y+=J6:u==="[object Float64Array]"?y+=Q6:g(new Error("Failed to get type for BinaryArray"))),g(y+m3(L))}else if(u==="[object Blob]"){var m=new FileReader;m.onload=function(){var E=$0+a.type+"~"+m3(this.result);g(De+p3+E)},m.readAsArrayBuffer(a)}else try{g(JSON.stringify(a))}catch(E){console.error("Couldn't convert value into a JSON string: ",a),g(null,E)}}function Z0(a){if(a.substring(0,v3)!==De)return JSON.parse(a);var g=a.substring(K6),u=a.substring(v3,K6),L;if(u===p3&&U6.test(g)){var y=g.match(U6);L=y[1],g=g.substring(y[0].length)}var m=tn(g);switch(u){case g3:return m;case p3:return b([m],{type:L});case j6:return new Int8Array(m);case z6:return new Uint8Array(m);case G6:return new Uint8ClampedArray(m);case W6:return new Int16Array(m);case X6:return new Uint16Array(m);case Y6:return new Int32Array(m);case q6:return new Uint32Array(m);case J6:return new Float32Array(m);case Q6:return new Float64Array(m);default:throw new Error("Unkown type: "+u)}}var b3={serialize:x0,deserialize:Z0,stringToBuffer:tn,bufferToString:m3};function nn(a,g,u,L){a.executeSql("CREATE TABLE IF NOT EXISTS "+g.storeName+" (id INTEGER PRIMARY KEY, key unique, value)",[],u,L)}function A0(a){var g=this,u={db:null};if(a)for(var L in a)u[L]=typeof a[L]!="string"?a[L].toString():a[L];var y=new d(function(m,E){try{u.db=openDatabase(u.name,String(u.version),u.description,u.size)}catch(R){return E(R)}u.db.transaction(function(R){nn(R,u,function(){g._dbInfo=u,m()},function(Z,A){E(A)})},E)});return u.serializer=b3,y}function V1(a,g,u,L,y,m){a.executeSql(u,L,y,function(E,R){R.code===R.SYNTAX_ERR?E.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?",[g.storeName],function(Z,A){A.rows.length?m(Z,R):nn(Z,g,function(){Z.executeSql(u,L,y,m)},m)},m):m(E,R)},m)}function P0(a,g){var u=this;a=S(a);var L=new d(function(y,m){u.ready().then(function(){var E=u._dbInfo;E.db.transaction(function(R){V1(R,E,"SELECT * FROM "+E.storeName+" WHERE key = ? LIMIT 1",[a],function(Z,A){var B=A.rows.length?A.rows.item(0).value:null;B&&(B=E.serializer.deserialize(B)),y(B)},function(Z,A){m(A)})})}).catch(m)});return w(L,g),L}function B0(a,g){var u=this,L=new d(function(y,m){u.ready().then(function(){var E=u._dbInfo;E.db.transaction(function(R){V1(R,E,"SELECT * FROM "+E.storeName,[],function(Z,A){for(var B=A.rows,j=B.length,Q=0;Q<j;Q++){var t1=B.item(Q),n1=t1.value;if(n1&&(n1=E.serializer.deserialize(n1)),n1=a(n1,t1.key,Q+1),n1!==void 0){y(n1);return}}y()},function(Z,A){m(A)})})}).catch(m)});return w(L,g),L}function rn(a,g,u,L){var y=this;a=S(a);var m=new d(function(E,R){y.ready().then(function(){g===void 0&&(g=null);var Z=g,A=y._dbInfo;A.serializer.serialize(g,function(B,j){j?R(j):A.db.transaction(function(Q){V1(Q,A,"INSERT OR REPLACE INTO "+A.storeName+" (key, value) VALUES (?, ?)",[a,B],function(){E(Z)},function(t1,n1){R(n1)})},function(Q){if(Q.code===Q.QUOTA_ERR){if(L>0){E(rn.apply(y,[a,Z,u,L-1]));return}R(Q)}})})}).catch(R)});return w(m,u),m}function F0(a,g,u){return rn.apply(this,[a,g,u,1])}function k0(a,g){var u=this;a=S(a);var L=new d(function(y,m){u.ready().then(function(){var E=u._dbInfo;E.db.transaction(function(R){V1(R,E,"DELETE FROM "+E.storeName+" WHERE key = ?",[a],function(){y()},function(Z,A){m(A)})})}).catch(m)});return w(L,g),L}function U0(a){var g=this,u=new d(function(L,y){g.ready().then(function(){var m=g._dbInfo;m.db.transaction(function(E){V1(E,m,"DELETE FROM "+m.storeName,[],function(){L()},function(R,Z){y(Z)})})}).catch(y)});return w(u,a),u}function j0(a){var g=this,u=new d(function(L,y){g.ready().then(function(){var m=g._dbInfo;m.db.transaction(function(E){V1(E,m,"SELECT COUNT(key) as c FROM "+m.storeName,[],function(R,Z){var A=Z.rows.item(0).c;L(A)},function(R,Z){y(Z)})})}).catch(y)});return w(u,a),u}function z0(a,g){var u=this,L=new d(function(y,m){u.ready().then(function(){var E=u._dbInfo;E.db.transaction(function(R){V1(R,E,"SELECT key FROM "+E.storeName+" WHERE id = ? LIMIT 1",[a+1],function(Z,A){var B=A.rows.length?A.rows.item(0).key:null;y(B)},function(Z,A){m(A)})})}).catch(m)});return w(L,g),L}function G0(a){var g=this,u=new d(function(L,y){g.ready().then(function(){var m=g._dbInfo;m.db.transaction(function(E){V1(E,m,"SELECT key FROM "+m.storeName,[],function(R,Z){for(var A=[],B=0;B<Z.rows.length;B++)A.push(Z.rows.item(B).key);L(A)},function(R,Z){y(Z)})})}).catch(y)});return w(u,a),u}function W0(a){return new d(function(g,u){a.transaction(function(L){L.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name <> '__WebKitDatabaseInfoTable__'",[],function(y,m){for(var E=[],R=0;R<m.rows.length;R++)E.push(m.rows.item(R).name);g({db:a,storeNames:E})},function(y,m){u(m)})},function(L){u(L)})})}function Y0(a,g){g=N.apply(this,arguments);var u=this.config();a=typeof a!="function"&&a||{},a.name||(a.name=a.name||u.name,a.storeName=a.storeName||u.storeName);var L=this,y;return a.name?y=new d(function(m){var E;a.name===u.name?E=L._dbInfo.db:E=openDatabase(a.name,"","",0),a.storeName?m({db:E,storeNames:[a.storeName]}):m(W0(E))}).then(function(m){return new d(function(E,R){m.db.transaction(function(Z){function A(t1){return new d(function(n1,c1){Z.executeSql("DROP TABLE IF EXISTS "+t1,[],function(){n1()},function(a1,I1){c1(I1)})})}for(var B=[],j=0,Q=m.storeNames.length;j<Q;j++)B.push(A(m.storeNames[j]));d.all(B).then(function(){E()}).catch(function(t1){R(t1)})},function(Z){R(Z)})})}):y=d.reject("Invalid arguments"),w(y,g),y}var X0={_driver:"webSQLStorage",_initStorage:A0,_support:T0(),iterate:B0,getItem:P0,setItem:F0,removeItem:k0,clear:U0,length:j0,key:z0,keys:G0,dropInstance:Y0};function q0(){try{return typeof localStorage<"u"&&"setItem"in localStorage&&!!localStorage.setItem}catch{return!1}}function on(a,g){var u=a.name+"/";return a.storeName!==g.storeName&&(u+=a.storeName+"/"),u}function J0(){var a="_localforage_support_test";try{return localStorage.setItem(a,!0),localStorage.removeItem(a),!1}catch{return!0}}function Q0(){return!J0()||localStorage.length>0}function K0(a){var g=this,u={};if(a)for(var L in a)u[L]=a[L];return u.keyPrefix=on(a,g._defaultConfig),Q0()?(g._dbInfo=u,u.serializer=b3,d.resolve()):d.reject()}function e5(a){var g=this,u=g.ready().then(function(){for(var L=g._dbInfo.keyPrefix,y=localStorage.length-1;y>=0;y--){var m=localStorage.key(y);m.indexOf(L)===0&&localStorage.removeItem(m)}});return w(u,a),u}function t5(a,g){var u=this;a=S(a);var L=u.ready().then(function(){var y=u._dbInfo,m=localStorage.getItem(y.keyPrefix+a);return m&&(m=y.serializer.deserialize(m)),m});return w(L,g),L}function n5(a,g){var u=this,L=u.ready().then(function(){for(var y=u._dbInfo,m=y.keyPrefix,E=m.length,R=localStorage.length,Z=1,A=0;A<R;A++){var B=localStorage.key(A);if(B.indexOf(m)===0){var j=localStorage.getItem(B);if(j&&(j=y.serializer.deserialize(j)),j=a(j,B.substring(E),Z++),j!==void 0)return j}}});return w(L,g),L}function r5(a,g){var u=this,L=u.ready().then(function(){var y=u._dbInfo,m;try{m=localStorage.key(a)}catch{m=null}return m&&(m=m.substring(y.keyPrefix.length)),m});return w(L,g),L}function o5(a){var g=this,u=g.ready().then(function(){for(var L=g._dbInfo,y=localStorage.length,m=[],E=0;E<y;E++){var R=localStorage.key(E);R.indexOf(L.keyPrefix)===0&&m.push(R.substring(L.keyPrefix.length))}return m});return w(u,a),u}function i5(a){var g=this,u=g.keys().then(function(L){return L.length});return w(u,a),u}function l5(a,g){var u=this;a=S(a);var L=u.ready().then(function(){var y=u._dbInfo;localStorage.removeItem(y.keyPrefix+a)});return w(L,g),L}function s5(a,g,u){var L=this;a=S(a);var y=L.ready().then(function(){g===void 0&&(g=null);var m=g;return new d(function(E,R){var Z=L._dbInfo;Z.serializer.serialize(g,function(A,B){if(B)R(B);else try{localStorage.setItem(Z.keyPrefix+a,A),E(m)}catch(j){(j.name==="QuotaExceededError"||j.name==="NS_ERROR_DOM_QUOTA_REACHED")&&R(j),R(j)}})})});return w(y,u),y}function a5(a,g){if(g=N.apply(this,arguments),a=typeof a!="function"&&a||{},!a.name){var u=this.config();a.name=a.name||u.name,a.storeName=a.storeName||u.storeName}var L=this,y;return a.name?y=new d(function(m){a.storeName?m(on(a,L._defaultConfig)):m(a.name+"/")}).then(function(m){for(var E=localStorage.length-1;E>=0;E--){var R=localStorage.key(E);R.indexOf(m)===0&&localStorage.removeItem(R)}}):y=d.reject("Invalid arguments"),w(y,g),y}var c5={_driver:"localStorageWrapper",_initStorage:K0,_support:q0(),iterate:n5,getItem:t5,setItem:s5,removeItem:l5,clear:e5,length:i5,key:r5,keys:o5,dropInstance:a5},u5=function(g,u){return g===u||typeof g=="number"&&typeof u=="number"&&isNaN(g)&&isNaN(u)},d5=function(g,u){for(var L=g.length,y=0;y<L;){if(u5(g[y],u))return!0;y++}return!1},ln=Array.isArray||function(a){return Object.prototype.toString.call(a)==="[object Array]"},ie={},sn={},j1={INDEXEDDB:N0,WEBSQL:X0,LOCALSTORAGE:c5},f5=[j1.INDEXEDDB._driver,j1.WEBSQL._driver,j1.LOCALSTORAGE._driver],Oe=["dropInstance"],L3=["clear","getItem","iterate","key","keys","length","removeItem","setItem"].concat(Oe),h5={description:"",driver:f5.slice(),name:"localforage",size:4980736,storeName:"keyvaluepairs",version:1};function C5(a,g){a[g]=function(){var u=arguments;return a.ready().then(function(){return a[g].apply(a,u)})}}function w3(){for(var a=1;a<arguments.length;a++){var g=arguments[a];if(g)for(var u in g)g.hasOwnProperty(u)&&(ln(g[u])?arguments[0][u]=g[u].slice():arguments[0][u]=g[u])}return arguments[0]}var v5=(function(){function a(g){i(this,a);for(var u in j1)if(j1.hasOwnProperty(u)){var L=j1[u],y=L._driver;this[u]=y,ie[y]||this.defineDriver(L)}this._defaultConfig=w3({},h5),this._config=w3({},this._defaultConfig,g),this._driverSet=null,this._initDriver=null,this._ready=!1,this._dbInfo=null,this._wrapLibraryMethodsWithReady(),this.setDriver(this._config.driver).catch(function(){})}return a.prototype.config=function(u){if((typeof u>"u"?"undefined":l(u))==="object"){if(this._ready)return new Error("Can't call config() after localforage has been used.");for(var L in u){if(L==="storeName"&&(u[L]=u[L].replace(/\W/g,"_")),L==="version"&&typeof u[L]!="number")return new Error("Database version must be a number.");this._config[L]=u[L]}return"driver"in u&&u.driver?this.setDriver(this._config.driver):!0}else return typeof u=="string"?this._config[u]:this._config},a.prototype.defineDriver=function(u,L,y){var m=new d(function(E,R){try{var Z=u._driver,A=new Error("Custom driver not compliant; see https://mozilla.github.io/localForage/#definedriver");if(!u._driver){R(A);return}for(var B=L3.concat("_initStorage"),j=0,Q=B.length;j<Q;j++){var t1=B[j],n1=!d5(Oe,t1);if((n1||u[t1])&&typeof u[t1]!="function"){R(A);return}}var c1=function(){for(var le=function(m5){return function(){var b5=new Error("Method "+m5+" is not implemented by the current driver"),an=d.reject(b5);return w(an,arguments[arguments.length-1]),an}},y3=0,p5=Oe.length;y3<p5;y3++){var I3=Oe[y3];u[I3]||(u[I3]=le(I3))}};c1();var a1=function(le){ie[Z]&&console.info("Redefining LocalForage driver: "+Z),ie[Z]=u,sn[Z]=le,E()};"_support"in u?u._support&&typeof u._support=="function"?u._support().then(a1,R):a1(!!u._support):a1(!0)}catch(I1){R(I1)}});return I(m,L,y),m},a.prototype.driver=function(){return this._driver||null},a.prototype.getDriver=function(u,L,y){var m=ie[u]?d.resolve(ie[u]):d.reject(new Error("Driver not found."));return I(m,L,y),m},a.prototype.getSerializer=function(u){var L=d.resolve(b3);return I(L,u),L},a.prototype.ready=function(u){var L=this,y=L._driverSet.then(function(){return L._ready===null&&(L._ready=L._initDriver()),L._ready});return I(y,u,u),y},a.prototype.setDriver=function(u,L,y){var m=this;ln(u)||(u=[u]);var E=this._getSupportedDrivers(u);function R(){m._config.driver=m.driver()}function Z(j){return m._extend(j),R(),m._ready=m._initStorage(m._config),m._ready}function A(j){return function(){var Q=0;function t1(){for(;Q<j.length;){var n1=j[Q];return Q++,m._dbInfo=null,m._ready=null,m.getDriver(n1).then(Z).catch(t1)}R();var c1=new Error("No available storage method found.");return m._driverSet=d.reject(c1),m._driverSet}return t1()}}var B=this._driverSet!==null?this._driverSet.catch(function(){return d.resolve()}):d.resolve();return this._driverSet=B.then(function(){var j=E[0];return m._dbInfo=null,m._ready=null,m.getDriver(j).then(function(Q){m._driver=Q._driver,R(),m._wrapLibraryMethodsWithReady(),m._initDriver=A(E)})}).catch(function(){R();var j=new Error("No available storage method found.");return m._driverSet=d.reject(j),m._driverSet}),I(this._driverSet,L,y),this._driverSet},a.prototype.supports=function(u){return!!sn[u]},a.prototype._extend=function(u){w3(this,u)},a.prototype._getSupportedDrivers=function(u){for(var L=[],y=0,m=u.length;y<m;y++){var E=u[y];this.supports(E)&&L.push(E)}return L},a.prototype._wrapLibraryMethodsWithReady=function(){for(var u=0,L=L3.length;u<L;u++)C5(this,L3[u])},a.prototype.createInstance=function(u){return new a(u)},a})(),g5=new v5;r.exports=g5},{3:3}]},{},[4])(4)})})(s3)),s3.exports}var Y4=W4();const T1=G4(Y4);class a3{getItem(n){return T1.getItem(n)}setItem(n,t){return T1.setItem(n,t)}removeItem(n){return T1.removeItem(n)}clear(){return T1.clear()}key(n){return T1.key(n)}keys(){return T1.keys()}iterate(n){return T1.iterate(n)}}var X4=Object.getOwnPropertyDescriptor,q4=(e,n,t,r)=>{for(var o=r>1?void 0:r?X4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},$6=(e,n)=>(t,r)=>n(t,r,e);h.DesktopMessageService=class extends f.Disposable{constructor(n,t){super(),this._injector=n,this._uiPartsService=t,this._initUIPart()}_initUIPart(){this.disposeWithMe(this._uiPartsService.registerComponent(i1.GLOBAL,()=>V.connectInjector(T.Messager,this._injector)))}dispose(){T.removeMessage()}show(n){let t=n;return typeof n.id>"u"&&(t=Object.assign({},n,{id:`message-${Date.now()}`})),T.message(t),f.toDisposable(()=>T.removeMessage(t.id))}remove(n){T.removeMessage(n)}removeAll(){T.removeMessage()}},h.DesktopMessageService=q4([$6(0,f.Inject(f.Injector)),$6(1,w1)],h.DesktopMessageService);function J4(){const e=V.useDependency(f.ThemeService),n=V.useObservable(e.darkMode$);return C.jsx(T.Toaster,{theme:n?"dark":"light"})}const Q4={show:e=>{const{type:n="message",title:t,content:r,duration:o,closable:l=!0,position:i="top-right"}=e;T.toast[n](t,{position:i,description:r,duration:o,closeButton:l})}};var K4=Object.getOwnPropertyDescriptor,e0=(e,n,t,r)=>{for(var o=r>1?void 0:r?K4(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},x6=(e,n)=>(t,r)=>n(t,r,e);h.DesktopNotificationService=class extends f.Disposable{constructor(n,t){super(),this._injector=n,this._uiPartsService=t,this._initUIPart()}show(n){return Q4.show(n),f.toDisposable(()=>{})}_initUIPart(){this.disposeWithMe(this._uiPartsService.registerComponent(i1.GLOBAL,()=>V.connectInjector(J4,this._injector)))}},h.DesktopNotificationService=e0([x6(0,f.Inject(f.Injector)),x6(1,w1)],h.DesktopNotificationService);class c3{constructor(){z(this,"_sidebarOptions",{});z(this,"sidebarOptions$",new U.Subject);z(this,"scrollEvent$",new U.Subject);z(this,"_container")}get visible(){return this._sidebarOptions.visible||!1}get options(){return this._sidebarOptions}open(n){return this._sidebarOptions={...n,id:n.id,visible:!0},this.sidebarOptions$.next(this._sidebarOptions),f.toDisposable(()=>{this.close()})}close(n){n&&this._sidebarOptions.id!==n||(this._sidebarOptions={...this._sidebarOptions,visible:!1},this.sidebarOptions$.next(this._sidebarOptions),this._sidebarOptions.onClose&&this._sidebarOptions.onClose())}getContainer(){return this._container}setContainer(n){this._container=n}}var t0=Object.getOwnPropertyDescriptor,n0=(e,n,t,r)=>{for(var o=r>1?void 0:r?t0(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},r0=(e,n)=>(t,r)=>n(t,r,e);h.DesktopZenZoneService=class{constructor(n){z(this,"visible$",new U.BehaviorSubject(!1));z(this,"componentKey$",new U.ReplaySubject);z(this,"_temporaryHidden$",new U.BehaviorSubject(!1));z(this,"temporaryHidden$",this._temporaryHidden$.asObservable());z(this,"_visible",!1);this._componentManager=n}get visible(){return this._visible}get temporaryHidden(){return this._temporaryHidden$.getValue()}dispose(){this.visible$.next(!1),this.visible$.complete(),this.componentKey$.complete()}hide(){this._temporaryHidden$.next(!0)}show(){this._temporaryHidden$.next(!1)}set(n,t){return this._componentManager.register(n,t),this.componentKey$.next(n),f.toDisposable(()=>{this._componentManager.delete(n),this.visible$.complete(),this.componentKey$.complete()})}open(){this._visible=!0,this.visible$.next(!0)}close(){this._visible=!1,this.visible$.next(!1)}},h.DesktopZenZoneService=n0([r0(0,f.Inject(v1))],h.DesktopZenZoneService);var o0=Object.defineProperty,i0=Object.getOwnPropertyDescriptor,l0=(e,n,t)=>n in e?o0(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t,s0=(e,n,t,r)=>{for(var o=r>1?void 0:r?i0(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},u3=(e,n)=>(t,r)=>n(t,r,e),a0=(e,n,t)=>l0(e,n+"",t);const c0="UNIVER_MOBILE_UI_PLUGIN",u0="DISABLE_AUTO_FOCUS";h.UniverMobileUIPlugin=class extends f.Plugin{constructor(n=de,t,r,o){super(),this._config=n,this._contextService=t,this._injector=r,this._configService=o;const{menu:l,...i}=f.merge({popupRootId:`univer-popup-portal-${f.generateRandomId(6)}`},de,this._config);i.disableAutoFocus&&this._contextService.setContextValue(u0,!0),l&&this._configService.setConfig("menu",l,{merge:!0}),this._configService.setConfig(A1,i)}onStarting(){f.registerDependencies(this._injector,f.mergeOverrideWithDependencies([[v1],[te],[Y1],[se],[w1,{useClass:Ue}],[S1,{useClass:h.DesktopLayoutService}],[P1,{useClass:h.ShortcutService}],[he,{useClass:ke}],[M1,{useClass:h.MenuManagerService}],[ne,{useClass:Ye}],[o3,{useClass:h.BrowserClipboardService,lazy:!0}],[oe,{useClass:h.DesktopNotificationService,lazy:!0}],[Ie,{useClass:h.DesktopGalleryService,lazy:!0}],[ye,{useClass:h.DesktopDialogService,lazy:!0}],[we,{useClass:h.DesktopConfirmService,lazy:!0}],[x1,{useClass:c3,lazy:!0}],[Le,{useClass:h.DesktopZenZoneService,lazy:!0}],[be,{useClass:h.DesktopGlobalZoneService,lazy:!0}],[fe,{useClass:h.DesktopMessageService,lazy:!0}],[f.ILocalStorageService,{useClass:a3,lazy:!0}],[e3,{useClass:h.DesktopBeforeCloseService}],[l3,{useClass:i3}],[ge,{useClass:ze}],[ve],[re,{useFactory:n=>n.createInstance(Ke,this._config),deps:[f.Injector]}],[h.SharedController],[h.ErrorController],[h.ShortcutPanelController]],this._config.override)),f.touchDependencies(this._injector,[[re],[h.ErrorController]])}onReady(){f.touchDependencies(this._injector,[[h.SharedController]])}onSteady(){f.touchDependencies(this._injector,[[h.ShortcutPanelController]])}},a0(h.UniverMobileUIPlugin,"pluginName",c0),h.UniverMobileUIPlugin=s0([f.DependentOn(z1.UniverRenderEnginePlugin),u3(1,f.IContextService),u3(2,f.Inject(f.Injector)),u3(3,f.IConfigService)],h.UniverMobileUIPlugin);var d0=Object.defineProperty,f0=Object.getOwnPropertyDescriptor,h0=(e,n,t)=>n in e?d0(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t,C0=(e,n,t,r)=>{for(var o=r>1?void 0:r?f0(n,t):n,l=e.length-1,i;l>=0;l--)(i=e[l])&&(o=i(o)||o);return o},d3=(e,n)=>(t,r)=>n(t,r,e),v0=(e,n,t)=>h0(e,n+"",t);const Z6="UNIVER_UI_PLUGIN",A6="DISABLE_AUTO_FOCUS";h.UniverUIPlugin=class extends f.Plugin{constructor(n=de,t,r,o){super(),this._config=n,this._contextService=t,this._injector=r,this._configService=o;const{menu:l,...i}=f.merge({popupRootId:`univer-popup-portal-${f.generateRandomId(6)}`},de,this._config);i.disableAutoFocus&&this._contextService.setContextValue(A6,!0),l&&this._configService.setConfig("menu",l,{merge:!0}),this._configService.setConfig(A1,i)}onStarting(){f.registerDependencies(this._injector,f.mergeOverrideWithDependencies([[v1],[te],[Y1],[se],[w1,{useClass:Ue}],[S1,{useClass:h.DesktopLayoutService}],[P1,{useClass:h.ShortcutService}],[he,{useClass:ke}],[M1,{useClass:h.MenuManagerService}],[ne,{useClass:Ye}],[o3,{useClass:h.BrowserClipboardService,lazy:!0}],[oe,{useClass:h.DesktopNotificationService,lazy:!0}],[Ie,{useClass:h.DesktopGalleryService,lazy:!0}],[ye,{useClass:h.DesktopDialogService,lazy:!0}],[we,{useClass:h.DesktopConfirmService,lazy:!0}],[x1,{useClass:c3,lazy:!0}],[Le,{useClass:h.DesktopZenZoneService,lazy:!0}],[be,{useClass:h.DesktopGlobalZoneService,lazy:!0}],[fe,{useClass:h.DesktopMessageService,lazy:!0}],[f.ILocalStorageService,{useClass:a3,lazy:!0}],[e3,{useClass:h.DesktopBeforeCloseService}],[l3,{useClass:i3}],[ge,{useClass:ze}],[ve],[re,{useFactory:n=>n.createInstance(h.DesktopUIController,this._config),deps:[f.Injector]}],[h.SharedController],[h.ErrorController],[h.ShortcutPanelController]],this._config.override)),f.touchDependencies(this._injector,[[re],[h.ErrorController]])}onReady(){f.touchDependencies(this._injector,[[h.SharedController]])}onSteady(){f.touchDependencies(this._injector,[[h.ShortcutPanelController]])}},v0(h.UniverUIPlugin,"pluginName",Z6),h.UniverUIPlugin=C0([f.DependentOn(z1.UniverRenderEnginePlugin),d3(1,f.IContextService),d3(2,f.Inject(f.Injector)),d3(3,f.IConfigService)],h.UniverUIPlugin);class g0{show(n){return f.toDisposable(()=>{})}remove(n){}removeAll(){}setContainer(){}getContainer(){}}const p0=e=>{const t=V.useDependency(x1).getContainer();s.useEffect(()=>{if(t)return t.addEventListener("mousedown",e),()=>{t.removeEventListener("mousedown",e)}},[e,t])};function Se(e){return e.length===0?e:e.replace(/^\s+|\s+$/gm,"")}const m0=.75,P6=78,B6=9;function f3(e){var c;let n=e.childNodes;if(n.length===0)return e.textContent;if(n[0].nodeName==="DIV"&&(n=n[0].childNodes),n.length===1&&n[0].nodeName==="#text")return n[0].textContent;const t=[];let r=0,o=0,l=e.textContent||"";l+=`\r
`;for(let v=0;v<n.length;v++){let p=n[`${v}`],b;p.nodeName==="#text"?(b=(c=p.textContent)!=null?c:"",p=p.parentElement):b=p.innerText;const d=He(p);k6(b).forEach(I=>{const S=I.length;o+=S,r=o-S;const N=f.generateRandomId(6);t.push({sId:N,st:r,ed:o-1,ts:d})})}return{id:f.generateRandomId(6),body:{dataStream:l,textRuns:t},documentStyle:{}}}function He(e,n=""){var i,c;let t=(c=(i=e==null?void 0:e.style)==null?void 0:i.cssText)!=null?c:"";if(t+=n,t=t.replace(/[\r\n]+/g,""),t.length===0)return{};const r=t.split(";"),o={},l={t:"",r:"",b:"",l:""};return r.forEach(v=>{var w;const p=v.toLowerCase(),b=Se(p.substr(0,p.indexOf(":"))),d=Se(p.substr(p.indexOf(":")+1));if(b==="font-weight")d==="bold"||d==="700"?o.bl=1:o.bl=0;else if(b==="font-style")d==="italic"?o.it=1:o.it=0;else if(b==="font-family"){const I=Se(v),S=H0(I);o.ff=S}else if(b==="font-size"){let I=Number.parseInt(d);t.indexOf("vertical-align")>-1&&(t.indexOf("sub")>-1||t.indexOf("sup")>-1)&&(I*=2),d.indexOf("px")!==-1&&(I=S0(Number.parseInt(d,10))),o.fs=I}else if(b==="color"){const I=new f.ColorKit(d);o.cl={rgb:I.isValid?I.toRgbString():"rgb(0,0,0)"}}else if(b==="background"||b==="background-color"){const I=new f.ColorKit(d);I.isValid&&(o.bg={rgb:I.toRgbString()})}else if(b==="text-decoration-line")d==="underline"?(o.ul||(o.ul={s:1}),o.ul.s=1):d==="line-through"?(o.st||(o.st={s:1}),o.st.s=1):d==="overline"&&(o.ol||(o.ol={s:1}),o.ol.s=1);else if(b==="text-decoration-color")o.hasOwnProperty("ul")&&(o.ul||(o.ul={s:1,cl:{rgb:d}}),o.ul.cl={rgb:d}),o.hasOwnProperty("st")&&(o.st||(o.st={s:1,cl:{rgb:d}}),o.st.cl={rgb:d}),o.hasOwnProperty("ol")&&(o.ol||(o.ol={s:1,cl:{rgb:d}}),o.ol.cl={rgb:d});else if(b==="text-decoration-style")o.hasOwnProperty("ul")&&(o.ul||(o.ul={s:1,t:Number(d)}),o.ul.t=Number(d)),o.hasOwnProperty("st")&&(o.st||(o.st={s:1,t:Number(d)}),o.st.t=Number(d)),o.hasOwnProperty("ol")&&(o.ol||(o.ol={s:1,t:Number(d)}),o.ol.t=Number(d));else if(b==="text-decoration"||b==="univer-strike"){const I=(w=d.split(" "))==null?void 0:w[0];I==="underline"?(o.ul||(o.ul={s:1}),o.ul.s=1):I==="line-through"?(o.st||(o.st={s:1}),o.st.s=1):I==="overline"&&(o.ol||(o.ol={s:1}),o.ol.s=1)}if(b==="univer-underline"&&(o.ul={s:1}),b==="vertical-align"&&(d==="sub"?o.va=f.BaselineOffset.SUBSCRIPT:d==="super"?o.va=f.BaselineOffset.SUPERSCRIPT:d==="top"?o.vt=1:d==="middle"?o.vt=2:d==="bottom"?o.vt=3:o.va=f.BaselineOffset.NORMAL),b==="transform"){const I=d.split(")"),S=I.findIndex(N=>N.includes("rotate"));if(S>-1){const N=I[S].match(/\d+/g);let D=0,_=0;N!=null&&N.length&&(D=+N[0]),e!=null&&e.dataset.vertical&&(_=+e.dataset.vertical),o.tr={a:D,v:_}}}if(b==="text-align"&&(d==="left"?o.ht=1:d==="center"?o.ht=2:d==="right"?o.ht=3:d==="justify"?o.ht=4:o.ht=0),o.tb!==1&&(b==="overflow-wrap"||b==="word-wrap"?d==="break-word"&&(o.tb=3):b==="text-overflow"?d==="clip"&&(o.tb=2):b==="text-break"&&d==="overflow"&&(o.tb=1)),b==="white-space"&&(d==="nowrap"?o.tb=1:d==="normal"?o.tb=3:d==="clip"&&(o.tb=2)),b==="border-color"){const I=F6(d,")");if(o.bd)for(const S in I)o.bd[S].cl.rgb=I[S];else{o.bd={b:{cl:{rgb:"#000"},s:0},t:{cl:{rgb:"#000"},s:0},l:{cl:{rgb:"#000"},s:0},r:{cl:{rgb:"#000"},s:0}};for(const S in I)o.bd[S].cl.rgb=I[S]}}if(b==="border-width"||b==="border-style"){const I=F6(d," ");for(const S in I)l[S]+=` ${I[S]}`;o.bd?(o.bd.b.s=f.getBorderStyleType(l.b),o.bd.t.s=f.getBorderStyleType(l.t),o.bd.l.s=f.getBorderStyleType(l.l),o.bd.r.s=f.getBorderStyleType(l.r)):o.bd={b:{cl:{rgb:"#000"},s:f.getBorderStyleType(l.b)},t:{cl:{rgb:"#000"},s:f.getBorderStyleType(l.t)},l:{cl:{rgb:"#000"},s:f.getBorderStyleType(l.l)},r:{cl:{rgb:"#000"},s:f.getBorderStyleType(l.r)}}}if(b==="border-bottom"||b==="border-top"||b==="border-left"||b==="border-right"||b==="border"){o.bd||(o.bd={});const I=d.split(" "),S=`${I[0]} ${I[1]}`;I.splice(0,2);const N=I.join("");if(f.getBorderStyleType(S)!==f.BorderStyleTypes.NONE&&N){const _={cl:{rgb:N},s:f.getBorderStyleType(S)};b==="border-bottom"?o.bd.b=d==="none"?null:_:b==="border-top"?o.bd.t=d==="none"?null:_:b==="border-left"?o.bd.l=d==="none"?null:_:b==="border-right"?o.bd.r=d==="none"?null:_:b==="border"&&(o.bd={r:d==="none"?null:_,t:d==="none"?null:_,b:d==="none"?null:_,l:d==="none"?null:_})}}else if(b==="--data-rotate"){const I=/[+-]?\d+/,S=d.match(I);d==="(0deg ,1)"?o.tr={a:0,v:1}:S&&(o.tr={a:Number(S[0])})}}),Object.keys(o).forEach(v=>{typeof o[v]=="object"&&!Object.keys(o[v]).length&&delete o[v]}),o}function F6(e,n){let t;n===" "?t=e.trim().split(n):t=e.trim().split(n).slice(0,-1),t.forEach(o=>`${o.trim()})`);let r={};return t.length===1?r={t:t[0],r:t[0],b:t[0],l:t[0]}:t.length===2?r={t:t[0],r:t[1],b:t[0],l:t[1]}:t.length===3?r={t:t[0],r:t[1],b:t[2],l:t[1]}:t.length===4&&(r={t:t[0],r:t[1],b:t[2],l:t[3]}),r}function k6(e){if(e==="")return[e];const n=/(?:(\n+.+)|(.+))/g;return e.match(n).map(o=>o.replace(/\n/g,`\r
`))}function b0(e){const n=document.createElement("DIV"),t=[];n.innerHTML=e;const r=n.querySelectorAll("table col");if(!r.length)return[];for(let o=0;o<r.length;o++){const l=r[o],i=l.getAttribute("span");if(i&&+i>1)for(let c=0;c<+i;c++){const v=Ee(l.getAttribute("width"),72);t.push(v)}else{const c=Ee(l.getAttribute("width"),72);t.push(c)}}return t}function Ee(e,n){if(!e)return n;let t;return e.includes("pt")?t=z1.ptToPx(Number.parseFloat(e)):e.includes("px")?t=Number.parseFloat(e):t=Number.parseFloat(e)*72/96,t}function L0(e){const n=document.createElement("DIV"),t=[];n.innerHTML=e;const r=n.querySelectorAll("table tr");if(!r.length)return[];for(let o=0;o<r.length;o++){const i=r[o].querySelectorAll("td");let c=Ee(i[0].style.height,19);for(let v=0;v<i.length;v++){const p=i[v].getAttribute("rowSpan");if(!(p&&+p>1)){c=Ee(i[v].style.height,19);break}}t.push(c)}return t}function w0(e){let n=[];const t=document.createElement("DIV");if(t.innerHTML=e,n=new Array(t.querySelectorAll("table tr").length),!n.length)return[];let r=0;const o=t.querySelectorAll("table tr");o[0].querySelectorAll("td").forEach(c=>{let v=0;const p=c.getAttribute("colSpan");p!==null?v=+p:v=1,r+=v});for(let c=0;c<n.length;c++)n[c]=new Array(r);let i=0;return o.forEach(c=>{let v=0;c.querySelectorAll("td").forEach(p=>{var I,S;const b={};if(p.querySelectorAll("span").length||p.querySelectorAll("font").length){const N=f3(p);typeof N!="string"&&(b.p=N)}const d=p.innerText;d.trim().length===0?b.v="":b.v=d;const w=He(p);for(f.Tools.isPlainObject(w)&&(b.s=w);v<r&&n[i][v]!=null;)v++;if(v!==r){if(n[i][v]==null){n[i][v]=b;const N=(I=Number(p.getAttribute("rowSpan")))!=null?I:1,D=(S=Number(p.getAttribute("colSpan")))!=null?S:1;if(N>1||D>1){const _={rs:+N-1,cs:+D-1,r:i,c:v};n[i][v].mc=_;for(let $=0;$<N;$++)for(let O=0;O<D;O++)$===0&&O===0||(n[i+$][v+O]={mc:null})}}v++}}),i++}),n}function y0(e){const n=[],t=document.createElement("DIV");t.innerHTML=e;const o=e.replace(/\r/g,"").split(`
`),l=o[0].split("	").length;for(let i=0;i<o.length;i++)o[i].split("	").length<l||n.push(o[i].split("	"));for(let i=0;i<n.length;i++)for(let c=0;c<n[i].length;c++)n[i][c].length?n[i][c]={v:n[i][c]||"",m:n[i][c]||""}:n[i][c]=null;return n}function I0(e,n){e.length,e[0].length;let t=0,r=0;n&&(t=n.startRow,r=n.startColumn);const o=[];for(let l=0;l<e.length;l++)for(let i=0;i<e[l].length;i++)if(e[l][i]&&typeof e[l][i]=="object"&&"mc"in e[l][i])if(e[l][i].mc){const c=e[l][i].mc,v=c.r+t,p=v+c.rs,b=c.c+r,d=b+c.cs;o.push({startRow:v,endRow:p,startColumn:b,endColumn:d}),delete e[l][i].mc}else e[l][i]=null;return{data:e,mergeData:o}}function M0(e){var p;let n=[];const t=document.createElement("html");t.innerHTML=e;const r=(p=t.querySelector("style"))==null?void 0:p.innerText;if(!r)return;const o=_0(r);if(n=new Array(t.querySelectorAll("table tr").length),!n.length)return[];let l=0;const i=t.querySelectorAll("table tr");i[0].querySelectorAll("td").forEach(b=>{let d=0;const w=b.getAttribute("colSpan");w!==null?d=+w:d=1,l+=d});for(let b=0;b<n.length;b++)n[b]=new Array(l);let v=0;return i.forEach(b=>{let d=0;b.querySelectorAll("td").forEach(w=>{var _,$;const I={};if(w.querySelectorAll("span").length||w.querySelectorAll("font").length){const O=f3(w);typeof O!="string"&&(I.p=O)}const S=w.innerText;S.trim().length===0?I.v="":I.v=S;let N="";for(const O in o)w.classList.contains(O)&&(N+=o[O]);const D=He(w,N);for(f.Tools.isPlainObject(D)&&(I.s=D);d<l&&n[v][d]!=null;)d++;if(d!==l){if(n[v][d]==null){n[v][d]=I;const O=(_=Number(w.getAttribute("rowSpan")))!=null?_:1,k=($=Number(w.getAttribute("colSpan")))!=null?$:1;if(O>1||k>1){const M={rs:+O-1,cs:+k-1,r:v,c:d};n[v][d].mc=M;for(let x=0;x<O;x++)for(let P=0;P<k;P++)x===0&&P===0||(n[v+x][d+P]={mc:null})}}d++}}),v++}),n}function _0(e){const n={},t=e.replaceAll("<!--","").replaceAll("-->","").trim(),r=t==null?void 0:t.replaceAll("	","").replaceAll(`
`,"").split("}");for(let o=0;o<r.length;o++){if(!r[o])continue;let l=r[o].split("{")[0].trim();l.includes(".")&&(l=l.slice(1));const i=r[o].split("{")[1].trim();n[l]=i}return n}function S0(e){const n=Math.round(e*m0);return n<B6?B6:n>P6?P6:n}function H0(e){const n=/font-family:\s*(?:"([^"]+)"|'([^']+)'|([^;]+))/i,t=e.match(n);return t?(t[1]||t[2]||t[3]).trim():null}const E0=s.memo(e=>{var N,D;const{layer:n,id:t,position:r}=e,o=V.useDependency(f.IUniverInstanceService),l=s.useRef(null),i=s.useRef(null),c=s.useRef(`transform: rotate(${r==null?void 0:r.rotate}deg) translate(${r==null?void 0:r.startX}px, ${r==null?void 0:r.startY}px)`),v=s.useRef((N=r==null?void 0:r.startY)!=null?N:0),p=s.useRef((D=r==null?void 0:r.startX)!=null?D:0),b=typeof n.componentKey=="string"?V.useDependency(v1).get(n.componentKey):n.componentKey,d=s.useMemo(()=>({data:n.data,...n.props}),[n.data,n.props]),w={width:`${r.width-4}px`,height:`${r.height-4}px`,left:`${r.absolute.left?0:"auto"}`,top:`${r.absolute.top?0:"auto"}`,right:`${r.absolute.left?"auto":0}`,bottom:`${r.absolute.top?"auto":0}`};c.current=`rotate(${r.rotate}deg)`,v.current=r.startY,p.current=r.startX;const I=o.getUnit(n.unitId),S=s.useMemo(()=>b?C.jsx(b,{...d,unitId:n.unitId,unit:I,floatDomId:n.id,context:{root:i}}):null,[b,d]);return r?C.jsx("div",{ref:l,className:"univer-absolute univer-z-10 univer-origin-center univer-overflow-hidden",style:{top:v.current,left:p.current,width:Math.max(r.endX-r.startX-2,0),height:Math.max(r.endY-r.startY-2,0),transform:c.current},onPointerMove:_=>{n.onPointerMove(_.nativeEvent)},onPointerDown:_=>{n.onPointerDown(_.nativeEvent)},onPointerUp:_=>{n.onPointerUp(_.nativeEvent)},onWheel:_=>{n.onWheel(_.nativeEvent)},children:C.jsx("div",{ref:i,id:t,className:"univer-absolute univer-overflow-hidden",style:{...w},children:S})}):null});h.BuiltInUIPart=i1,h.COLOR_PICKER_COMPONENT=A9,h.COMMON_LABEL_COMPONENT=N9,h.CanvasFloatDomService=ve,h.CanvasPopup=Ge,h.CanvasPopupService=ze,h.CommonLabel=V9,h.ComponentContainer=p1,h.ComponentManager=v1,h.ContextMenu=w6,h.ContextMenuGroup=o1,h.ContextMenuPosition=E1,h.ContextMenuService=Ye,h.CopyCommand=Pe,h.CopyShortcutItem=a6,h.CustomLabel=d1,h.CutCommand=Be,h.CutShortcutItem=c6,h.DISABLE_AUTO_FOCUS_KEY=A6,h.DesktopLocalFileService=i3,h.DesktopLocalStorageService=a3,h.DesktopMenu=Ae,h.DesktopSidebarService=c3,h.FILE_PNG_CLIPBOARD_MIME_TYPE=S6,h.FILE_SVG_XML_CLIPBOARD_MIME_TYPE=E4,h.FILE__BMP_CLIPBOARD_MIME_TYPE=E6,h.FILE__JPEG_CLIPBOARD_MIME_TYPE=H6,h.FILE__WEBP_CLIPBOARD_MIME_TYPE=D6,h.FONT_FAMILY_COMPONENT=F9,h.FONT_FAMILY_ITEM_COMPONENT=k9,h.FONT_FAMILY_LIST=S2,h.FONT_SIZE_COMPONENT=j9,h.FONT_SIZE_LIST=H2,h.FloatDom=je,h.FloatDomSingle=f6,h.FontFamily=P9,h.FontFamilyItem=B9,h.FontSize=U9,h.GlobalZone=Xe,h.HEADING_ITEM_COMPONENT=$9,h.HEADING_LIST=E2,h.HTML_CLIPBOARD_MIME_TYPE=r3,h.HeadingItem=T9,h.IBeforeCloseService=e3,h.ICanvasPopupService=ge,h.IClipboardInterfaceService=o3,h.IConfirmService=we,h.IContextMenuService=ne,h.IDialogService=ye,h.IGalleryService=Ie,h.IGlobalZoneService=be,h.ILayoutService=S1,h.ILeftSidebarService=cn,h.ILocalFileService=l3,h.IMenuManagerService=M1,h.IMessageService=fe,h.INotificationService=oe,h.IPlatformService=he,h.IShortcutService=P1,h.ISidebarService=x1,h.IUIController=re,h.IUIPartsService=w1,h.IZenZoneService=Le,h.KeyCode=D1,h.MenuItemType=g1,h.MenuManagerPosition=X1,h.MetaKeys=h1,h.MobileContextMenu=I6,h.MockMessageService=g0,h.PLAIN_TEXT_CLIPBOARD_MIME_TYPE=n3,h.PasteCommand=Fe,h.PlatformService=ke,h.PrintFloatDomSingle=E0,h.ProgressBar=k2,h.RectPopup=pe,h.RedoShortcutItem=d6,h.Ribbon=L6,h.RibbonDataGroup=Z1,h.RibbonFormulasGroup=ue,h.RibbonInsertGroup=q1,h.RibbonOthersGroup=Ze,h.RibbonPosition=f1,h.RibbonStartGroup=H1,h.RibbonViewGroup=J1,h.SheetPasteShortKeyCommandName=X2,h.ShortcutPanelService=se,h.Sidebar=qe,h.SingleCanvasPopup=v6,h.SingleUnitUIController=Qe,h.Slider=_2,h.TestConfirmService=V4,h.ThemeSwitcherService=te,h.ToggleShortcutPanelOperation=G1,h.ToolbarButton=p6,h.ToolbarItem=ee,h.UIMenu=Ae,h.UIMenuSchema=t6,h.UIPartsService=Ue,h.UI_PLUGIN_CONFIG_KEY=A1,h.UNIVER_UI_PLUGIN_NAME=Z6,h.UNI_DISABLE_CHANGING_FOCUS_KEY=U2,h.UndoShortcutItem=u6,h.ZIndexManager=Y1,h.ZenZone=Je,h.getHeaderFooterMenuHiddenObservable=y2,h.getMenuHiddenObservable=w2,h.handelExcelToJson=M0,h.handelTableToJson=w0,h.handleDomToJson=f3,h.handlePlainToJson=y0,h.handleStringToStyle=He,h.handleTableColgroup=b0,h.handleTableMergeData=I0,h.handleTableRowGroup=L0,h.imageMimeTypeSet=D4,h.mergeMenuConfigs=O9,h.splitSpanText=k6,h.supportClipboardAPI=_6,h.t=T2,h.textTrim=Se,h.useClickOutSide=O2,h.useComponentsOfPart=m1,h.useConfigValue=Z9,h.useDebounceFn=R2,h.useEvent=N1,h.useObservableRef=R9,h.useScrollYOverContainer=x9,h.useSidebarClick=p0,h.useToolbarItemStatus=m6,h.useUpdateEffect=D2,h.useVirtualList=N2,Object.keys(V).forEach(e=>{e!=="default"&&!Object.prototype.hasOwnProperty.call(h,e)&&Object.defineProperty(h,e,{enumerable:!0,get:()=>V[e]})}),Object.defineProperty(h,Symbol.toStringTag,{value:"Module"})}));
