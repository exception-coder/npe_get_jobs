...
//#region ts/select-range-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const SelectRangeIcon = (0, react.forwardRef)(function SelectRangeIcon$1(props, ref) {
...
SelectRangeIcon.displayName = "SelectRangeIcon";
var select_range_icon_default = SelectRangeIcon;

//#endregion
exports.SelectRangeIcon = SelectRangeIcon;
exports.default = select_range_icon_default;