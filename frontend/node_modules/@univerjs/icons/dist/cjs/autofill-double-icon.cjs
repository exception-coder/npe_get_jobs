...
//#region ts/autofill-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const AutofillDoubleIcon = (0, react.forwardRef)(function AutofillDoubleIcon$1(props, ref) {
...
AutofillDoubleIcon.displayName = "AutofillDoubleIcon";
var autofill_double_icon_default = AutofillDoubleIcon;

//#endregion
exports.AutofillDoubleIcon = AutofillDoubleIcon;
exports.default = autofill_double_icon_default;