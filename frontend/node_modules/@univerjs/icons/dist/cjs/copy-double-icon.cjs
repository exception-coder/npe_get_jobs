...
//#region ts/copy-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const CopyDoubleIcon = (0, react.forwardRef)(function CopyDoubleIcon$1(props, ref) {
...
CopyDoubleIcon.displayName = "CopyDoubleIcon";
var copy_double_icon_default = CopyDoubleIcon;

//#endregion
exports.CopyDoubleIcon = CopyDoubleIcon;
exports.default = copy_double_icon_default;