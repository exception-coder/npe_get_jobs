...
//#region ts/create-copy-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const CreateCopyIcon = (0, react.forwardRef)(function CreateCopyIcon$1(props, ref) {
...
CreateCopyIcon.displayName = "CreateCopyIcon";
var create_copy_icon_default = CreateCopyIcon;

//#endregion
exports.CreateCopyIcon = CreateCopyIcon;
exports.default = create_copy_icon_default;