...
//#region ts/grid-outline-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const GridOutlineIcon = (0, react.forwardRef)(function GridOutlineIcon$1(props, ref) {
...
GridOutlineIcon.displayName = "GridOutlineIcon";
var grid_outline_icon_default = GridOutlineIcon;

//#endregion
exports.GridOutlineIcon = GridOutlineIcon;
exports.default = grid_outline_icon_default;