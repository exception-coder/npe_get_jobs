...
//#region ts/relationship-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
	...
	"children": [{
		...
		"children": [{
			"tag": "clipPath",
			"attrs": { "id": "relationship-icon_clip0_1997_112" },
			"children": [{
				"tag": "path",
				"attrs": {
					"fill": "white",
	...
	"defIds": ["relationship-icon_clip0_1997_112"]
};
const RelationshipIcon = (0, react.forwardRef)(function RelationshipIcon$1(props, ref) {
...
RelationshipIcon.displayName = "RelationshipIcon";
var relationship_icon_default = RelationshipIcon;

//#endregion
exports.RelationshipIcon = RelationshipIcon;
exports.default = relationship_icon_default;