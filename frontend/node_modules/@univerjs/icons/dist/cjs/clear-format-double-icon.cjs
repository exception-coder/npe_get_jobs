...
//#region ts/clear-format-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const ClearFormatDoubleIcon = (0, react.forwardRef)(function ClearFormatDoubleIcon$1(props, ref) {
...
ClearFormatDoubleIcon.displayName = "ClearFormatDoubleIcon";
var clear_format_double_icon_default = ClearFormatDoubleIcon;

//#endregion
exports.ClearFormatDoubleIcon = ClearFormatDoubleIcon;
exports.default = clear_format_double_icon_default;