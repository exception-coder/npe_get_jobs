...
//#region ts/ungroup-sparkline-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
	...
	"children": [{
		...
		"children": [{
			"tag": "clipPath",
			"attrs": { "id": "ungroup-sparkline-icon_clip0_1729_95" },
			"children": [{
				"tag": "path",
				"attrs": {
					"fill": "white",
	...
	"defIds": ["ungroup-sparkline-icon_clip0_1729_95"]
};
const UngroupSparklineIcon = (0, react.forwardRef)(function UngroupSparklineIcon$1(props, ref) {
	return (0, react.createElement)(ts_base.IconBase, Object.assign({}, props, {
		id: "ungroup-sparkline-icon",
		ref,
		icon: element
	}));
});
UngroupSparklineIcon.displayName = "UngroupSparklineIcon";
var ungroup_sparkline_icon_default = UngroupSparklineIcon;

//#endregion
exports.UngroupSparklineIcon = UngroupSparklineIcon;
exports.default = ungroup_sparkline_icon_default;