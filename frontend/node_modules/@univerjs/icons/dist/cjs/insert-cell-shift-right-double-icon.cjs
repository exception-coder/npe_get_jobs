...
//#region ts/insert-cell-shift-right-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const InsertCellShiftRightDoubleIcon = (0, react.forwardRef)(function InsertCellShiftRightDoubleIcon$1(props, ref) {
...
InsertCellShiftRightDoubleIcon.displayName = "InsertCellShiftRightDoubleIcon";
var insert_cell_shift_right_double_icon_default = InsertCellShiftRightDoubleIcon;

//#endregion
exports.InsertCellShiftRightDoubleIcon = InsertCellShiftRightDoubleIcon;
exports.default = insert_cell_shift_right_double_icon_default;