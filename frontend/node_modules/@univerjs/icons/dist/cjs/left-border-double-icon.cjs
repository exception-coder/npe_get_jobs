...
//#region ts/left-border-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
LeftBorderDoubleIcon.displayName = "LeftBorderDoubleIcon";
var left_border_double_icon_default = LeftBorderDoubleIcon;

//#endregion
exports.LeftBorderDoubleIcon = LeftBorderDoubleIcon;
exports.default = left_border_double_icon_default;