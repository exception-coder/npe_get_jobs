...
//#region ts/insert-row-above-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
InsertRowAboveDoubleIcon.displayName = "InsertRowAboveDoubleIcon";
var insert_row_above_double_icon_default = InsertRowAboveDoubleIcon;

//#endregion
exports.InsertRowAboveDoubleIcon = InsertRowAboveDoubleIcon;
exports.default = insert_row_above_double_icon_default;