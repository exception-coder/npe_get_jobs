...
const element = {
	...
	"children": [{
		...
		"children": [{
			"tag": "clipPath",
			"attrs": { "id": "history-icon_clip0_907_281" },
			"children": [{
				"tag": "path",
				"attrs": {
					"fill": "white",
	...
	"defIds": ["history-icon_clip0_907_281"]
};
const HistoryIcon = (0, react.forwardRef)(function HistoryIcon$1(props, ref) {
...
exports.default = history_icon_default;