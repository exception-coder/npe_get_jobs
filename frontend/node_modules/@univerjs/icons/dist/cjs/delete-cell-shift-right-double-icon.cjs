...
//#region ts/delete-cell-shift-right-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const DeleteCellShiftRightDoubleIcon = (0, react.forwardRef)(function DeleteCellShiftRightDoubleIcon$1(props, ref) {
...
DeleteCellShiftRightDoubleIcon.displayName = "DeleteCellShiftRightDoubleIcon";
var delete_cell_shift_right_double_icon_default = DeleteCellShiftRightDoubleIcon;

//#endregion
exports.DeleteCellShiftRightDoubleIcon = DeleteCellShiftRightDoubleIcon;
exports.default = delete_cell_shift_right_double_icon_default;