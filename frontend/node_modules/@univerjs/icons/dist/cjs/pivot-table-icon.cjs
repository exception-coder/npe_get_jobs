...
//#region ts/pivot-table-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const PivotTableIcon = (0, react.forwardRef)(function PivotTableIcon$1(props, ref) {
...
PivotTableIcon.displayName = "PivotTableIcon";
var pivot_table_icon_default = PivotTableIcon;

//#endregion
exports.PivotTableIcon = PivotTableIcon;
exports.default = pivot_table_icon_default;