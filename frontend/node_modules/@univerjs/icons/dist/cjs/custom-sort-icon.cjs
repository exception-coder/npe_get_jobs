...
//#region ts/custom-sort-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const CustomSortIcon = (0, react.forwardRef)(function CustomSortIcon$1(props, ref) {
...
CustomSortIcon.displayName = "CustomSortIcon";
var custom_sort_icon_default = CustomSortIcon;

//#endregion
exports.CustomSortIcon = CustomSortIcon;
exports.default = custom_sort_icon_default;