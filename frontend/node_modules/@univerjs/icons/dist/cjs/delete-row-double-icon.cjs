...
//#region ts/delete-row-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const DeleteRowDoubleIcon = (0, react.forwardRef)(function DeleteRowDoubleIcon$1(props, ref) {
...
DeleteRowDoubleIcon.displayName = "DeleteRowDoubleIcon";
var delete_row_double_icon_default = DeleteRowDoubleIcon;

//#endregion
exports.DeleteRowDoubleIcon = DeleteRowDoubleIcon;
exports.default = delete_row_double_icon_default;