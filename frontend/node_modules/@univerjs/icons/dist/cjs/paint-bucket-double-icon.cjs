...
//#region ts/paint-bucket-double-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const PaintBucketDoubleIcon = (0, react.forwardRef)(function PaintBucketDoubleIcon$1(props, ref) {
...
PaintBucketDoubleIcon.displayName = "PaintBucketDoubleIcon";
var paint_bucket_double_icon_default = PaintBucketDoubleIcon;

//#endregion
exports.PaintBucketDoubleIcon = PaintBucketDoubleIcon;
exports.default = paint_bucket_double_icon_default;