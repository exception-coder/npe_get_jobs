<template>
  <section class="capabilities" :class="{ wide: active === 'resume' }" aria-labelledby="capability-title">
...
const items = [
  ...
  { id: 'resume', title: '简历表达', component: defineAsyncComponent(() => import('@/features/resume-optimizer/public-api').then(({ ResumeWorkspacePanel }) => ResumeWorkspacePanel)) },
] as const;
...
.capabilities.wide { max-width: 1380px; }
